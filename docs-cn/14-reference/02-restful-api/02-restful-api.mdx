...
:::note 
如果使用 taosd 提供的 RESTful API, 那么以上配置需要写在 taosd 的配置文件 taos.cfg 中。如果使用 taosAdaper 提供的 RESTful API, 那么需要参考 taosAdaper [对应的配置方法](https://github.com/taosdata/taosadapter/blob/develop/README-CN.md#%E5%A6%82%E4%BD%95%E4%BB%8E%E6%97%A7%E7%89%88%E6%9C%AC-tdengine-%E8%BF%81%E7%A7%BB%E5%88%B0-taosadapter)。
