...
该连接器是可以连接到 TDengine 2.0 版本的 Node.js 库。它的构建使您可以通过提供广泛的 API 尽可能多地使用它或尽可能少地使用它。如果您想要从表中检索的行数据的数组形式的原始数据，可以用对象包装该数据，以便您轻松操作和显示数据。
...
[API 参考](docs.taosdata.com/api/Node)
