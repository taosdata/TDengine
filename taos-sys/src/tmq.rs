...
//     macro_rules! todo_tmq {
//         () => {
//             unimplemented!(
//                 "unsupported function in {}",
//                 CStr::from_ptr(crate::taos_get_client_info()).to_string_lossy()
//             )
//         };
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_list_new() -> *mut tmq_list_t {
//         todo_tmq!()
//     }
//     #[no_mangle]
//     pub unsafe fn tmq_list_append(arg1: *mut tmq_list_t, arg2: *const c_char) -> i32 {
//         todo_tmq!()
//     }
//     #[no_mangle]
//     pub unsafe fn tmq_list_destroy(list: *mut tmq_list_t) {
//         todo_tmq!()
//     }
...
//     #[no_mangle]
//     pub unsafe fn tmq_err2str(err: tmq_resp_err_t) -> *const c_char {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_subscribe(tmq: *mut tmq_t, topic_list: *mut tmq_list_t) -> tmq_resp_err_t {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_unsubscribe(tmq: *mut tmq_t) -> tmq_resp_err_t {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_subscription(
//         tmq: *mut tmq_t,
//         topic_list: *mut *mut tmq_list_t,
//     ) -> tmq_resp_err_t {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_consumer_poll(tmq: *mut tmq_t, blocking_time: i64) -> *mut tmq_message_t {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_consumer_close(tmq: *mut tmq_t) -> tmq_resp_err_t {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_commit(
//         tmq: *mut tmq_t,
//         offsets: *const tmq_topic_vgroup_list_t,
//         async_: i32,
//     ) -> tmq_resp_err_t {
...
//     #[no_mangle]
//     pub unsafe fn tmq_seek(tmq: *mut tmq_t, offset: *const tmq_topic_vgroup_t) -> tmq_resp_err_t {
//         todo_tmq!()
//     }
...
//     #[no_mangle]
//     pub unsafe fn tmq_message_destroy(message: *mut tmq_message_t) {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_conf_new() -> *mut tmq_conf_t {
//         todo_tmq!()
//     }

//     #[no_mangle]
//     pub unsafe fn tmq_conf_destroy(conf: *mut tmq_conf_t) {
//         todo_tmq!()
//     }
...
//     #[no_mangle]
//     pub unsafe fn tmq_conf_set_offset_commit_cb(conf: *mut tmq_conf_t, cb: tmq_commit_cb) {

//     }

//     #[no_mangle]
//     pub unsafe fn tmqShowMsg(tmq_message: *const tmq_message_t) {
//         todo_tmq!()
//     }
//     #[no_mangle]
//     pub unsafe fn tmqGetSkipLogNum(tmq_message: *const tmq_message_t) -> i32 {
//         todo_tmq!()
//     }
// }
