...
SArray *mmGetMsgHandles() {
  ...
  if (dmSetMgmtHandle(pArray, TDMT_VND_QUERY_RETENTION_PROGRESS_RSP, mmPutMsgToReadQueue, 0) == NULL) goto _OVER;
  ...
  if (dmSetMgmtHandle(pArray, TDMT_VND_RECALC_RSMA_RSP, mmPutMsgToWriteQueue, 0) == NULL) goto _OVER;
  if (dmSetMgmtHandle(pArray, TDMT_VND_KILL_RETENTION_RSP, mmPutMsgToWriteQueue, 0) == NULL) goto _OVER;
