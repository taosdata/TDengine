...
SArray *dmGetMsgHandles() {
  ...
  if (dmSetMgmtHandle(pArray, TDMT_DND_CREATE_XNODE, dmPutNodeMsgToMgmtQueue, 0) == NULL) goto _OVER;
  if (dmSetMgmtHandle(pArray, TDMT_DND_DROP_XNODE, dmPutNodeMsgToMgmtQueue, 0) == NULL) goto _OVER;
