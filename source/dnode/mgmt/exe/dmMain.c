...
int mainWindows(int argc, char **argv) {
  ...
  if ((code = dmInit()) != 0) {
    if (code == TSDB_CODE_NOT_FOUND) {
      dError("Initialization of dnode failed because your current operating system is not supported. For more information and supported platforms, please visit https://www.taosdata.com/reference/supported.");
    } else {
