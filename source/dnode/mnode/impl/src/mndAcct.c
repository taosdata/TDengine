...
static int32_t  mndProcessCreateAcctReq(SMndMsg *pReq);
static int32_t  mndProcessAlterAcctReq(SMndMsg *pReq);
static int32_t  mndProcessDropAcctReq(SMndMsg *pReq);
