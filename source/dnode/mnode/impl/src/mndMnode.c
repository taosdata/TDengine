...
static int32_t mndProcessCreateMnodeReq(SRpcMsg *pReq) {
  ...
  auditRecord1(pReq, pMnode->clusterId, "createMnode", obj, "", createReq.sql, createReq.sqlLen);
...
static int32_t mndProcessDropMnodeReq(SRpcMsg *pReq) {
  ...
  auditRecord1(pReq, pMnode->clusterId, "dropMnode", obj, "", dropReq.sql, dropReq.sqlLen);
