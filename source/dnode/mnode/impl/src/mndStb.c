...
static int32_t  mndProcessMCreateStbReq(SMndMsg *pReq);
static int32_t  mndProcessMAlterStbReq(SMndMsg *pReq);
static int32_t  mndProcessMDropStbReq(SMndMsg *pReq);
static int32_t  mndProcessVCreateStbRsp(SMndMsg *pRsp);
static int32_t  mndProcessVAlterStbRsp(SMndMsg *pRsp);
static int32_t  mndProcessVDropStbRsp(SMndMsg *pRsp);
static int32_t  mndProcessTableMetaReq(SMndMsg *pReq);
static int32_t  mndGetStbMeta(SMndMsg *pReq, SShowObj *pShow, STableMetaRsp *pMeta);
static int32_t  mndRetrieveStb(SMndMsg *pReq, SShowObj *pShow, char *data, int32_t rows);
...
static int32_t mndCreateStb(SMnode *pMnode, SMndMsg *pReq, SMCreateStbReq *pCreate, SDbObj *pDb) {
  SStbObj stbObj = {0};
...
static int32_t mndAlterStb(SMnode *pMnode, SMndMsg *pReq, const SMAltertbReq *pAlter, SDbObj *pDb, SStbObj *pOld) {
  SStbObj stbObj = {0};
...
static int32_t mndDropStb(SMnode *pMnode, SMndMsg *pReq, SDbObj *pDb, SStbObj *pStb) {
  int32_t code = -1;
