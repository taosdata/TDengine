...
void *mndBuildVCreateRsmaReq(SMnode *pMnode, SVgObj *pVgroup, SStbObj *pStb, SRsmaObj *pObj, SMCreateRsmaReq *pCreate,
                             int32_t *pContLen) {
  int32_t         code = 0, lino = 0;
  void           *pBuf = NULL;
...
static int32_t mndSetCreateRsmaRedoActions(SMnode *pMnode, STrans *pTrans, SDbObj *pDb, SStbObj *pStb, SRsmaObj *pObj, SMCreateRsmaReq *pCreate) {
  int32_t code = 0;
  SSdb   *pSdb = pMnode->pSdb;
  SVgObj *pVgroup = NULL;
  void   *pIter = NULL;
...
static int32_t mndDropRsma(SMnode *pMnode, SRpcMsg *pReq, SDbObj *pDb, SRsmaObj *pObj) {
  ...
  // TAOS_CHECK_EXIT(mndSetDropRsmaRedoActions(pMnode, pTrans, pObj));
...
static int32_t mndCreateRsma(SMnode *pMnode, SRpcMsg *pReq, SUserObj *pUser, SDbObj *pDb, SStbObj *pStb, SMCreateRsmaReq *pCreate) {
  int32_t    code = 0, lino = 0;
  SRsmaObj   obj = {0};
