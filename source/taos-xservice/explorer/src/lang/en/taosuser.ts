export default {
  taosuser: {
    ...
    clsEnabled: 'Enable',
    clsRefreshInterval: 'Refresh Interval',
    clsUrl: 'Service URL',
    clsLicenseId: 'License ID',
    clsQuotaSlotId: 'Quota Slot ID',
    clsActiveTip:
      'Fetch the license through the CLS service. Disable CLS here before switching back to classic activation.',
    clsActiveLockedTip:
      'CLS activation is currently enabled. Switch to the CLS tab and disable CLS before using classic activation.',
    clsRefreshIntervalTip: 'Allowed range: 10 to 86400 seconds.',
    clsRefreshIntervalInvalidTip: 'CLS refresh interval must be an integer between 10 and 86400.',
    clsUrlRequiredTip: 'CLS service URL is required when CLS is enabled.',
    clsLicenseIdRequiredTip: 'CLS license ID is required when CLS is enabled.',
    clsQuotaSlotIdTip: 'Optional. If omitted, {value} is used by default.',
