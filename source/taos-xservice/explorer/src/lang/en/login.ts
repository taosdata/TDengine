export default {
  login: {
    ...
    oauthBindSuccess: "OAuth login successful, please complete TSDB user binding",
    oauthBindError: "OAuth account binding exception occurred",
    oauthLoginSuccess: "Login with OAuth successfully!",
    oauthProcessing: "Processing OAuth login...",
    ...
    copyright: "Copyright (c) 2026 by TDengine, All Rights Reserved.",
