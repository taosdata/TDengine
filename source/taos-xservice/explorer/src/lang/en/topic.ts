export default {
  topic: {
    ...
    clsEnabled: 'CLS Enabled',
    clsRefreshInterval: 'CLS Interval(s)',
    clsUrl: 'CLS URL',
    clsLicenseId: 'CLS License ID',
    clsQuotaSlotId: 'CLS Slot ID',
    clsLastSucTime: 'CLS Last Success',
    clsLastReqTime: 'CLS Last Request',
    clsLastFailReason: 'CLS Fail Reason',
    clsConfigInfo: 'CLS Config',
    none: 'None',
    version: 'Version',
    license: 'License',
    audit: 'Audit',
