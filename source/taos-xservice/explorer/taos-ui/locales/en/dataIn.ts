...
export default {
  ...
  transformer: {
    ...
    addRule: 'Add Rule',
    matchesResTb: 'Preview Match Results',
  ...
  csvSelectFiles: 'Please Upload Files',
  csvSelectFilesTip: 'Only CSV files are allowed, and the file size cannot exceed 100MB. Batch upload is supported.',
  csvKeepProcessedFile: 'Retain Processed Files',
  csvKeepProcessedFileDesc: 'Whether to retain the file after processing the CSV file.',
  ...
  ViewBackPage: 'Back',
  dataInTitle: 'Data In',
  dataInTaskTitle: 'Data In Task',
  createDataInTaskTitle: 'Create New Data In Task',
  viewDataInTaskTitle: 'View Task',
  editDataInTaskTitle: 'Edit Task',
  discardEditConfirm:
    'You have unsaved changes. Do you want to discard them and go back to Data In?',
