      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              description:
                'The expression to generate subtable names in TDengine. E.g., "tb_${tag1}_${tag2}", means the subtable name is composed of the values of tag1 and tag2, keyword measurement denote influxdb measurement name. If not specified, the default subtable naming convention is used.',
