...
import { rangeArr } from 'element-plus/es/components/time-picker/index';
import { castArray, hasClass } from 'element-plus/es/utils/index';
import { basicYearTableProps } from '../props/basic-year-table';
import { getValidDateOfYear } from '../utils';
import ElDatePickerCell from './basic-cell-render.tsx';
...
const handleYearTableClick = (event: MouseEvent | KeyboardEvent) => {
  const target = (event.target as HTMLElement)?.closest('td') as HTMLTableCellElement;
