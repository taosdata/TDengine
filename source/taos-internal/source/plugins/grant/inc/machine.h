...
#define GRANT_UNIQ_DFT_BASIC_VNODES        192
#define GRANT_UNIQ_DFT_BASIC_STORAGE_SIZE  1048576  // GB
...
#define GRANT_UNIQ_DFT_TDGPT_EXPIRE        GRANT_EXPIRE_DAY
#define GRANT_UNIQ_DFT_TDGPT_ANODE_NUM     1
...
#define GRANT_UNIQ_DFT_IDMP_TS_ATTRIBUTES  1000000
#define GRANT_UNIQ_DFT_IDMP_NTS_ATTRIBUTES 1000000
#define GRANT_UNIQ_DFT_IDMP_ELEMENTS       200000
#define GRANT_UNIQ_DFT_IDMP_SERVERS        1
#define GRANT_UNIQ_DFT_IDMP_CPU_CORES      256
#define GRANT_UNIQ_DFT_IDMP_USERS          5
#define GRANT_UNIQ_DFT_IDMP_BASIC_EXPIRE_DAY     GRANT_EXPIRE_DAY
#define GRANT_UNIQ_DFT_IDMP_VERSION_CTRL_EXPIRE  GRANT_EXPIRE_DAY
#define GRANT_UNIQ_DFT_IDMP_DATA_FORECAST_EXPIRE GRANT_EXPIRE_DAY
#define GRANT_UNIQ_DFT_IDMP_DATA_DETECT_EXPIRE   GRANT_EXPIRE_DAY
#define GRANT_UNIQ_DFT_IDMP_DATA_QUALITY_EXPIRE  GRANT_EXPIRE_DAY
#define GRANT_UNIQ_DFT_IDMP_AI_CHAT_GEN_EXPIRE   GRANT_EXPIRE_DAY
#else
...
#define GRANT_UNIQ_DFT_BASIC_CPU           GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_BASIC_VNODES        GRANT_UNIQ_UNLIMITED  
#define GRANT_UNIQ_DFT_BASIC_STORAGE_SIZE  GRANT_UNIQ_UNLIMITED
...
#define GRANT_UNIQ_DFT_TDGPT_EXPIRE        GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_TDGPT_ANODE_NUM     GRANT_UNIQ_UNLIMITED
...
#define GRANT_UNIQ_DFT_IDMP_TS_ATTRIBUTES  GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_IDMP_NTS_ATTRIBUTES GRANT_UNIQ_UNLIMITED
...
#define GRANT_UNIQ_DFT_IDMP_BASIC_EXPIRE_DAY     GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_IDMP_VERSION_CTRL_EXPIRE  GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_IDMP_DATA_FORECAST_EXPIRE GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_IDMP_DATA_DETECT_EXPIRE   GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_IDMP_DATA_QUALITY_EXPIRE  GRANT_UNIQ_UNLIMITED
#define GRANT_UNIQ_DFT_IDMP_AI_CHAT_GEN_EXPIRE   GRANT_UNIQ_UNLIMITED
#endif
...
#define GRANT_UNIQ_DFT_DATAIN_EXPIRE atoi(GRANT_DATAIN_EXPIRE)
#endif

#ifdef GRANT_DATAIN_NUMBER
#undef GRANT_UNIQ_DFT_DATAIN_NUM
#define GRANT_UNIQ_DFT_DATAIN_NUM atoi(GRANT_DATAIN_NUMBER)
#endif

// IDMP specific grant items
#ifdef GRANT_IDMP_BASIC_EXPIRE
#undef GRANT_UNIQ_DFT_IDMP_BASIC_EXPIRE_DAY
#define GRANT_UNIQ_DFT_IDMP_BASIC_EXPIRE_DAY atoi(GRANT_IDMP_BASIC_EXPIRE)
#endif

#ifdef GRANT_IDMP_TS_ATTR
#undef GRANT_UNIQ_DFT_IDMP_TS_ATTRIBUTES
#define GRANT_UNIQ_DFT_IDMP_TS_ATTRIBUTES atoll(GRANT_IDMP_TS_ATTR)
#endif

#ifdef GRANT_IDMP_NTS_ATTR
#undef GRANT_UNIQ_DFT_IDMP_NTS_ATTRIBUTES
#define GRANT_UNIQ_DFT_IDMP_NTS_ATTRIBUTES atoll(GRANT_IDMP_NTS_ATTR)
#endif

#ifdef GRANT_IDMP_ELEMENT
#undef GRANT_UNIQ_DFT_IDMP_ELEMENTS
#define GRANT_UNIQ_DFT_IDMP_ELEMENTS atoll(GRANT_IDMP_ELEMENT)
#endif

#ifdef GRANT_IDMP_SERVER
#undef GRANT_UNIQ_DFT_IDMP_SERVERS
#define GRANT_UNIQ_DFT_IDMP_SERVERS atoll(GRANT_IDMP_SERVER)
#endif

#ifdef GRANT_IDMP_CPU_CORE
#undef GRANT_UNIQ_DFT_IDMP_CPU_CORES
#define GRANT_UNIQ_DFT_IDMP_CPU_CORES atoll(GRANT_IDMP_CPU_CORE)
#endif

#ifdef GRANT_IDMP_USER
#undef GRANT_UNIQ_DFT_IDMP_USERS
#define GRANT_UNIQ_DFT_IDMP_USERS atoll(GRANT_IDMP_USER)
#endif

#ifdef GRANT_IDMP_VERSION_CTRL_EXPIRE
#undef GRANT_UNIQ_DFT_IDMP_VERSION_CTRL_EXPIRE
#define GRANT_UNIQ_DFT_IDMP_VERSION_CTRL_EXPIRE atoi(GRANT_IDMP_VERSION_CTRL_EXPIRE)
#endif

#ifdef GRANT_IDMP_DATA_FORECAST_EXPIRE
#undef GRANT_UNIQ_DFT_IDMP_DATA_FORECAST_EXPIRE
#define GRANT_UNIQ_DFT_IDMP_DATA_FORECAST_EXPIRE atoi(GRANT_IDMP_DATA_FORECAST_EXPIRE)
#endif

#ifdef GRANT_IDMP_DATA_DETECT_EXPIRE
#undef GRANT_UNIQ_DFT_IDMP_DATA_DETECT_EXPIRE
#define GRANT_UNIQ_DFT_IDMP_DATA_DETECT_EXPIRE atoi(GRANT_IDMP_DATA_DETECT_EXPIRE)
#endif

#ifdef GRANT_IDMP_DATA_QUALITY_EXPIRE
#undef GRANT_UNIQ_DFT_IDMP_DATA_QUALITY_EXPIRE
#define GRANT_UNIQ_DFT_IDMP_DATA_QUALITY_EXPIRE atoi(GRANT_IDMP_DATA_QUALITY_EXPIRE)
#endif

#ifdef GRANT_IDMP_AI_CHAT_GEN_EXPIRE
#undef GRANT_UNIQ_DFT_IDMP_AI_CHAT_GEN_EXPIRE
#define GRANT_UNIQ_DFT_IDMP_AI_CHAT_GEN_EXPIRE atoi(GRANT_IDMP_AI_CHAT_GEN_EXPIRE)
#endif
...
typedef struct {
  ...
  // variant fields
  SArray *pDataIns;  // SGrantDataIns // DataIn items, used by taosx
  // various fields used by taosd
  SArray *pItem64;   // SGrantItem64  // deprecated, just for compatibility
  SArray *pItemI64;  // SGrantItemI64 // grant index is stored, used by taosd itself
