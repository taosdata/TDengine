...
int main(int argc, char *argv[])
{
  ...
  printf("table_num:%d thread_num:%d cache:%d ablocks:%d tblocks tables:%d   \n", table_num, thread_num, cache, ablocks, tblocks, tables);
