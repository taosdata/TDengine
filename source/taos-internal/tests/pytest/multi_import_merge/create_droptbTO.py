...
class TDTestCase:
  ...
  def run(self):
    ...
    tdLog.info("================= step4")
    tdLog.info("import 5 data later with overlap into each left %d tables" %(9))
    ...
    tdLog.info("================= step6")
    tdLog.info("import 5 data later with overlap into each %d tables" %(self.ntables))
    startTime = self.startTime + self.rowsPerTable -3
    for rid in range(1,6):
      sqlcmd = ['import into']
      for tid in range(1,self.ntables+1):
    ...
    tdLog.info("================= step8")
    tdLog.info("import 5 data before with overlap into each left %d tables" %(9))
    startTime = self.startTime + self.rowsPerTable -3
    for rid in range(1,6):
      sqlcmd = ['import into']
    ...
    tdLog.info("================= step10")
    tdLog.info("import 2 data before with overlap into each left %d tables" %(self.ntables))
    startTime = self.startTime + self.rowsPerTable -3
    for rid in range(1,6):
      sqlcmd = ['import into']
      for tid in range(1,self.ntables+1):
    ...
    tdLog.info("================= step12")
    tdLog.info("import 2 data before with overlap into each left %d tables" %(9))
    startTime = self.startTime + self.rowsPerTable -3
    for rid in range(1,6):
      sqlcmd = ['import into']
    ...
    tdLog.info("================= step14")
    tdLog.info("import 2 data before with overlap into each %d tables" %(self.ntables))
    startTime = self.startTime + self.rowsPerTable -3
    for rid in range(1,6):
      sqlcmd = ['import into']
      for tid in range(1,self.ntables+1):
