...
class TDTestCase:
	...
	def Loop(self):
		...
		for i in range (self.insertBatchs) :
			val = 10 * i + 2
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 200, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 3
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 300, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 4
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 400, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 5
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 500, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 6
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 600, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 7
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 700, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 8
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 800, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 9
			sql = "insert into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 900, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 1
			sql = "import into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 100, val, val, val)
			cursor.execute(sql)
			
			val = 10 * i + 0
			sql = "import into db.t%s values(%d, %d, %d, %d)" % (threadIndex, timestamp + 0, val, val, val)
			cursor.execute(sql)
