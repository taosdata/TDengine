#define MyAppName "PowerDB"
#define MyAppPublisher "powerdb"
...
#define MyAppInstallDir "C:\PowerDB"
#define MyAppOutputDir "./"
#define MyAppSourceDir "C:\PowerDB"
;#define MyAppAllFile "\*"
...
;#define MyAppTaosExeName "\power.exe"
;#define MyAppTaosdemoExeName "\powerdemo.exe"
#define MyAppDLLName "\driver\taos.dll"
#define MyAppVersion "2.0"
#define MyAppInstallName "PowerDB-client-2.0.13.0-Windows-x64"
...
[Messages]
ConfirmUninstall=Do you really want to uninstall PowerDB from your computer?%n%nPress [Y] to completely delete %1 and all its components;%nPress [N] to keep the software on your computer.
