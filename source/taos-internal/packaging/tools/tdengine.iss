...
Source: {#MyAppSourceDir}\taos.exe; DestDir: "{app}"; Flags: igNoreversion
Source: {#MyAppSourceDir}\taosBenchmark.exe; DestDir: "{app}"; Flags: igNoreversion
Source: {#MyAppSourceDir}\taosdump.exe; DestDir: "{app}"; Flags: igNoreversion
