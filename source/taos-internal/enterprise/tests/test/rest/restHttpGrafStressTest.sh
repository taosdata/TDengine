...
table="metrics1"
echo "grafana query parallel"
parallel http --print HBhb OPTIONS 10.0.2.15:9090/grafana/query targets:='[{"target":"'{1}'"}]' --auth-type=jwt --auth="$token" < search.txt
