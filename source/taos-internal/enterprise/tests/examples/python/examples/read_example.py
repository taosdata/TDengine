"""
This is the sample code for TDengine python client.
"""
import taos
import numpy as np
import pandas as pd
...
if __name__ == '__main__':
    start_time = datetime.datetime(2018, 11, 29)
    ...
    conn = taos.connect(host="192.168.0.1", user="root", password="taosdata", config="/home/hzcheng/Documents/work/dnodes/dnode1/config")
