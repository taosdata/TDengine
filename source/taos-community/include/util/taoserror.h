...
#define TSDB_CODE_EXT_WIN_SUB_UNORDERED         TAOS_DEF_ERROR_CODE(0, 0x0142)
#define TSDB_CODE_MAC_INSUFFICIENT_LEVEL        TAOS_DEF_ERROR_CODE(0, 0x0143)
#define TSDB_CODE_MAC_OBJ_LEVEL_BELOW_DB        TAOS_DEF_ERROR_CODE(0, 0x0144)
#define TSDB_CODE_MAC_OBJ_LEVEL_BELOW_USER_MIN  TAOS_DEF_ERROR_CODE(0, 0x0145)
#define TSDB_CODE_MAC_OBJ_LEVEL_ABOVE_USER_MAX  TAOS_DEF_ERROR_CODE(0, 0x0146)
#define TSDB_CODE_MAC_INVALID_LEVEL             TAOS_DEF_ERROR_CODE(0, 0x0147)
#define TSDB_CODE_MAC_NO_WRITE_DOWN             TAOS_DEF_ERROR_CODE(0, 0x0148)
#define TSDB_CODE_MAC_SEC_LEVEL_CONFLICTS_ROLE  TAOS_DEF_ERROR_CODE(0, 0x0149)
#define TSDB_CODE_MAC_PRECHECK_FAILED           TAOS_DEF_ERROR_CODE(0, 0x014A)
...
#define TSDB_CODE_NOT_SUPPORTTED_IN_WINDOWS    TSDB_CODE_NOT_SUPPORTED_IN_WINDOWS
...
#define TSDB_CODE_TSC_SESS_CONN_TIMEOUT          TAOS_DEF_ERROR_CODE(0, 0x023A)
#define TSDB_CODE_TSC_SESS_CONN_IDLE_TIMEOUT     TAOS_DEF_ERROR_CODE(0, 0x023B)
...
#define TSDB_CODE_MND_TOO_MANY_CONNECTIONS      TAOS_DEF_ERROR_CODE(0, 0x0309)
...
#define TSDB_CODE_MND_USER_PASSWORD_EXPIRED     TAOS_DEF_ERROR_CODE(0, 0x0319)
...
// mnode-token
#define TSDB_CODE_MND_TOKEN_NOT_AVAILABLE       TAOS_DEF_ERROR_CODE(0, 0x0348)
#define TSDB_CODE_MND_TOKEN_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x0349)
#define TSDB_CODE_MND_TOKEN_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x034A)
#define TSDB_CODE_MND_TOO_MANY_TOKENS           TAOS_DEF_ERROR_CODE(0, 0x034B)
#define TSDB_CODE_MND_INVALID_TOKEN_NAME        TAOS_DEF_ERROR_CODE(0, 0x034C)
#define TSDB_CODE_MND_TOKEN_EXPIRED             TAOS_DEF_ERROR_CODE(0, 0x034D)
#define TSDB_CODE_MND_TOKEN_DISABLED            TAOS_DEF_ERROR_CODE(0, 0x034E)
...
#define TSDB_CODE_MND_DB_DROP_NOT_ALLOWED       TAOS_DEF_ERROR_CODE(0, 0x038F)
...
#define TSDB_CODE_MND_STREAM_NO_CREATE_SQL      TAOS_DEF_ERROR_CODE(0, 0x03F9)
...
#define TSDB_CODE_DNODE_FAIL_LOAD_ENCRYPT_PROV  TAOS_DEF_ERROR_CODE(0, 0x042E)
...
//mnode-encrypt
#define TSDB_CODE_MNODE_ENCRYPT_ALGR_NOT_EXIST        TAOS_DEF_ERROR_CODE(0, 0x04E0)
#define TSDB_CODE_MNODE_INVALID_ENCRYPT_ALGR_TYPE     TAOS_DEF_ERROR_CODE(0, 0x04E1)
#define TSDB_CODE_MNODE_ALGR_EXIST                    TAOS_DEF_ERROR_CODE(0, 0x04E2)
...
#define TSDB_CODE_MND_ROLE_NOT_AVAILABLE        TAOS_DEF_ERROR_CODE(0, 0x04F3)
#define TSDB_CODE_MND_ROLE_INVALID_FORMAT       TAOS_DEF_ERROR_CODE(0, 0x04F4)
#define TSDB_CODE_MND_ROLE_SUBROLE_EXCEEDED     TAOS_DEF_ERROR_CODE(0, 0x04F5)
#define TSDB_CODE_MND_ROLE_CONFLICTS            TAOS_DEF_ERROR_CODE(0, 0x04F6)
#define TSDB_CODE_MND_ROLE_NO_VALID_SYSDBA      TAOS_DEF_ERROR_CODE(0, 0x04F7)
#define TSDB_CODE_MND_TOO_MANY_ROLES            TAOS_DEF_ERROR_CODE(0, 0x04F8)
#define TSDB_CODE_MND_TOO_MANY_PRIV_OBJS        TAOS_DEF_ERROR_CODE(0, 0x04F9)
#define TSDB_CODE_MND_TOO_MANY_PRIVS            TAOS_DEF_ERROR_CODE(0, 0x04FA)
#define TSDB_CODE_MND_ROLE_NO_VALID_SYSSEC      TAOS_DEF_ERROR_CODE(0, 0x04FB)
#define TSDB_CODE_MND_ROLE_NO_VALID_SYSAUDIT    TAOS_DEF_ERROR_CODE(0, 0x04FC)
#define TSDB_CODE_MND_SOD_RESTRICTED            TAOS_DEF_ERROR_CODE(0, 0x04FD)
...
#define TSDB_CODE_QRY_WINDOW_DUP_TIMESTAMP      TAOS_DEF_ERROR_CODE(0, 0x073E)
...
#define TSDB_CODE_PAR_NOT_SELECTED_EXPRESSION  TSDB_CODE_PAR_NOT_SELECT_EXPRESSION
...
#define TSDB_CODE_PAR_ALGR_ID_TOO_LONG          TAOS_DEF_ERROR_CODE(0, 0x2699)
#define TSDB_CODE_PAR_ALGR_NAME_TOO_LONG        TAOS_DEF_ERROR_CODE(0, 0x269A)
#define TSDB_CODE_PAR_ALGR_DESC_TOO_LONG        TAOS_DEF_ERROR_CODE(0, 0x269B)
#define TSDB_CODE_PAR_ALGR_TYPE_TOO_LONG        TAOS_DEF_ERROR_CODE(0, 0x269C)
#define TSDB_CODE_PAR_ALGR_OSSL_NAME_TOO_LONG   TAOS_DEF_ERROR_CODE(0, 0x269D)
#define TSDB_CODE_PAR_OPTION_DUPLICATED         TAOS_DEF_ERROR_CODE(0, 0x269E)
#define TSDB_CODE_PAR_INVALID_OPTION_VALUE      TAOS_DEF_ERROR_CODE(0, 0x269F)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_LONG     TAOS_DEF_ERROR_CODE(0, 0x26A0)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_SHORT    TAOS_DEF_ERROR_CODE(0, 0x26A1)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_BIG      TAOS_DEF_ERROR_CODE(0, 0x26A2)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_SMALL    TAOS_DEF_ERROR_CODE(0, 0x26A3)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_RES_COLS   TAOS_DEF_ERROR_CODE(0, 0x26A4)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_RES_ROWS   TAOS_DEF_ERROR_CODE(0, 0x26A5)
#define TSDB_CODE_PAR_INVALID_EXPR_SUBQ              TAOS_DEF_ERROR_CODE(0, 0x26A6)
#define TSDB_CODE_PAR_STMT_NOT_SUPPORT_SCALAR_SUBQ   TAOS_DEF_ERROR_CODE(0, 0x26A7)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_USAGE      TAOS_DEF_ERROR_CODE(0, 0x26A8)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_POLICY     TAOS_DEF_ERROR_CODE(0, 0x26A9)
#define TSDB_CODE_PAR_ORDERBY_INVALID_EXPR           TAOS_DEF_ERROR_CODE(0, 0x26AA)
#define TSDB_CODE_PAR_INVALID_TRUE_FOR_COUNT         TAOS_DEF_ERROR_CODE(0, 0x26AB)
...
#define TSDB_CODE_PAR_LACK_OF_PRIMARY_KEY_COL         TAOS_DEF_ERROR_CODE(0, 0x26E2)
...
#define TSDB_CODE_PAR_TB_INSERT_PERMISSION_DENIED     TAOS_DEF_ERROR_CODE(0, 0x26E5)
#define TSDB_CODE_PAR_TB_SELECT_PERMISSION_DENIED     TAOS_DEF_ERROR_CODE(0, 0x26E6)
...
#define TSDB_CODE_PLAN_INVALID_WINDOW_TYPE      TAOS_DEF_ERROR_CODE(0, 0x2707)
...
#define TSDB_CODE_TMQ_FETCH_TIMEOUT              TAOS_DEF_ERROR_CODE(0, 0x401A)
...
#define TSDB_CODE_UTIL_CIPHER_NOT_EXIST          TAOS_DEF_ERROR_CODE(0, 0x6002)
#define TSDB_CODE_UTIL_CRYPT_INVALID_PARA        TAOS_DEF_ERROR_CODE(0, 0x6003)
#define TSDB_CODE_UTIL_CRYPT_FAIL_NEW_CXT        TAOS_DEF_ERROR_CODE(0, 0x6004)
#define TSDB_CODE_UTIL_CRYPT_FAIL_INIT           TAOS_DEF_ERROR_CODE(0, 0x6005)
#define TSDB_CODE_UTIL_CRYPT_FAIL_EXEC           TAOS_DEF_ERROR_CODE(0, 0x6006)
...
#define TSDB_CODE_AUDIT_MUST_ENCRYPT             TAOS_DEF_ERROR_CODE(0, 0x6103)
#define TSDB_CODE_AUDIT_MUST_WALFORCE            TAOS_DEF_ERROR_CODE(0, 0x6104)
...
#define TSDB_CODE_VTABLE_COLUMN_TYPE_MISMATCH    TAOS_DEF_ERROR_CODE(0, 0x6208)
...
#define TSDB_CODE_XNODE_ALREADY_DEPLOYED        TAOS_DEF_ERROR_CODE(0, 0x8001)
#define TSDB_CODE_MND_XNODE_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x8002)
#define TSDB_CODE_MND_XNODE_TOO_LONG_URL        TAOS_DEF_ERROR_CODE(0, 0x8003)
#define TSDB_CODE_MND_XNODE_INVALID_PROTOCOL    TAOS_DEF_ERROR_CODE(0, 0x8004)
#define TSDB_CODE_MND_XNODE_INVALID_MSG         TAOS_DEF_ERROR_CODE(0, 0x8006)
#define TSDB_CODE_XNODE_NOT_FOUND               TAOS_DEF_ERROR_CODE(0, 0x8007)
#define TSDB_CODE_XNODE_UV_EXEC_FAILURE         TAOS_DEF_ERROR_CODE(0, 0x8008)
#define TSDB_CODE_MND_XNODE_URL_CANT_ACCESS     TAOS_DEF_ERROR_CODE(0, 0x8009)
#define TSDB_CODE_MND_XNODE_URL_RESP_IS_NULL    TAOS_DEF_ERROR_CODE(0, 0x800A)
#define TSDB_CODE_MND_XNODE_HTTP_CODE_ERROR     TAOS_DEF_ERROR_CODE(0, 0x800C)
#define TSDB_CODE_MND_XNODE_NEED_USER_PASS      TAOS_DEF_ERROR_CODE(0, 0x800D)
#define TSDB_CODE_MND_XNODE_USER_PASS_NOT_EXIST TAOS_DEF_ERROR_CODE(0, 0x800E)
// xnode-p1: task
#define TSDB_CODE_MND_XNODE_TASK_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x800F)
#define TSDB_CODE_MND_XNODE_TASK_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x8010)
#define TSDB_CODE_MND_XNODE_TASK_NAME_TOO_LONG       TAOS_DEF_ERROR_CODE(0, 0x8011)
// xnode-p2: task job
#define TSDB_CODE_MND_XNODE_JOB_SYNTAX_ERROR         TAOS_DEF_ERROR_CODE(0, 0x8012)
#define TSDB_CODE_MND_XNODE_TASK_JOB_CONFIG_TOO_LONG TAOS_DEF_ERROR_CODE(0, 0x8013)
#define TSDB_CODE_MND_XNODE_TASK_REASON_TOO_LONG     TAOS_DEF_ERROR_CODE(0, 0x8014)
#define TSDB_CODE_MND_XNODE_JOB_NOT_EXIST            TAOS_DEF_ERROR_CODE(0, 0x8015)
#define TSDB_CODE_MND_XNODE_URL_RESP_TIMEOUT         TAOS_DEF_ERROR_CODE(0, 0x8016)
#define TSDB_CODE_MND_XNODE_WHERE_COL_NOT_EXIST      TAOS_DEF_ERROR_CODE(0, 0x8017)
#define TSDB_CODE_MND_XNODE_WHERE_COL_TYPE_DIFF      TAOS_DEF_ERROR_CODE(0, 0x8018)
#define TSDB_CODE_MND_XNODE_WHERE_OP_NOT_SUPPORT     TAOS_DEF_ERROR_CODE(0, 0x8019)
// xnode-p3: agent
#define TSDB_CODE_MND_XNODE_AGENT_NOT_EXIST          TAOS_DEF_ERROR_CODE(0, 0x8020)
#define TSDB_CODE_MND_XNODE_AGENT_ALREADY_EXIST      TAOS_DEF_ERROR_CODE(0, 0x8021)
#define TSDB_CODE_MND_XNODE_NAME_DUPLICATE           TAOS_DEF_ERROR_CODE(0, 0x8022)
#define TSDB_CODE_MND_XNODE_TASK_PARSER_TOO_LONG     TAOS_DEF_ERROR_CODE(0, 0x8023)
#define TSDB_CODE_MND_XNODE_NO_PRIV                  TAOS_DEF_ERROR_CODE(0, 0x8024)
#define TSDB_CODE_MND_XNODE_TASK_NO_PRIV             TAOS_DEF_ERROR_CODE(0, 0x8025)
