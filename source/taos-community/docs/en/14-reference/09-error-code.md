...
| 0x80002629 | Invalid STATE_WINDOW column specification                                                              | Invalid STATE_WINDOW column specification                                  | Check and correct the SQL statement                          |
...
| 0x800026B2 | Invalid timezone                                                                                       | Invalid timezone string or ambiguous timezone abbreviation                 | Check and correct the timezone value in the SQL statement    |
| 0x800026B3 | Invalid firstDayOfWeek                                                                                 | firstDayOfWeek must be an integer in the range 0-6                        | Check and correct the firstDayOfWeek value in the SQL statement |
