...
11. 也可以使用 taos 程序内嵌的网络连通检测功能，来验证服务器和客户端之间指定的端口连接是否通畅：[运维指南](../11-operations-and-tooling/02-operations/index.md)。
...
有关 taosAdapter 组件的详细介绍请看文档：[taosAdapter](../11-operations-and-tooling/03-components/03-taosadapter.md)
...
如果是容器化部署，请参考部署文档中 Docker 部署章节的“[自定义密码、升级与健康检查](../11-operations-and-tooling/02-operations/03-deployment.md#custom-passwords-upgrades-and-health-checks)”说明。
...
使用到的网络端口请看文档：[运维指南](../11-operations-and-tooling/02-operations/index.md)
