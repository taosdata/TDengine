...
| 0x80008024 | No privilege to access xnode                          | 没有权限操作 xnode                                    | 检查当前用户是否有权限操作 xnode                 |
| 0x80008025 | No privilege to access xnode task                     | 没有权限操作 xnode 的任务                             | 检查当前用户是否有权限操作 xnode 任务            |
