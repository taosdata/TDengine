...
关于 TDengine TSDB 各服务的端口占用情况，请参考运维指南中的[网络端口要求](../../11-operations-and-tooling/02-operations/01-planning.md#网络端口要求)章节。
...
关于使用 Docker 部署 TDengine TSDB 的更多详情，请参考运维指南中的 [Docker 部署](../../11-operations-and-tooling/02-operations/03-deployment.md#docker-部署)章节。
