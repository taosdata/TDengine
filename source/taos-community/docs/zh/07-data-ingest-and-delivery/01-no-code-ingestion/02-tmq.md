...
![准备二](assets/tmq-pre2.png)

对于 `数据库` 或 `超级表` 类型，如果需要同步表的增/删/改操作，则需要开启 `同步 Meta` 选项用于数据库/超级表的迁移，否则此主题只会进行数据同步。

关于主题的创建，详情请参考 [数据订阅](../../03-quick-start/05-data-subscription.md) 章节。

### 第三步：复制主题的 DSN

点击“创建”按钮，回到主题列表复制主题的 **DSN** 备用。

![准备三](assets/tmq-pre3.png)
...
![步骤四](assets/tmq-step4.png)

点击“查看”按钮，可以监控任务的动态统计信息。
![步骤五](assets/tmq-step5.png)

也可以点击左侧折叠按钮，展开任务的活动信息。如果任务运行异常，此处可以看到详细的说明。
![步骤六](assets/tmq-step6.png)
