...
- 安装 TDengine TSDB 实例，请确认 TDengine TSDB 正常运行，并且 taosAdapter 已经安装并正常运行，具体细节请参考 [taosAdapter 的使用手册](../../11-operations-and-tooling/03-components/03-taosadapter.md)。
