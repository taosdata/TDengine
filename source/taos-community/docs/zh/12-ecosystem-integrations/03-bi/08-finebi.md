...
![finebi-workbook](finebi/assets/new-driver.webp)

**第 6 步**，在“数据连接管理”页面中，点击【新建数据连接】按钮，随后点击“其他” ，在右侧页面中点击“其他 JDBC”进行连接配置。

![finebi-workbook](finebi/assets/jdbc-connect.webp)
...
![finebi-workbook](finebi/assets/jdbc-config.webp)
...
![finebi-workbook](finebi/assets/common.webp)

**第 2 步**，点击“数据库表”，打开数据库选表页面，在左侧“数据连接”中选择已创建的连接，则在右侧会显示当前连接的数据库中的所有表，选择需要加载的表（比如 `meters`），点击【确定】即可显示 `meters` 表中的数据。

![finebi-workbook](finebi/assets/select-table.webp)

![finebi-workbook](finebi/assets/table-data.webp)
...
![finebi-workbook](finebi/assets/sql-data-config.webp)
...
![finebi-workbook](finebi/assets/load-data.webp)

**第 3 步**，点击分析主题页面下方的【组件】标签，打开图表配置页面，拖动字段到横轴或纵轴即可展示出图表。

![finebi-workbook](finebi/assets/analysis-chart.webp)
