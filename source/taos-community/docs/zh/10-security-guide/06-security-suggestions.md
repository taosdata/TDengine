...
![TDengine TSDB 产品生态拓扑架构](../11-operations-and-tooling/02-operations/assets/tdengine-topology.png)

关于各组件的详细介绍，请参考 [概览与架构](../11-operations-and-tooling/01-overview.md)。
