...
如果要想使用 TDegnine 的监控功能，taosKeeper 是一个必要的组件，关于监控请参考 [TDinsight](../03-components/08-tdinsight/index.mdx)，关于部署 taosKeeper 的细节请参考 [taosKeeper 参考手册](../03-components/05-taoskeeper.md)。
...
TDengine TSDB 提供了可视化管理 TDengine TSDB 集群的能力，要想使用图形化界面需要部署 taos-Explorer 服务，关于它的详细说明和部署请参考 [taos-Explorer 参考手册](../03-components/04-explorer.md)
