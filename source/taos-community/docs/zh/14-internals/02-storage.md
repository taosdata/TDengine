...
![Key-Value 行格式示意图](assets/key-value.png)
...
![B+ 树存储结构](assets/btree.png)

B+ Tree 的页结构如下图所示：

![B+ 树页结构](assets/btreepage.png)
...
![SkipList 索引](assets/skiplist.png)
