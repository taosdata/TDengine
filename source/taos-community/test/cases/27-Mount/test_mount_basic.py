...
class TestMountBasic:
    ...
    def s3_create_drop_show_mount(self):
        ...
        tdSql.execute(f"GRANT select ON mnt1_db1.* to u1;")
        tdSql.execute(f"GRANT insert ON mnt1_db1.* to u1;")
        tdSql.execute(f"GRANT select,insert,delete ON mnt1_db0.stb0 to u1")
        tdSql.execute(f"GRANT select,insert,delete ON table mnt1_db1.stb0 to u1;")
        tdSql.execute(f"GRANT select table,delete table,insert ON mnt1_db1.stb1 to u1;")
