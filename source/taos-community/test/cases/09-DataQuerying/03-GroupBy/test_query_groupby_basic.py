...
class TestGroupByBasic:
    ...
    def do_project_group(self):
        ...
        print("do project group ...................... [passed]")

    #
    # ------------------- main ----------------
    # 
    def test_query_groupby_basic(self):
        """Group by basic
        ...
        History:
            ...
            - 2025-12-09 Alex Duan Migrated from uncatalog/system-test/2-query/test_project_group.py
        """
        self.do_groupby_sim()
        self.do_project_group()