...
class TestUnionBugs:
    ...
    def test_union_bugs(self):
        ...
        History:
            - 2025-12-21 Alex Duan Migrated from uncatalog/system-test/2-query/test_union.py
        ...
        self.check_unionall_outer_count_regression()

    def check_unionall_outer_count_regression(self):
