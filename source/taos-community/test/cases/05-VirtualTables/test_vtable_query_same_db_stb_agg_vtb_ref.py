...
class TestVTableQuerySameDBStbAggVtbRef:
    ...
    def test_select_virtual_super_table(self):
        ...
        2. test vstable select super table agg group by
        3. test vstable select super table agg with tag condition
        4. test vstable select super table agg with time condition
        5. test vstable select super table agg with partition expression
