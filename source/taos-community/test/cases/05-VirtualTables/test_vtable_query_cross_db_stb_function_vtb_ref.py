...
class TestVTableQueryCrossDBStbFunctionVtbRef:
    updatecfgDict = {
        "supportVnodes": "1000",
    }
    ...
    def setup_class(cls):
        ...
        vtbUtil.prepare_cross_db_vtables(ref_mode="virtual_ref")
    ...
    def test_select_virtual_super_table(self):
        """Query: cross db virtual stable function query with virtual table ref

        1. test vstable select super table function
