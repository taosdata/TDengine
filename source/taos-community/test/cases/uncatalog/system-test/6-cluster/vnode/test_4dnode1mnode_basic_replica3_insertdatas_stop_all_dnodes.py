...
class Test4dnode1mnodeBasicReplica3InsertdatasStopAllDnodes:
    def setup_class(cls):
        ...
        cls.loop_restart_times = 2
        cls.current_thread = None
        cls.max_restart_time = 30
        cls.try_check_times = 30
    ...
    def test_4dnode1mnode_basic_replica3_insertdatas_stop_all_dnodes(self):
        """summary: xxx
