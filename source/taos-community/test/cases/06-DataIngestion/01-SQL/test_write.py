...
class TestInsertDouble:
    ...
    def check_value(self, table_name, dtype, bits):
        ...
        tdSql.execute(
            f"create table {table_name}(ts timestamp, i1 {dtype}, i2 {dtype} unsigned)"
        )
        ...
        tdSql.execute(
            f"insert into {table_name} values(1717122949000, -2.3e1, +2.324e2)"
        )
        ...
        tdSql.execute(
            f"insert into {table_name} values(1717122952000, -0x40, +0b10000)"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122953000, -0b10000, +0x40)"
        )

        # str support
        tdSql.execute(f"insert into {table_name} values(1717122954000, '-16', '+6')")
        tdSql.execute(
            f"insert into {table_name} values(1717122955000, ' -80.99', ' +0042')"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122956000, ' -0042', ' +80.99')"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122957000, '52.34354', '18.6')"
        )
        ...
        tdSql.execute(
            f"insert into {table_name} values(1717122960000, '-2.e1', '+2.e2')"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122961000, '-2e1',  '+2e2')"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122962000, '-2.3e1', '+2.324e2')"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122963000, '-0x40', '+0b10010')"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122964000, '-0b10010', '+0x40')"
        )
        ...
        tdSql.execute(
            f"insert into {table_name} values(1717122965000, {negval}, {posval})"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122966000, -{baseval}, {baseval})"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122967000, {max_i}, {max_u})"
        )
        tdSql.execute(
            f"insert into {table_name} values(1717122968000, {min_i}, {min_u})"
        )
    ...
    def check_tags(self, stable_name, dtype, bits):
        tdSql.execute(
            f"create stable {stable_name}(ts timestamp, i1 {dtype}, i2 {dtype} unsigned) tags(id {dtype})"
        )
        ...
        tdSql.execute(
            f"insert into {stable_name}_1 using {stable_name} tags('{negval}') values(1717122976000, {negval}, {posval})"
        )
        tdSql.execute(
            f"insert into {stable_name}_2 using {stable_name} tags({posval}) values(1717122977000, -{baseval} , {baseval})"
        )
        tdSql.execute(
            f"insert into {stable_name}_3 using {stable_name} tags('0x40') values(1717122978000, {max_i}, {max_u})"
        )
        tdSql.execute(
            f"insert into {stable_name}_4 using {stable_name} tags(0b10000) values(1717122979000, {min_i}, {min_u})"
        )

        tdSql.execute(
            f"insert into {stable_name}_5 using {stable_name} tags({max_i}) values(1717122980000, '{negval}', '{posval}')"
        )
        tdSql.execute(
            f"insert into {stable_name}_6 using {stable_name} tags('{min_i}') values(1717122981000, '-{baseval}' , '{baseval}')"
        )
        tdSql.execute(
            f"insert into {stable_name}_7 using {stable_name} tags(-0x40) values(1717122982000, '{max_i}', '{max_u}')"
        )
        tdSql.execute(
            f"insert into {stable_name}_8 using {stable_name} tags('-0b10000') values(1717122983000, '{min_i}', '{min_u}')"
        )

        tdSql.execute(
            f"insert into {stable_name}_9 using {stable_name} tags(12.) values(1717122984000, {negval}, {posval})"
        )
        tdSql.execute(
            f"insert into {stable_name}_10 using {stable_name} tags('-8.3') values(1717122985000, -{baseval} , {baseval})"
        )
        tdSql.execute(
            f"insert into {stable_name}_11 using {stable_name} tags(2.e1) values(1717122986000, {max_i}, {max_u})"
        )
        tdSql.execute(
            f"insert into {stable_name}_12 using {stable_name} tags('-2.3e1') values(1717122987000, {min_i}, {min_u})"
        )
    ...
    def do_write_timestamp(self):
        ...
        tdSql.error(
            "insert into test_t values(now + today(), 1 );",
        ...
        tdSql.error(
            "insert into test_t values(today() + now(), 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
        ...
        tdSql.error(
            "insert into test_t values('2023-11-28 00:00:00.000' + '2023-11-28 00:00:00.000', 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values('2023-11-28 00:00:00.000' + 1701111600000, 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(1701111500000 + 1701111600000, 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        ...
        tdSql.error(
            "insert into test_t values(today() + 1d + 1s, 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        ...
        tdSql.error(
            "insert into test_t values(2h - now(), 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(2h - today(), 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        ...
        tdSql.error(
            "insert into test_t values(2h - 1h, 1 ); ",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
        ...
        tdSql.error(
            "insert into test_t values(today() - 2y, 8);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        ...
        tdSql.error(
            "insert into test_t values('a1701619200000', 8);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values('ss2023-12-05 00:00:00.000' + '1701619200000', 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(123456, 1);",
            expectErrInfo="Timestamp data out of range",
        )
        tdSql.error(
            "insert into test_t values(123.456, 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(True, 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(None, 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(null, 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        ...
        tdSql.error(
            "insert into test_t values('2023-122-05 00:00:00.000' + '1701619200000', 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values('2023-12--05 00:00:00.000' + '1701619200000', 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values('12/12/2023' + 10a, 1);",
            expectErrInfo=expectErrInfo,
            fullMatched=False,
        )
        tdSql.error(
            "insert into test_t values(1701619200000111, 1);",
            expectErrInfo="Timestamp data out of range",
            fullMatched=False,
        )
        ...
        tdSql.execute(
            "insert into test_t values('2023-12-05 00:00:00.000000000' - 2a, 9);"
        )
        ...
        tdSql.execute(
            "insert into test_t values('2023-12-05 00:00:59.999999999+07:00' + 10a, 16);"
        )
        tdSql.execute(
            "insert into test_t values('2023-12-05T00:00:59.110+07:00' + 10a, 17);"
        )
        ...
        tdSql.checkEqual(
            tdSql.queryResult[5][0], self.__get_today_ts() + 2000000
        )  # c1=3
        ...
        tdSql.checkEqual(
            tdSql.queryResult[8][0], self.__get_today_ts() - 2000000000
        )  # c1=6
        tdSql.checkEqual(
            self.__convert_ts_to_date(tdSql.queryResult[9][0]),
            str(datetime.date.today()),
        )  # c1=7
        tdSql.checkEqual(
            tdSql.queryResult[10][0], self.__get_today_ts() - 7200000000000
        )  # c1=8
        ...
        tdSql.checkEqual(
            self.__convert_ts_to_date(tdSql.queryResult[13][0]),
            str(datetime.date.today() + datetime.timedelta(days=2)),
        )  # c1=11
        tdSql.checkEqual(
            self.__convert_ts_to_date(tdSql.queryResult[14][0]),
        ...
        tdSql.checkEqual(
            self.__convert_ts_to_date(tdSql.queryResult[17][0]),
            str(datetime.date.today()),
        )  # c1=15
    ...
    def check_db(
        ...
        self.autoGen.create_stable(
            stbname,
            tag_cnt,
            column_cnt,
            binary_len,
            nchar_len,
            type_set="varchar_preferred",
        )
    ...
    def initdb(self):
        ...
        tdSql.execute(
            "create stable stb0 (ts timestamp, w_ts timestamp, opc nchar(100), quality int) tags(t0 int)"
        )
    ...
    def multi_insert(self):
        for i in range(5):
            tdSql.execute(
                f"insert into t1 values(1721265436000, now() + {i + 1}s, '0', 12) t1(opc, quality, ts) values ('opc2', 192, now()+ {i + 2}s) t1(ts, opc, quality) values(now() + {i + 3}s, 'opc4', 10) t1 values(1721265436000, now() + {i + 4}s, '1', 191) t1(opc, quality, ts) values('opc5', 192, now() + {i + 5}s) t1 values(now(), now() + {i + 6}s, '2', 192)"
            )
            tdSql.execute(
                "insert into t0 values(1721265436000,now(),'0',192) t0(quality,w_ts,ts) values(192,now(),1721265326000) t0(quality,w_ts,ts) values(190,now()+1s,1721265326000) t0 values(1721265436000,now()+2s,'1',191) t0(quality,w_ts,ts) values(192,now()+3s,1721265326002) t0(ts,w_ts,opc,quality) values(1721265436003,now()+4s,'3',193) t0 values(now(), now() + 4s , '2', 192)"
            )
