...
int32_t streamVtableCreateMergeHandle(SStreamVtableMergeHandle **pHandle, int32_t nSrcTbls, SDiskbasedBuf *pBuf,
                                      const char *idstr);

void streamVtableDestroyMergeHandle(SStreamVtableMergeHandle *pHandle, const char *idstr);

int32_t streamVtableMergeOpen(SStreamVtableMergeHandle *pHandle, const char *idstr);
