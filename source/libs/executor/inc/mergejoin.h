...
#define MJOIN_ROW_BITMAP_SET(_b, _base, _idx) JOIN_ROW_BITMAP_SET((_b), (_base), (_idx))
#define MJOIN_SET_ROW_BITMAP(_b, _base, _idx) JOIN_SET_ROW_BITMAP((_b), (_base), (_idx))
