...
/************************************************ create/drop xnode ***************************************/
cmd ::= CREATE XNODE ON DNODE NK_INTEGER(A) xnode_options(B).                     { pCxt->pRootNode = createCreateXnodeStmt(pCxt, &A, B); }
cmd ::= DROP XNODE ON DNODE NK_INTEGER(A).                                        { pCxt->pRootNode = createDropXnodeStmt(pCxt, &A); }
