...
static int32_t raftLogGetLastEntry(SSyncLogStore* pLogStore, SSyncRaftEntry** ppLastEntry) {
  ...
  *ppLastEntry = NULL;
  if (walIsEmpty(pWal)) {
    ...
    tAssert(lastIndex >= SYNC_INDEX_BEGIN);
