...
#define LIBTXNODE_MAJOR    1
#define LIBTXNODE_MINOR    0
#define LIBTXNODE_REVISION 0
/* LIBTXNODE_VERSION_NUMBER looks like 1003002 for e.g. version 1.3.2. */
#define LIBTXNODE_VERSION_NUMBER (LIBTXNODE_MAJOR * 1000000 + LIBTXNODE_MINOR * 1000 + LIBTXNODE_REVISION)
...
enum xnode_err_t {
  XNODE_ERR_AUTH_CONTINUE = -4,
  XNODE_ERR_NO_SUBSCRIBERS = -3,
  XNODE_ERR_SUB_EXISTS = -2,
  XNODE_ERR_CONN_PENDING = -1,
  XNODE_ERR_SUCCESS = 0,
  XNODE_ERR_NOMEM = 1,
  XNODE_ERR_PROTOCOL = 2,
  XNODE_ERR_INVAL = 3,
  XNODE_ERR_NO_CONN = 4,
  XNODE_ERR_CONN_REFUSED = 5,
  XNODE_ERR_NOT_FOUND = 6,
  XNODE_ERR_CONN_LOST = 7,
  XNODE_ERR_TLS = 8,
  XNODE_ERR_PAYLOAD_SIZE = 9,
  XNODE_ERR_NOT_SUPPORTED = 10,
  XNODE_ERR_AUTH = 11,
  XNODE_ERR_ACL_DENIED = 12,
  XNODE_ERR_UNKNOWN = 13,
  XNODE_ERR_ERRNO = 14,
  XNODE_ERR_EAI = 15,
  XNODE_ERR_PROXY = 16,
  XNODE_ERR_PLUGIN_DEFER = 17,
  XNODE_ERR_MALFORMED_UTF8 = 18,
  XNODE_ERR_KEEPALIVE = 19,
  XNODE_ERR_LOOKUP = 20,
  XNODE_ERR_MALFORMED_PACKET = 21,
  XNODE_ERR_DUPLICATE_PROPERTY = 22,
  XNODE_ERR_TLS_HANDSHAKE = 23,
  XNODE_ERR_QOS_NOT_SUPPORTED = 24,
  XNODE_ERR_OVERSIZE_PACKET = 25,
  XNODE_ERR_OCSP = 26,
  XNODE_ERR_TIMEOUT = 27,
  XNODE_ERR_RETAIN_NOT_SUPPORTED = 28,
  XNODE_ERR_TOPIC_ALIAS_INVALID = 29,
  XNODE_ERR_ADMINISTRATIVE_ACTION = 30,
  XNODE_ERR_ALREADY_EXISTS = 31,
};

// Client options.
enum xnode_opt_t {
  XNODE_OPT_PROTOCOL_VERSION = 1,
  XNODE_OPT_SSL_CTX = 2,
  XNODE_OPT_SSL_CTX_WITH_DEFAULTS = 3,
  XNODE_OPT_RECEIVE_MAXIMUM = 4,
  XNODE_OPT_SEND_MAXIMUM = 5,
  XNODE_OPT_TLS_KEYFORM = 6,
  XNODE_OPT_TLS_ENGINE = 7,
  XNODE_OPT_TLS_ENGINE_KPASS_SHA1 = 8,
  XNODE_OPT_TLS_OCSP_REQUIRED = 9,
  XNODE_OPT_TLS_ALPN = 10,
  XNODE_OPT_TCP_NODELAY = 11,
  XNODE_OPT_BIND_ADDRESS = 12,
  XNODE_OPT_TLS_USE_OS_CERTS = 13,
};

/* MQTT spec. restricts client ids to a maximum of 23 characters */
// #define XNODE_ID_MAX_LENGTH 23

// #define XNODE_PROTOCOL_V31  3
// #define XNODE_PROTOCOL_V311 4
// #define XNODE_PROTOCOL_V5   5

// struct xnode_message {
//   int   mid;
//   char *topic;
//   void *payload;
//   int   payloadlen;
