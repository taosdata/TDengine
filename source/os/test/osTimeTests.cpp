...
TEST(osTimeTests, taosLocalTime) {
  ...
  struct tm  result;
  struct tm* local_time = taosLocalTime(&timep, &result);
  ...
  local_time = taosLocalTime(NULL, &result);
  ASSERT_EQ(local_time, nullptr);

  // Test 3: Test when result is NULL
  local_time = taosLocalTime(&timep, NULL);
  ASSERT_NE(local_time, nullptr);
  ASSERT_EQ(local_time->tm_year, 121);
  ASSERT_EQ(local_time->tm_mon, 3);
  ASSERT_EQ(local_time->tm_mday, 4);
  ...
  local_time = taosLocalTime(&neg_timep, &result);
  ASSERT_NE(local_time, nullptr);
  ...
  local_time = taosLocalTime(&neg_timep2, &result);
  ASSERT_NE(local_time, nullptr);
  ...
  local_time = taosLocalTime(&zero_timep, &result);
  ASSERT_NE(local_time, nullptr);
  ...
  local_time = taosLocalTime(&over_timep, &result);
  ASSERT_EQ(local_time, nullptr);
#endif
}
