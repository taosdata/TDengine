...
public class MetaCreateChildTableTest {
  ...
  public void testEqualsWithSuperClassDifference() {
    ...
    MetaCreateChildTable table1 =
        new MetaCreateChildTable() {
          @Override
  ...
  public void testDeserializeRefsWithRefTbNameAlias() throws Exception {
    ...
    MetaCreateChildTable deserialized =
        JsonUtil.getObjectReader(MetaCreateChildTable.class).readValue(json);
    ...
    assertEquals(
        "src_table_2", deserialized.getCreateList().get(0).getRefs().get(0).getRefTableName());
  }
}
