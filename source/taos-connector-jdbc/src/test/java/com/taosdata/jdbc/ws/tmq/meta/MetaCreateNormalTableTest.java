...
public class MetaCreateNormalTableTest {
  ...
  public void testEqualsWithSuperClassDifference() {
    ...
    MetaCreateNormalTable table1 =
        new MetaCreateNormalTable() {
          @Override
  ...
  public void testHashCodeConsistency() {
    metaCreateNormalTable.setColumns(
        Arrays.asList(new Column("col1", 1, 10, true, "UTF8", "GZIP", "low")));
    metaCreateNormalTable.setTags(
        Arrays.asList(new Column("tag1", 2, 20, false, "ASCII", "SNAPPY", "medium")));
