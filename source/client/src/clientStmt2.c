...
/*
int stmtUpdateTableUid2(STscStmt2* pStmt, SSubmitRsp* pRsp) {
...
// int stmtAffectedRows2(TAOS_STMT2* stmt) { return ((STscStmt2*)stmt)->affectedRows; }

// int stmtAffectedRowsOnce2(TAOS_STMT2* stmt) { return ((STscStmt2*)stmt)->exec.affectedRows; }
...
/*
int stmtGetParam2(TAOS_STMT2* stmt, int idx, int* type, int* bytes) {
  STscStmt2* pStmt = (STscStmt2*)stmt;
  ...
  STMT_ERR_RET(stmtFetchColFields2(stmt, &nums, &pField));
  if (idx >= nums) {
