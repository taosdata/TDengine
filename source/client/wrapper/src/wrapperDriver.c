...
#ifdef WEBSOCKET
    LOAD_FUNC(fp_ws_enable_log, "ws_enable_log");
    LOAD_FUNC(fp_ws_data_type, "ws_data_type");
    LOAD_FUNC(fp_ws_connect, "ws_connect");
    LOAD_FUNC(fp_ws_get_server_info, "ws_get_server_info");
    LOAD_FUNC(fp_ws_close, "ws_close");
    LOAD_FUNC(fp_ws_query, "ws_query");
    LOAD_FUNC(fp_ws_query_with_reqid, "ws_query_with_reqid");
    LOAD_FUNC(fp_ws_stop_query, "ws_stop_query");
    LOAD_FUNC(fp_ws_query_timeout, "ws_query_timeout");
    LOAD_FUNC(fp_ws_take_timing, "ws_take_timing");
    LOAD_FUNC(fp_ws_errno, "ws_errno");
    LOAD_FUNC(fp_ws_errstr, "ws_errstr");
    LOAD_FUNC(fp_ws_affected_rows, "ws_affected_rows");
    LOAD_FUNC(fp_ws_affected_rows64, "ws_affected_rows64");
    LOAD_FUNC(fp_ws_select_db, "ws_select_db");
    LOAD_FUNC(fp_ws_get_client_info, "ws_get_client_info");
    LOAD_FUNC(fp_ws_field_count, "ws_field_count");
    LOAD_FUNC(fp_ws_is_update_query, "ws_is_update_query");
    LOAD_FUNC(fp_ws_fetch_fields, "ws_fetch_fields");
    LOAD_FUNC(fp_ws_fetch_fields_v2, "ws_fetch_fields_v2");
    LOAD_FUNC(fp_ws_fetch_raw_block, "ws_fetch_raw_block");
    LOAD_FUNC(fp_ws_is_null, "ws_is_null");
    LOAD_FUNC(fp_ws_fetch_row, "ws_fetch_row");
    LOAD_FUNC(fp_ws_num_fields, "ws_num_fields");
    LOAD_FUNC(fp_ws_free_result, "ws_free_result");
    LOAD_FUNC(fp_ws_result_precision, "ws_result_precision");
    LOAD_FUNC(fp_ws_get_value_in_block, "ws_get_value_in_block");
    LOAD_FUNC(fp_ws_timestamp_to_rfc3339, "ws_timestamp_to_rfc3339");
    LOAD_FUNC(fp_ws_print_row, "ws_print_row");
    LOAD_FUNC(fp_ws_get_current_db, "ws_get_current_db");
    LOAD_FUNC(fp_ws_schemaless_insert_raw, "ws_schemaless_insert_raw");
    LOAD_FUNC(fp_ws_schemaless_insert_raw_with_reqid, "ws_schemaless_insert_raw_with_reqid");
    LOAD_FUNC(fp_ws_schemaless_insert_raw_ttl, "ws_schemaless_insert_raw_ttl");
    LOAD_FUNC(fp_ws_schemaless_insert_raw_ttl_with_reqid, "ws_schemaless_insert_raw_ttl_with_reqid");
    LOAD_FUNC(fp_ws_stmt_init, "ws_stmt_init");
    LOAD_FUNC(fp_ws_stmt_init_with_reqid, "ws_stmt_init_with_reqid");
    LOAD_FUNC(fp_ws_stmt_prepare, "ws_stmt_prepare");
    LOAD_FUNC(fp_ws_stmt_set_tbname, "ws_stmt_set_tbname");
    LOAD_FUNC(fp_ws_stmt_set_sub_tbname, "ws_stmt_set_sub_tbname");
    LOAD_FUNC(fp_ws_stmt_set_tbname_tags, "ws_stmt_set_tbname_tags");
    LOAD_FUNC(fp_ws_stmt_get_tag_fields, "ws_stmt_get_tag_fields");
    LOAD_FUNC(fp_ws_stmt_get_col_fields, "ws_stmt_get_col_fields");
    LOAD_FUNC(fp_ws_stmt_reclaim_fields, "ws_stmt_reclaim_fields");
    LOAD_FUNC(fp_ws_stmt_is_insert, "ws_stmt_is_insert");
    LOAD_FUNC(fp_ws_stmt_set_tags, "ws_stmt_set_tags");
    LOAD_FUNC(fp_ws_stmt_bind_param_batch, "ws_stmt_bind_param_batch");
    LOAD_FUNC(fp_ws_stmt_add_batch, "ws_stmt_add_batch");
    LOAD_FUNC(fp_ws_stmt_execute, "ws_stmt_execute");
    LOAD_FUNC(fp_ws_stmt_affected_rows, "ws_stmt_affected_rows");
    LOAD_FUNC(fp_ws_stmt_affected_rows_once, "ws_stmt_affected_rows_once");
    LOAD_FUNC(fp_ws_stmt_num_params, "ws_stmt_num_params");
    LOAD_FUNC(fp_ws_stmt_get_param, "ws_stmt_get_param");
    LOAD_FUNC(fp_ws_stmt_errstr, "ws_stmt_errstr");
    LOAD_FUNC(fp_ws_stmt_close, "ws_stmt_close");
    LOAD_FUNC(fp_ws_tmq_conf_new, "ws_tmq_conf_new");
    LOAD_FUNC(fp_ws_tmq_conf_set, "ws_tmq_conf_set");
    LOAD_FUNC(fp_ws_tmq_conf_destroy, "ws_tmq_conf_destroy");
    LOAD_FUNC(fp_ws_tmq_list_new, "ws_tmq_list_new");
    LOAD_FUNC(fp_ws_tmq_list_append, "ws_tmq_list_append");
    LOAD_FUNC(fp_ws_tmq_list_destroy, "ws_tmq_list_destroy");
    LOAD_FUNC(fp_ws_tmq_list_get_size, "ws_tmq_list_get_size");
    LOAD_FUNC(fp_ws_tmq_list_to_c_array, "ws_tmq_list_to_c_array");
    LOAD_FUNC(fp_ws_tmq_list_free_c_array, "ws_tmq_list_free_c_array");
    LOAD_FUNC(fp_ws_tmq_consumer_new, "ws_tmq_consumer_new");
    LOAD_FUNC(fp_ws_tmq_consumer_close, "ws_tmq_consumer_close");
    LOAD_FUNC(fp_ws_tmq_subscribe, "ws_tmq_subscribe");
    LOAD_FUNC(fp_ws_tmq_unsubscribe, "ws_tmq_unsubscribe");
    LOAD_FUNC(fp_ws_tmq_consumer_poll, "ws_tmq_consumer_poll");
    LOAD_FUNC(fp_ws_tmq_get_topic_name, "ws_tmq_get_topic_name");
    LOAD_FUNC(fp_ws_tmq_get_db_name, "ws_tmq_get_db_name");
    LOAD_FUNC(fp_ws_tmq_get_table_name, "ws_tmq_get_table_name");
    LOAD_FUNC(fp_ws_tmq_get_vgroup_id, "ws_tmq_get_vgroup_id");
    LOAD_FUNC(fp_ws_tmq_get_vgroup_offset, "ws_tmq_get_vgroup_offset");
    LOAD_FUNC(fp_ws_tmq_get_res_type, "ws_tmq_get_res_type");
    LOAD_FUNC(fp_ws_tmq_get_topic_assignment, "ws_tmq_get_topic_assignment");
    LOAD_FUNC(fp_ws_tmq_free_assignment, "ws_tmq_free_assignment");
    LOAD_FUNC(fp_ws_tmq_commit_sync, "ws_tmq_commit_sync");
    LOAD_FUNC(fp_ws_tmq_commit_offset_sync, "ws_tmq_commit_offset_sync");
    LOAD_FUNC(fp_ws_tmq_committed, "ws_tmq_committed");
    LOAD_FUNC(fp_ws_tmq_offset_seek, "ws_tmq_offset_seek");
    LOAD_FUNC(fp_ws_tmq_position, "ws_tmq_position");
    LOAD_FUNC(fp_ws_tmq_errstr, "ws_tmq_errstr");
#endif
  }
