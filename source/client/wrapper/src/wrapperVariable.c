...
void (*fp_taos_fetch_ip_accesslist_a)(TAOS *taos, __taos_async_ip_accesslist_fn_t fp, void *param) = NULL;

void (*fp_taos_fetch_datetime_accesslist_a)(TAOS *taos, __taos_async_datetime_accesslist_fn_t fp, void *param) = NULL;
