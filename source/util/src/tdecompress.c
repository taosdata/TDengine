...
int32_t tsDecompressFloatImplAvx2(const char *input, int32_t nelements, char *output) { return 0; }

FORCE_INLINE __m256i decodeDoubleAvx2(const char *data, const char *flag) {
  __m256i dataVec = _mm256_lddqu_si256((__m256i *)data);
  __m256i flagVec = _mm256_lddqu_si256((__m256i *)flag);
