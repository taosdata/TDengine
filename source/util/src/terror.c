...
TAOS_DEFINE_ERROR(TSDB_CODE_DLL_NOT_LOAD,                 "The dynamic link library was not loaded")
TAOS_DEFINE_ERROR(TSDB_CODE_DLL_FUNC_NOT_LOAD,            "The function was not loaded from the dynamic link library")
