...
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_FUNC_NOT_SUPPORT_DISTINCT, "Function does not support DISTINCT")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_TOO_LESS_TAG_COLUMN,      "The only tag cannot be dropped")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_INVALID_WINDOW_FUNC,      "Window function is not allowed in this clause")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_WINDOW_ORDER_REQUIRED,    "Window function requires ORDER BY")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_WINDOW_NOT_DEFINED,       "Referenced window name is not defined")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_WINDOW_DUP_NAME,          "Duplicate window name")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_WINDOW_RANGE_MULTI_ORDER, "RANGE offset frame requires exactly one ORDER BY expression")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_WINDOW_INVALID_BOUND,     "Invalid window frame bound")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_WINDOW_INVALID_ARGUMENT,  "Invalid window function argument")
...
TAOS_DEFINE_ERROR(TSDB_CODE_MND_SASL_SESSION_EXPIRED,     "SASL session expired, retry login")
...
TAOS_DEFINE_ERROR(TSDB_CODE_GRANT_QRY_RESTRICTED,         "Query denied by license: external query is restricted")
...
TAOS_DEFINE_ERROR(TSDB_CODE_TXN_TOO_MANY_DDL_OPS,           "Transaction DDL operation count exceeds per-transaction limit")
TAOS_DEFINE_ERROR(TSDB_CODE_TXN_EXCEEDED_LIFETIME,          "Transaction exceeded maximum lifetime")
TAOS_DEFINE_ERROR(TSDB_CODE_TXN_TIMEOUT_KILLED,             "Transaction killed by server due to inactivity timeout; execute ROLLBACK to clean up")
...
TAOS_DEFINE_ERROR(TSDB_CODE_AUDIT_MUST_NANO_PRECISION,      "Audit database precision must be nanosecond")
...
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_CONNECT_FAILED,     "External source connection failed")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_AUTH_FAILED,        "External source authentication failed")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_ACCESS_DENIED,      "External source access denied")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_QUERY_TIMEOUT,      "External query timeout")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_REMOTE_INTERNAL,    "External source internal error")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_TYPE_NOT_MAPPABLE,  "External column type not mappable")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_NO_TS_PRIMARY_KEY,  "External table has no timestamp primary key")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SOURCE_NOT_FOUND,   "External source not found")
// 0x6408 reserved
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SYNTAX_UNSUPPORTED, "SQL syntax unsupported for external source")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_RESOURCE_EXHAUSTED, "External source resource exhausted")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SOURCE_EXISTS,      "External source already exists")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_DEFAULT_NS_MISSING, "External source default namespace not configured")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_TYPE_CONVERT_FAILED,"External data type conversion failed")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_FEDERATED_DISABLED, "Federated query is disabled")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_PUSHDOWN_FAILED,    "External pushdown SQL failed, need replanning")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_TABLE_NOT_EXIST,    "External table not found on remote source")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_FETCH_FAILED,       "External data fetch failed")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SOURCE_CHANGED,     "External source configuration changed")
...
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_OPTIONS_TLS_CONFLICT, "External source TLS options are incomplete")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_DB_NOT_EXIST,       "External source database or schema not found")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SOURCE_INTERNAL,    "Connector internal logic error")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SOURCE_WRITE_NOT_SUPPORTED, "Write operation not supported on external source table")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_SOURCE_NAME_CONFLICT, "Database name conflicts with an existing external source")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_COLUMN_NOT_EXIST,   "External column not found")
TAOS_DEFINE_ERROR(TSDB_CODE_EXT_TAG_REF_NOT_ALLOWED,       "InfluxDB tag columns cannot be used as virtual table column source")
