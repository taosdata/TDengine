...
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_VST_EXPAND_NO_INHERIT,    "EXPAND requires a VST with inheritance")
...
TAOS_DEFINE_ERROR(TSDB_CODE_MND_VST_HAS_CHILDREN,         "VST has child tables, cannot drop or drop column")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_VST_INHERIT_DEPTH_EXCEED, "VST inheritance depth exceeds limit")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_VST_CIRCULAR_INHERIT,     "Circular VST inheritance detected")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_VST_PARENT_NOT_VIRTUAL,   "Parent table is not a virtual super table")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_VST_COL_NAME_CONFLICT,    "Column or tag name conflicts with parent VST")
