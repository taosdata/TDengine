...
int32_t tsSyncLogLagThreshold = 1000;
int32_t tsSyncCatchupLogIntervalMs = 30000;
...
static int32_t taosAddServerCfg(SConfig *pCfg) {
  ...
  TAOS_CHECK_RETURN(cfgAddInt32(pCfg, "syncLogLagThreshold", tsSyncLogLagThreshold, 1, INT32_MAX, CFG_SCOPE_SERVER, CFG_DYN_SERVER,CFG_CATEGORY_GLOBAL, CFG_PRIV_SYSTEM));
  TAOS_CHECK_RETURN(cfgAddInt32(pCfg, "syncCatchupLogIntervalMs", tsSyncCatchupLogIntervalMs, 100, 60 * 24 * 2 * 1000, CFG_SCOPE_SERVER, CFG_DYN_SERVER,CFG_CATEGORY_GLOBAL, CFG_PRIV_SYSTEM));
...
static int32_t taosSetServerCfg(SConfig *pCfg) {
  ...
  TAOS_CHECK_GET_CFG_ITEM(pCfg, pItem, "syncLogLagThreshold");
  tsSyncLogLagThreshold = pItem->i32;

  TAOS_CHECK_GET_CFG_ITEM(pCfg, pItem, "syncCatchupLogIntervalMs");
  tsSyncCatchupLogIntervalMs = pItem->i32;
...
static int32_t taosCfgDynamicOptionsForServer(SConfig *pCfg, const char *name) {
  ...
  {  //  'bool/int32_t/int64_t/float/double' variables with general modification function
    ...
    static OptionNameAndVar options[] = {{"audit", &tsEnableAudit},
                                         ...
                                         {"syncLogLagThreshold", &tsSyncLogLagThreshold},
                                         {"syncCatchupLogIntervalMs", &tsSyncCatchupLogIntervalMs},
