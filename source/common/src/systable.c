...
static const SSysTableMeta infosMeta[] = {
    ...
    {TSDB_INS_TABLE_ENCRYPT_STATUS, userEncryptStatusSchema, tListLen(userEncryptStatusSchema), false},
    {TSDB_INS_TABLE_TOKENS, tokenSchema, tListLen(tokenSchema), false},
...
static const SSysDbTableSchema querySchema[] = {
    ...
    {.name = "exec_time_ms", .bytes = 8, .type = TSDB_DATA_TYPE_BIGINT, .sysInfo = false},
    {.name = "wait_time_ms", .bytes = 8, .type = TSDB_DATA_TYPE_BIGINT, .sysInfo = false},
    {.name = "slow_query", .bytes = 1, .type = TSDB_DATA_TYPE_BOOL, .sysInfo = false},
    {.name = "rows_scanned", .bytes = 8, .type = TSDB_DATA_TYPE_BIGINT, .sysInfo = false},
    {.name = "rows_returned", .bytes = 8, .type = TSDB_DATA_TYPE_BIGINT, .sysInfo = false},
    {.name = "memory_used", .bytes = 8, .type = TSDB_DATA_TYPE_BIGINT, .sysInfo = false},
