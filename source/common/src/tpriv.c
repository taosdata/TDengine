...
static SPrivInfo privInfoTable[] = {
    ...
    {PRIV_USER_ENABLE, PRIV_CATEGORY_SYSTEM, 0, 0, ROLE_SYSDBA, "ENABLE USER"},
    {PRIV_USER_DISABLE, PRIV_CATEGORY_SYSTEM, 0, 0, ROLE_SYSDBA, "DISABLE USER"},
    ...
    {PRIV_NODES_SHOW, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO_ROLES, "SHOW NODES"},
    ...
    {PRIV_TRANS_SHOW, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO_ROLES, "SHOW TRANS"},
