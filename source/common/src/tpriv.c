...
static SPrivInfo privInfoTable[] = {
    ...
    {PRIV_INFO_SCHEMA_READ_LIMIT, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO_ROLES, "READ INFORMATION SCHEMA LIMIT"},
    ...
    {PRIV_PERF_SCHEMA_READ_LIMIT, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO1_ROLES, "READ PERFORMANCE SCHEMA LIMIT"},
