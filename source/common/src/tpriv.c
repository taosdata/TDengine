...
static SPrivInfo privInfoTable[] = {
    ...
    {PRIV_INFO_SCHEMA_READ_PRIVILEGED, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO_ROLES, "READ INFORMATION SCHEMA PRIVILEGED"},
    {PRIV_PERF_SCHEMA_READ_BASIC, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO1_ROLES, "READ PERFORMANCE SCHEMA BASIC"},
    {PRIV_PERF_SCHEMA_READ_PRIVILEGED, PRIV_CATEGORY_SYSTEM, 0, 0, SYS_ADMIN_INFO_ROLES, "READ PERFORMANCE SCHEMA PRIVILEGED"},
