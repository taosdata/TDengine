...
static SPrivInfo privInfoTable[] = {
    ...
    {PRIV_VG_BALANCE_LEADER, PRIV_CATEGORY_OBJECT, 0, ROLE_SYSDBA, "BALANCE VGROUP LEADER"},
    {PRIV_VG_MERGE, PRIV_CATEGORY_OBJECT, 0, ROLE_SYSDBA, "MERGE VGROUP"},
    {PRIV_VG_REDISTRIBUTE, PRIV_CATEGORY_OBJECT, 0, ROLE_SYSDBA, "REDISTRIBUTE VGROUP"},
    {PRIV_VG_SPLIT, PRIV_CATEGORY_OBJECT, 0, ROLE_SYSDBA, "SPLIT VGROUP"},
    ...
    {PRIV_SHOW_DATABASES, PRIV_CATEGORY_OBJECT, PRIV_OBJ_DB, SYS_ADMIN_INFO_ROLES, "SHOW DATABASES"},
