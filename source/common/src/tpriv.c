...
static SPrivInfo privInfoTable[] = {
    ...
    {PRIV_VG_BALANCE_LEADER, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "BALANCE VGROUP LEADER"},
    {PRIV_VG_MERGER, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "MERGE VGROUP"},
    {PRIV_VG_REDISTRIBUTE, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "REDISTRIBUTE VGROUP"},
    {PRIV_VG_SPLIT, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SPLIT VGROUP"},
    {PRIV_SHOW_DATABASES, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW DATABASES"},
    {PRIV_SHOW_VNODES, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW VNODES"},
    {PRIV_SHOW_VGROUPS, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW VGROUPS"},
    {PRIV_SHOW_COMPACTS, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW COMPACTS"},
    {PRIV_SHOW_RETENTIONS, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW RETENTIONS"},
    {PRIV_SHOW_SCANS, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW SCANS"},
    {PRIV_SHOW_SSMIGRATES, PRIV_CATEGORY_OBJECT, OBJ_TYPE_DB, "SHOW SSMIGRATES"},
    ...
    {PRIV_TBL_SELECT, PRIV_CATEGORY_OBJECT, OBJ_TYPE_TABLE, "READ TABLE"},
    {PRIV_TBL_INSERT, PRIV_CATEGORY_OBJECT, OBJ_TYPE_TABLE, "WRITE TABLE"},
    ...
    {PRIV_CONSUMER_SHOW, PRIV_CATEGORY_OBJECT, OBJ_TYPE_TOPIC, "SHOW CONSUMERS"},
    {PRIV_SUBSCRIPTION_SHOW, PRIV_CATEGORY_OBJECT, OBJ_TYPE_TOPIC, "SHOW SUBSCRIPTIONS"},
    ...
    {PRIV_STREAM_START, PRIV_CATEGORY_OBJECT, OBJ_TYPE_STREAM, "START STREAM"},
    {PRIV_STREAM_STOP, PRIV_CATEGORY_OBJECT, OBJ_TYPE_STREAM, "STOP STREAM"},
    {PRIV_STREAM_RECALC, PRIV_CATEGORY_OBJECT, OBJ_TYPE_STREAM, "RECALC STREAM"},
