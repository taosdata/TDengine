...
static SPrivInfo privInfoTable[] = {
    ...
    {PRIV_DB_DROP_OWNED, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSDBA, "DROP OWNED DATABASE"},
    {PRIV_VG_BALANCE, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSDBA, "BALANCE VGROUP"},
    {PRIV_VG_BALANCE_LEADER, PRIV_CATEGORY_OBJECT, 0, 0, T_ROLE_SYSDBA, "BALANCE VGROUP LEADER"},
    {PRIV_VG_MERGE, PRIV_CATEGORY_OBJECT, 0, 0, T_ROLE_SYSDBA, "MERGE VGROUP"},
    {PRIV_VG_REDISTRIBUTE, PRIV_CATEGORY_OBJECT, 0, 0, T_ROLE_SYSDBA, "REDISTRIBUTE VGROUP"},
    {PRIV_VG_SPLIT, PRIV_CATEGORY_OBJECT, 0, 0, T_ROLE_SYSDBA, "SPLIT VGROUP"},
    ...
    // System Variables
    {PRIV_VAR_SECURITY_ALTER, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSSEC, "ALTER SECURITY VARIABLE"},
    {PRIV_VAR_AUDIT_ALTER, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSAUDIT, "ALTER AUDIT VARIABLE"},
    ...
    {PRIV_TOTP_UPDATE, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSSEC, "UPDATE TOTP"},
    ...
    // Audit Management
    {PRIV_AUDIT_DB_CREATE, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSDBA, "CREATE AUDIT DATABASE"},
    ...
    {PRIV_CONNECTION_KILL, PRIV_CATEGORY_SYSTEM, 0, 0, T_ROLE_SYSDBA, "KILL CONNECTION"},
    ...
    // ==================== object privileges ====================
    // Database Privileges
    {PRIV_DB_ALTER, PRIV_CATEGORY_OBJECT, PRIV_OBJ_DB, 0, T_ROLE_SYSDBA, "ALTER DATABASE"},
    {PRIV_DB_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_DB, 0, T_ROLE_SYSDBA, "DROP DATABASE"},
    ...
    {PRIV_TBL_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "DROP TABLE"},
    {PRIV_TBL_ALTER, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "ALTER TABLE"},
    // can't show tables created by others at default
    {PRIV_TBL_SHOW, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, SYS_ADMIN_BASIC_ROLES, "SHOW TABLES"},
    // can't desc tables created by others at default
    {PRIV_TBL_SHOW_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, SYS_ADMIN_BASIC_ROLES, "SHOW CREATE TABLE"},
    {PRIV_TBL_SELECT, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, 0, "SELECT TABLE"},
    {PRIV_TBL_INSERT, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, 0, "INSERT TABLE"},
    {PRIV_TBL_UPDATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, 0, "UPDATE TABLE"},
    {PRIV_TBL_DELETE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, 0, "DELETE TABLE"},

    // Index Privileges
    {PRIV_IDX_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "CREATE INDEX"},
    {PRIV_IDX_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_INDEX, 1, T_ROLE_SYSDBA, "DROP INDEX"},
    ...
    // TSMA Privileges
    {PRIV_TSMA_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "CREATE TSMA"},
    {PRIV_TSMA_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TSMA, 1, T_ROLE_SYSDBA, "DROP TSMA"},
    {PRIV_TSMA_SHOW, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TSMA, 1, SYS_ADMIN_INFO_ROLES, "SHOW TSMAS"},

    // View Privileges
    {PRIV_VIEW_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "CREATE VIEW"},
    {PRIV_VIEW_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_VIEW, 1, T_ROLE_SYSDBA, "DROP VIEW"},
    {PRIV_VIEW_SHOW, PRIV_CATEGORY_OBJECT, PRIV_OBJ_VIEW, 1, SYS_ADMIN_INFO_ROLES, "SHOW VIEWS"},
    {PRIV_VIEW_SHOW_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_VIEW, 1, SYS_ADMIN_INFO_ROLES, "SHOW CREATE VIEW"},
    {PRIV_VIEW_SELECT, PRIV_CATEGORY_OBJECT, PRIV_OBJ_VIEW, 1, 0, "SELECT VIEW"},

    // Topic Privileges
    {PRIV_TOPIC_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "CREATE TOPIC"},
    {PRIV_TOPIC_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TOPIC, 1, T_ROLE_SYSDBA, "DROP TOPIC"},
    ...
    // Stream Privileges
    {PRIV_STREAM_CREATE, PRIV_CATEGORY_OBJECT, PRIV_OBJ_TABLE, 1, T_ROLE_SYSDBA, "CREATE STREAM"},
    {PRIV_STREAM_DROP, PRIV_CATEGORY_OBJECT, PRIV_OBJ_STREAM, 1, T_ROLE_SYSDBA, "DROP STREAM"},
