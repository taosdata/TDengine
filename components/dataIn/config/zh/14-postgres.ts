...
export default {
  ...
  type: 'uri',
  description:
    'PostgreSQL 是一个功能非常强大的、源代码开放的客户/服务器关系型数据库管理系统， 有很多在大型商业RDBMS中所具有的特性，包括事务、子选择、触发器、视图、外键引用完整性和复杂锁定功能。\nTDengine 可以高效地从 PostgreSQL 读取数据并将其写入 TDengine，以实现历史数据迁移或实时数据同步。\n',
  config: [
    {
      label: '连接配置',
    ...
    },
    {
      ...
      children: [
        {
          label: '连接选项',
          field: '37988628-2363-4659-bbc8-c10045f3f7fe',
    ...
    },
    {
      ...
      children: [
        {
          label: 'SQL 查询',
          field: 'd5d442a3-e18a-4494-bab5-4572218022d8',
