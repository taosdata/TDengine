...
export default {
  ...
  type: 'uri',
  description:
    'Microsoft SQL Server 是一种关系型数据库管理系统，由 Microsoft 公司开发，具有使用方便可伸缩性好与相关软件集成程度高等优点。\n\nTDengine 可以高效地从 Microsoft SQL Server 读取数据并将其写入 TDengine，以实现历史数据迁移或实时数据同步。\n',
  config: [
    {
      label: '连接配置',
    ...
    },
    {
      ...
      children: [
        {
          label: '连接选项',
          field: '6a9ec8d2-7cb4-4c70-a86d-9de5630baeee',
          ...
          children: [
            ...
            },
            {
              ...
              templateUrl: '',
              accept: '.pem',
              displayDependsOn: ['groups_before/6a9ec8d2-7cb4-4c70-a86d-9de5630baeee/trust_cert'],
    ...
    },
    {
      ...
      children: [
        {
          label: 'SQL 查询',
          field: '8cdc6be6-708b-4588-9440-a9a0b577e60b',
