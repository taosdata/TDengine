import { buildProps, definePropType, isArray } from 'element-plus/es/utils/index';
import { datePickTypes } from 'element-plus/es/constants/index';

import type { ExtractPropTypes } from 'vue';
import type { Dayjs } from 'dayjs';
import type { DatePickType } from 'element-plus/es/constants/index';
...
export const selectionModeWithDefault = (mode: (typeof selectionModes)[number]) => {
  return {
    type: String,
