        ...
        <div :class="[ppNs.e('content'), drpNs.e('content')]" class="is-left">
          <div :class="drpNs.e('header')">
            ...
            <button
              ...
              :class="[ppNs.e('icon-btn'), { [ppNs.is('disabled')]: !enableYearArrow }]"
              class="d-arrow-right"
              @click="leftNextYear"
            >
              <slot name="next-year">
...
const leftDate = ref(switchTimezone(dayjs()).locale(lang.value));
const rightDate = ref(switchTimezone(dayjs()).locale(lang.value).add(1, unit));
