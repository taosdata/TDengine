...
class Case3(ClusterCase):
    ...
    def init(self):
        ...
        self.params = {"_ts" : 1420041600000 , "_ts_step":1 ,"_row_nums":2 ,"_col_nums":12 ,  "tables_of_per_stable":2 ,"_tags_nums" : 10 , "_replica" :1 }
        self.db_nums = 100 
    ...
    def desc(self) -> str:
        case_description = '''
            [test]<wenzhouwww> test case for cluster about 1.5 alter schema task  and stop master dnode... ;
        '''
