...
class TDTestQuery(TDCase):
    ...
    def desc(self) -> str:
        case_description = '''
        case1:# not support stddev/percentile in the outer query [hanshu = 'STDDEV']
        case2:
        '''
    ...
    #basic_param
    db = "stable_stddev"
    db_1 = "stable_stddev_1"
    db_1_1 = "stable_stddev_1_1"
    db_2 = "stable_stddev_2"
    db_3 = "stable_stddev_3"
    ...
    def right_case_1(self):
        ...
        # 1: not support stddev/percentile in the outer query [hanshu = 'STDDEV']
        for i in (2,):
            ...
            try:
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,31,32,33,34,35,):                        
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (61,71,81,91,):   
                            ...
                            time_window_new = tdWhere.time_window_new(i)
                            self.logger.info("\n\n\n====right case========case1=====time num = %d======interval======\n\n\n" %i)
                            sql1 = "select %s from %s where %s tbname in ('%s_1') %s;"  % (func,self.table,interval_fill_f_and,self.table,time_window_new)
    ...
    def rm_sql_1_1(self):
        os.system("rm -rf %s/%s.sql" % (self.testcasePath,self.testcaseFilename))  
        self.tdCreateData.drop_db("%s" % self.db_1_1) 
