...
class TestAutoCreateTable(TDCase):
    ...
    def check_tag_value_for_auto_create_table(self):
        ...
        self.tdSql.execute(f'insert into {dbname}.t3 using {dbname}.stb tags(31, 32) (ts, c11, c12) values (now-2m, 13, 23)')
        self.tdSql.execute(f'insert into {dbname}.t4 using {dbname}.stb(t11, t12) tags("41", 42) (ts, c11, c12) values (now-3m, 14, 24)')
        # no tags
        self.tdSql.error(f'insert into {dbname}.t5 using {dbname}.stb(t11, t12) (ts, c11, c12) values (now-4m, 11, 21)')
        # blank tags
        self.tdSql.error(f'insert into {dbname}.t6 using {dbname}.stb(t11, t12) tags() (ts, c11, c12) values (now-5m, 11, 21)')
        # count nmatch
        self.tdSql.error(f'insert into {dbname}.t7 using {dbname}.stb(t11, t12) tags(41) (ts, c11, c12) values (now-6m, 11, 21)')
        self.tdSql.error(f'insert into {dbname}.t8 using {dbname}.stb(t11) tags(51, 52) (ts, c11, c12) values (now-7m, 11, 21)')
        self.tdSql.query(f'select count(*) from {dbname}.stb')
        self.tdSql.checkEqual(self.tdSql.query_data[0][0], 4)
    ...
    def check_col_value_for_auto_create_table(self):
        ...
        self.tdSql.execute(f'insert into {dbname}.t3 using {dbname}.stb(t11, t12) tags(31, 32) (ts, c11, c12) values (now-2m, "Null", 31)')
        self.tdSql.error(f'insert into {dbname}.t4 using {dbname}.stb(t11, t12) tags(41, 42) (c11, c12) values (41, 42)')
        # no values
        self.tdSql.error(f'insert into {dbname}.t5 using {dbname}.stb(t11, t12) (ts, c11, c12) tags(51, 52) values ()')
        self.tdSql.error(f'insert into {dbname}.t6 using {dbname}.stb(t11, t12) (ts, c11, c12) tags(61, 62)')
        # count nmatch
        self.tdSql.error(f'insert into {dbname}.t7 using {dbname}.stb(t11, t12) tags(71, 72) values (now-3m, 71)')
        self.tdSql.error(f'insert into {dbname}.t8 using {dbname}.stb(t11, t12) tags(81, 82) (ts, c11) values (now-4m, 81, 82)')
        self.tdSql.error(f'insert into {dbname}.t9 using {dbname}.stb(t11, t12) tags(91, 92) (ts, c11, c12) values (now-5m, 91)')
        # type nmatch
        self.tdSql.error(f'insert into {dbname}.t10 using {dbname}.stb(t11, t12) tags(101, 102) (ts, c11, c12) values (now-6m, Nan, 102)')
        self.tdSql.error(f'insert into {dbname}.t11 using {dbname}.stb(t11, t12) tags(111, 112) (ts, c11, c12) values (now-7m, "Nan", 112)')

        self.tdSql.query(f'select count(*) from {dbname}.stb')
        self.tdSql.checkEqual(self.tdSql.query_data[0][0], 3)
        self.tdSql.execute(f'drop database if exists {dbname}')
    ...
    def tags(self):
        return T.Write.TaoscSql.Table.Create.AutoCreate
