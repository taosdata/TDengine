...
class TDTestCase:
    ...
    def run(self):
        ...
        tdSql.execute('insert into ct0 values (1601482200000 , 10 , 10 , 10 , 10 , 10 , 10 , 10 , 10 , 10 );')

        tdSql.execute('insert into ct0 values (1601482260000 , 11 , 11 , 11 , 11 , 11 , 11 , 11 , 11 , 11 );')

        tdSql.execute('insert into ct0 values (1601482320000 , 12 , 12 , 12 , 12 , 12 , 12 , 12 , 12 , 12 );')

        tdSql.execute('insert into ct0 values (1601482380000 , 13 , 13 , 13 , 13 , 13 , 13 , 13 , 13 , 13 );')

        tdSql.execute('insert into ct0 values (1601482440000 , 14 , 14 , 14 , 14 , 14 , 14 , 14 , 14 , 14 );')

        tdSql.execute('insert into ct0 values (1601482500000 , 15 , 15 , 15 , 15 , 15 , 15 , 15 , 15 , 15 );')

        tdSql.execute('insert into ct0 values (1601482560000 , 16 , 16 , 16 , 16 , 16 , 16 , 16 , 16 , 16 );')

        tdSql.execute('insert into ct0 values (1601482620000 , 17 , 17 , 17 , 17 , 17 , 17 , 17 , 17 , 17 );')

        tdSql.execute('insert into ct0 values (1601482680000 , 18 , 18 , 18 , 18 , 18 , 18 , 18 , 18 , 18 );')

        tdSql.execute('insert into ct0 values (1601482740000 , 19 , 19 , 19 , 19 , 19 , 19 , 19 , 19 , 19 );')

        tdSql.execute('insert into ct0 values (1601482800000 , 20 , 20 , 20 , 20 , 20 , 20 , 20 , 20 , 20 );')

        tdSql.execute('insert into ct0 values (1601482860000 , 21 , 21 , 21 , 21 , 21 , 21 , 21 , 21 , 21 );')

        tdSql.execute('insert into ct0 values (1601482920000 , 22 , 22 , 22 , 22 , 22 , 22 , 22 , 22 , 22 );')

        tdSql.execute('insert into ct0 values (1601482980000 , 23 , 23 , 23 , 23 , 23 , 23 , 23 , 23 , 23 );')

        tdSql.execute('insert into ct0 values (1601483040000 , 24 , 24 , 24 , 24 , 24 , 24 , 24 , 24 , 24 );')

        tdSql.execute('insert into ct0 values (1601483100000 , 25 , 25 , 25 , 25 , 25 , 25 , 25 , 25 , 25 );')

        tdSql.execute('insert into ct0 values (1601483160000 , 26 , 26 , 26 , 26 , 26 , 26 , 26 , 26 , 26 );')

        tdSql.execute('insert into ct0 values (1601483220000 , 27 , 27 , 27 , 27 , 27 , 27 , 27 , 27 , 27 );')

        tdSql.execute('insert into ct0 values (1601483280000 , 28 , 28 , 28 , 28 , 28 , 28 , 28 , 28 , 28 );')

        tdSql.execute('insert into ct0 values (1601483340000 , 29 , 29 , 29 , 29 , 29 , 29 , 29 , 29 , 29 );')

        tdSql.execute('insert into ct0 values (1601483400000 , 30 , 30 , 30 , 30 , 30 , 30 , 30 , 30 , 30 );')

        tdSql.execute('insert into ct0 values (1601483460000 , 31 , 31 , 31 , 31 , 31 , 31 , 31 , 31 , 31 );')

        tdSql.execute('insert into ct0 values (1601483520000 , 32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 );')

        tdSql.execute('insert into ct0 values (1601483580000 , 33 , 33 , 33 , 33 , 33 , 33 , 33 , 33 , 33 );')

        tdSql.execute('insert into ct0 values (1601483640000 , 34 , 34 , 34 , 34 , 34 , 34 , 34 , 34 , 34 );')

        tdSql.execute('insert into ct0 values (1601483700000 , 35 , 35 , 35 , 35 , 35 , 35 , 35 , 35 , 35 );')

        tdSql.execute('insert into ct0 values (1601483760000 , 36 , 36 , 36 , 36 , 36 , 36 , 36 , 36 , 36 );')

        tdSql.execute('insert into ct0 values (1601483820000 , 37 , 37 , 37 , 37 , 37 , 37 , 37 , 37 , 37 );')

        tdSql.execute('insert into ct0 values (1601483880000 , 38 , 38 , 38 , 38 , 38 , 38 , 38 , 38 , 38 );')

        tdSql.execute('insert into ct0 values (1601483940000 , 39 , 39 , 39 , 39 , 39 , 39 , 39 , 39 , 39 );')

        tdSql.execute('insert into ct0 values (1601484000000 , 40 , 40 , 40 , 40 , 40 , 40 , 40 , 40 , 40 );')

        tdSql.execute('insert into ct0 values (1601484060000 , 41 , 41 , 41 , 41 , 41 , 41 , 41 , 41 , 41 );')

        tdSql.execute('insert into ct0 values (1601484120000 , 42 , 42 , 42 , 42 , 42 , 42 , 42 , 42 , 42 );')

        tdSql.execute('insert into ct0 values (1601484180000 , 43 , 43 , 43 , 43 , 43 , 43 , 43 , 43 , 43 );')

        tdSql.execute('insert into ct0 values (1601484240000 , 44 , 44 , 44 , 44 , 44 , 44 , 44 , 44 , 44 );')

        tdSql.execute('insert into ct0 values (1601484300000 , 45 , 45 , 45 , 45 , 45 , 45 , 45 , 45 , 45 );')

        tdSql.execute('insert into ct0 values (1601484360000 , 46 , 46 , 46 , 46 , 46 , 46 , 46 , 46 , 46 );')

        tdSql.execute('insert into ct0 values (1601484420000 , 47 , 47 , 47 , 47 , 47 , 47 , 47 , 47 , 47 );')

        tdSql.execute('insert into ct0 values (1601484480000 , 48 , 48 , 48 , 48 , 48 , 48 , 48 , 48 , 48 );')

        tdSql.execute('insert into ct0 values (1601484540000 , 49 , 49 , 49 , 49 , 49 , 49 , 49 , 49 , 49 );')
        ...
        tdSql.execute('insert into ct1 values (1601482800000 , 20 , 20 , 20 , 20 , 20 , 20 , 20 , 20 , 20 );')

        tdSql.execute('insert into ct1 values (1601482860000 , 21 , 21 , 21 , 21 , 21 , 21 , 21 , 21 , 21 );')

        tdSql.execute('insert into ct1 values (1601482920000 , 22 , 22 , 22 , 22 , 22 , 22 , 22 , 22 , 22 );')

        tdSql.execute('insert into ct1 values (1601482980000 , 23 , 23 , 23 , 23 , 23 , 23 , 23 , 23 , 23 );')

        tdSql.execute('insert into ct1 values (1601483040000 , 24 , 24 , 24 , 24 , 24 , 24 , 24 , 24 , 24 );')

        tdSql.execute('insert into ct1 values (1601483100000 , 25 , 25 , 25 , 25 , 25 , 25 , 25 , 25 , 25 );')

        tdSql.execute('insert into ct1 values (1601483160000 , 26 , 26 , 26 , 26 , 26 , 26 , 26 , 26 , 26 );')

        tdSql.execute('insert into ct1 values (1601483220000 , 27 , 27 , 27 , 27 , 27 , 27 , 27 , 27 , 27 );')

        tdSql.execute('insert into ct1 values (1601483280000 , 28 , 28 , 28 , 28 , 28 , 28 , 28 , 28 , 28 );')

        tdSql.execute('insert into ct1 values (1601483340000 , 29 , 29 , 29 , 29 , 29 , 29 , 29 , 29 , 29 );')

        tdSql.execute('insert into ct1 values (1601483400000 , 30 , 30 , 30 , 30 , 30 , 30 , 30 , 30 , 30 );')

        tdSql.execute('insert into ct1 values (1601483460000 , 31 , 31 , 31 , 31 , 31 , 31 , 31 , 31 , 31 );')

        tdSql.execute('insert into ct1 values (1601483520000 , 32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 );')

        tdSql.execute('insert into ct1 values (1601483580000 , 33 , 33 , 33 , 33 , 33 , 33 , 33 , 33 , 33 );')

        tdSql.execute('insert into ct1 values (1601483640000 , 34 , 34 , 34 , 34 , 34 , 34 , 34 , 34 , 34 );')

        tdSql.execute('insert into ct1 values (1601483700000 , 35 , 35 , 35 , 35 , 35 , 35 , 35 , 35 , 35 );')

        tdSql.execute('insert into ct1 values (1601483760000 , 36 , 36 , 36 , 36 , 36 , 36 , 36 , 36 , 36 );')

        tdSql.execute('insert into ct1 values (1601483820000 , 37 , 37 , 37 , 37 , 37 , 37 , 37 , 37 , 37 );')

        tdSql.execute('insert into ct1 values (1601483880000 , 38 , 38 , 38 , 38 , 38 , 38 , 38 , 38 , 38 );')

        tdSql.execute('insert into ct1 values (1601483940000 , 39 , 39 , 39 , 39 , 39 , 39 , 39 , 39 , 39 );')

        tdSql.execute('insert into ct1 values (1601484000000 , 40 , 40 , 40 , 40 , 40 , 40 , 40 , 40 , 40 );')

        tdSql.execute('insert into ct1 values (1601484060000 , 41 , 41 , 41 , 41 , 41 , 41 , 41 , 41 , 41 );')

        tdSql.execute('insert into ct1 values (1601484120000 , 42 , 42 , 42 , 42 , 42 , 42 , 42 , 42 , 42 );')

        tdSql.execute('insert into ct1 values (1601484180000 , 43 , 43 , 43 , 43 , 43 , 43 , 43 , 43 , 43 );')

        tdSql.execute('insert into ct1 values (1601484240000 , 44 , 44 , 44 , 44 , 44 , 44 , 44 , 44 , 44 );')

        tdSql.execute('insert into ct1 values (1601484300000 , 45 , 45 , 45 , 45 , 45 , 45 , 45 , 45 , 45 );')

        tdSql.execute('insert into ct1 values (1601484360000 , 46 , 46 , 46 , 46 , 46 , 46 , 46 , 46 , 46 );')
        ...
        tdSql.checkRows(50)
        tdSql.checkData(0, 0, 7.0)
        tdSql.checkData(1, 0, 7.0)
        tdSql.checkData(2, 0, 7.0)
        tdSql.checkData(3, 0, 7.0)
        tdSql.checkData(4, 0, 7.0)
        tdSql.checkData(5, 0, 7.0)
        tdSql.checkData(6, 0, 7.0)
        tdSql.checkData(7, 0, 7.0)
        tdSql.checkData(8, 0, 7.0)
        tdSql.checkData(9, 0, 7.0)
        tdSql.checkData(10, 0, 7.0)
        tdSql.checkData(11, 0, 7.0)
        tdSql.checkData(12, 0, 7.0)
        tdSql.checkData(13, 0, 7.0)
        tdSql.checkData(14, 0, 7.0)
        tdSql.checkData(15, 0, 7.0)
        tdSql.checkData(16, 0, 7.0)
        tdSql.checkData(17, 0, 7.0)
        tdSql.checkData(18, 0, 7.0)
        tdSql.checkData(19, 0, 7.0)
        tdSql.checkData(20, 0, 7.0)
        tdSql.checkData(21, 0, 7.0)
        tdSql.checkData(22, 0, 7.0)
        tdSql.checkData(23, 0, 7.0)
        tdSql.checkData(24, 0, 7.0)
        tdSql.checkData(25, 0, 7.0)
        tdSql.checkData(26, 0, 7.0)
        tdSql.checkData(27, 0, 7.0)
        tdSql.checkData(28, 0, 7.0)
        tdSql.checkData(29, 0, 7.0)
        tdSql.checkData(30, 0, 7.0)
        tdSql.checkData(31, 0, 7.0)
        tdSql.checkData(32, 0, 7.0)
        tdSql.checkData(33, 0, 7.0)
        tdSql.checkData(34, 0, 7.0)
        tdSql.checkData(35, 0, 7.0)
        tdSql.checkData(36, 0, 7.0)
        tdSql.checkData(37, 0, 7.0)
        tdSql.checkData(38, 0, 7.0)
        tdSql.checkData(39, 0, 7.0)
        tdSql.checkData(40, 0, 7.0)
        tdSql.checkData(41, 0, 7.0)
        tdSql.checkData(42, 0, 7.0)
        tdSql.checkData(43, 0, 7.0)
        tdSql.checkData(44, 0, 7.0)
        tdSql.checkData(45, 0, 7.0)
        tdSql.checkData(46, 0, 7.0)
        tdSql.checkData(47, 0, 7.0)
        tdSql.checkData(48, 0, 7.0)
        tdSql.checkData(49, 0, 7.0)
