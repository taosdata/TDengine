...
class TDTestCase:
    ...
    def run(self):
        ...
        os.system("%s" % cmd)
        tdSql.execute("reset query cache")
        tdSql.query("select count(tbname) from db2.stb")
        tdSql.checkData(0, 0, 8)
        tdSql.query("select count(*) from db2.stb")
        tdSql.checkData(0, 0, 160)
        ...
        os.system("%s" % cmd)
        tdSql.execute("reset query cache")
        tdSql.query("select count(tbname) from db3.stb")
        tdSql.checkData(0, 0, 8)
        tdSql.query("select count(*) from db3.stb")
        tdSql.checkData(0, 0, 160)
