...
class TDTestCase:
    ...
    def run(self):
        ...
        tdSql.checkData(14, 1, "INT")
        tdSql.checkData(15, 1, "BIGINT")
        tdSql.checkData(16, 1, "FLOAT")
        tdSql.checkData(17, 1, "DOUBLE")
        tdSql.checkData(18, 1, "SMALLINT")
        tdSql.checkData(19, 1, "TINYINT")
        tdSql.checkData(20, 1, "BOOL")
        tdSql.checkData(21, 1, "NCHAR")
        tdSql.checkData(21, 2, 17)
        tdSql.checkData(22, 1, "INT UNSIGNED")
        tdSql.checkData(23, 1, "BIGINT UNSIGNED")
        tdSql.checkData(24, 1, "TINYINT UNSIGNED")
        tdSql.checkData(25, 1, "SMALLINT UNSIGNED")
        tdSql.checkData(26, 1, "BINARY")
        tdSql.checkData(26, 2, 19)
