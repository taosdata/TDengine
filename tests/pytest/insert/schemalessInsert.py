...
class TDTestCase:
    ...
    def resCmp(self, input_sql, stb_name, query_sql="select * from", condition="", ts=None, id=True, none_check_tag=None, precision=None):
        ...
        if precision == None:
            self._conn.schemaless_insert([input_sql], 0, None)
        else:
            self._conn.schemaless_insert([input_sql], 0, precision)
    ...
    def tsCheckCase(self):
        ...
        """
        tdCom.cleanTb()
        ts_list = ["1626006833639000000ns", "1626006833639019us", "1626006833640ms", "1626006834s", "1626006833639000000", 0]
        for ts in ts_list:
        ...
        input_sql = ['test_ms,t0=t c0=t 1626006833640ms', 'test_ms,t0=t c0=f 1626006833641ms']
        self._conn.schemaless_insert(input_sql, 0, None)
        ...
        tdSql.execute("use test_ts")
        input_sql = ['test_us,t0=t c0=t 1626006833639000us', 'test_us,t0=t c0=f 1626006833639001us']
        self._conn.schemaless_insert(input_sql, 0, None)
        ...
        tdSql.execute("use test_ts")
        input_sql = ['test_ns,t0=t c0=t 1626006833639000000ns', 'test_ns,t0=t c0=f 1626006833639000001ns']
        self._conn.schemaless_insert(input_sql, 0, None)
    ...
    def tsPriorityCheckCase(self):
        tdCom.cleanTb()
        input_sql_list = [f'tbname_1,t0=127,t1=32767I16,t2=2147483647I32,t3=9223372036854775807,t4=11.12345027923584F32,t5=22.123456789F64 c0=127,c1=32767I16,c2=2147483647I32,c3=9223372036854775807,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639019us',
                            f'tbname_2,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789 1626006833640ms',
                            f'tbname_3,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=10e5F32 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=10e5F64 1626006834s',
                            f'tbname_4,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=-10.0e5 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=-10.0e5 1626006833639000000ns']
        for input_sql in input_sql_list:
            stb_name = input_sql.split(",")[0]
            self.resCmp(input_sql, stb_name, precision="ms")
    
    def zeroTsCheckCase(self):
        tdCom.cleanTb()
        for ts_tag in ["h", "m", "s", "u", "ns"]:
    ...
    def influxTsCheckCase(self):
        tdCom.cleanTb()
        input_sql = f'{tdCom.getLongName(len=10, mode="letters")},t0=127,t1=32767I16,t2=2147483647I32,t3=9223372036854775807,t4=11.12345027923584F32,t5=22.123456789F64 c0=127,c1=32767I16,c2=2147483647I32,c3=9223372036854775807,c4=11.12345027923584F32,c5=22.123456789F64 100'
        stb_name = input_sql.split(",")[0]
        self._conn.schemaless_insert([input_sql], 0, "h")
        ...
        stb_name = input_sql.split(",")[0]
        self._conn.schemaless_insert([input_sql], 0, "m")
        tdSql.query(f'select * from {stb_name}')
        tdSql.checkData(0, 0, 0)
        ...
        stb_name = input_sql.split(",")[0]
        self._conn.schemaless_insert([input_sql], 0, "s")
        tdSql.query(f'select * from {stb_name}')
        tdSql.checkData(0, 0, 0)
        ...
        stb_name = input_sql.split(",")[0]
        self._conn.schemaless_insert([input_sql], 0, "ms")
        tdSql.query(f'select * from {stb_name}')
        tdSql.checkData(0, 0, 0)
        ...
        stb_name = input_sql.split(",")[0]
        self._conn.schemaless_insert([input_sql], 0, "u")
        tdSql.query(f'select * from {stb_name}')
        tdSql.checkData(0, 0, 0)
        ...
        stb_name = input_sql.split(",")[0]
        self._conn.schemaless_insert([input_sql], 0, "ns")
        tdSql.query(f'select * from {stb_name}')
        tdSql.checkData(0, 0, 0)
    ...
    def tbnameCheckCase(self):
        ...
        input_sql = 'Abcdffgg,id=Abcddd,T1=127i8 c0=False 1626006833639000000ns'
        stb_name = "Abcdffgg"
        self.resCmp(input_sql, stb_name)
    ...
    def tagValueLengthCheckCase(self):
        ...
        input_sql = f'{stb_name},t0=t,t1={tdCom.getLongName(4093, "letters")} c0=f 1626006833639000000ns'
        self._conn.schemaless_insert([input_sql], 0, None)

        input_sql = f'{stb_name},t0=t,t1={tdCom.getLongName(4094, "letters")} c0=f 1626006833639000000ns'
        try:
            self._conn.schemaless_insert([input_sql], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
    ...
    def colValueLengthCheckCase(self):
        ...
        # # binary 
        stb_name = tdCom.getLongName(7, "letters")
        input_sql = f'{stb_name},t0=t c0=f,c1="{tdCom.getLongName(16374, "letters")}" 1626006833639000000ns'
        self._conn.schemaless_insert([input_sql], 0, None)
        input_sql = f'{stb_name},t0=t c0=f,c1="{tdCom.getLongName(16375, "letters")}" 1626006833639000000ns'
        try:
            self._conn.schemaless_insert([input_sql], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
        ...
        # * legal nchar could not be larger than 16374/4
        stb_name = tdCom.getLongName(7, "letters")
        input_sql = f'{stb_name},t0=t c0=f,c1=L"{tdCom.getLongName(4093, "letters")}" 1626006833639000000ns'
        self._conn.schemaless_insert([input_sql], 0, None)

        input_sql = f'{stb_name},t0=t c0=f,c1=L"{tdCom.getLongName(4094, "letters")}" 1626006833639000000ns'
        try:
            self._conn.schemaless_insert([input_sql], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
    ...
    def tagColIllegalValueCheckCase(self):
        ...
        for symbol in list('~!@#$¥%^&*()-+={}|[]、「」:;'):
            ...
            self._conn.schemaless_insert([input_sql1], 0, None)
            self._conn.schemaless_insert([input_sql2], 0, None)
    ...
    def duplicateIdTagColInsertCheckCase(self):
        ...
        try:
            self._conn.schemaless_insert([input_sql_id], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
            tdSql.checkNotEqual(err.errno, 0)
        ...
        try:
            self._conn.schemaless_insert([input_sql_tag], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
            tdSql.checkNotEqual(err.errno, 0)
        ...
        try:
            self._conn.schemaless_insert([input_sql_col], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
            tdSql.checkNotEqual(err.errno, 0)
    ...
    def tagColNcharMaxLengthCheckCase(self):
        ...
        stb_name = tdCom.getLongName(7, "letters")
        tb_name = f'{stb_name}_1'
        input_sql = f'{stb_name},id={tb_name},t2={tdCom.getLongName(1, "letters")} c0=f 1626006833639000000ns'
        self._conn.schemaless_insert([input_sql], 0, None)

        # * legal nchar could not be larger than 16374/4
        input_sql = f'{stb_name},t1={tdCom.getLongName(4093, "letters")},t2={tdCom.getLongName(1, "letters")} c0=f 1626006833639000000ns'
        self._conn.schemaless_insert([input_sql], 0, None)
        tdSql.query(f"select * from {stb_name}")
        tdSql.checkRows(2)
        input_sql = f'{stb_name},t1={tdCom.getLongName(4093, "letters")},t2={tdCom.getLongName(2, "letters")} c0=f 1626006833639000000ns'
        try:
            self._conn.schemaless_insert([input_sql], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
        ...
        input_sql = f'{stb_name},t2={tdCom.getLongName(1, "letters")} c0=f,c1=L"{tdCom.getLongName(4093, "letters")}",c2=L"{tdCom.getLongName(4093, "letters")}",c3=L"{tdCom.getLongName(4093, "letters")}",c4=L"{tdCom.getLongName(4, "letters")}" 1626006833639000000ns'
        self._conn.schemaless_insert([input_sql], 0, None)
        tdSql.query(f"select * from {stb_name}")
        tdSql.checkRows(3)
        input_sql = f'{stb_name},t2={tdCom.getLongName(1, "letters")} c0=f,c1=L"{tdCom.getLongName(4093, "letters")}",c2=L"{tdCom.getLongName(4093, "letters")}",c3=L"{tdCom.getLongName(4093, "letters")}",c4=L"{tdCom.getLongName(5, "letters")}" 1626006833639000000ns'
        try:
            self._conn.schemaless_insert([input_sql], 0, None)
            raise Exception("should not reach here")
        except SchemalessError as err:
    ...
    def batchInsertCheckCase(self):
        ...
        self._conn.schemaless_insert(lines, 0, None)
    ...
    def multiInsertCheckCase(self, count):
            ...
            self._conn.schemaless_insert(sql_list, 0, None)
            tdSql.query('show tables')
    ...
    def batchErrorInsertCheckCase(self):
        ...
        tdCom.cleanTb()
        stb_name = tdCom.getLongName(8, "letters")
        lines = ["st123456,t1=3i64,t2=4f64,t3=\"t3\" c1=3i 64,c3=L\"passit\",c2=false,c4=4f64 1626006833639000000ns",
                f"{stb_name},t2=5f64,t3=L\"ste\" c1=tRue,c2=4i64,c3=\"iam\" 1626056811823316532ns"]
        try:
            self._conn.schemaless_insert(lines, 0, None)
            raise Exception("should not reach here")
    ...
    def spellCheckCase(self):
        stb_name = tdCom.getLongName(8, "letters")
        input_sql_list = [f'{stb_name}_1,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639000000Ns',
                            f'{stb_name}_2,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639000000nS',
                            f'{stb_name}_3,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639000000NS',
                            f'{stb_name}_4,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639019Us',
                            f'{stb_name}_5,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639019uS',
                            f'{stb_name}_6,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639019US',
                            f'{stb_name}_7,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833640Ms',
                            f'{stb_name}_8,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833640mS',
                            f'{stb_name}_9,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006833640MS',
                            f'{stb_name}_10,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789F64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789F64 1626006834S']
        for input_sql in input_sql_list:
            stb_name = input_sql.split(',')[0]
            self.resCmp(input_sql, stb_name)
    ...
    def defaultTypeCheckCase(self):
        stb_name = tdCom.getLongName(8, "letters")
        input_sql_list = [f'{stb_name}_1,t0=127,t1=32767I16,t2=2147483647I32,t3=9223372036854775807,t4=11.12345027923584F32,t5=22.123456789F64 c0=127,c1=32767I16,c2=2147483647I32,c3=9223372036854775807,c4=11.12345027923584F32,c5=22.123456789F64 1626006833639000000Ns',
                            f'{stb_name}_2,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=22.123456789 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=22.123456789 1626006833639000000nS',
                            f'{stb_name}_3,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=10e5F32 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=10e5F64 1626006833639000000NS',
                            f'{stb_name}_4,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=10.0e5f64 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=10.0e5f32 1626006833639019Us',
                            f'{stb_name}_5,t0=127I8,t1=32767I16,t2=2147483647I32,t3=9223372036854775807I64,t4=11.12345027923584F32,t5=-10.0e5 c0=127I8,c1=32767I16,c2=2147483647I32,c3=9223372036854775807I64,c4=11.12345027923584F32,c5=-10.0e5 1626006833639019uS']
        for input_sql in input_sql_list:
            stb_name = input_sql.split(",")[0]
            self.resCmp(input_sql, stb_name)
    ...
    def genMultiThreadSeq(self, sql_list):
        ...
        for insert_sql in sql_list:
            t = threading.Thread(target=self._conn.schemaless_insert,args=([insert_sql[0]], 0, None))
            tlist.append(t)
        return tlist
