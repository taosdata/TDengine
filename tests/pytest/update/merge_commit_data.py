...
class TDTestCase:
    ...
    def run(self):
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t3 values (%d , 1)' % (t0 + i))
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t4 values (%d , 1)' % (t0 + i))
        ...
        for i in range(0, 100):
            ret = tdSql.execute('insert into t4 values (%d , 1)' %
                                (t0 + 200 + i))
        tdSql.query("select * from t4")
        tdSql.checkRows(insertRows + 100)
        tdDnodes.stopAll()
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t5 values (%d , 1)' % (t0 + i))
        ...
        for i in range(0, 6000):
            ret = tdSql.execute('insert into t5 values (%d , 1)' %
                                (t0 + 200 + i))
        tdSql.query("select * from t5")
        tdSql.checkRows(insertRows + 6000)
        tdDnodes.stopAll()
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t6 values (%d , 1)' % (t0 + i))
        ...
        tdSql.checkRows(insertRows)
        for i in range(0, 100):
            ret = tdSql.execute('insert into t6 values (%d , 2)' % (t0 + i))
        tdSql.query("select * from t6")
        tdSql.checkRows(insertRows)
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t7 values (%d , 1)' % (t0 + i))
        ...
        for i in range(100, 300):
            ret = tdSql.execute('insert into t7 values (%d , 2)' % (t0 + i))
        tdSql.query("select * from t7")
        tdSql.checkRows(300)
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t8 values (%d , 1)' % (t0 + i))
        ...
        tdSql.checkRows(insertRows)
        for i in range(6000):
            ret = tdSql.execute('insert into t8 values (%d , 2)' % (t0 + i))
        tdSql.query("select * from t8")
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t9 values (%d , 1)' % (t0 + i))
        ...
        for i in range(-100, 100):
            ret = tdSql.execute('insert into t9 values (%d , 2)' % (t0 + i))
        tdSql.query("select * from t9")
        tdSql.checkRows(300)
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t10 values (%d , 1)' % (t0 + i))
        ...
        for i in range(-6000, 100):
            ret = tdSql.execute('insert into t10 values (%d , 2)' % (t0 + i))
        tdSql.query("select * from t10")
        ...
        insertRows = 200
        for i in range(0, insertRows):
            ret = tdSql.execute('insert into t11 values (%d , 1)' % (t0 + i))
        ...
        tdSql.checkRows(insertRows)
        for i in range(100):
            ret = tdSql.execute('insert into t11 values (%d , 2)' % (t0 + i))
