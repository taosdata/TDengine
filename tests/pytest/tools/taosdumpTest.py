...
class TDTestCase:
    ...
    def run(self):
        ...
        tdSql.error("create stable st1(ts timestamp, c1 int, col2_012345678901234567890123456789012345678901234567890123456789abc1111111111111111111222333333333333333344444444455555555555abc nchar(10)) tags(t1 int, t2 binary(10))")
