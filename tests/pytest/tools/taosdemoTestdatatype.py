...
class TDTestCase:
    ...
    def run(self):
        ...
        os.system("taosdemo -d test002 -y -t %d -n %d -b INT,nchar\\(8\\),binary\\(16\\),binary,nchar -w 8" %
        ...
        os.system("taosdemo -d test002 -y -t %d -n %d --data-type INT,nchar\\(8\\),binary\\(16\\),binary,nchar -w 8" %
                  (binPath, self.numberOfTables, self.numberOfRecords))
        ...
        os.system("taosdemo -d test002 -y -t %d -n %d -bINT,nchar\\(8\\),binary\\(16\\),binary,nchar -w 8" %
                  (binPath, self.numberOfTables, self.numberOfRecords))
