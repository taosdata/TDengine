...
class TDTestCase:
    ...
    def run(self):
        ...
        #regular old && new
        startTime = time.time()
        os.system("taosdemo -N -d regular_old -t 1 -n 10 -l 1023 -y" % binPath)
        ...
        os.system("taosdemo -N -d regular_new -t 1 -n 10 -l 4095 -y" % binPath)
        ...
        os.system("taosdemo -d super_old -t 1 -n 10 -l 1021 -y" % binPath)
        ...
        os.system("taosdemo -d super_new -t 1 -n 10 -l 4093 -y" % binPath)
        ...
        os.system("taosdemo -f tools/taosdemoAllTest/TD-5213/insertSigcolumnsNum4096.json -y " % binPath)
