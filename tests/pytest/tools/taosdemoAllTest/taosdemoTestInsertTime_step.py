...
class TDTestCase:
    ...
    def run(self):
        ...
        os.system("taosdemo -f tools/taosdemoAllTest/taosdemoInsertNanoDB.json -y " % binPath)
        ...
        os.system("taosdemo -f tools/taosdemoAllTest/taosdemoInsertUSDB.json -y " % binPath)
        ...
        os.system("taosdemo -f tools/taosdemoAllTest/taosdemoInsertMSDB.json -y " % binPath)
