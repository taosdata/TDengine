...
class TDTestCase:
    ...
    def run(self):
       ...
       # query: query test for nanoSecond  with where and max min groupby order 
        os.system("%staosBenchmark -f tools/taosdemoAllTest/taosdemoTestNanoDatabase.json -y " % binPath)
        ...
        os.system("%staosBenchmark -f tools/taosdemoAllTest/taosdemoTestSupportNanoQuery.json -y " % binPath)


        os.system("%staosBenchmark -f tools/taosdemoAllTest/taosdemoTestNanoDatabasecsv.json  -y " % binPath)
        ...
        #  query : query above sqls by taosdemo and continuously
        os.system("%staosBenchmark -f tools/taosdemoAllTest/taosdemoTestSupportNanoQuerycsv.json -y " % binPath)
