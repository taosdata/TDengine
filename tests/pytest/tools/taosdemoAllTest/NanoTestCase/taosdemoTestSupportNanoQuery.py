...
class TDTestCase:
    ...
    def run(self):
       ...
       # query: query test for nanoSecond  with where and max min groupby order 
        os.system("taosdemo -f tools/taosdemoAllTest/NanoTestCase/taosdemoTestNanoDatabase.json -y " % binPath)
        ...
        os.system("taosdemo -f tools/taosdemoAllTest/NanoTestCase/taosdemoTestSupportNanoQuery.json -y " % binPath)


        os.system("taosdemo -f tools/taosdemoAllTest/NanoTestCase/taosdemoTestNanoDatabasecsv.json  -y " % binPath)
        ...
        #  query : query above sqls by taosdemo and continuously
        os.system("taosdemo -f tools/taosdemoAllTest/NanoTestCase/taosdemoTestSupportNanoQuerycsv.json -y " % binPath)
