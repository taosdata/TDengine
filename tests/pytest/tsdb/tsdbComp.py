...
class TDTestCase:
    ...
    def run(self):
        ...
        dataType = [
            ...
            " binary(20)", "nchar(20)", "tinyint unsigned",
        ...
        for i in range(rowNum2):
            tdSql.execute("alter table test add column col%d  %s ;" %
                          (i + 14, choice(dataType)))
        ...
        for j in range(self.rowNum2):
            ...
            for i in range(self.rowNum):
                tdSql.execute(
                    ...
                    % (j, self.ts + i * 1000, i + 1, i + 1, i + 1, i + 1,
                       i + 1, i + 0.1, i + 0.1, i % 2, i + 1, i + 1, i + 1,
                       i + 1, i + 1, i + 1))
