...
class TDTestCase:
    ...
    def run(self):        
        ...
        tdSql.checkData(0, 1, "CREATE DATABASE `电力系统` REPLICA 1 QUORUM 1 DAYS 10 KEEP 3650 CACHE 16 BLOCKS 6 MINROWS 100 MAXROWS 4096 WAL 2 FSYNC 1000 COMP 2 CACHELAST 0 PRECISION 'ms' UPDATE 0")        
