...
class TDTestCase:
    ...
    def run(self):
        ...
        sqls = {
            "int":"select * from t00,t01 where t00.ts=t01.ts",
            "bigint":"select * from t20,t21 where t20.ts=t21.ts",
            "StfloatANDbigint":"select * from stb1,stb2 where stb1.ts=stb2.ts and stb1.t1=stb2.t1",
            "double":"select * from t50,t51 where t50.ts=t51.ts",
            "bigintANDdouble":"select * from t20,t50 where t20.ts=t50.ts",
            "binary":"select * from t60,t61 where t60.ts=t61.ts",
            "nchar":"select * from t70,t71 where t70.ts=t71.ts",
            "binaryANDnchar":"select * from t60,t70 where t60.ts=t70.ts",
        }
