...
function lcovFunc {
    ...
    lcov -d "$CAPTURE_GCDA_DIR" --capture --rc lcov_branch_coverage=1 --rc geninfo_function_coverage=1 --no-external -b $TDENGINE_DIR -o coverage.info 

    # remove exclude paths 
    lcov --remove coverage.info \
        '*/contrib/*' '*/test/*' '*/passwdTest.c'  '*/taoscTest.cpp' '*/packaging/*' '*/taos-tools/deps/*' '*/taosadapter/*' '*/TSZ/*' \
        ...
        --rc lcov_branch_coverage=1 --rc geninfo_function_coverage=1  -o coverage.info

    # generate result
    echo "generate result"
    lcov -l --rc lcov_branch_coverage=1 --rc geninfo_function_coverage=1  coverage.info    
