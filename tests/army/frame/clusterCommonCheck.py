...
class ClusterComCheck:
    ...
    def check_vgroups_status_with_offline(self,vgroup_numbers=2,db_replica=3,count_number=10,db_name="db"):
        """ 
            ...
            return 1, n leaders, unstable
            return 2, 0 < num of leader < n, unstable
            return 0, no leader, unstable
            return -1, Elections not yet completed, unstable
        """
        ...
        while count < count_number:
            ...
            for i in range(vgroup_numbers):
                ...
                elif tdSql.res[i].count('follow') >= 2:
