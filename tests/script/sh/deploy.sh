...
echo "mDebugFlag             0"                >> $TAOS_CFG
echo "dDebugFlag             0"                >> $TAOS_CFG
echo "vDebugFlag             0"                >> $TAOS_CFG
echo "tsdbDebugFlag          0"                >> $TAOS_CFG
echo "cDebugFlag             0"                >> $TAOS_CFG
echo "jnidebugFlag           0"                >> $TAOS_CFG
echo "qdebugFlag             0"                >> $TAOS_CFG
echo "rpcDebugFlag           0"                >> $TAOS_CFG
echo "tmrDebugFlag           131"                >> $TAOS_CFG
echo "udebugFlag             0"                >> $TAOS_CFG
echo "sdebugFlag             0"                >> $TAOS_CFG
echo "wdebugFlag             0"                >> $TAOS_CFG
