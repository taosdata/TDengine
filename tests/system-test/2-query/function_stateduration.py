...
class TDTestCase:
    ...
    def check_boundary_values(self, dbname="bound_test"):
        ...
        tdSql.execute(
                f"insert into {dbname}.sub1_bound values ( now()-2s, 2147483647, 9223372036854775807, 32767, 127, 3.40E+38, 1.7e+308, True, 'binary_tb1', 'nchar_tb1', now() )"
            )
        tdSql.execute(
        ...
        tdSql.error(
                f"insert into {dbname}.sub1_bound values ( now()+3s, 2147483648, 9223372036854775808, 32768, 128, 3.40E+38, 1.7e+308, True, 'binary_tb1', 'nchar_tb1', now() )"
            )
