...
class TDTestCase:
    ...
    def ts5181(self):
        ...
        tdSql.execute("CREATE STABLE `stb1` (`ts` TIMESTAMP ENCODE 'delta-i' COMPRESS 'lz4' LEVEL 'medium', `v1` INT ENCODE 'simple8b' COMPRESS 'lz4' LEVEL 'medium') TAGS (`t1` INT)")

        tdSql.execute("insert into ttt_10000     using stb1 tags( 44400 )  values('2024-02-19 16:05:17.649', 22300  );  ")   
        tdSql.execute("insert into ttt_10000     using stb1 tags( 44400 )  values('2024-02-19 16:05:48.818',  22300 );  ")   
        tdSql.execute("insert into  ttt_10       using stb1 tags( 40    )  values('2024-02-19 16:25:36.013',  20    );  ") 
        tdSql.execute("insert into  ttt_11       using stb1 tags( 11   )   values('2024-02-19 16:39:50.385' , 20     ); ")  
        tdSql.execute("insert into  ttt_11       using stb1 tags( 11   )   values('2024-02-19 16:43:51.742' , 20     ); ")  
        tdSql.execute("insert into  ttt_11       using stb1 tags( 11   )   values('2024-02-20 08:35:13.518' , 20     ); ")  
        tdSql.execute("insert into  ttt_11       using stb1 tags( 11   )   values('2024-02-20 08:58:42.255' , 20     ); ")  
        tdSql.execute("insert into  ttt_11       using stb1 tags( 11   )   values('2024-02-21 09:57:49.477' , 20     ); ")  
        tdSql.execute("insert into `ttt_2024-2-21` using stb1 tags( 11   ) values('2024-02-21 09:58:21.882' , 20     ); ")  
        tdSql.execute("insert into `ttt_2024-2-21` using stb1 tags( 11   ) values('2024-02-26 16:08:31.675' , 20     ); ")  
        tdSql.execute("insert into `ttt_2024-2-21` using stb1 tags( 11   ) values('2024-02-26 16:11:43.445' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:12:30.276' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:07.188' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:07.653' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:07.879' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:08.083' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:08.273' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:08.429' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:08.599' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:08.775' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:08.940' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:09.110' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:09.254' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:09.409' , NULL   ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:34.750' , 12     ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:49.820' , 12     ); ")  
        tdSql.execute("insert into `ttt_2024-2-33` using stb1 tags( 11   ) values('2024-02-26 16:25:59.551' , NULL   ); ")  
        tdSql.execute("insert into  ttt_2        using stb1 tags( 2    )   values('2024-02-19 15:26:39.644' , 2      ); ") 
        tdSql.execute("insert into  ttt_2        using stb1 tags( 2    )   values('2024-02-19 15:26:40.433' , 2      ); ") 
        tdSql.execute("insert into  ttt_3        using stb1 tags( 3    )   values('2024-02-19 15:27:22.613' , 1      ); ") 
        tdSql.execute("insert into  ttt_13       using stb1 tags( 3    )   values('2024-02-19 15:27:39.719' , 1      ); ")  
        tdSql.execute("insert into  ttt_14       using stb1 tags( 3    )   values('2024-02-19 15:28:36.235' , 222    ); ")  
        tdSql.execute("insert into  ttt_14       using stb1 tags( 3    )   values('2024-02-19 15:28:59.310' , 222    ); ")  
        tdSql.execute("insert into  ttt_14       using stb1 tags( 3    )   values('2024-02-19 15:29:18.897' , 222    ); ")  
        tdSql.execute("insert into  ttt_14       using stb1 tags( 3    )   values('2024-02-19 15:50:24.682' , 223    ); ")  
        tdSql.execute("insert into  ttt_4        using stb1 tags( 3    )   values('2024-02-19 15:31:19.945' , 222    ); ") 
        tdSql.execute("insert into  ttt_a        using stb1 tags( 3    )   values('2024-02-19 15:31:37.915' , 4      ); ") 
        tdSql.execute("insert into  ttt_axxxx    using stb1 tags( NULL )   values('2024-02-19 15:31:58.953' , 4      ); ") 
        tdSql.execute("insert into  ttt_axxx     using stb1 tags( 56   )   values('2024-02-19 15:32:22.323' , NULL   ); ")  
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-19 15:36:44.625' , 5444   ); ") 
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-19 15:38:41.479' , 5444   ); ") 
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-19 15:57:23.249' , 5444   ); ") 
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-19 16:04:20.465' , 5444   ); ") 
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-26 16:11:29.364' , 5444   ); ") 
        tdSql.execute("insert into  ttt_123      using stb1 tags( 0    )   values('2024-02-19 15:44:52.136' , 223    ); ") 
        tdSql.execute("insert into  ttt_145      using stb1 tags( 0    )   values('2024-02-19 15:50:28.580' , 223    ); ") 
        tdSql.execute("insert into  ttt_1465     using stb1 tags( 0    )   values('2024-02-19 15:50:32.493' , 223    ); ")  
        tdSql.execute("insert into  ttt_1465     using stb1 tags( 0    )   values('2024-02-19 15:57:36.866' , 223    ); ")  
        tdSql.execute("insert into  ttt_1465     using stb1 tags( 0    )   values('2024-02-19 16:04:52.794' , 221113 ); ")  
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-27 08:47:11.366' , 5444   ); ") 
        tdSql.execute("insert into  ttt_444      using stb1 tags( 5633 )   values('2024-02-28 09:35:46.474' , 5444   ); ") 


        tdSql.query("select *,tbname from stb1 ;")
        tdSql.checkRows(51)

        tdSql.query("select _irowts as ts,interp(v1),t1,tbname from stb1 \
        ...
        tdSql.query("select _irowts as ts,interp(v1),tbname from stb1 \
            where ts>'2024-02-19T15:25:00+08:00' and ts<'2024-02-19T16:05:00+08:00' \
            partition by tbname range('2024-02-19T15:30:00+08:00','2024-02-19T15:30:00+08:00') every(1m) \
            fill(value, 0) order by tbname")
        tdSql.checkRows(12)
        ...
        tdSql.query("select _irowts as ts,interp(v1),t1 from stb1 \
            where ts>'2024-02-19T15:25:00+08:00' and ts<'2024-02-19T16:05:00+08:00' \
            partition by tbname range('2024-02-19T15:30:00+08:00','2024-02-19T15:30:00+08:00') every(1m) \
            fill(NULL) order by tbname")
        tdSql.checkRows(12)
