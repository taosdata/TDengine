...
class TDTestCase:
    ...
    def check_result_auto(self ,origin_query , log_query):
    ...
    def test_errors(self):
        error_sql_lists = [
            ...
            "select log(c1 ,NULL) from t1",
            "select log(,) from t1;",
            "select log(log(c1) ab from t1)",
            "select log(c1) as int from t1",
            ...
            "select log(123--123)==1 from stb1",
            "select log(c1) as 'd1' from stb1",
            "select log(c1 ,c2 ) from stb1",
            "select log(c1 ,NULL) from stb1",
            "select log(,) from stb1;",
            "select log(log(c1) ab from stb1)",
            "select log(c1) as int from stb1"
        ]
    ...
    def support_types(self):
        type_error_sql_lists = [
            "select log(ts) from t1" , 
            "select log(c7) from t1",
            "select log(c8) from t1",
            "select log(c9) from t1",
            "select log(ts) from ct1" , 
            "select log(c7) from ct1",
            "select log(c8) from ct1",
            "select log(c9) from ct1",
            "select log(ts) from ct3" , 
            "select log(c7) from ct3",
            "select log(c8) from ct3",
            "select log(c9) from ct3",
            "select log(ts) from ct4" , 
            "select log(c7) from ct4",
            "select log(c8) from ct4",
            "select log(c9) from ct4",
            "select log(ts) from stb1" , 
            "select log(c7) from stb1",
            "select log(c8) from stb1",
            "select log(c9) from stb1" ,

            "select log(ts) from stbbb1" , 
            "select log(c7) from stbbb1",

            "select log(ts) from tbname",
            "select log(c9) from tbname"
        ...
        type_sql_lists = [
            "select log(c1) from t1",
            "select log(c2) from t1",
            "select log(c3) from t1",
            "select log(c4) from t1",
            "select log(c5) from t1",
            "select log(c6) from t1",

            "select log(c1) from ct1",
            "select log(c2) from ct1",
            "select log(c3) from ct1",
            "select log(c4) from ct1",
            "select log(c5) from ct1",
            "select log(c6) from ct1",

            "select log(c1) from ct3",
            "select log(c2) from ct3",
            "select log(c3) from ct3",
            "select log(c4) from ct3",
            "select log(c5) from ct3",
            "select log(c6) from ct3",

            "select log(c1) from stb1",
            "select log(c2) from stb1",
            "select log(c3) from stb1",
            "select log(c4) from stb1",
            "select log(c5) from stb1",
            "select log(c6) from stb1",

            "select log(c6) as alisb from stb1", 
            "select log(c6) alisb from stb1", 
        ]
    ...
    def basic_log_function(self):
        ...
        tdSql.query("select log(c1) from ct3")
        tdSql.checkRows(0)
        tdSql.query("select log(c2) from ct3")
        tdSql.checkRows(0)
        tdSql.query("select log(c3) from ct3")
        tdSql.checkRows(0)
        tdSql.query("select log(c4) from ct3")
        tdSql.checkRows(0)
        tdSql.query("select log(c5) from ct3")
        tdSql.checkRows(0)
        tdSql.query("select log(c6) from ct3")
        ...
        self.check_result_auto( "select c1, c2, c3 , c4, c5 from t1", "select (c1), log(c2) ,log(c3), log(c4), log(c5) from t1")
        
        # used for sub table
        tdSql.query("select log(c1) from ct1")
        ...
        self.check_result_auto("select log(log(log(log(log(log(log(log(log(log(c1)))))))))) nest_col_func from ct1;","select c1 from ct1" )

        # used for stable table 
        
        tdSql.query("select log(c1) from stb1")
        tdSql.checkRows(25)
        ...
        tdSql.error("select log(c1) from stbbb1")
        tdSql.error("select log(c1) from tbname")
        tdSql.error("select log(c1) from ct5")

        # mix with common col 
        tdSql.query("select c1, log(c1) from ct1")
        tdSql.checkData(0 , 0 ,8)
        tdSql.checkData(0 , 1 ,8)
        tdSql.checkData(4 , 0 ,0)
        tdSql.checkData(4 , 1 ,0)
        tdSql.query("select c1, log(c1) from ct4")
        tdSql.checkData(0 , 0 , None)
        ...
        tdSql.query("select c1, log(c1),c5, floor(c5) from ct4 ")
        tdSql.checkData(0 , 0 ,None)
        tdSql.checkData(0 , 1 ,None)
        ...
        tdSql.query("select c1, log(c1),c5, floor(c5) from stb1 ")

        # mix with agg functions , not support
        tdSql.error("select c1, log(c1),c5, count(c5) from stb1 ")
        tdSql.error("select c1, log(c1),c5, count(c5) from ct1 ")
        tdSql.error("select log(c1), count(c5) from stb1 ")
        tdSql.error("select log(c1), count(c5) from ct1 ")
        ...
        # bug fix for compute 
        tdSql.query("select c1, log(c1) -0 ,ceil(c1)-0 from ct4 ")
        tdSql.checkData(0, 0, None)
        tdSql.checkData(0, 1, None)
        tdSql.checkData(0, 2, None)
        ...
        tdSql.query(" select c1, log(c1) -0 ,ceil(c1-0.1)-0.1 from ct4")
        tdSql.checkData(0, 0, None)
        tdSql.checkData(0, 1, None)
        tdSql.checkData(0, 2, None)
        tdSql.checkData(1, 0, 8)
    ...
    def check_boundary_values(self):
        ...
        self.check_result_auto( "select c1, c2, c3 , c4, c5 ,c6 from sub1_bound ", "select log(c1), log(c2) ,log(c3), log(c4), log(c5) ,log(c6) from sub1_bound")
        self.check_result_auto( "select c1, c2, c3 , c3, c2 ,c1 from sub1_bound ", "select log(c1), log(c2) ,log(c3), log(c3), log(c2) ,log(c1) from sub1_bound")
        ...
        self.check_result_auto("select c1+1 ,c2 , c3*1 , c4/2, c5/2, c6 from sub1_bound" ,"select log(c1+1) ,log(c2) , log(c3*1) , log(c4/2), log(c5)/2, log(c6) from sub1_bound ")
    ...
    def run(self):  # sourcery skip: extract-duplicate-method, remove-redundant-fstring
        ...
        tdLog.printNoPrefix("==========step5: log boundary query ============") 
