...
class TDTestCase:
    ...
    def dropandcreateDB_primary_key(self,database,once_insert_num,updata_num=1,dropdb='yes',insertdata='yes',deletedata='yes'): #fixed
        ...
        if insertdata == 'yes':            
            for tag_i in range(1,11):
                for column_i in range(1,51):    
                    ...
                    tdSql.execute(f'''insert into {database}.stable_0_{tag_i}  (ts) values('{self.ts + 100000000 + 10 }') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_0_{tag_i}  (ts) values('{self.ts + column_i*100000000 + 11 }') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_0_{tag_i}  (ts) values('{self.ts + 2000000000 - 1000000000 + 12 }') ;''' ) 
                    
                    tdSql.execute(f'''insert into {database}.stable_1_{tag_i}  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                    ...
                    tdSql.execute(f'''insert into {database}.stable_1_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i - 25}') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_1_{tag_i}  (ts , ts_pk ) values('{self.ts + column_i*100000000 + 11 }', '{column_i - 25}') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_1_{tag_i}  (ts , ts_pk ) values('{self.ts + 2000000000 - 1000000000 + 12 }', '{column_i - 25}') ;''' ) 
                    
                    tdSql.execute(f'''insert into {database}.stable_2_{tag_i}  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                    ...
                    tdSql.execute(f'''insert into {database}.stable_2_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i}') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_2_{tag_i}  (ts , ts_pk ) values('{self.ts + column_i*200000000 + 12 }', '{column_i}') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_2_{tag_i}  (ts , ts_pk ) values('{self.ts + 1000000000 + 11 }', '{column_i}') ;''' ) 
                    
                    tdSql.execute(f'''insert into {database}.stable_3_{tag_i}  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                    ...
                    tdSql.execute(f'''insert into {database}.stable_3_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i - 25}') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_3_{tag_i}  (ts , ts_pk ) values('{self.ts + column_i*300000000 + 13 }', '{column_i - 25}') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_3_{tag_i}  (ts , ts_pk ) values('{self.ts + 10000000000 + 11 }', '{column_i - 25}') ;''' ) 
                    
                    tdSql.execute(f'''insert into {database}.stable_4_{tag_i}  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                    ...
                    tdSql.execute(f'''insert into {database}.stable_4_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i}') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_4_{tag_i}  (ts , ts_pk ) values('{self.ts + column_i*400000000 + 14 }', '{column_i}') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_4_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000000 + 11 }', '{column_i}') ;''' ) 
                    
                    tdSql.execute(f'''insert into {database}.stable_5_{tag_i}  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                    ...
                    tdSql.execute(f'''insert into {database}.stable_5_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i - 25}') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_5_{tag_i}  (ts , ts_pk ) values('{self.ts + column_i*500000000 + 15 }', '{column_i - 25}') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_5_{tag_i}  (ts , ts_pk ) values('{self.ts + 1000000000000 + 11 }', '{column_i - 25}') ;''' ) 
                    
                    tdSql.execute(f'''insert into {database}.stable_6_{tag_i}  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                    ...
                    tdSql.execute(f'''insert into {database}.stable_6_{tag_i}  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i}') ;''' ) 
                    tdSql.execute(f'''insert into {database}.stable_6_{tag_i}  (ts , ts_pk ) values('{self.ts + column_i*600000000 + 16 }', '{column_i}') ;''' )
                    tdSql.execute(f'''insert into {database}.stable_6_{tag_i}  (ts , ts_pk ) values('{self.ts + 10000000000000 + 11 }', '{column_i}') ;''' ) 
            ...
            for column_i in range(1,51):    
                ...
                tdSql.execute(f'''insert into {database}.regular_table_0  (ts , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*100000000 + 1 }',  '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_0  (ts , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 2000000000 - 1000000000 + 2 }', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_0  (ts) values('{self.ts + 100000000 + 10 }') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_0  (ts) values('{self.ts + column_i*100000000 + 11 }') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_0  (ts) values('{self.ts + 2000000000 - 1000000000 + 12 }') ;''' ) 
                    
                tdSql.execute(f'''insert into {database}.regular_table_1  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_1  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*100000000 + 1 }', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_1  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 2000000000 - 1000000000 + 2 }', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_1  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i - 25}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_1  (ts , ts_pk ) values('{self.ts + column_i*100000000 + 11 }', '{column_i - 25}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_1  (ts , ts_pk ) values('{self.ts + 2000000000 - 1000000000 + 12 }', '{column_i - 25}') ;''' ) 
                
                tdSql.execute(f'''insert into {database}.regular_table_2  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_2  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*200000000 + 2 }', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_2  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 1000000000 + 1 }', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_2  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_2  (ts , ts_pk ) values('{self.ts + column_i*200000000 + 12 }', '{column_i}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_2  (ts , ts_pk ) values('{self.ts + 1000000000 + 11 }', '{column_i}') ;''' ) 
                
                tdSql.execute(f'''insert into {database}.regular_table_3  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_3  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*300000000 + 3 }', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_3  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 10000000000 + 1 }', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_3  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i - 25}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_3  (ts , ts_pk ) values('{self.ts + column_i*300000000 + 13 }', '{column_i - 25}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_3  (ts , ts_pk ) values('{self.ts + 10000000000 + 11 }', '{column_i - 25}') ;''' ) 
                
                tdSql.execute(f'''insert into {database}.regular_table_4  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_4  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*400000000 + 4 }', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_4  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000000 + 1 }', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_4  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_4  (ts , ts_pk ) values('{self.ts + column_i*400000000 + 14 }', '{column_i}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_4  (ts , ts_pk ) values('{self.ts + 100000000000 + 11 }', '{column_i}') ;''' ) 
                
                tdSql.execute(f'''insert into {database}.regular_table_5  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_5  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*500000000 + 5 }', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_5  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 1000000000000 + 1 }', '{column_i - 25}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_5  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i - 25}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_5  (ts , ts_pk ) values('{self.ts + column_i*500000000 + 15 }', '{column_i - 25}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_5  (ts , ts_pk ) values('{self.ts + 1000000000000 + 11 }', '{column_i - 25}') ;''' ) 
                
                tdSql.execute(f'''insert into {database}.regular_table_6  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 100000000}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_6  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + column_i*600000000 + 6 }', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_6  (ts , ts_pk , q_int , q_bigint , q_smallint , q_tinyint ,q_int_unsigned , q_bigint_unsigned , q_smallint_unsigned , q_tinyint_unsigned , q_float , q_double , q_bool , q_binary , q_nchar, q_ts) values('{self.ts + 10000000000000 + 1 }', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i * updata_num}', '{column_i}', '{column_i * updata_num}', '{column_i * updata_num}', 0, 'binary.{column_i * updata_num}', 'nchar.{column_i * updata_num}', '{column_i * updata_num}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_6  (ts , ts_pk ) values('{self.ts + 100000000 + 10 }', '{column_i}') ;''' ) 
                tdSql.execute(f'''insert into {database}.regular_table_6  (ts , ts_pk ) values('{self.ts + column_i*600000000 + 16 }', '{column_i}') ;''' )
                tdSql.execute(f'''insert into {database}.regular_table_6  (ts , ts_pk ) values('{self.ts + 10000000000000 + 11 }', '{column_i}') ;''' ) 
        ...
        if deletedata != 'yes':     
            ...
            tdSql.checkData(0,0,10*300*once_insert_num)
            tdSql.query("select count(*) from %s.regular_table_1;"%database)
            tdSql.checkData(0,0,300*once_insert_num)
            
            tdSql.query("select count(*) from %s.stable_0;"%database)
            tdSql.checkData(0,0,10*104*once_insert_num)
            tdSql.query("select count(*) from %s.regular_table_0;"%database)
            tdSql.checkData(0,0,104*once_insert_num)
            ...
            tdSql.checkData(0,0,104*once_insert_num)
            tdSql.checkData(2,0,104*once_insert_num)
            tdSql.checkData(4,0,104*once_insert_num)
    ...
    def count_pk(self,db,num=1):
        ...
        for i in stable_list:
            ...
            tdSql.checkData(0,0,10*300*num)
            ...
            tdSql.checkData(0,0,10*150*num)
        ...
        for i in table_list:
            tdSql.query("select count(*) from {}.{} ".format(db, i))
            tdSql.checkData(0,0,300*num)
            tdSql.query("select count(ts) from {}.{} ".format(db, i))
            tdSql.checkData(0,0,300*num)
            tdSql.query("select count(ts_pk) from {}.{} ".format(db, i))
            tdSql.checkData(0,0,300*num)
            tdSql.query("select count(q_int) from {}.{} ".format(db, i))
            tdSql.checkData(0,0,150*num)
            tdSql.query("select count(q_bigint) from {}.{} ".format(db, i))
            tdSql.checkData(0,0,150*num)
            tdSql.query("select count(q_smallint) from {}.{} ".format(db, i))
            tdSql.checkData(0,0,150*num)
        ...
        for i in stable_list:
            ...
            tdSql.checkData(0,0,300*num)
            tdSql.checkData(2,0,300*num)
            tdSql.checkData(4,0,300*num)
            tdSql.checkData(6,0,300*num)
            tdSql.checkData(8,0,300*num)   
    ...
    def touying_pk_where(self,db,replace_fun,num=1):
        ...
        for i in stable_list:   
            ...
            tdSql.query(sql)
            tdSql.checkRows(10*204*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) >= 10 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows(10*(300-204)*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) <= 20 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(10*270*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) > 20 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows(10*(300-270)*num)   
            
        stable_list = ['stable_2','stable_4','stable_6']
        for i in stable_list:   
            sql = "select {} * from {}.{} where cast(ts_pk as int) < 10 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(10*54*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) >= 10 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows(10*(300-54)*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) <= 20 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(10*120*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) > 20 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows(10*(300-120)*num)   
            
        table_list = ['regular_table_1','regular_table_3','regular_table_5']
        for i in table_list:   
            sql = "select {} * from {}.{} where cast(ts_pk as int) < 10 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(204*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) >= 10 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows((300-204)*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) <= 20 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(270*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) > 20 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows((300-270)*num)   
            
        table_list = ['regular_table_2','regular_table_4','regular_table_6']
        for i in table_list:   
            sql = "select {} * from {}.{} where cast(ts_pk as int) < 10 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(54*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) >= 10 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows((300-54)*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) <= 20 order by ts ".format(replace_fun,db, i)
            tdSql.query(sql)
            tdSql.checkRows(120*num)
            sql = "select {} * from {}.{} where cast(ts_pk as int) > 20 order by ts desc ".format(replace_fun, db,i)
            tdSql.query(sql)
            tdSql.checkRows((300-120)*num)   
