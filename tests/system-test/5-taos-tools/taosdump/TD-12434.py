...
class TDTestCase:
    def caseDescription(self):
        '''
        case1<xyguo>:core:taos-tools/src/taosdump.c:3844 
        ''' 
        return
    ...
    def init(self, conn, logSql):
        ...
        #os.system("rm -rf 2-query/1-select/TD-12204.py.sql")
    ...
    def run(self):
        ...
        #os.system("taos -f 5-taos-tools/taosdump/TD-12204.py.sql")
       
        os.system("taosdump -D db")
