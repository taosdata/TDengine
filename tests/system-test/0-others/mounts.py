...
class TDTestCase:
    ...
    #         dnode.addExtraCfg("dataDir","/var/lib/taos00 0 1")
    #         dnode.addExtraCfg("dataDir","/var/lib/taos01 0 0")
    #         dnode.addExtraCfg("dataDir","/var/lib/taos02 0 0")
    #         dnode.addExtraCfg("dataDir","/var/lib/taos10 1 0")
    #         dnode.addExtraCfg("dataDir","/var/lib/taos11 1 0")
    #         dnode.addExtraCfg("dataDir","/var/lib/taos12 1 0")
    #         dnodes.append(dnode)
