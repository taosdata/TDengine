...
class TDTestCase:
    ...
    def s1_mounts_check_error():
        
    def s2_mounts_create_drop_show():
    
    def s3_mounts_check_conflicts():
    ...
    def run(self):
        ...
        self.s1_mounts_check_error()
        self.s2_mounts_create_drop_show()
        self.s3_mounts_check_conflicts()
