...
class TDTestCase:
    ...
    def init(self, conn, logSql, replicaVar=1):
        ...
        self.nchar_str = '涛思数据'
        self.ins_list = ['ins_dnodes','ins_mnodes','ins_qnodes','ins_snodes','ins_xnodes','ins_cluster','ins_databases','ins_functions',\
    ...
    def ins_columns_check(self):
        ...
        tdSql.checkEqual(True, len(tdSql.queryResult) in range(331, 332))
