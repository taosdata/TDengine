...
function lcovFunc {
    ...
    # collect data
    lcov -d "$CAPTURE_GCDA_DIR" -capture --rc lcov_branch_coverage=1 --rc genhtml_branch_coverage=1 --no-external -b $TDINTRENAL_DIR -o coverage.info 
    ...
    #TDinternal
    codecov -t 88ed2789-23be-455d-acb6-3f729d285d1c -f $TDINTRENAL_DIR/coverage.info  -b $branch
}
