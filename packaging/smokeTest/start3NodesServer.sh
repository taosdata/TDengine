...
touch ${workdir}/dnode1/cfg/taos.cfg
echo -e "firstEp ${hostname}:6031\nsecondEp ${hostname}:6032\nfqdn ${hostname}\nserverPort 6031\nlogDir ${workdir}/dnode1/log\ndataDir ${workdir}/dnode1/data\n" >> ${workdir}/dnode1/cfg/taos.cfg

# Start first node
nohup taosd -c ${workdir}/dnode1/cfg/taos.cfg & > /dev/null
sleep 5

taos -P 6031 -s "CREATE DNODE \`${hostname}:6032\`;CREATE DNODE \`${hostname}:6033\`"

mkdir ${workdir}/dnode2
mkdir ${workdir}/dnode2/data
mkdir ${workdir}/dnode2/log
mkdir ${workdir}/dnode2/cfg
touch ${workdir}/dnode2/cfg/taos.cfg
echo -e "firstEp ${hostname}:6031\nsecondEp ${hostname}:6032\nfqdn ${hostname}\nserverPort 6032\nlogDir ${workdir}/dnode2/log\ndataDir ${workdir}/dnode2/data\n" >> ${workdir}/dnode2/cfg/taos.cfg

nohup taosd -c ${workdir}/dnode2/cfg/taos.cfg & > /dev/null
sleep 5
...
touch ${workdir}/dnode3/cfg/taos.cfg
echo -e "firstEp ${hostname}:6031\nsecondEp ${hostname}:6032\nfqdn ${hostname}\nserverPort 6033\nlogDir ${workdir}/dnode3/log\ndataDir ${workdir}/dnode3/data\n" >> ${workdir}/dnode3/cfg/taos.cfg

nohup taosd -c ${workdir}/dnode3/cfg/taos.cfg & > /dev/null
sleep 5

taos -P 6031 -s "CREATE MNODE ON DNODE 2;CREATE MNODE ON DNODE 3;"