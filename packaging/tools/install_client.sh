...
function install_lib() {
    ...
    if [ "$osType" != "Darwin" ]; then
        ...
        [ -f ${install_main_dir}/driver/libtaosws.* ] && ${csudo}ln -sf ${install_main_dir}/driver/libtaosws.*  ${lib_link_dir}/libtaosws.so ||:
        ...
        if [ -d "${lib64_link_dir}" ]; then
            ...
            [ -f ${install_main_dir}/driver/libtaosws.* ] && ${csudo}ln -sf ${install_main_dir}/driver/libtaosws.*  ${lib64_link_dir}/libtaosws.so       || :
        fi
    else
        ...
        [ -f ${install_main_dir}/driver/libtaosws.* ] && ${csudo}ln -sf ${install_main_dir}/driver/libtaosws.* ${lib_link_dir}/libtaosws.dylib ||:
    fi
