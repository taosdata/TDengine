...
function clean_lib() {
    ...
    sudo rm -f /usr/lib/libtaosinternal.* || :
...
function install_lib() {
    ...
    if [ "$osType" != "Darwin" ]; then
        ...
        ${csudo}ln -s ${install_main_dir}/driver/libtaosinternal.* ${lib_link_dir}/libtaosinternal.so.1
        ${csudo}ln -s ${lib_link_dir}/libtaosinternal.so.1 ${lib_link_dir}/libtaosinternal.so
        ...
        if [ -d "${lib64_link_dir}" ]; then
            ...
            ${csudo}ln -s ${install_main_dir}/driver/libtaosinternal.* ${lib64_link_dir}/libtaosinternal.so.1       || :
            ${csudo}ln -s ${lib64_link_dir}/libtaosinternal.so.1 ${lib64_link_dir}/libtaosinternal.so               || :
        ...
        ${csudo}ln -s ${install_main_dir}/driver/libtaosinternal.* ${lib_link_dir}/libtaosinternal.1.dylib
        ${csudo}ln -s ${lib_link_dir}/libtaosinternal.1.dylib ${lib_link_dir}/libtaosinternal.dylib
...
function install_header() {
    ${csudo}rm -f ${inc_link_dir}/taos.h ${inc_link_dir}/taosws.h ${inc_link_dir}/taosinternal.h ${inc_link_dir}/taosdef.h ${inc_link_dir}/tdef.h ${inc_link_dir}/taoserror.h  ${inc_link_dir}/taosudf.h  || :
