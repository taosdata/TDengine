...
function install_bin() {
    ...
    [ -x ${bin_dir}/taosBenchmark ] && ${csudo} ln -s ${bin_dir}/taosBenchmark ${bin_link_dir}/taosdemo || :
    [ -x ${bin_dir}/taosBenchmark ] && ${csudo} ln -s ${bin_dir}/taosBenchmark ${bin_link_dir}/taosBenchmark || :
