...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/java/src/main/java/com/taos/example/TelnetLineProtocolExample.java"},`view source code`)));};MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/python/telnet_line_protocol_example.py"},`view source code`)));};_py_opts_telnet_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/c/telnet_line_example.c"},`view source code`)));};_c_opts_telnet_MDXContent.isMDXComponent=true;
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/40-opentsdb-telnet.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _40_opentsdb_telnet_frontMatter={title:'OpenTSDB Line Protocol',sidebar_label:'OpenTSDB Line Protocol',description:'This document describes how to insert data into TDengine using the OpenTSDB Line Protocol.'};const _40_opentsdb_telnet_contentTitle=undefined;const metadata={"unversionedId":"develop/insert-data/opentsdb-telnet","id":"develop/insert-data/opentsdb-telnet","title":"OpenTSDB Line Protocol","description":"This document describes how to insert data into TDengine using the OpenTSDB Line Protocol.","source":"@site/docs/07-develop/03-insert-data/40-opentsdb-telnet.mdx","sourceDirName":"07-develop/03-insert-data","slug":"/develop/insert-data/opentsdb-telnet","permalink":"/docs-en/develop/insert-data/opentsdb-telnet","draft":false,"tags":[],"version":"current","sidebarPosition":40,"frontMatter":{"title":"OpenTSDB Line Protocol","sidebar_label":"OpenTSDB Line Protocol","description":"This document describes how to insert data into TDengine using the OpenTSDB Line Protocol."},"sidebar":"defaultSidebar","previous":{"title":"InfluxDB Line Protocol","permalink":"/docs-en/develop/insert-data/influxdb-line"},"next":{"title":"OpenTSDB JSON Protocol","permalink":"/docs-en/develop/insert-data/opentsdb-json"}};const assets={};const _40_opentsdb_telnet_toc=[{value:'Introduction',id:'introduction',level:2},{value:'Examples',id:'examples',level:2},{value:'Query Examples',id:'query-examples',level:2}];const _40_opentsdb_telnet_layoutProps={toc: _40_opentsdb_telnet_toc};const _40_opentsdb_telnet_MDXLayout="wrapper";function _40_opentsdb_telnet_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_40_opentsdb_telnet_MDXLayout,(0,esm_extends/* default */.Z)({},_40_opentsdb_telnet_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("h2",{"id":"introduction"},`Introduction`),(0,esm/* mdx */.kt)("p",null,`A single line of text is used in OpenTSDB line protocol to represent one row of data. OpenTSDB employs a single column data model, so each line can only contain a single data column. There can be multiple tags. Each line contains 4 parts as below:`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-txt"},`<metric> <timestamp> <value> <tagk_1>=<tagv_1>[ <tagk_n>=<tagv_n>]
`)),(0,esm/* mdx */.kt)("ul",null,(0,esm/* mdx */.kt)("li",{parentName:"ul"},(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`metric`),` will be used as the STable name.`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`timestamp`),` is the timestamp of current row of data. The time precision will be determined automatically based on the length of the timestamp. Second and millisecond time precision are supported.`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`value`),` is a metric which must be a numeric value, The corresponding column name is "value".`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`The last part is the tag set separated by spaces, all tags will be converted to NCHAR type automatically.`)),(0,esm/* mdx */.kt)("p",null,`For example:`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-txt"},`meters.current 1648432611250 11.3 location=California.LosAngeles groupid=3
`)),(0,esm/* mdx */.kt)("ul",null,(0,esm/* mdx */.kt)("li",{parentName:"ul"},(0,esm/* mdx */.kt)("p",{parentName:"li"},`The child table name is created automatically in a rule to guarantee its uniqueness. But you can configure `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`smlChildTableName`),` in taos.cfg to specify a tag value as the table names if the tag value is unique globally. For example, if a tag is called `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`tname`),` and you set `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`smlChildTableName=tname`),` in taos.cfg, when you insert `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`st,tname=cpu1,t1=4 c1=3 1626006833639000000`),`, the child table `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`cpu1`),` will be automatically created. Note that if multiple rows have the same tname but different tag_set values, the tag_set of the first row is used to create the table and the others are ignored.`),(0,esm/* mdx */.kt)("p",{parentName:"li"},`Please refer to `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"http://opentsdb.net/docs/build/html/api_telnet/put.html"},`OpenTSDB Telnet API`),` for more details.`))),(0,esm/* mdx */.kt)("h2",{"id":"examples"},`Examples`),(0,esm/* mdx */.kt)(Tabs/* default */.Z,{defaultValue:"java",groupId:"lang",mdxType:"Tabs"},(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Java",value:"java",mdxType:"TabItem"},(0,esm/* mdx */.kt)(MDXContent,{mdxType:"JavaTelnet"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Python",value:"Python",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_py_opts_telnet_MDXContent,{mdxType:"PyTelnet"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Go",value:"go",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_go_opts_telnet/* default */.ZP,{mdxType:"GoTelnet"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Node.js",value:"nodejs",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_js_opts_telnet/* default */.ZP,{mdxType:"NodeTelnet"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C#",value:"csharp",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_cs_opts_telnet/* default */.ZP,{mdxType:"CsTelnet"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C",value:"c",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_c_opts_telnet_MDXContent,{mdxType:"CTelnet"}))),(0,esm/* mdx */.kt)("p",null,`2 STables will be created automatically and each STable has 4 rows of data in the above sample code.`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-cmd"},`taos> use test;
Database changed.
...
`)),(0,esm/* mdx */.kt)("h2",{"id":"query-examples"},`Query Examples`),(0,esm/* mdx */.kt)("p",null,`If you want query the data of `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`location=California.LosAngeles groupid=3`),`, here is the query SQL:`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`SELECT * FROM \`meters_current\` WHERE location = "California.LosAngeles" AND groupid = 3;
