"use strict";
(self["webpackChunkdocs"] = self["webpackChunkdocs"] || []).push([[8831],{
...
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const frontMatter={title:'Third Party Tools',description:'This document describes how to integrate TDengine with various third-party tools.'};const contentTitle=undefined;const metadata={"unversionedId":"third-party/index","id":"third-party/index","title":"Third Party Tools","description":"This document describes how to integrate TDengine with various third-party tools.","source":"@site/docs/20-third-party/index.md","sourceDirName":"20-third-party","slug":"/third-party/","permalink":"/docs-en/third-party/","draft":false,"tags":[],"version":"current","frontMatter":{"title":"Third Party Tools","description":"This document describes how to integrate TDengine with various third-party tools."},"sidebar":"defaultSidebar","previous":{"title":"Problem Diagnostics","permalink":"/docs-en/operation/diagnose"},"next":{"title":"Grafana","permalink":"/docs-en/third-party/grafana"}};const assets={};const toc=[];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent(_ref){let{components,...props}=_ref;return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout,(0,_root_enterprise_docs_enterprise_docs_en_node_modules_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`Since TDengine supports standard SQL commands, common database connector standards (e.g., JDBC), ORM, and other popular time-series database writing protocols (e.g., InfluxDB Line Protocol, OpenTSDB JSON, OpenTSDB Telnet, etc.), it is very easy to integrate TDengine with other third party tools. You only need to provide simple configuration, the integration can be done without a line of code. `),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(_theme_DocCardList__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,{items:(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_4__/* .useCurrentSidebarCategory */ .jA)().items,mdxType:"DocCardList"}));};MDXContent.isMDXComponent=true;
