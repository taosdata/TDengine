"use strict";
(self["webpackChunkdocs"] = self["webpackChunkdocs"] || []).push([[6200],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  contentTitle: () => (/* binding */ _50_opentsdb_json_contentTitle),
  "default": () => (/* binding */ _50_opentsdb_json_MDXContent),
  frontMatter: () => (/* binding */ _50_opentsdb_json_frontMatter),
  metadata: () => (/* binding */ metadata),
  toc: () => (/* binding */ _50_opentsdb_json_toc)
});
...
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/_java_opts_json.mdx
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/java/src/main/java/com/taos/example/JSONProtocolExample.java"},`view source code`)));};MDXContent.isMDXComponent=true;
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/_py_opts_json.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _py_opts_json_frontMatter={};const _py_opts_json_contentTitle=(/* unused pure expression or super */ null && (undefined));const _py_opts_json_toc=[];const _py_opts_json_layoutProps={toc: _py_opts_json_toc};const _py_opts_json_MDXLayout="wrapper";function _py_opts_json_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_py_opts_json_MDXLayout,(0,esm_extends/* default */.Z)({},_py_opts_json_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-py"},`import json
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/python/json_protocol_example.py"},`view source code`)));};_py_opts_json_MDXContent.isMDXComponent=true;
// EXTERNAL MODULE: ./docs/07-develop/03-insert-data/_go_opts_json.mdx
var _go_opts_json = __webpack_require__(3899);
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/_rust_opts_json.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _rust_opts_json_frontMatter={};const _rust_opts_json_contentTitle=(/* unused pure expression or super */ null && (undefined));const _rust_opts_json_toc=[];const _rust_opts_json_layoutProps={toc: _rust_opts_json_toc};const _rust_opts_json_MDXLayout="wrapper";function _rust_opts_json_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_rust_opts_json_MDXLayout,(0,esm_extends/* default */.Z)({},_rust_opts_json_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-rust"},``)));};_rust_opts_json_MDXContent.isMDXComponent=true;
// EXTERNAL MODULE: ./docs/07-develop/03-insert-data/_js_opts_json.mdx
var _js_opts_json = __webpack_require__(8291);
// EXTERNAL MODULE: ./docs/07-develop/03-insert-data/_cs_opts_json.mdx
var _cs_opts_json = __webpack_require__(5549);
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/_c_opts_json.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _c_opts_json_frontMatter={};const _c_opts_json_contentTitle=(/* unused pure expression or super */ null && (undefined));const _c_opts_json_toc=[];const _c_opts_json_layoutProps={toc: _c_opts_json_toc};const _c_opts_json_MDXLayout="wrapper";function _c_opts_json_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_c_opts_json_MDXLayout,(0,esm_extends/* default */.Z)({},_c_opts_json_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-c"},`int main() {
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/c/json_protocol_example.c"},`view source code`)));};_c_opts_json_MDXContent.isMDXComponent=true;
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/50-opentsdb-json.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _50_opentsdb_json_frontMatter={title:'OpenTSDB JSON Protocol',sidebar_label:'OpenTSDB JSON Protocol',description:'This document describes how to insert data into TDengine using the OpenTSDB JSON protocol.'};const _50_opentsdb_json_contentTitle=undefined;const metadata={"unversionedId":"develop/insert-data/opentsdb-json","id":"develop/insert-data/opentsdb-json","title":"OpenTSDB JSON Protocol","description":"This document describes how to insert data into TDengine using the OpenTSDB JSON protocol.","source":"@site/docs/07-develop/03-insert-data/50-opentsdb-json.mdx","sourceDirName":"07-develop/03-insert-data","slug":"/develop/insert-data/opentsdb-json","permalink":"/docs-en/develop/insert-data/opentsdb-json","draft":false,"tags":[],"version":"current","sidebarPosition":50,"frontMatter":{"title":"OpenTSDB JSON Protocol","sidebar_label":"OpenTSDB JSON Protocol","description":"This document describes how to insert data into TDengine using the OpenTSDB JSON protocol."},"sidebar":"defaultSidebar","previous":{"title":"OpenTSDB Line Protocol","permalink":"/docs-en/develop/insert-data/opentsdb-telnet"},"next":{"title":"High Performance Writing","permalink":"/docs-en/develop/insert-data/high-volume"}};const assets={};const _50_opentsdb_json_toc=[{value:'Introduction',id:'introduction',level:2},{value:'Examples',id:'examples',level:2},{value:'Query Examples',id:'query-examples',level:2}];const _50_opentsdb_json_layoutProps={toc: _50_opentsdb_json_toc};const _50_opentsdb_json_MDXLayout="wrapper";function _50_opentsdb_json_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_50_opentsdb_json_MDXLayout,(0,esm_extends/* default */.Z)({},_50_opentsdb_json_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("h2",{"id":"introduction"},`Introduction`),(0,esm/* mdx */.kt)("p",null,`A JSON string is used in OpenTSDB JSON to represent one or more rows of data, for example: For example:`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-json"},`[
  {
    "metric": "sys.cpu.nice",
...
`)),(0,esm/* mdx */.kt)("p",null,`Similar to OpenTSDB line protocol, `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`metric`),` will be used as the STable name, `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`timestamp`),` is the timestamp to be used, `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`value`),` represents the metric collected, `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`tags`),` are the tag sets.`),(0,esm/* mdx */.kt)("p",null,`Please refer to `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"http://opentsdb.net/docs/build/html/api_http/put.html"},`OpenTSDB HTTP API`),` for more details.`),(0,esm/* mdx */.kt)("admonition",{"type":"note"},(0,esm/* mdx */.kt)("ul",{parentName:"admonition"},(0,esm/* mdx */.kt)("li",{parentName:"ul"},`In JSON protocol, strings will be converted to NCHAR type and numeric values will be converted to double type.`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`The child table name is created automatically in a rule to guarantee its uniqueness. But you can configure `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`smlChildTableName`),` in taos.cfg to specify a tag value as the table names if the tag value is unique globally. For example, if a tag is called `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`tname`),` and you set `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`smlChildTableName=tname`),` in taos.cfg, when you insert `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`st,tname=cpu1,t1=4 c1=3 1626006833639000000`),`, the child table `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`cpu1`),` will be automatically created. Note that if multiple rows have the same tname but different tag_set values, the tag_set of the first row is used to create the table and the others are ignored.`))),(0,esm/* mdx */.kt)("h2",{"id":"examples"},`Examples`),(0,esm/* mdx */.kt)(Tabs/* default */.Z,{defaultValue:"java",groupId:"lang",mdxType:"Tabs"},(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Java",value:"java",mdxType:"TabItem"},(0,esm/* mdx */.kt)(MDXContent,{mdxType:"JavaJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Python",value:"Python",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_py_opts_json_MDXContent,{mdxType:"PyJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Go",value:"go",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_go_opts_json/* default */.ZP,{mdxType:"GoJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Node.js",value:"nodejs",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_js_opts_json/* default */.ZP,{mdxType:"NodeJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C#",value:"csharp",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_cs_opts_json/* default */.ZP,{mdxType:"CsJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C",value:"c",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_c_opts_json_MDXContent,{mdxType:"CJson"}))),(0,esm/* mdx */.kt)("p",null,`2 STables will be created automatically and each STable has 2 rows of data in the above sample code.`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-cmd"},`taos> use test;
Database changed.
...
`)),(0,esm/* mdx */.kt)("h2",{"id":"query-examples"},`Query Examples`),(0,esm/* mdx */.kt)("p",null,`If you want query the data of "tags": {"location": "California.LosAngeles", "groupid": 1}, here is the query SQL:`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`SELECT * FROM \`meters_current\` WHERE location = "California.LosAngeles" AND groupid = 3;
`)));};_50_opentsdb_json_MDXContent.isMDXComponent=true;
