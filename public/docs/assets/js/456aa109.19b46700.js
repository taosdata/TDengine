...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/java/src/main/java/com/taos/example/RestInsertExample.java"},`查看源码`)));};MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/java/src/main/java/com/taos/example/StmtInsertExample.java"},`查看源码`)));};_java_stmt_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/python/bind_param_example.py"},`查看源码`)),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-py","metastring":"title=一次绑定多行","title":"一次绑定多行"},`table_tags = {
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/python/multi_bind_example.py"},`查看源码`)),(0,esm/* mdx */.kt)("admonition",{"type":"info"},(0,esm/* mdx */.kt)("p",{parentName:"admonition"},`一次绑定一行效率不如一次绑定多行，但支持非 INSERT 语句。一次绑定多行效率更高，但仅支持 INSERT 语句。`)));};_py_stmt_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/go/insert/stmt/main.go"},`查看源码`)),(0,esm/* mdx */.kt)("admonition",{"type":"tip"},(0,esm/* mdx */.kt)("p",{parentName:"admonition"},`driver-go 的模块 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`github.com/taosdata/driver-go/v3/wrapper`),` 是 C 接口的底层封装。使用这个模块也可以实现参数绑定写入。`)));};_go_stmt_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/node/nativeexample/param_bind_example.js"},`查看源码`)),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-js","metastring":"title=一次绑定多行","title":"一次绑定多行"},`function insertData() {
  // init
  cursor.stmtInit();
  // prepare
  cursor.stmtPrepare(
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/node/nativeexample/multi_bind_example.js"},`查看源码`)),(0,esm/* mdx */.kt)("admonition",{"type":"info"},(0,esm/* mdx */.kt)("p",{parentName:"admonition"},`一次绑定一行效率不如一次绑定多行，但支持非 INSERT 语句。一次绑定多行效率更高，但仅支持 INSERT 语句。`)));};_js_stmt_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/csharp/stmtInsert/Program.cs"},`查看源码`)));};_cs_stmt_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/c/stmt_example.c"},`查看源码`)),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-c","metastring":"title=一次绑定多行 72:117","title":"一次绑定多行","72:117":true},`// compile with
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/c/multi_bind_example.c"},`查看源码`)));};_c_stmt_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/php/insert.php"},`查看源码`)));};_php_sql_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/php/insert_stmt.php"},`查看源码`)));};_php_stmt_MDXContent.isMDXComponent=true;
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/01-sql-writing.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _01_sql_writing_frontMatter={title:'SQL 写入'};const _01_sql_writing_contentTitle=undefined;const metadata={"unversionedId":"develop/insert-data/sql-writing","id":"develop/insert-data/sql-writing","title":"SQL 写入","description":"SQL 写入简介","source":"@site/docs/07-develop/03-insert-data/01-sql-writing.mdx","sourceDirName":"07-develop/03-insert-data","slug":"/develop/insert-data/sql-writing","permalink":"/docs/develop/insert-data/sql-writing","draft":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"SQL 写入"},"sidebar":"defaultSidebar","previous":{"title":"写入数据","permalink":"/docs/develop/insert-data/"},"next":{"title":"从 Kafka 写入","permalink":"/docs/develop/insert-data/kafka-writting"}};const assets={};const _01_sql_writing_toc=[{value:'SQL 写入简介',id:'sql-写入简介',level:2},{value:'一次写入一条',id:'一次写入一条',level:3},{value:'一次写入多条',id:'一次写入多条',level:3},{value:'一次写入多表',id:'一次写入多表',level:3},{value:'示例程序',id:'示例程序',level:2},{value:'普通 SQL 写入',id:'普通-sql-写入',level:3},{value:'参数绑定写入',id:'参数绑定写入',level:3}];const _01_sql_writing_layoutProps={toc: _01_sql_writing_toc};const _01_sql_writing_MDXLayout="wrapper";function _01_sql_writing_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_01_sql_writing_MDXLayout,(0,esm_extends/* default */.Z)({},_01_sql_writing_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("h2",{"id":"sql-写入简介"},`SQL 写入简介`),(0,esm/* mdx */.kt)("p",null,`应用通过连接器执行 INSERT 语句来插入数据，用户还可以通过 TDengine CLI，手动输入 INSERT 语句插入数据。`),(0,esm/* mdx */.kt)("h3",{"id":"一次写入一条"},`一次写入一条`),(0,esm/* mdx */.kt)("p",null,`下面这条 INSERT 就将一条记录写入到表 d1001 中：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`INSERT INTO d1001 VALUES (ts1, 10.3, 219, 0.31);
`)),(0,esm/* mdx */.kt)("p",null,`这里的`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`ts1`),`为Unix时间戳(Unix timestamp)，允许插入的最老记录的时间戳，是相对于当前服务器时间，减去配置的 KEEP 值。时间戳详情规则参考 `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"/taos-sql/insert"},`TDengine SQL数据写入 关于时间戳一节`)),(0,esm/* mdx */.kt)("h3",{"id":"一次写入多条"},`一次写入多条`),(0,esm/* mdx */.kt)("p",null,`TDengine 支持一次写入多条记录，比如下面这条命令就将两条记录写入到表 d1001 中：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`INSERT INTO d1001 VALUES (ts1, 10.2, 220, 0.23) (ts2, 10.3, 218, 0.25);
`)),(0,esm/* mdx */.kt)("p",null,`这里的`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`ts1`),`和`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`ts2`),`为Unix时间戳(Unix timestamp)，允许插入的最老记录的时间戳，是相对于当前服务器时间，减去配置的 KEEP 值。时间戳详情规则参考 `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"/taos-sql/insert"},`TDengine SQL数据写入 关于时间戳一节`)),(0,esm/* mdx */.kt)("h3",{"id":"一次写入多表"},`一次写入多表`),(0,esm/* mdx */.kt)("p",null,`TDengine 也支持一次向多个表写入数据，比如下面这条命令就向 d1001 写入两条记录，向 d1002 写入一条记录：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`INSERT INTO d1001 VALUES (ts1, 10.3, 219, 0.31) (ts2, 12.6, 218, 0.33) d1002 VALUES (ts3, 12.3, 221, 0.31);
`)),(0,esm/* mdx */.kt)("p",null,`这里的`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`ts1`),`、`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`ts2`),`和`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`ts3`),`为Unix时间戳(Unix timestamp)，允许插入的最老记录的时间戳，是相对于当前服务器时间，减去配置的 KEEP 值。时间戳详情规则参考 `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"/taos-sql/insert"},`TDengine SQL数据写入 关于时间戳一节`)),(0,esm/* mdx */.kt)("p",null,`详细的 SQL INSERT 语法规则参考 `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"/taos-sql/insert"},`TDengine SQL 的数据写入`),`。`),(0,esm/* mdx */.kt)("admonition",{"type":"info"},(0,esm/* mdx */.kt)("ul",{parentName:"admonition"},(0,esm/* mdx */.kt)("li",{parentName:"ul"},`要提高写入效率，需要批量写入。一般来说一批写入的记录条数越多，插入效率就越高。但一条记录不能超过 48KB，一条 SQL 语句总长度不能超过 1MB。`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`TDengine 支持多线程同时写入，要进一步提高写入速度，一个客户端需要打开多个同时写。但线程数达到一定数量后，无法再提高，甚至还会下降，因为线程频繁切换，会带来额外开销，合适的线程数量与服务端的处理能力，服务端的具体配置，数据库的参数，数据定义的 Schema，写入数据的 Batch Size 等很多因素相关。一般来说，服务端和客户端处理能力越强，所能支持的并发写入的线程可以越多；数据库配置时的 vgroups 参数值越多（但仍然要在服务端的处理能力以内）则所能支持的并发写入越多；数据定义的 Schema 越简单，所能支持的并发写入越多。`))),(0,esm/* mdx */.kt)("admonition",{"type":"warning"},(0,esm/* mdx */.kt)("ul",{parentName:"admonition"},(0,esm/* mdx */.kt)("li",{parentName:"ul"},`对同一张表，如果新插入记录的时间戳已经存在，则指定了新值的列会用新值覆盖旧值，而没有指定新值的列则不受影响。`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`写入的数据的时间戳必须大于当前时间减去数据库配置参数 KEEP 的时间。如果 KEEP 配置为 3650 天，那么无法写入比 3650 天还早的数据。写入数据的时间戳也不能大于当前时间加配置参数 DURATION。如果 DURATION 为 2，那么无法写入比当前时间还晚 2 天的数据。`))),(0,esm/* mdx */.kt)("h2",{"id":"示例程序"},`示例程序`),(0,esm/* mdx */.kt)("h3",{"id":"普通-sql-写入"},`普通 SQL 写入`),(0,esm/* mdx */.kt)(Tabs/* default */.Z,{defaultValue:"java",groupId:"lang",mdxType:"Tabs"},(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Java",value:"java",mdxType:"TabItem"},(0,esm/* mdx */.kt)(MDXContent,{mdxType:"JavaSQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Python",value:"python",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_py_sql_MDXContent,{mdxType:"PySQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Go",value:"go",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_go_sql/* default */.ZP,{mdxType:"GoSQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Rust",value:"rust",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_rust_sql/* default */.ZP,{mdxType:"RustSQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Node.js",value:"nodejs",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_js_sql/* default */.ZP,{mdxType:"NodeSQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C#",value:"csharp",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_cs_sql/* default */.ZP,{mdxType:"CsSQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C",value:"c",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_c_sql_MDXContent,{mdxType:"CSQL"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"PHP",value:"php",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_php_sql_MDXContent,{mdxType:"PhpSQL"}))),(0,esm/* mdx */.kt)("admonition",{"type":"note"},(0,esm/* mdx */.kt)("ol",{parentName:"admonition"},(0,esm/* mdx */.kt)("li",{parentName:"ol"},`无论 RESTful 方式建立连接还是本地驱动方式建立连接，以上示例代码都能正常工作。`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`唯一需要注意的是：由于 RESTful 接口无状态， 不能使用 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`USE db;`),` 语句来切换数据库, 所以在上面示例中使用了`,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`dbName.tbName`),`指定表名。`))),(0,esm/* mdx */.kt)("h3",{"id":"参数绑定写入"},`参数绑定写入`),(0,esm/* mdx */.kt)("p",null,`TDengine 也提供了支持参数绑定的 Prepare API，与 MySQL 类似，这些 API 目前也仅支持用问号 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`?`),` 来代表待绑定的参数。在通过参数绑定接口写入数据时，就避免了 SQL 语法解析的资源消耗，从而在绝大多数情况下显著提升写入性能。`),(0,esm/* mdx */.kt)("p",null,`需要注意的是，只有使用原生连接的连接器，才能使用参数绑定功能。`),(0,esm/* mdx */.kt)(Tabs/* default */.Z,{defaultValue:"java",groupId:"lang",mdxType:"Tabs"},(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Java",value:"java",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_java_stmt_MDXContent,{mdxType:"JavaStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Python",value:"python",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_py_stmt_MDXContent,{mdxType:"PyStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Go",value:"go",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_go_stmt_MDXContent,{mdxType:"GoStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Rust",value:"rust",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_rust_stmt/* default */.ZP,{mdxType:"RustStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Node.js",value:"nodejs",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_js_stmt_MDXContent,{mdxType:"NodeStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C#",value:"csharp",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_cs_stmt_MDXContent,{mdxType:"CsStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C",value:"c",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_c_stmt_MDXContent,{mdxType:"CStmt"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"PHP",value:"php",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_php_stmt_MDXContent,{mdxType:"PhpStmt"}))));};_01_sql_writing_MDXContent.isMDXComponent=true;
