...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/java/src/main/java/com/taos/example/LineProtocolExample.java"},`查看源码`)));};MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/python/line_protocol_example.py"},`查看源码`)));};_py_line_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/c/line_example.c"},`查看源码`)));};_c_line_MDXContent.isMDXComponent=true;
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/30-influxdb-line.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _30_influxdb_line_frontMatter={sidebar_label:'InfluxDB 行协议',title:'InfluxDB 行协议'};const _30_influxdb_line_contentTitle=undefined;const metadata={"unversionedId":"develop/insert-data/influxdb-line","id":"develop/insert-data/influxdb-line","title":"InfluxDB 行协议","description":"协议介绍","source":"@site/docs/07-develop/03-insert-data/30-influxdb-line.mdx","sourceDirName":"07-develop/03-insert-data","slug":"/develop/insert-data/influxdb-line","permalink":"/docs/develop/insert-data/influxdb-line","draft":false,"tags":[],"version":"current","sidebarPosition":30,"frontMatter":{"sidebar_label":"InfluxDB 行协议","title":"InfluxDB 行协议"},"sidebar":"defaultSidebar","previous":{"title":"从 Kafka 写入","permalink":"/docs/develop/insert-data/kafka-writting"},"next":{"title":"OpenTSDB 行协议","permalink":"/docs/develop/insert-data/opentsdb-telnet"}};const assets={};const _30_influxdb_line_toc=[{value:'协议介绍',id:'协议介绍',level:2},{value:'示例代码',id:'示例代码',level:2},{value:'SQL 查询示例',id:'sql-查询示例',level:2}];const _30_influxdb_line_layoutProps={toc: _30_influxdb_line_toc};const _30_influxdb_line_MDXLayout="wrapper";function _30_influxdb_line_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_30_influxdb_line_MDXLayout,(0,esm_extends/* default */.Z)({},_30_influxdb_line_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("h2",{"id":"协议介绍"},`协议介绍`),(0,esm/* mdx */.kt)("p",null,`InfluxDB Line 协议采用一行字符串来表示一行数据。分为四部分：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre"},`measurement,tag_set field_set timestamp
`)),(0,esm/* mdx */.kt)("ul",null,(0,esm/* mdx */.kt)("li",{parentName:"ul"},`measurement 将作为超级表名。它与 tag_set 之间使用一个英文逗号来分隔。`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`tag_set 将作为标签数据，其格式形如 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`<tag_key>=<tag_value>,<tag_key>=<tag_value>`),`，也即可以使用英文逗号来分隔多个标签数据。它与 field_set 之间使用一个半角空格来分隔。`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`field_set 将作为普通列数据，其格式形如 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`<field_key>=<field_value>,<field_key>=<field_value>`),`，同样是使用英文逗号来分隔多个普通列的数据。它与 timestamp 之间使用一个半角空格来分隔。`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`timestamp 即本行数据对应的主键时间戳。`)),(0,esm/* mdx */.kt)("p",null,`例如：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre"},`meters,location=California.LosAngeles,groupid=2 current=13.4,voltage=223,phase=0.29 1648432611249500
`)),(0,esm/* mdx */.kt)("admonition",{"type":"note"},(0,esm/* mdx */.kt)("ul",{parentName:"admonition"},(0,esm/* mdx */.kt)("li",{parentName:"ul"},`tag_set 中的所有的数据自动转化为 NCHAR 数据类型`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`field_set 中的每个数据项都需要对自身的数据类型进行描述, 比如 1.2f32 代表 FLOAT 类型的数值 1.2, 如果不带类型后缀会被当作 DOUBLE 处理`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`timestamp 支持多种时间精度。写入数据的时候需要用参数指定时间精度，支持从小时到纳秒的 6 种时间精度`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`为了提高写入的效率，默认假设同一个超级表中 field_set 的顺序是一样的（第一条数据包含所有的 field，后面的数据按照这个顺序），如果顺序不一样，需要配置参数 smlDataFormat 为 false，否则，数据写入按照相同顺序写入，库中数据会异常。（3.0.1.3 之后的版本 smlDataFormat 默认为 false，从3.0.3.0开始，该配置废弃） `,(0,esm/* mdx */.kt)("a",{parentName:"li","href":"/reference/schemaless/#%E6%97%A0%E6%A8%A1%E5%BC%8F%E5%86%99%E5%85%A5%E8%A1%8C%E5%8D%8F%E8%AE%AE"},`TDengine 无模式写入参考指南`)),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`默认产生的子表名是根据规则生成的唯一 ID 值。用户也可以通过在client端的 taos.cfg 里配置 smlChildTableName 参数来指定某个标签值作为子表名。该标签值应该具有全局唯一性。举例如下：假设有个标签名为tname, 配置 smlChildTableName=tname, 插入数据为 st,tname=cpu1,t1=4 c1=3 1626006833639000000 则创建的子表名为 cpu1。注意如果多行数据 tname 相同，但是后面的 tag_set 不同，则使用第一行自动建表时指定的 tag_set，其他的行会忽略）。`,(0,esm/* mdx */.kt)("a",{parentName:"li","href":"/reference/schemaless/#%E6%97%A0%E6%A8%A1%E5%BC%8F%E5%86%99%E5%85%A5%E8%A1%8C%E5%8D%8F%E8%AE%AE"},`TDengine 无模式写入参考指南`)))),(0,esm/* mdx */.kt)("p",null,`要了解更多可参考：`,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://docs.influxdata.com/influxdb/v2.0/reference/syntax/line-protocol/"},`InfluxDB Line 协议官方文档`),` 和 `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"/reference/schemaless/#%E6%97%A0%E6%A8%A1%E5%BC%8F%E5%86%99%E5%85%A5%E8%A1%8C%E5%8D%8F%E8%AE%AE"},`TDengine 无模式写入参考指南`)),(0,esm/* mdx */.kt)("h2",{"id":"示例代码"},`示例代码`),(0,esm/* mdx */.kt)(Tabs/* default */.Z,{defaultValue:"java",groupId:"lang",mdxType:"Tabs"},(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Java",value:"java",mdxType:"TabItem"},(0,esm/* mdx */.kt)(MDXContent,{mdxType:"JavaLine"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Python",value:"Python",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_py_line_MDXContent,{mdxType:"PyLine"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Go",value:"go",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_go_line/* default */.ZP,{mdxType:"GoLine"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Node.js",value:"nodejs",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_js_line/* default */.ZP,{mdxType:"NodeLine"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C#",value:"csharp",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_cs_line/* default */.ZP,{mdxType:"CsLine"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C",value:"c",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_c_line_MDXContent,{mdxType:"CLine"}))),(0,esm/* mdx */.kt)("h2",{"id":"sql-查询示例"},`SQL 查询示例`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`meters`),` 是插入数据的超级表名。`),(0,esm/* mdx */.kt)("p",null,`可以通过超级表的 TAG 来过滤数据，比如查询 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`location=California.LosAngeles,groupid=2`),` 可以通过如下 SQL：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`SELECT * FROM meters WHERE location = "California.LosAngeles" AND groupid = 2;
