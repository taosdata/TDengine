...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/java/src/main/java/com/taos/example/JSONProtocolExample.java"},`查看源码`)));};MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/python/json_protocol_example.py"},`查看源码`)));};_py_opts_json_MDXContent.isMDXComponent=true;
...
`)),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/taosdata/TDengine/blob/main/docs/examples/c/json_protocol_example.c"},`查看源码`)));};_c_opts_json_MDXContent.isMDXComponent=true;
;// CONCATENATED MODULE: ./docs/07-develop/03-insert-data/50-opentsdb-json.mdx
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const _50_opentsdb_json_frontMatter={sidebar_label:'OpenTSDB JSON 格式协议',title:'OpenTSDB JSON 格式协议'};const _50_opentsdb_json_contentTitle=undefined;const metadata={"unversionedId":"develop/insert-data/opentsdb-json","id":"develop/insert-data/opentsdb-json","title":"OpenTSDB JSON 格式协议","description":"协议介绍","source":"@site/docs/07-develop/03-insert-data/50-opentsdb-json.mdx","sourceDirName":"07-develop/03-insert-data","slug":"/develop/insert-data/opentsdb-json","permalink":"/docs/develop/insert-data/opentsdb-json","draft":false,"tags":[],"version":"current","sidebarPosition":50,"frontMatter":{"sidebar_label":"OpenTSDB JSON 格式协议","title":"OpenTSDB JSON 格式协议"},"sidebar":"defaultSidebar","previous":{"title":"OpenTSDB 行协议","permalink":"/docs/develop/insert-data/opentsdb-telnet"},"next":{"title":"高效写入","permalink":"/docs/develop/insert-data/high-volume"}};const assets={};const _50_opentsdb_json_toc=[{value:'协议介绍',id:'协议介绍',level:2},{value:'示例代码',id:'示例代码',level:2},{value:'SQL 查询示例',id:'sql-查询示例',level:2}];const _50_opentsdb_json_layoutProps={toc: _50_opentsdb_json_toc};const _50_opentsdb_json_MDXLayout="wrapper";function _50_opentsdb_json_MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(_50_opentsdb_json_MDXLayout,(0,esm_extends/* default */.Z)({},_50_opentsdb_json_layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("h2",{"id":"协议介绍"},`协议介绍`),(0,esm/* mdx */.kt)("p",null,`OpenTSDB JSON 格式协议采用一个 JSON 字符串表示一行或多行数据。例如：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-json"},`[
  {
    "metric": "sys.cpu.nice",
...
`)),(0,esm/* mdx */.kt)("p",null,`与 OpenTSDB 行协议类似， metric 将作为超级表名， timestamp 表示时间戳，value 表示度量值， tags 表示标签集。`),(0,esm/* mdx */.kt)("p",null,`参考`,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"http://opentsdb.net/docs/build/html/api_http/put.html"},`OpenTSDB HTTP API 文档`),`。`),(0,esm/* mdx */.kt)("admonition",{"type":"note"},(0,esm/* mdx */.kt)("ul",{parentName:"admonition"},(0,esm/* mdx */.kt)("li",{parentName:"ul"},`对于 JSON 格式协议，TDengine 并不会自动把所有标签转成 NCHAR 类型， 字符串将将转为 NCHAR 类型， 数值将同样转换为 DOUBLE 类型。`),(0,esm/* mdx */.kt)("li",{parentName:"ul"},`默认生成的子表名是根据规则生成的唯一 ID 值。用户也可以通过在client端的 taos.cfg 里配置 smlChildTableName 参数来指定某个标签值作为子表名。该标签值应该具有全局唯一性。举例如下：假设有个标签名为tname, 配置 smlChildTableName=tname, 插入数据为 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"li"},`"tags": { "host": "web02","dc": "lga","tname":"cpu1"}`),` 则创建的子表名为 cpu1。注意如果多行数据 tname 相同，但是后面的 tag_set 不同，则使用第一行自动建表时指定的 tag_set，其他的行会忽略）。`))),(0,esm/* mdx */.kt)("h2",{"id":"示例代码"},`示例代码`),(0,esm/* mdx */.kt)(Tabs/* default */.Z,{defaultValue:"java",groupId:"lang",mdxType:"Tabs"},(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Java",value:"java",mdxType:"TabItem"},(0,esm/* mdx */.kt)(MDXContent,{mdxType:"JavaJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Python",value:"Python",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_py_opts_json_MDXContent,{mdxType:"PyJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Go",value:"go",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_go_opts_json/* default */.ZP,{mdxType:"GoJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"Node.js",value:"nodejs",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_js_opts_json/* default */.ZP,{mdxType:"NodeJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C#",value:"csharp",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_cs_opts_json/* default */.ZP,{mdxType:"CsJson"})),(0,esm/* mdx */.kt)(TabItem/* default */.Z,{label:"C",value:"c",mdxType:"TabItem"},(0,esm/* mdx */.kt)(_c_opts_json_MDXContent,{mdxType:"CJson"}))),(0,esm/* mdx */.kt)("p",null,`以上示例代码会自动创建 2 个超级表， 每个超级表有 2 条数据。`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-cmd"},`taos> USE test;
Database changed.
...
`)),(0,esm/* mdx */.kt)("h2",{"id":"sql-查询示例"},`SQL 查询示例`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`meters_voltage`),` 是插入数据的超级表名。`),(0,esm/* mdx */.kt)("p",null,`可以通过超级表的 TAG 来过滤数据，比如查询 `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`location=California.LosAngeles groupid=1`),` 可以通过如下 SQL：`),(0,esm/* mdx */.kt)("pre",null,(0,esm/* mdx */.kt)("code",{parentName:"pre","className":"language-sql"},`SELECT * FROM \`meters_current\` WHERE location = "California.LosAngeles" AND groupid = 3;
