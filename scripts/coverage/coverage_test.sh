...
function runTest() {
    ...
    mkdir -p $TDENGINE_DIR/build/bin
    cp $TDENGINE_DIR/debug/build/bin/tmq_sim $TDENGINE_DIR/build/bin/
...
#python3 ./test.py -f 0-others/compatibility_coverage.py
lcovFunc
...
mkdir -p /root/reprot/
mv $TDENGINE_COVERAGE_REPORT /root/report
