...
use crate::runners::mssql::appender::to_schema;
use crate::runners::mssql::config::MssqlConfig;
use crate::runners::mssql::query::MssqlQuery;
use crate::runners::mssql::worker::consumer::Consumer;
use crate::runners::mssql::worker::producer::Producer;
...
pub async fn migrate_history_by_interval(
    ...
    // schema
    let mut query =
        MssqlQuery::try_new(config.connect.clone(), config.task.time_zone.clone()).await?;
