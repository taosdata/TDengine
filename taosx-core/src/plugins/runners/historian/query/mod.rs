...
mod tests {
    ...
    fn test_select_from_history_sql() {
        ...
        let expect = format!("select * from Runtime.dbo.History where wwRetrievalMode = 'full' and TagName in ('tag1','tag2') and DateTime >= '{}' and DateTime < '{}'",
    ...
    fn test_select_top_n_sql() {
        ...
        assert_eq!(sql, "select top 10 * from Runtime.dbo.History where wwRetrievalMode = 'full' and TagName not like 'Sys%' and DateTime >= '2024-01-01T11:11:11.111+08:00' and DateTime < '2024-01-01T22:22:22.222+08:00'");
    }
}
