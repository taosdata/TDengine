...
use crate::runners::sparkplugb::variables::NAMESPACE;
...
mod tests {
    ...
    fn parse_topic_test() -> anyhow::Result<()> {
        ...
        assert!("spBv2.0/group_1/NCMD/node_1"
            .parse::<TopicComponents>()
            .is_err());
        assert!("spBv1.0/NCMD/node_1".parse::<TopicComponents>().is_err());
        assert!("spBv1.0/group_1/NCMDD/node_1"
            .parse::<TopicComponents>()
            .is_err());
        assert!("spBv1.0/group_1/NCMD/node_1/d1/d2"
            .parse::<TopicComponents>()
            .is_err());
        Ok(())
    }
