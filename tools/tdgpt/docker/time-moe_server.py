...
model_path = [
    "models/models--Maple728--TimeMoE-200M/snapshots/794591bfeb1225fdf742cec0f4c71f20c3f3b87e/"
]
...
# model = AutoModelForCausalLM.from_pretrained('Maple728/TimeMoE-50M', device_map="auto",
