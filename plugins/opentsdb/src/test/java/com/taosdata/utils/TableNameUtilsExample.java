...
public class TableNameUtilsExample {
    ...
    private static void example2() {
        System.out.println("【示例2】使用 ${metric} 变量");

        String pattern = "tb_${metric}_${host}";
        String metric = "system.memory";
        Map<String, Object> tags = new HashMap<>();
    ...
    private static void example4() {
        ...
        System.out.println("  标签: " + tags);
        System.out.println("  生成的表名: " + tableName);
        System.out.println("  格式: metric_tagValue1_tagValue2_...");
        System.out.println();
    }
    ...
    private static void example5() {
        ...
        String pattern = "${metric}_${env}_${host}_${region}";
