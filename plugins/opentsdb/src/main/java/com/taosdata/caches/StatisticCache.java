...
public class StatisticCache {
     ...
     * @param stopTime
     */
    public static void noteCreatedTask(String metric, String startTime, String stopTime) {
        noteCreatedTask(metric + "," + startTime + "," + stopTime);
    }
     ...
     * @param stopTime
     */
    public static void noteCompletedTask(String metric, String startTime, String stopTime) {
        noteCompletedTask(metric + "," + startTime + "," + stopTime);
    }
}
