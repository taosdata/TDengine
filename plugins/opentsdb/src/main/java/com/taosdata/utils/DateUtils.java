...
public class DateUtils {
    ...
    public static String DATE_FORMAT_21 = "yyyy-MM-dd'T'HH:mm:ssXXX";
    ...
    public static String PATTERN_YMDHMS_TZ = "^((19|20)[0-9]{2})-((0?2-((0?[1-9])|([1-2][0-9])))|(0?(1|3|5|7|8|10|12)-((0?[1-9])|([1-2][0-9])|(3[0-1])))|(0?(4|6|9|11)-((0?[1-9])|([1-2][0-9])|30)))T([0-1]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])([+-]\\d{2}:?\\d{2}|Z)$";
