...
typedef enum EFunctionType {
  ...
  FUNCTION_TYPE_NUM_POINTS,
  FUNCTION_TYPE_NUM_INTERIOR_RINGS,
  FUNCTION_TYPE_NUM_GEOMETRIES,
  FUNCTION_TYPE_GEOM_IS_SIMPLE,
  FUNCTION_TYPE_GEOM_IS_EMPTY,
  FUNCTION_TYPE_GEOM_DIMENSION,
