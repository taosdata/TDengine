...
// mnode-retention
#define TSDB_CODE_MND_INVALID_TRIM_ID           TAOS_DEF_ERROR_CODE(0, 0x04CA)
...
#define TSDB_CODE_STREAM_INVALID_WINDOW_TYPE     TAOS_DEF_ERROR_CODE(0, 0x4118)
...
#define TSDB_CODE_STREAM_WALVERSION_NOT_FOUND    TAOS_DEF_ERROR_CODE(0, 0x7018)
