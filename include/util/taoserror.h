...
#define TSDB_CODE_MND_TXN_SEQ_IN_CREATING        TAOS_DEF_ERROR_CODE(0, 0x3307)
#define TSDB_CODE_MND_TXN_SEQ_IN_DROPPING        TAOS_DEF_ERROR_CODE(0, 0x3308)
#define TSDB_CODE_MND_TXN_SEQ_NOT_READY          TAOS_DEF_ERROR_CODE(0, 0x3309)
