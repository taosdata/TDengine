...
#define TSDB_CODE_MND_XNODE_INVALID_VERSION     TAOS_DEF_ERROR_CODE(0, 0x8005)
...
#define TSDB_CODE_MND_XNODE_URL_RSP_IS_NULL     TAOS_DEF_ERROR_CODE(0, 0x800A)
#define TSDB_CODE_MND_XNODE_RETURN_ERROR        TAOS_DEF_ERROR_CODE(0, 0x800B)
// xnode-p1: task
#define TSDB_CODE_MND_XNODE_TASK_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x800C)
#define TSDB_CODE_MND_XNODE_TASK_NAME_TOO_LONG       TAOS_DEF_ERROR_CODE(0, 0x800D)
// xnode-p2: task job
#define TSDB_CODE_MND_XNODE_JOB_SYNTAX_ERROR         TAOS_DEF_ERROR_CODE(0, 0x800E)
#define TSDB_CODE_MND_XNODE_TASK_JOB_CONFIG_TOO_LONG TAOS_DEF_ERROR_CODE(0, 0x800F)
#define TSDB_CODE_MND_XNODE_TASK_REASON_TOO_LONG     TAOS_DEF_ERROR_CODE(0, 0x8010)
