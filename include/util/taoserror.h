...
#define TSDB_CODE_PAR_NOT_SUPPORT               TAOS_DEF_ERROR_CODE(0, 0x2680)
#define TSDB_CODE_PAR_FUNC_NOT_FOUND            TAOS_DEF_ERROR_CODE(0, 0x2681)
#define TSDB_CODE_PAR_FUNC_MISSING_ARGS         TAOS_DEF_ERROR_CODE(0, 0x2682)
#define TSDB_CODE_PAR_FUNC_TOO_MANY_ARGS        TAOS_DEF_ERROR_CODE(0, 0x2683)
