...
#define TSDB_CODE_MND_TRANS_GROUP_FINISHED      TAOS_DEF_ERROR_CODE(0, 0x03D3)
...
#define TSDB_CODE_DNODE_NOT_MATCH_WITH_LOCAL    TAOS_DEF_ERROR_CODE(0, 0x042C)
...
#define TSDB_CODE_GRANT_INVALID_AUTH_SERVER     TAOS_DEF_ERROR_CODE(0, 0x0832)
#define TSDB_CODE_GRANT_DISABLED                TAOS_DEF_ERROR_CODE(0, 0x0833)
#define TSDB_CODE_GRANT_RESTFUL_ERROR           TAOS_DEF_ERROR_CODE(0, 0x0834)
#define TSDB_CODE_GRANT_RESTFUL_TIMEOUT         TAOS_DEF_ERROR_CODE(0, 0x0835)
#define TSDB_CODE_GRANT_NO_UPDATE_NEEDED        TAOS_DEF_ERROR_CODE(0, 0x0836)
#define TSDB_CODE_GRANT_QUOTA_OUT_OF_RANGE      TAOS_DEF_ERROR_CODE(0, 0x0837)
