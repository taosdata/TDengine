...
//mnode-encrypt
#define TSDB_CODE_DNODE_ENCRYPT_ALGR_NOT_EXIST  TAOS_DEF_ERROR_CODE(0, 0x04E0)
#define TSDB_CODE_DNODE_CIPHER_NOT_EXIST        TAOS_DEF_ERROR_CODE(0, 0x04E1)
#define TSDB_CODE_INVALID_ENCRYPT_ALGR_TYPE     TAOS_DEF_ERROR_CODE(0, 0x04E2)
#define TSDB_CODE_ALGR_EXIST                    TAOS_DEF_ERROR_CODE(0, 0x04E3)
