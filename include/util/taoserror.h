...
//mnode-s3migrate
#define TSDB_CODE_MND_INVALID_S3MIGRATE_ID      TAOS_DEF_ERROR_CODE(0, 0x04C1)
#define TSDB_CODE_MND_S3MIGRATE_DETAIL_NOT_EXIST  TAOS_DEF_ERROR_CODE(0, 0x04C2)
#define TSDB_CODE_MND_S3MIGRATE_ALREADY_EXIST     TAOS_DEF_ERROR_CODE(0, 0x04C3)
