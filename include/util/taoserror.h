...
#define TSDB_CODE_MND_VST_HAS_CHILDREN          TAOS_DEF_ERROR_CODE(0, 0x03CA)
#define TSDB_CODE_MND_VST_INHERIT_DEPTH_EXCEED  TAOS_DEF_ERROR_CODE(0, 0x03CB)
#define TSDB_CODE_MND_VST_CIRCULAR_INHERIT      TAOS_DEF_ERROR_CODE(0, 0x03CC)
#define TSDB_CODE_MND_VST_PARENT_NOT_VIRTUAL    TAOS_DEF_ERROR_CODE(0, 0x03CD)
#define TSDB_CODE_MND_VST_COL_NAME_CONFLICT     TAOS_DEF_ERROR_CODE(0, 0x03CE)
...
#define TSDB_CODE_PAR_VST_EXPAND_NO_INHERIT          TAOS_DEF_ERROR_CODE(0, 0x26B2)
//
