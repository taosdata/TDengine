...
// mnode-role
#define TSDB_CODE_MND_ROLE_ALREADY_EXIST        TAOS_DEF_ERROR_CODE(0, 0x04E0)
#define TSDB_CODE_MND_ROLE_NOT_EXIST            TAOS_DEF_ERROR_CODE(0, 0x04E1)
#define TSDB_CODE_MND_ROLE_NOT_AVAILABLE        TAOS_DEF_ERROR_CODE(0, 0x04E2)
#define TSDB_CODE_MND_ROLE_INVALID_FORMAT       TAOS_DEF_ERROR_CODE(0, 0x04E3)
#define TSDB_CODE_MND_ROLE_SUBROLE_EXCEEDED     TAOS_DEF_ERROR_CODE(0, 0x04E4)
