...
// mnode-mount
#define TSDB_CODE_MND_MOUNT_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x04D0)
#define TSDB_CODE_MND_MOUNT_IN_CREATING         TAOS_DEF_ERROR_CODE(0, 0x04D1)
#define TSDB_CODE_MND_MOUNT_IN_DROPPING         TAOS_DEF_ERROR_CODE(0, 0x04D2)
