...
#define TSDB_CODE_PAR_NOT_ALLOWED_FILL_MODE          TAOS_DEF_ERROR_CODE(0, 0x26AB)
#define TSDB_CODE_PAR_NOT_ALLOWED_FILL_VALUES        TAOS_DEF_ERROR_CODE(0, 0x26AC)
#define TSDB_CODE_PAR_INVALID_SURROUND_TIME_VALUES   TAOS_DEF_ERROR_CODE(0, 0x26AD)
// 
