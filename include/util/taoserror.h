...
// Virtual table reference virtual table support
#define TSDB_CODE_VTABLE_CIRCULAR_REFERENCE      TAOS_DEF_ERROR_CODE(0, 0x620C)
#define TSDB_CODE_VTABLE_REF_DEPTH_EXCEEDED      TAOS_DEF_ERROR_CODE(0, 0x620D)
#define TSDB_CODE_VTABLE_NO_ORIGINAL_TABLE       TAOS_DEF_ERROR_CODE(0, 0x620E)
