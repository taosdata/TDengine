...
#define TSDB_CODE_MND_ANODE_URL_CANT_ACCESS     TAOS_DEF_ERROR_CODE(0, 0x0433)
#define TSDB_CODE_MND_ANODE_RSP_IS_NULL         TAOS_DEF_ERROR_CODE(0, 0x0434)
#define TSDB_CODE_MND_ANODE_INVALID_PROTOCOL    TAOS_DEF_ERROR_CODE(0, 0x0435)
#define TSDB_CODE_MND_ANODE_INVALID_VERSION     TAOS_DEF_ERROR_CODE(0, 0x0436)
#define TSDB_CODE_MND_ANODE_TOO_MANY_FUNC       TAOS_DEF_ERROR_CODE(0, 0x0437)
#define TSDB_CODE_MND_ANODE_TOO_LONG_FUNC_NAME  TAOS_DEF_ERROR_CODE(0, 0x0438)
#define TSDB_CODE_MND_ANODE_TOO_MANY_TYPE       TAOS_DEF_ERROR_CODE(0, 0x0439)
#define TSDB_CODE_MND_AFUNC_NOT_FOUND           TAOS_DEF_ERROR_CODE(0, 0x043A)
#define TSDB_CODE_MND_AFUNC_NOT_LOAD            TAOS_DEF_ERROR_CODE(0, 0x043B)
...
#define TSDB_CODE_PAR_INVALID_ANOMALY_OPT       TAOS_DEF_ERROR_CODE(0, 0x2684)
