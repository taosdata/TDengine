...
#define TSDB_CODE_MAC_INSUFFICIENT_LEVEL        TAOS_DEF_ERROR_CODE(0, 0x0142)
#define TSDB_CODE_MAC_OBJ_LEVEL_BELOW_DB        TAOS_DEF_ERROR_CODE(0, 0x0143)
#define TSDB_CODE_MAC_OBJ_LEVEL_BELOW_USER_MIN  TAOS_DEF_ERROR_CODE(0, 0x0144)
#define TSDB_CODE_MAC_OBJ_LEVEL_ABOVE_USER_MAX  TAOS_DEF_ERROR_CODE(0, 0x0145)
#define TSDB_CODE_MAC_INVALID_LEVEL             TAOS_DEF_ERROR_CODE(0, 0x0146)
