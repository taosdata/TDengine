...
#define TSDB_CODE_MND_ANODE_RSP_IS_NULL         TAOS_DEF_ERROR_CODE(0, 0x0433)
#define TSDB_CODE_MND_ANODE_INVALID_PROTOCOL    TAOS_DEF_ERROR_CODE(0, 0x0434)
#define TSDB_CODE_MND_ANODE_INVALID_VERSION     TAOS_DEF_ERROR_CODE(0, 0x0435)
#define TSDB_CODE_MND_ANODE_TOO_MANY_FUNC       TAOS_DEF_ERROR_CODE(0, 0x0436)
#define TSDB_CODE_MND_ANODE_TOO_LONG_FUNC_NAME  TAOS_DEF_ERROR_CODE(0, 0x0437)
#define TSDB_CODE_MND_ANODE_TOO_MANY_TYPE       TAOS_DEF_ERROR_CODE(0, 0x0438)

// analfunc
#define TSDB_CODE_ANAL_URL_CANT_ACCESS          TAOS_DEF_ERROR_CODE(0, 0x0440)
#define TSDB_CODE_ANAL_FUNC_NOT_FOUND           TAOS_DEF_ERROR_CODE(0, 0x0441)
#define TSDB_CODE_ANAL_FUNC_NOT_LOAD            TAOS_DEF_ERROR_CODE(0, 0x0442)
