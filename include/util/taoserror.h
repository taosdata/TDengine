...
#define TSDB_CODE_TSC_SESS_PER_USER_LIMIT        TAOS_DEF_ERROR_CODE(0, 0x0238)
#define TSDB_CODE_TSC_SESS_CONN_TIMEOUT          TAOS_DEF_ERROR_CODE(0, 0x0239)
#define TSDB_CODE_TSC_SESS_CONN_IDLE_TIMEOUT     TAOS_DEF_ERROR_CODE(0, 0x023A)
#define TSDB_CODE_TSC_SESS_MAX_CONCURRENCY_LIMIT TAOS_DEF_ERROR_CODE(0, 0x023B)
#define TSDB_CODE_TSC_SESS_MAX_CALL_VNODE_LIMIT  TAOS_DEF_ERROR_CODE(0, 0x023C)
...
#define TSDB_CODE_MND_USER_PASSWORD_EXPIRED     TAOS_DEF_ERROR_CODE(0, 0x0318)
#define TSDB_CODE_MND_INTERNAL_ERROR            TAOS_DEF_ERROR_CODE(0, 0x0319)
...
#define TSDB_CODE_PAR_OPTION_DUPLICATED         TAOS_DEF_ERROR_CODE(0, 0x2699)
#define TSDB_CODE_PAR_INVALID_OPTION_VALUE      TAOS_DEF_ERROR_CODE(0, 0x269A)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_LONG     TAOS_DEF_ERROR_CODE(0, 0x269B)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_SHORT    TAOS_DEF_ERROR_CODE(0, 0x269C)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_BIG      TAOS_DEF_ERROR_CODE(0, 0x269D)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_SMALL    TAOS_DEF_ERROR_CODE(0, 0x269E)
