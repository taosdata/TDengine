...
#define TSDB_CODE_ADD_TEMPLATE_ONLY_JSON         TAOS_DEF_ERROR_CODE(0, 0x4204)
#define TSDB_CODE_TEMPLATE_NOT_EXIST             TAOS_DEF_ERROR_CODE(0, 0x4205)
#define TSDB_CODE_TEMPLATE_ARRAY_ONLY_ONE_TYPE   TAOS_DEF_ERROR_CODE(0, 0x4206)
#define TSDB_CODE_TEMPLATE_VALUE_INVALIDATE      TAOS_DEF_ERROR_CODE(0, 0x4207)
#define TSDB_CODE_TEMPLATE_TOO_LONG              TAOS_DEF_ERROR_CODE(0, 0x4208)
#define TSDB_CODE_TEMPLATE_MUST_BE_OBJECT        TAOS_DEF_ERROR_CODE(0, 0x4209)
#define TSDB_CODE_TEMPLATE_ALREADY_EXIST         TAOS_DEF_ERROR_CODE(0, 0x420A)
#define TSDB_CODE_JSON_COL_TEMPLATE_NEEDED       TAOS_DEF_ERROR_CODE(0, 0x420B)
#define TSDB_CODE_TEMPLATE_NUM_EXCEED_LIMIT      TAOS_DEF_ERROR_CODE(0, 0x420C)
#define TSDB_CODE_TEMPLATE_TO_AVRO_ERROR         TAOS_DEF_ERROR_CODE(0, 0x420D)
#define TSDB_CODE_TEMPLATE_ALREADY_DROPPED       TAOS_DEF_ERROR_CODE(0, 0x420E)
#define TSDB_CODE_TEMPLATE_ONLY_ONE              TAOS_DEF_ERROR_CODE(0, 0x420F)
