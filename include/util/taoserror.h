...
#define TSDB_CODE_MND_USER_IP_RANGE_CONFLICT    TAOS_DEF_ERROR_CODE(0, 0x035A)
...
#define TSDB_CODE_MND_TRANS_CONFLICT_RETENTION  TAOS_DEF_ERROR_CODE(0, 0x03DA)
#define TSDB_CODE_MND_TRANS_NOT_ABLE_TO_kILLED  TAOS_DEF_ERROR_CODE(0, 0x03DE)
...
#define TSDB_CODE_PAR_OPTION_CONFLICT           TAOS_DEF_ERROR_CODE(0, 0x269A)
#define TSDB_CODE_PAR_INVALID_OPTION_VALUE      TAOS_DEF_ERROR_CODE(0, 0x269B)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_LONG     TAOS_DEF_ERROR_CODE(0, 0x269C)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_SHORT    TAOS_DEF_ERROR_CODE(0, 0x269D)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_BIG      TAOS_DEF_ERROR_CODE(0, 0x269E)
#define TSDB_CODE_PAR_OPTION_VALUE_TOO_SMALL    TAOS_DEF_ERROR_CODE(0, 0x269F)
