...
// mnode-mount
#define TSDB_CODE_MND_MOUNT_DUP_DB_NAME_EXIST   TAOS_DEF_ERROR_CODE(0, 0x04D0)
#define TSDB_CODE_MND_MOUNT_DUP_DB_ID_EXIST     TAOS_DEF_ERROR_CODE(0, 0x04D1)
#define TSDB_CODE_MND_MOUNT_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x04D2)
#define TSDB_CODE_MND_MOUNT_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x04D3)
#define TSDB_CODE_MND_MOUNT_IN_CREATING         TAOS_DEF_ERROR_CODE(0, 0x04D4)
#define TSDB_CODE_MND_MOUNT_IN_DROPPING         TAOS_DEF_ERROR_CODE(0, 0x04D5)
#define TSDB_CODE_MND_INVALID_MOUNT_INFO        TAOS_DEF_ERROR_CODE(0, 0x04D6)
#define TSDB_CODE_MND_MOUNT_NOT_EMPTY           TAOS_DEF_ERROR_CODE(0, 0x04D7)
...
#define TSDB_CODE_GRANT_MOUNTS_EXPIRED          TAOS_DEF_ERROR_CODE(0, 0x082F)
#define TSDB_CODE_GRANT_MOUNTS_LIMITED          TAOS_DEF_ERROR_CODE(0, 0x0830)
