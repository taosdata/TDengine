...
#define TSDB_CODE_GRANT_MEMORY_LIMITED          TAOS_DEF_ERROR_CODE(0, 0x082F)
#define TSDB_CODE_GRANT_VNODE_LIMITED           TAOS_DEF_ERROR_CODE(0, 0x0830)
#define TSDB_CODE_GRANT_ANODE_LIMITED           TAOS_DEF_ERROR_CODE(0, 0x0831)
#define TSDB_CODE_GRANT_LACK_OF_TA_BASIC        TAOS_DEF_ERROR_CODE(0, 0x0832)
