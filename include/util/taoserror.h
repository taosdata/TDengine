...
#define TSDB_CODE_MNODE_INVALID_ENCRYPT_ALGR_TYPE     TAOS_DEF_ERROR_CODE(0, 0x04E2)
#define TSDB_CODE_MNODE_ALGR_EXIST                    TAOS_DEF_ERROR_CODE(0, 0x04E3)
#define TSDB_CODE_MNODE_ENCRYPT_TYPE_NOT_MATCH        TAOS_DEF_ERROR_CODE(0, 0x04E4)
#define TSDB_CODE_MND_INVALID_ENCRYPT_ALGR_FORMAT     TAOS_DEF_ERROR_CODE(0, 0x04E5)
#define TSDB_CODE_MNODE_ENCRYPT_ALGR_IN_USE           TAOS_DEF_ERROR_CODE(0, 0x04E6)
...
#define TSDB_CODE_UTIL_CIPHER_NOT_EXIST        TAOS_DEF_ERROR_CODE(0, 0x04E1)
