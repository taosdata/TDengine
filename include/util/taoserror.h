...
#define TSDB_CODE_GRANT_RESTFUL_TIMEOUT         TAOS_DEF_ERROR_CODE(0, 0x0839)
#define TSDB_CODE_GRANT_NO_UPDATE_NEEDED        TAOS_DEF_ERROR_CODE(0, 0x0837)
#define TSDB_CODE_GRANT_QUOTA_OUT_OF_RANGE      TAOS_DEF_ERROR_CODE(0, 0x0838)
