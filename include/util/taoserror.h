...
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_RES_COLS   TAOS_DEF_ERROR_CODE(0, 0x2699)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_RES_ROWS   TAOS_DEF_ERROR_CODE(0, 0x269A)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ            TAOS_DEF_ERROR_CODE(0, 0x269B)
#define TSDB_CODE_PAR_STMT_NOT_SUPPORT_SCALAR_SUBQ   TAOS_DEF_ERROR_CODE(0, 0x269C)
#define TSDB_CODE_PAR_INVALID_SCALAR_SUBQ_USAGE      TAOS_DEF_ERROR_CODE(0, 0x269D)
