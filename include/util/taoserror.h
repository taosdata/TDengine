...
#define TSDB_CODE_INVALID_MEM_POOL_PARAM        TAOS_DEF_ERROR_CODE(0, 0x0138)
#define TSDB_CODE_SYSTEM_ERROR                  TAOS_DEF_ERROR_CODE(0, 0x0139)
...
#define TSDB_CODE_QRY_REACH_QMEM_THRESHOLD      TAOS_DEF_ERROR_CODE(0, 0x0735)
#define TSDB_CODE_QRY_QUERY_MEM_EXHAUSTED       TAOS_DEF_ERROR_CODE(0, 0x0736)
#define TSDB_CODE_QRY_TOO_FEW_AVAILBLE_MEM      TAOS_DEF_ERROR_CODE(0, 0x0737)
