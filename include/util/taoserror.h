...
#define TSDB_CODE_MND_ANODE_TOO_MANY_FUNC       TAOS_DEF_ERROR_CODE(0, 0x0435)
#define TSDB_CODE_MND_ANODE_TOO_LONG_FUNC_NAME  TAOS_DEF_ERROR_CODE(0, 0x0436)
#define TSDB_CODE_MND_ANODE_TOO_MANY_TYPE       TAOS_DEF_ERROR_CODE(0, 0x0437)
...
#define TSDB_CODE_ANAL_FUNC_NOT_FOUND           TAOS_DEF_ERROR_CODE(0, 0x0442)
#define TSDB_CODE_ANAL_FUNC_NOT_LOAD            TAOS_DEF_ERROR_CODE(0, 0x0443)
