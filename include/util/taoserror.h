...
// mnode-rsma
#define TSDB_CODE_MND_RSMA_ALREADY_EXIST        TAOS_DEF_ERROR_CODE(0, 0x0490)
#define TSDB_CODE_MND_RSMA_NOT_EXIST            TAOS_DEF_ERROR_CODE(0, 0x0491)
#define TSDB_CODE_MND_INVALID_RSMA_OPTION       TAOS_DEF_ERROR_CODE(0, 0x0492)
#define TSDB_CODE_MND_RSMA_IN_CREATING          TAOS_DEF_ERROR_CODE(0, 0x0493)
#define TSDB_CODE_MND_RSMA_IN_DROPPING          TAOS_DEF_ERROR_CODE(0, 0x0494)
