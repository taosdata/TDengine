...
#define TSDB_CODE_XNODE_ALREADY_DEPLOYED        TAOS_DEF_ERROR_CODE(0, 0x0461)
#define TSDB_CODE_MND_XNODE_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x0462)
#define TSDB_CODE_MND_XNODE_TOO_LONG_URL        TAOS_DEF_ERROR_CODE(0, 0x0463)
#define TSDB_CODE_MND_XNODE_INVALID_PROTOCOL    TAOS_DEF_ERROR_CODE(0, 0x0464)
#define TSDB_CODE_MND_XNODE_INVALID_VERSION     TAOS_DEF_ERROR_CODE(0, 0x0465)
#define TSDB_CODE_MND_XNODE_INVALID_MSG         TAOS_DEF_ERROR_CODE(0, 0x0466)
#define TSDB_CODE_XNODE_NOT_FOUND               TAOS_DEF_ERROR_CODE(0, 0x0467)
#define TSDB_CODE_XNODE_UV_EXEC_FAILURE         TAOS_DEF_ERROR_CODE(0, 0x0468)
#define TSDB_CODE_MND_XNODE_URL_CANT_ACCESS     TAOS_DEF_ERROR_CODE(0, 0x0469)
#define TSDB_CODE_MND_XNODE_URL_RSP_IS_NULL     TAOS_DEF_ERROR_CODE(0, 0x0469)
#define TSDB_CODE_MND_XNODE_RETURN_ERROR        TAOS_DEF_ERROR_CODE(0, 0x0469)
// xnode-p1: task
