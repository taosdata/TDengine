...
// xnode
#define TSDB_CODE_MND_XNODE_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x0450)
#define TSDB_CODE_XNODE_ALREADY_DEPLOYED        TAOS_DEF_ERROR_CODE(0, 0x0451)
#define TSDB_CODE_XNODE_NOT_DEPLOYED            TAOS_DEF_ERROR_CODE(0, 0x0452)
#define TSDB_CODE_MND_XNODE_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x0453)
#define TSDB_CODE_XNODE_NOT_FOUND               TAOS_DEF_ERROR_CODE(0, 0x0454)
#define TSDB_CODE_XNODE_UV_EXEC_FAILURE         TAOS_DEF_ERROR_CODE(0, 0x0455)
...
#define TSDB_CODE_PAR_INVALID_XNODE_OPTION      TAOS_DEF_ERROR_CODE(0, 0x261C)
