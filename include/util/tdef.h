...
#define TSDB_DEFAULT_SECURITY_LEVEL          0
#define TSDB_DEFAULT_USER_MIN_SECURITY_LEVEL 0
#define TSDB_DEFAULT_USER_MAX_SECURITY_LEVEL 1
#define TSDB_MIN_SECURITY_LEVEL              0
#define TSDB_MAX_SECURITY_LEVEL              4
