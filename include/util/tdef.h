...
#define TSDB_XNODE_OPT_PROTO_STR_MQTT "mqtt"
#define TSDB_XNODE_OPT_PROTO_MQTT     1
#define TSDB_XNODE_OPT_PROTO_STR_LEN  sizeof(TSDB_XNODE_OPT_PROTO_STR_MQTT)
#define TSDB_XNODE_OPT_PROTO_DEFAULT  TSDB_XNODE_OPT_PROTO_MQTT
#define TSDB_XNODE_OPT_PROTO_DFT_STR  TSDB_XNODE_OPT_PROTO_STR_MQTT
