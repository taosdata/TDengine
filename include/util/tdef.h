...
typedef enum {
  // ==================== DB Privileges (0-63) ====================
  PRIV_DB_CREATE_BIT = 0,  // 0: CREATE DATABASE
  PRIV_DB_ALTER_BIT,       // 1: ALTER DATABASE
  PRIV_DB_DROP_BIT,        // 2: DROP DATABASE
  PRIV_DB_USE_BIT,         // 3: USE DATABASE
  PRIV_DB_FLUSH_BIT,       // 4: FLUSH DATABASE
  PRIV_DB_COMPACT_BIT,     // 5: COMPACT DATABASE
  PRIV_DB_TRIM_BIT,        // 6: TRIM DATABASE
  PRIV_DB_ROLLUP_BIT,      // 7: ROLLUP DATABASE
  PRIV_DB_SCAN_BIT,        // 8: SCAN DATABASE
  PRIV_DB_SSMIGRATE_BIT,   // 9: SSMIGRATE DATABASE

  // VGROUP Operations（10-16预留）
  PRIV_VG_BALANCE_BIT = 17,  // 17: BALANCE VGROUP
  PRIV_VG_MERGER_BIT,        // 18: MERGER VGROUP
  PRIV_VG_REDISTRIBUTE_BIT,  // 19: REDISTRIBUTE VGROUP
  PRIV_VG_SPLIT_BIT,         // 20: SPLIT VGROUP

  // DB Show Operations（21-31预留）
  PRIV_SHOW_DATABASES_BIT = 32,  // 32: SHOW DATABASES
  PRIV_SHOW_VNODES_BIT,          // 33: SHOW VNODES
  PRIV_SHOW_VGROUPS_BIT,         // 34: SHOW VGROUPS
  PRIV_SHOW_COMPACTS_BIT,        // 35: SHOW COMPACTS
  PRIV_SHOW_RETENTIONS_BIT,      // 36: SHOW RETENTIONS
  PRIV_SHOW_SCANS_BIT,           // 37: SHOW SCANS
  PRIV_SHOW_SSMIGRATES_BIT,      // 38: SHOW SSMIGRATES

  // ==================== Table Privileges (64-95) ================
  PRIV_TBL_CREATE_BIT = 64,  // 64: CREATE TABLE
  PRIV_TBL_DROP_BIT,         // 65: DROP TABLE
  PRIV_TBL_ALTER_BIT,        // 66: ALTER TABLE
  PRIV_TBL_SHOW_BIT,         // 67: SHOW TABLES
  PRIV_TBL_SHOW_CREATE_BIT,  // 68: SHOW CREATE TABLE
  PRIV_TBL_READ_BIT,         // 69: READ TABLE
  PRIV_TBL_READ_BY_TAG_BIT,  // 70: READ TABLE BY TAG
  PRIV_TBL_WRITE_BIT,        // 71: WRITE TABLE
  PRIV_TBL_DELETE_BIT,       // 72: DELETE TABLE

  // ==================== 对象创建权限 (96-127) ====================
  // function
  PRIV_FUNC_CREATE_BIT = 96,  // 96: CREATE FUNCTION
  PRIV_FUNC_DROP_BIT,         // 97: DROP FUNCTION
  PRIV_FUNC_SHOW_BIT,         // 98: SHOW FUNCTIONS

  // index
  PRIV_IDX_CREATE_BIT,  // 99: CREATE INDEX
  PRIV_IDX_DROP_BIT,    // 100: DROP INDEX
  PRIV_IDX_SHOW_BIT,    // 101: SHOW INDEXES

  // SMA
  PRIV_RSMA_CREATE_BIT,       // 102: CREATE RSMA
  PRIV_RSMA_DROP_BIT,         // 103: DROP RSMA
  PRIV_RSMA_ALTER_BIT,        // 104: ALTER RSMA
  PRIV_RSMA_SHOW_BIT,         // 105: SHOW RSMA
  PRIV_RSMA_SHOW_CREATE_BIT,  // 106: SHOW CREATE RSMA
  PRIV_TSMA_CREATE_BIT,       // 107: CREATE TSMA
  PRIV_TSMA_DROP_BIT,         // 108: DROP TSMA
  PRIV_TSMA_SHOW_BIT,         // 109: SHOW TSMA

  // view（110-119预留）
  PRIV_VIEW_CREATE_BIT = 120,  // 120: CREATE VIEW
  PRIV_VIEW_DROP_BIT,          // 121: DROP VIEW
  PRIV_VIEW_SHOW_BIT,          // 122: SHOW VIEW
  PRIV_VIEW_READ_BIT,          // 123: READ VIEW

  // ==================== 系统管理权限 (128-191) ====================
  // 挂载权限
  PRIV_MOUNT_CREATE_BIT = 128,  // 128: CREATE MOUNT
  PRIV_MOUNT_DROP_BIT,          // 129: DROP MOUNT
  PRIV_MOUNT_SHOW_BIT,          // 130: SHOW MOUNT

  // 角色权限
  PRIV_ROLE_CREATE_BIT,  // 131: CREATE ROLE
  PRIV_ROLE_DROP_BIT,    // 132: DROP ROLE
  PRIV_ROLE_SHOW_BIT,    // 133: SHOW ROLE

  // 用户权限
  PRIV_USER_CREATE_BIT,        // 134: CREATE USER
  PRIV_USER_DROP_BIT,          // 135: DROP USER
  PRIV_USER_SET_SECURITY_BIT,  // 136: SET USER SECURITY INFO
  PRIV_USER_SET_AUDIT_BIT,     // 137: SET USER AUDIT INFO
  PRIV_USER_SET_BASIC_BIT,     // 138: SET USER BASIC INFO
  PRIV_USER_ENABLE_BIT,        // 139: ENABLE USER
  PRIV_USER_DISABLE_BIT,       // 140: DISABLE USER
  PRIV_USER_SHOW_BIT,          // 141: SHOW USERS

  // 令牌权限
  PRIV_TOKEN_CREATE_BIT,  // 142: CREATE TOKEN
  PRIV_TOKEN_DROP_BIT,    // 143: DROP TOKEN
  PRIV_TOKEN_ALTER_BIT,   // 144: ALTER TOKEN
  PRIV_TOKEN_SHOW_BIT,    // 145: SHOW TOKEN

  // 密码权限
  PRIV_PASS_ALTER_BIT,       // 146: ALTER PASS
  PRIV_PASS_ALTER_SELF_BIT,  // 147: ALTER SELF PASS

  // ==================== 高级管理权限 (192-255) ====================
  // 权限授予权限（148-191预留）
  PRIV_GRANT_PRIVILEGE_BIT = 192,  // 192: GRANT PRIVILEGE
  PRIV_REVOKE_PRIVILEGE_BIT,       // 193: REVOKE PRIVILEGE
  PRIV_GRANT_SYSDBA_BIT,           // 194: GRANT SYSDBA PRIVILEGE
  PRIV_REVOKE_SYSDBA_BIT,          // 195: REVOKE SYSDBA PRIVILEGE
  PRIV_GRANT_SYSSEC_BIT,           // 196: GRANT SYSSEC PRIVILEGE
  PRIV_REVOKE_SYSSEC_BIT,          // 197: REVOKE SYSSEC PRIVILEGE
  PRIV_GRANT_SYSAUDIT_BIT,         // 198: GRANT SYSAUDIT PRIVILEGE
  PRIV_REVOKE_SYSAUDIT_BIT,        // 199: REVOKE SYSAUDIT PRIVILEGE

  // 节点管理权限
  PRIV_DNODE_CREATE_BIT = 200,  // 200: CREATE DNODE
  PRIV_DNODE_DROP_BIT,          // 201: DROP DNODE
  PRIV_DNODE_SHOW_BIT,          // 202: SHOW DNODES
  PRIV_MNODE_CREATE_BIT,        // 203: CREATE MNODE
  PRIV_MNODE_DROP_BIT,          // 204: DROP MNODE
  PRIV_MNODE_SHOW_BIT,          // 205: SHOW MNODES

  // 系统参数权限（206-209预留）
  PRIV_VAR_SECURITY_ALTER_BIT = 210,  // 210: ALTER SECURITY VARIABLE
  PRIV_VAR_AUDIT_ALTER_BIT,           // 211: ALTER AUDIT VARIABLE
  PRIV_VAR_SYSTEM_ALTER_BIT,          // 212: ALTER SYSTEM VARIABLE
  PRIV_VAR_DEBUG_ALTER_BIT,           // 213: ALTER DEBUG VARIABLE
  PRIV_VAR_SECURITY_SHOW_BIT,         // 214: SHOW SECURITY VARIABLE
  PRIV_VAR_AUDIT_SHOW_BIT,            // 215: SHOW AUDIT VARIABLE
  PRIV_VAR_SYSTEM_SHOW_BIT,           // 216: SHOW SYSTEM VARIABLE
  PRIV_VAR_DEBUG_SHOW_BIT,            // 217: SHOW DEBUG VARIABLE

  // 密钥权限
  PRIV_KEY_UPDATE_BIT,   // 218: UPDATE KEY
  PRIV_TOTP_CREATE_BIT,  // 219: CREATE TOTP
  PRIV_TOTP_SHOW_BIT,    // 220: SHOW TOTP
  PRIV_TOTP_DROP_BIT,    // 221: DROP TOTP
  PRIV_TOTP_UPDATE_BIT,  // 222: UPDATE TOTP

  // ==================== 功能模块权限 (256-319) ====================
  // 订阅权限（223-255预留）
  PRIV_TOPIC_CREATE_BIT = 256,  // 256: CREATE TOPIC
  PRIV_TOPIC_DROP_BIT,          // 257: DROP TOPIC
  PRIV_TOPIC_SHOW_BIT,          // 258: SHOW TOPICS
  PRIV_CONSUMER_SHOW_BIT,       // 259: SHOW CONSUMERS
  PRIV_SUBSCRIPTION_SHOW_BIT,   // 260: SHOW SUBSCRIPTIONS

  // 流计算权限
  PRIV_STREAM_CREATE_BIT,  // 261: CREATE STREAM
  PRIV_STREAM_DROP_BIT,    // 262: DROP STREAM
  PRIV_STREAM_SHOW_BIT,    // 263: SHOW STREAM
  PRIV_STREAM_START_BIT,   // 264: START STREAM
  PRIV_STREAM_STOP_BIT,    // 265: STOP STREAM
  PRIV_STREAM_RECALC_BIT,  // 266: RECALC STREAM

  // 系统管理权限
  PRIV_TRANS_SHOW_BIT,       // 267: SHOW TRANS
  PRIV_TRANS_KILL_BIT,       // 268: KILL TRANS
  PRIV_CONNECTION_SHOW_BIT,  // 269: SHOW CONNECTIONS
  PRIV_CONNECTION_KILL_BIT,  // 270: KILL CONNECTION
  PRIV_QUERY_SHOW_BIT,       // 271: SHOW QUERIES
  PRIV_QUERY_KILL_BIT,       // 272: KILL QUERY

  // ==================== 系统信息权限 (320-383) ====================
  // （273-319预留）
  PRIV_INFO_SCHEMA_USE_BIT = 320,   // 320: USE INFORMATION_SCHEMA
  PRIV_PERF_SCHEMA_USE_BIT,         // 321: USE PERFORMANCE_SCHEMA
  PRIV_INFO_SCHEMA_READ_LIMIT_BIT,  // 322: READ INFORMATION_SCHEMA LIMIT
  PRIV_INFO_SCHEMA_READ_SEC_BIT,    // 323: READ INFORMATION_SCHEMA SECURITY
  PRIV_INFO_SCHEMA_READ_AUDIT_BIT,  // 324: READ INFORMATION_SCHEMA AUDIT
  PRIV_INFO_SCHEMA_READ_BASIC_BIT,  // 325: READ INFORMATION_SCHEMA BASIC
  PRIV_PERF_SCHEMA_READ_LIMIT_BIT,  // 326: READ PERFORMANCE_SCHEMA LIMIT
  PRIV_PERF_SCHEMA_READ_BASIC_BIT,  // 327: READ PERFORMANCE_SCHEMA BASIC
  PRIV_GRANTS_SHOW_BIT,             // 328: SHOW GRANTS
  PRIV_CLUSTER_SHOW_BIT,            // 329: SHOW CLUSTER
  PRIV_APPS_SHOW_BIT,               // 330: SHOW APPS

  // ==================== 审计管理权限 (384-447) ====================
  // （331-383预留）
  PRIV_AUDIT_DB_CREATE_BIT = 384,  // 384: CREATE AUDIT DATABASE
  PRIV_AUDIT_DB_DROP_BIT,          // 385: DROP AUDIT DATABASE
  PRIV_AUDIT_DB_ALTER_BIT,         // 386: ALTER AUDIT DATABASE
  PRIV_AUDIT_DB_READ_BIT,          // 387: READ AUDIT DATABASE
  PRIV_AUDIT_DB_WRITE_BIT,         // 388: WRITE AUDIT DATABASE

  // ==================== 预留扩展空间 (448-511) ====================
  MAX_PRIV_BIT = 511  // 最大权限位（用于计算分组数量）
} PrivBit;
