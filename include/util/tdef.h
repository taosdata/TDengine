...
#define TSDB_ANODE_URL_LEN        256
#define TSDB_ANAL_FUNC_NAME_LEN   TSDB_FUNC_NAME_LEN
#define TSDB_ANAL_FUNC_TYPE_LEN   32
#define TSDB_ANAL_FUNC_KEY_LEN    (TSDB_ANAL_FUNC_NAME_LEN + 10)
#define TSDB_ANAL_FUNC_URL_LEN    (TSDB_ANODE_URL_LEN + TSDB_ANAL_FUNC_TYPE_LEN)
#define TSDB_ANAL_FUNC_OPTION_LEN 128
...
typedef enum {
  ANAL_FUNC_TYPE_START = 0,
  ANAL_FUNC_TYPE_ANOMALY_WINDOW = 1,
  ANAL_FUNC_TYPE_ANOMALY_DETECT = 2,
  ANAL_FUNC_TYPE_FORECAST = 3,
  ANAL_FUNC_TYPE_HISTORIC = 4,
  ANAL_FUNC_TYPE_END,
} EAnalFuncType;
