...
#ifndef TD_ASTRA
#define TSDB_SYNC_LOG_BUFF_MIN_MSG   10LL
#define TSDB_SYNC_LOG_BUFF_MEM_RATIO 0.1
#else
#define TSDB_SYNC_LOG_BUFF_MIN_MSG   1LL
#define TSDB_SYNC_LOG_BUFF_MEM_RATIO 0.01
#endif
