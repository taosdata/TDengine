...
typedef enum {
  ...
  PRIV_TBL_READ_BIT,         // 69: READ TABLE(equivalent to SELECT TABLE)
  PRIV_TBL_READ_BY_TAG_BIT,  // 70: READ TABLE BY TAG(equivalent to SELECT TABLE BY TAG)
  PRIV_TBL_WRITE_BIT,        // 71: WRITE TABLE(equivalent to INSERT TABLE)
  PRIV_TBL_DELETE_BIT,       // 72: DELETE TABLE

  PRIV_COL_READ_DATA_BIT = 80,  // READ COLUMN DATA
  PRIV_COL_WRITE_DATA_BIT,      // WRITE COLUMN DATA
  PRIV_ROW_READ_DATA_BIT,       // READ ROW DATA
  PRIV_ROW_WRITE_DATA_BIT,      // WRITE ROW DATA

  // ==================== Other Privileges (96-511) ================
  // function management
  ...
  // index management
  PRIV_IDX_CREATE_BIT = 99,  // 99: CREATE INDEX
  PRIV_IDX_DROP_BIT,         // 100: DROP INDEX
  PRIV_IDX_SHOW_BIT,         // 101: SHOW INDEXES

  // RSMA management
  PRIV_RSMA_CREATE_BIT = 102,  // 102: CREATE RSMA
  ...
  // TSMA management
  PRIV_TSMA_CREATE_BIT = 110,  // CREATE TSMA
  ...
  // role management
  PRIV_ROLE_CREATE_BIT = 131,  // 131: CREATE ROLE
  PRIV_ROLE_DROP_BIT,          // 132: DROP ROLE
  PRIV_ROLE_SHOW_BIT,          // 133: SHOW ROLE

  // user management
  PRIV_USER_CREATE_BIT = 134,  // 134: CREATE USER
  ...
  // password management
  PRIV_PASS_ALTER_BIT = 142,  // ALTER PASS
  PRIV_PASS_ALTER_SELF_BIT,   // ALTER SELF PASS

  // audit management
  PRIV_AUDIT_DB_CREATE_BIT = 150,  // CREATE AUDIT DATABASE
  ...
  // node management
  PRIV_DNODE_CREATE_BIT = 210,  // CREATE DNODE
  ...
  // system variables
  PRIV_VAR_SECURITY_ALTER_BIT = 230,  // ALTER SECURITY VARIABLE
  ...
  // topic management
  PRIV_TOPIC_CREATE_BIT = 250,  // 250: CREATE TOPIC
  PRIV_TOPIC_DROP_BIT,          // 251: DROP TOPIC
  PRIV_TOPIC_SHOW_BIT,          // 252: SHOW TOPICS
  PRIV_CONSUMER_SHOW_BIT,       // 253: SHOW CONSUMERS
  PRIV_SUBSCRIPTION_SHOW_BIT,   // 254: SHOW SUBSCRIPTIONS

  // stream management
  PRIV_STREAM_CREATE_BIT = 270,  // 270: CREATE STREAM
  PRIV_STREAM_DROP_BIT,          // 271: DROP STREAM
  PRIV_STREAM_SHOW_BIT,          // 272: SHOW STREAM
  PRIV_STREAM_START_BIT,         // 273: START STREAM
  PRIV_STREAM_STOP_BIT,          // 274: STOP STREAM
  PRIV_STREAM_RECALC_BIT,        // 275: RECALC STREAM

  // system operation management
  PRIV_TRANS_SHOW_BIT = 290,  // SHOW TRANS
  ...
  // extended privileges can be defined here (512 bits reserved in total)
