...
//  TD_DEF_MSG_TYPE(TDMT_MND_TMQ_CONSUMER_LOST, "consumer-lost", SMqConsumerLostMsg, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_STREAM_ACT_DEPLOY, "stream-act-deploy", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_STREAM_ACT_DROP, "stream-act-drop", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UNUSED5, "mnd-unused5", NULL, NULL)   // not used
