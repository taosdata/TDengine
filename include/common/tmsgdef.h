...
#undef TD_MSG_SEG_CODE_
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_GET_USER_IP_WHITELIST_DUAL, "get-user-ip-whitelist-dual", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_RETRIEVE_IP_WHITELIST_DUAL, "retrieve-ip-whitelist-dual", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_GET_USER_DATETIME_WHITELIST, "get-user-datetime-whitelist", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_RETRIEVE_DATETIME_WHITELIST, "retrieve-datetime-whitelist", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_CREATE_TOKEN, "create-token", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_ALTER_TOKEN, "alter-token", NULL, NULL)
...
//  TD_DEF_MSG_TYPE(TDMT_MND_TMQ_CONSUMER_LOST, "consumer-lost", SMqConsumerLostMsg, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_RETRIEVE_IP_WHITELIST, "retrieve-ip-whitelist", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_GET_USER_IP_WHITELIST, "get-user-ip-whitelist", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_VND_RELOAD_LAST_CACHE,        "vnode-reload-last-cache",        NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_VND_QUERY_LAST_CACHE_STATUS,  "vnode-query-last-cache-status",  NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_VND_CANCEL_LAST_CACHE_RELOAD, "vnode-cancel-last-cache-reload", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_INSTANCE_TIMER, "instance-tmr", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_CREATE_ENCRYPT_ALGR, "create-encrypt-algr", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_DROP_ENCRYPT_ALGR, "drop-encrypt-algr", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_BUILTIN_ENCRYPT_ALGR, "builtin-encrypt-algr", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_ALTER_DNODE_RELOAD_TLS, "alter-tls", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_DND_RELOAD_DNODE_TLS, "dnode-reload-tls", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_BATCH_AUDIT, "batch-audit", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_CREATE_ROLE, "create-role", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_DROP_ROLE, "drop-role", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_ALTER_ROLE, "alter-role", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UPGRADE_USER, "upgrade-user", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UPGRADE_ROLE, "upgrade-role", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_RELOAD_LAST_CACHE, "mnd-reload-last-cache", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_DROP_RELOAD,       "mnd-drop-reload",        SDropReloadReq, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_DRAIN_XNODE, "drain-xnode", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_CREATE_XNODE_TASK, "create-xnode-task", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_START_XNODE_TASK, "start-xnode-task", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_STOP_XNODE_TASK, "stop-xnode-task", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_REBALANCE_XNODE_JOB, "rebalance-xnode-job", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_REBALANCE_XNODE_JOBS_WHERE, "rebalance-xnode-jobs-where", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_DROP_XNODE_JOB, "drop-xnode-job", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_UPDATE_XNODE_AGENT, "update-xnode-agent", NULL, NULL)
  TD_CLOSE_MSG_SEG(TDMT_MND_XNODE_MSG)
