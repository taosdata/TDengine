...
//  TD_DEF_MSG_TYPE(TDMT_MND_TMQ_CONSUMER_LOST, "consumer-lost", SMqConsumerLostMsg, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_VND_KILL_RETENTION, "kill-retention", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_VND_QUERY_RETENTION_PROGRESS, "vnode-query-retention-progress", NULL, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_RECALC_RSMA, "recalc-rsma", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_START_RSMA, "start-rsma", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_STOP_RSMA, "stop-rsma", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_KILL_RSMA_TASK, "kill-rsma-task", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_KILL_RETENTION, "kill-retention-task", NULL, NULL)
