...
//  TD_DEF_MSG_TYPE(TDMT_MND_TMQ_CONSUMER_LOST, "consumer-lost", SMqConsumerLostMsg, NULL)
  ...
  TD_DEF_MSG_TYPE(TDMT_MND_BEGIN_TRANS, "begin-trans", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_COMMIT_TRANS, "commit-trans", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_MND_ROLLBACK_TRANS, "rollback-trans", NULL, NULL)
