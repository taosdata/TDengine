...
typedef enum _mgmt_table {
  ...
  TSDB_MGMT_TABLE_XNODE_TASK_JOBS,
...
#define tSerializeSQuerySsMigrateProgressRsp(buf, bufLen, pRsp)   tSerializeSVnodeSsMigrateState(buf, bufLen, pRsp)
#define tDeserializeSQuerySsMigrateProgressRsp(buf, bufLen, pRsp) tDeserializeSVnodeSsMigrateState(buf, bufLen, pRsp)
#define tFreeSQuerySsMigrateProgressRsp(pRsp)                     tFreeSVnodeSsMigrateState(pRsp)

typedef SVnodeSsMigrateState SFollowerSsMigrateReq;
#define tSerializeSFollowerSsMigrateReq(buf, bufLen, pReq)   tSerializeSVnodeSsMigrateState(buf, bufLen, pReq)
#define tDeserializeSFollowerSsMigrateReq(buf, bufLen, pReq) tDeserializeSVnodeSsMigrateState(buf, bufLen, pReq)
#define tFreeSFollowerSsMigrateReq(pReq)                     tFreeSVnodeSsMigrateState(pReq)
