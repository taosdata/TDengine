            ...
            try:
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        # CSUM | LEASTSQUARES 可以用在普通表查询，因此特殊处理一下 
                        sql2 = "select %s from (select * from %s) where %s %s %s group by tbname" %(func.replace("CSUM","TWA").replace("LEASTSQUARES","TWA"),self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        sql2 = "select %s from (select * from %s) where tbname in ('%s_1') and %s %s %s group by tbname" %(func.replace("CSUM","TWA").replace("LEASTSQUARES","TWA"),self.table,self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
            ...
            try:
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        sql2 = "select %s from (select * from %s where  %s %s %s group by tbname order by ts)" %(func.replace("CSUM","TWA").replace("LEASTSQUARES","TWA"),self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
                        ...
                        sql2 = "select %s from (select * from %s where  %s %s %s group by tbname order by ts ) order by ts" %(func.replace("CSUM","TWA").replace("LEASTSQUARES","TWA"),self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        sql2 = "select %s from (select * from %s) where  %s %s %s group by tbname order by ts desc" %(func.replace("CSUM","TWA").replace("LEASTSQUARES","TWA"),self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
                        ...
                        sql2 = "select %s from (select * from %s where  %s %s %s group by tbname order by ts desc ) order by ts desc" %(func.replace("CSUM","TWA").replace("LEASTSQUARES","TWA"),self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
            ...
            try:
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        sql2 = "select %s from %s where %s %s %s group by tbname order by ts limit 10 offset 5" %(func,self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2

                        sql2 = "select * from (select %s from %s where %s %s %s group by tbname order by ts limit 10 offset 5)" %(func,self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
            ...
            try:
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        sql2 = "select %s from %s where %s %s %s %s group by tbname" %(func,self.table,qt_where,qt_like_match,qt_in_where,time_window)
                        self.tdSql.error(sql2)
                        sql= sql + sql2

                        sql2 = "select * from (select %s from %s where %s %s %s %s group by tbname)" %(func,self.table,qt_where,qt_like_match,qt_in_where,time_window)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
                        ...
                        sql2 = "select distinct(*) from %s where %s %s %s group by tbname" %(self.table,qt_where,qt_like_match,qt_in_where)
                        self.tdSql.error(sql2)
                        sql= sql + sql2
