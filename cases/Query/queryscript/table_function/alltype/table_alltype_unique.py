...
class TDTestQuery(TDCase):
    ...
    def desc(self) -> str:
        case_description = '''
        case1:# support all type(not include key timestamp)  support UNIQUE function [hanshu = 'UNIQUE']
        case2:
        '''
        return case_description

    #basic_param
    db = "table_alltype_unique"
    service_host = "ceph01"
    ...
    def right_case_1_groupby(self):
        ...
        # 1: support UNIQUE function [hanshu = 'UNIQUE']
        for i in (9,):
