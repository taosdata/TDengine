...
class TDTestQuery(TDCase):
    ...
    def desc(self) -> str:
        case_description = '''
        case1:# support int type\ support math function [hanshu = ['SIN','COS','TAN','ASIN','ACOS','ATAN']]
        case2:
        '''
        return case_description

    #basic_param
    db = "table_math_sin_cos_tan"
    ...
    def right_case_1_groupby(self):
        ...
        # 1: support math function [hanshu = ['SIN','COS','TAN','ASIN','ACOS','ATAN']]
        for i in (1,):
