...
class TDTestQuery(TDCase):
    ...
    def desc(self) -> str:
        case_description = '''
        case1:# support binary and nchar type\ support str function [hanshu = ['CONCAT_WS']
        case2:
        '''
    ...
    def np_check(self,sql1,sql2):  
        ...
        # sql0 = sql1.replace("CONCAT_WS(","").replace(") from"," from")
        ...
        #     self.tdCreateData.check_one_row_one_col_str_value('%s' %sql2 , j ,0,'CONCAT_WS','%s' %value) 
        pass
    ...
    def right_case_1_groupby(self):
        ...
        # 1: support str function [hanshu = ['CONCAT_WS']
        for i in (10,11,):
