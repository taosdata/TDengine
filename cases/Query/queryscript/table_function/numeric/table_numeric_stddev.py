                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,6,7,8,9,):                        
                            ...
                            #TD-14782 self.tdCreateData.data_matrix_equal('%s' %sql1 ,1,1,1,1,'%s' %sql2 ,1,1,1,1)
                            #cur1.execute(sql2)
                            sql= sql + sql2
                        ...
                        for i in (21,):                           
                            ...
                            sql2 = "select %s from %s where  %s %s %s %s order by ts desc" %(func_desc,self.table,qt_where,qt_like_match,qt_in_where,time_window_new)
                            print(sql2)
                            #TD-15162 self.tdCreateData.data_matrix_equal('%s' %sql1 ,1,1,1,1,'%s' %sql2 ,1,1,1,1)
                            #cur1.execute(sql2)
                            sql= sql + sql2
                        ...
                        for i in (22,):                           
                            ...
                            sql2 = "select %s from %s where  %s %s %s %s order by ts desc" %(func_desc,self.table,qt_where,qt_like_match,qt_in_where,time_window_new)
                            print(sql2)
                            #TD-15164 self.tdCreateData.data_matrix_equal('%s' %sql1 ,1,1,1,1,'%s' %sql2 ,1,1,1,1)
                            #TD-15169 cur1.execute(sql2)
                            sql= sql + sql2
