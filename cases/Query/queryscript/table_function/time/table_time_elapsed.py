                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,):                          
                            ...
                            sql1 = "select %s from %s where tbname in ('%s_1')  %s order by ts desc ;"  % (func,self.table,self.table,time_window_new) 
                        ...
                        for i in (1,2,3,4,6,7,8,9,21,):                        
                            ...
                            sql2 = "select %s from (select * from %s where tbname in ('%s_1') and  %s %s %s %s %s order by ts ) group by tbname order by ts;" %(func,self.table,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdSql.error(sql2)
                            sql= sql + sql2
                            
                            sql2 = "select %s from (select * from %s where tbname in ('%s_1') and  %s %s %s %s %s group by tbname order by ts ) group by tbname order by ts;" %(func,self.table,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdSql.error(sql2)
                            sql= sql + sql2
                            ...
                            sql1 = "select %s from %s where %s tbname in ('%s_1')  %s order by ts desc ;"  % (func,self.table,interval_fill_and,self.table,time_window_new) 
                            ...
                            sql2 = "select %s from (select * from %s where tbname in ('%s_1') and  %s %s %s %s %s order by ts desc ) group by tbname order by ts desc;" %(func_desc,self.table,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdSql.error(sql2)
                            sql= sql + sql2
                            
                            sql2 = "select %s from (select * from %s where tbname in ('%s_1') and  %s %s %s %s %s group by tbname order by ts desc ) group by tbname order by ts desc;" %(func_desc,self.table,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdSql.error(sql2)
                            sql= sql + sql2
