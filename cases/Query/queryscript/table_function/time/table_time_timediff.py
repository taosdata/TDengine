...
class TDTestQuery(TDCase):
    ...
    def desc(self) -> str:
        case_description = '''
        case1:# support (ts_val1 | datetime_string1 | ts_col1, ts_val2 | datetime_string2 | ts_col2 [, time_unit]) \ support time function [hanshu = ['TIMEDIFF']]
        case2:
        '''
    ...
    def right_case_1_groupby(self):
        ...
        # 1: support time function [hanshu = ['TIMEDIFF']
        for i in (7,8,):
