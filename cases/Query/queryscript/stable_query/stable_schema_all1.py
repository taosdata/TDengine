...
class TDTestQuery(TDCase):
    ...
    def data_create(self,db):  
        ...
        sql = "create database %s replica 3 vgroups 5" %(db)
        self.tdSql.execute('%s' %sql)
    ...
    def ts_4555_create(self):       
        ...
        i11 = random.randint(1000,1100)
        i12 = random.randint(1000,1500)
        i13 = random.randint(1000,2000)
        ...
        try:
            ...
            sql = f'stb{i11+1},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000000'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)            
            sql = f'stb{i11},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000001'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)            
            sql = f'stb{i11-1},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000002'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)
            
            sql = f'stb{i12+1},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000000'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)            
            sql = f'stb{i12},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000001'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)            
            sql = f'stb{i12-1},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000002'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)
            
            sql = f'stb{i13+1},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000000'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)           
            sql = f'stb{i13},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000001'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)            
            sql = f'stb{i13-1},t0=True,t1={i1}i8,t2={i2}i16,t3={i3}i64 c0=f,c1={i1}i8,c2={i2}i16 1626006833639000002'
            self.tdSql._conn.schemaless_insert([sql], TDSmlProtocolType.LINE.value, None)
    ...
    def run(self)-> bool:
        ...
        while 1 : 
            ...
            t16.start()
            t21 = threading.Thread(target=self.ts_4555_create)
            t21.start()       
            t22 = threading.Thread(target=self.ts_4555_create)
            t22.start()        
            t23 = threading.Thread(target=self.ts_4555_create)
            t23.start()
            t24 = threading.Thread(target=self.ts_4555_modify)
            t24.start()       
            t25 = threading.Thread(target=self.ts_4555_modify)
            t25.start()        
            t26 = threading.Thread(target=self.ts_4555_modify)
            t26.start()
