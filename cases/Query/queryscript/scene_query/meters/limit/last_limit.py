...
class TDTestQuery(TDTestQuery):
    ...
    def fun_last(self,dbname,num,num2,tables,per_table_num,dbnamejoin,base_fun,replace_fun):
        ...
        self.logger.info("last query ---------10----------")
        ...
        self.logger.info("last query ---------11----------")
        ...
        self.logger.info("last query ---------12----------")
        ...
        self.logger.info("last query ---------13----------")
        ...
        self.logger.info("last query ---------14----------") 
        ...
        self.logger.info("last query ---------15----------")
        ...
        self.logger.info("last query ---------16----------")
        ...
        self.logger.info("last query ---------17----------")
        ...
        self.logger.info("last query ---------18----------")
        ...
        self.logger.info("last query ---------19----------")
        ...
        self.logger.info("last query ---------20----------") 
        ...
        self.logger.info("last query ---------21----------")
        ...
        self.logger.info("last query ---------22----------")
    ...
    def run_sql(self,dbname,tables,per_table_num,dbnamejoin):
        ...
        #self.fun_last(self.dbname,num,num2,self.tables,self.per_table_num,self.dbnamejoin_local,'last','last')
        self.fun_last(self.dbname,num,num2,self.tables,self.per_table_num,self.dbnamejoin_local,'last','first')
