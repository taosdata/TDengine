...
class TDTestQuery(TDCase):
    ...
    def base_sql_count(self,dbname,table_num,table_per_row):
        ...
        sql = "select count(*) from %s.meters as a join %s.meters as b on a.ts = b.ts" %(dbname,dbname)
        self.tdSql.query(sql)
        self.tdSql.checkData(0,0,table_num*table_per_row*table_num)           
    ...
    def sql_base(self,dbname,num,num2,tables,per_table_num,dbnamejoin):
        ...
        self.join_base(dbname,num,num2,tables,per_table_num,dbnamejoin,'*','*')
