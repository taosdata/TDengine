...
class TDTestQuery(TDCase):
    ...
    def sql_cachemodel_both_none_check(self,sql1):
    ...
    def sql_cachemodel_both_none_desc_check(self,sql1,sql2):
        self.tdSql.execute("alter database %s cachemodel 'last_row' ;" %self.db)
        self.tdSql.execute("reset query cache;")
        ...
        for i in range(col):
            ...
            value_desc = self.tdSql.getData(0,i)
        
            self.tdSql.checkEqual(value_both,value_desc)
    ...
    def run(self)-> bool:
        ...
        #self.sql_cachemodel_both_none_desc_check("select last(*) from %s.stb0 ;"%self.db, "select * from %s.stb0 order by ts desc limit 1;"%self.db)
        ...
        self.sql_cachemodel_both_none_desc_check("select last_row(*) from %s.stb0 ;"%self.db, "select * from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(ts) from %s.stb0 ;"%self.db, "select ts from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(c0) from %s.stb0 ;"%self.db, "select c0 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(c1) from %s.stb0 ;"%self.db, "select c1 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(c2) from %s.stb0 ;"%self.db, "select c2 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(c3) from %s.stb0 ;"%self.db, "select c3 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(c4) from %s.stb0 ;"%self.db, "select c4 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(c5) from %s.stb0 ;"%self.db, "select c5 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(t0) from %s.stb0 ;"%self.db, "select t0 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(t1) from %s.stb0 ;"%self.db, "select t1 from %s.stb0 order by ts desc limit 1;"%self.db)
        self.sql_cachemodel_both_none_desc_check("select last_row(tbname) from %s.stb0 ;"%self.db, "select tbname from %s.stb0 order by ts desc limit 1;"%self.db)
