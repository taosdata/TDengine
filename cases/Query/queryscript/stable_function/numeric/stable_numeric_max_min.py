...
class TDTestQuery(TDCase):
    ...
    #basic_param
    db = "stable_max_min"
    db_1 = "stable_max_min_1"
    db_2 = "stable_max_min_2"
    db_3 = "stable_max_min_3"
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,22,62,72,82,92,31,32,33,34,35,):  
                            ...
                            sql2 = "select %s from (select * from %s where  %s %s %s %s %s order by ts ) order by ts" %(func,self.table,interval_fill_ts_equal_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdSql.error(sql2)
                            sql= sql + sql2
                        ...
                        for i in (61,71,81,91,):   
                            ...
                            sql2 = "select %s from (select * from %s where  %s %s %s %s %s order by ts ) order by ts" %(func,self.table,interval_fill_f_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdSql.error(sql2)
                            sql= sql + sql2
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,22,62,72,82,92,31,32,33,34,35,):  
                            ...
                            time_window_new = tdWhere.time_window_new(i)
                            self.logger.info("\n\n\n=====right case========case3====time num = %d======interval======\n\n\n" %i)
                            sql1 = 'select %s from %s %s %s order by ts ;'  % (func,self.table,interval_fill_ts_equal_and,time_window_new)
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,31,32,33,34,35,):                        
                            ...
                            sql2 = "select ts,%s from (select * from %s order by ts ) where  %s %s %s %s order by ts limit 10;" %(func,self.table,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.dataequal('%s' %sql1 ,1,2,'%s' %sql2 ,1,2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in (1,2,3,4,6,7,8,9,21,):                           
                            ...
                            sql2 = "select _wstart,%s from (select * from %s order by ts ) where %s  %s %s %s %s order by _wstart limit 10;" %(func,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.dataequal('%s' %sql1 ,1,2,'%s' %sql2 ,1,2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2                                                  
                        ...
                        for i in (1,2,3,4,21,22,62,72,82,92,31,32,33,34,35,):  
                            ...
                            sql2 = "select _wstart,%s from (select * from %s order by ts ) where %s  %s %s %s %s order by _wstart limit 10;" %(func,self.table,interval_fill_ts_equal_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.result_0(sql2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in (61,71,81,91,):   
                            ...
                            sql2 = "select _wstart,%s from (select * from %s order by ts ) where %s  %s %s %s %s order by _wstart limit 10;" %(func,self.table,interval_fill_f_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.dataequal('%s' %sql1 ,1,2,'%s' %sql2 ,1,2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in (22,):                        
                            ...
                            sql2 = "select ts,%s from (select * from %s order by ts) where %s  %s %s %s %s order by ts limit 10;" %(func,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.dataequal('%s' %sql1 ,1,2,'%s' %sql2 ,1,2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
