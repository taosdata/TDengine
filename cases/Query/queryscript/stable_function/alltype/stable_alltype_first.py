...
class TDTestQuery(TDCase):
    ...
    db_1 = "stable_first_1"
    db_2 = "stable_first_2"
    db_2_1 = "stable_first_2_1"
    db_2_2 = "stable_first_2_2"
    db_3 = "stable_first_3"
    ...
    def right_case_2_interval(self):
        ...
        for i in (111,):
            ...
            try:
                ...
                #             sql2 = "select %s from (select * from %s where  %s %s %s %s %s order by ts desc ) order by ts desc;" %(func,self.table,interval_fill_ts_equal_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                #             self.tdSql.error(sql2)
                #             sql= sql + sql2
                ...
                #             sql2 = "select %s from (select * from %s where  %s %s %s %s %s order by ts desc ) order by ts desc;" %(func,self.table,interval_fill_f_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                #             self.tdSql.error(sql2)
                #             sql= sql + sql2
