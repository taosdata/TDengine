                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (6,7,8,9,21,22,):                     
                            ...
                            #TD-14911  self.tdCreateData.data_matrix_equal('%s' %sql1 ,1,1,1,2,'%s' %sql2 ,1,1,1,2)
                            #cur1.execute(sql2)
                            sql= sql + sql2
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (6,7,8,9,21,22,):                        
                            ...
                            #TD-14782 self.tdCreateData.data_matrix_equal('%s' %sql1 ,1,1,1,2,'%s' %sql2 ,1,1,1,2)
                            #cur1.execute(sql2)
                            sql= sql + sql2
