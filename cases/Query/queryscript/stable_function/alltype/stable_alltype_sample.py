                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,):                        
                            ...
                            #self.tdCreateData.data_matrix_equal('%s' %sql1 ,1,2,1,3,'%s' %sql2 ,1,2,1,3)
                            cur1.execute(sql2)
                            sql= sql + sql2
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,):                        
                            ...
                            n = random.randrange(2,1001) 
                            func = func.replace("num","%d" %n)
                            sql1 = "select %s from %s where tbname in ('%s_1') %sgroup by tbname ;"  % (func,self.table,self.table,time_window_new)
