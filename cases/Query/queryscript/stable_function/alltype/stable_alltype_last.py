    ...
    def right_case_2_interval(self):
        ...
        for i in (121,):
            ...
            try:
                ...
                self.tdSql.execute('use %s;' %self.db_2_1)             
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,31,32,33,34,35,):                        
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s order by ts" %(func,self.table,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.dataequal('%s' %sql1 ,1,1,'%s' %sql2 ,1,1)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in (1,2,3,4,6,7,8,9,21):                        
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s %s order by ts" %(func,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.ignore_error_check(self.service_host,self.db_2_1,sql1,sql2)
                            sql= sql + sql2
                        ...
                        for i in (1,2,3,4,21,22,62,72,82,92,31,32,33,34,35,):  
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s %s order by ts" %(func,self.table,interval_fill_ts_equal_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.result_0(sql2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in  (61,71,81,91,):   
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s %s order by ts" %(func,self.table,interval_fill_f_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.ignore_error_check(self.service_host,self.db_2_1,sql1,sql2)
                            sql= sql + sql2
                ...
                #             sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s order by ts desc" %(func,self.table,qt_where,qt_like_match,qt_in_where,time_window_new)
                #             self.tdCreateData.dataequal('%s' %sql1 ,1,1,'%s' %sql2 ,1,1)
                #             cur1.execute(sql2)
                #             self.tdCreateData.explain_sql(sql2)
                #             sql= sql + sql2
                ...
                #             sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s %s order by ts desc;" %(func,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                #             self.tdCreateData.ignore_error_check(self.service_host,self.db_2_1,sql1,sql2)
                #             sql= sql + sql2
                ...
                #             sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s %s order by ts desc;" %(func,self.table,interval_fill_ts_equal_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                #             self.tdCreateData.result_0(sql2)
                #             cur1.execute(sql2)
                #             self.tdCreateData.explain_sql(sql2)
                #             sql= sql + sql2
                ...
                #             sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s %s order by ts desc;" %(func,self.table,interval_fill_f_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                #             self.tdCreateData.ignore_error_check(self.service_host,self.db_2_1,sql1,sql2)
                #             sql= sql + sql2
                ...
                for i in range(2,len(stable_where[2])+1):
                    ...
                    for qt_where in qt_where:
                        ...
                        for i in (1,2,3,4,21,31,32,33,34,35,):                        
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where  %s %s %s %s order by ts limit 10;" %(func,self.table,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.dataequal('%s' %sql1 ,1,1,'%s' %sql2 ,1,1)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in (1,2,3,4,6,7,8,9,21,):                        
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where %s  %s %s %s %s order by ts limit 10;" %(func,self.table,interval_fill_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.ignore_error_check(self.service_host,self.db_3,sql1,sql2)
                            sql= sql + sql2
                        ...
                        for i in (1,2,3,4,21,22,62,72,82,92,31,32,33,34,35,):  
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where %s  %s %s %s %s order by ts limit 10;" %(func,self.table,interval_fill_ts_equal_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.result_0(sql2)
                            cur1.execute(sql2)
                            self.tdCreateData.explain_sql(sql2)
                            sql= sql + sql2
                        ...
                        for i in  (61,71,81,91,):   
                            ...
                            sql2 = "select %s from (select * from %s order by ts) where %s  %s %s %s %s order by ts limit 10;" %(func,self.table,interval_fill_f_and,qt_where,qt_like_match,qt_in_where,time_window_new)
                            self.tdCreateData.ignore_error_check(self.service_host,self.db_3,sql1,sql2)
                            sql= sql + sql2
