...
class TestAutoCreateTable(TDCase):
    ...
    def check_col_value_for_auto_create_table(self):
        ...
        self.tdRest.request(f'insert into {dbname}.t4 using {dbname}.stb(t11, t12) tags(41, 42) (c11, c12) values (41, 42)')
        # no values
    ...
    def check_multi_cols_for_auto_create_table(self):
        ...
        self.tdRest.request(f'insert into {dbname}.t3 using {dbname}.stb(t11, t12) tags(11, 12) (ts, c11, c12) values (now-7m, 11, 21)(now-8m, 11, 21)')
        ...
        self.tdRest.request(f'select count(*) from {dbname}.stb')
        self.tdSql.checkEqual(self.tdRest.resp[0][0], 6)
        self.tdRest.request(f'drop database if exists {dbname}')
