...
class TestErrorInsert(TDCase):
    ...
    def illegal_insertsql_check(self):
        ...
        self.tdRest.request(f'create table if not exists {dbname}.tb (col_ts timestamp, c1 tinyint, c2 smallint, c3 int, c4 bigint, c5 tinyint unsigned, c6 smallint unsigned, \
    ...
    def type_mismatch_check(self):
        ...
        self.tdRest.request(f'create table if not exists {dbname}.ctb using {dbname}.stb tags (now, 1, 2, 3, 4, 5, 6, 7, 8, 9.9, 10.1, "binary", "nchar", True)')
