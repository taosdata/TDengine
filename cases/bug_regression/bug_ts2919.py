...
class TestTs2919(TDCase):
    ...
    def run(self):
        ...
        self.tdSql.execute('create stream nginx_avg_1 into test_ts2919.nginx_avg_output subtable(short_request) as select _wstart as start_time, _wend as end_time, short_request, short_request1, avg(upstream_response) as avg_response from test_ts2919.nginx partition by short_request,short_request1 interval(1m);')
        for i in range(25):
            for j in range(20):
