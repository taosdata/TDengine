...
class TestTs2912(TDCase):
    ...
    def insert_data(self):
        ...
        try:
            ...
            stmt.execute()
            self.tdSql.execute(f'alter stable power.meters modify column var_val binary(10)')
    ...
    def insert_data_notb(self):
        ...
        try:
            ...
            stmt.execute()
            self.tdSql.execute(f'alter stable power.meters modify column var_val binary(15)')
