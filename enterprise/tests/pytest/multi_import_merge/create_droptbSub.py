...
class TDTestCase:
  ...
  def run(self):
    ...
    tdLog.info("================= step4")
    tdLog.info("import 5 data totally repetitive into the left %d tables" %(9))
    startTime = self.startTime 
    ...
    tdLog.info("================= step6")
    tdLog.info("import 5 data totally repetitive into each %d tables" %(self.ntables))
    startTime = self.startTime
    ...
    tdLog.info("================= step8")
    tdLog.info("import 5 data totally repetitive into each left %d tables" %(9))
    startTime = self.startTime
