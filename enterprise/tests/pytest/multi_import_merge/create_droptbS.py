...
class TDTestCase:
  ...
  def run(self):
    ...
    tdLog.info("================= step4")
    tdLog.info("import 12 data covering the existing data into the left %d tables" %(9))
    ...
    tdLog.info("================= step6")
    tdLog.info("import 14 data covering the existing data into each %d tables" %(self.ntables))
    startTime = self.startTime - 1
    ...
    tdLog.info("================= step8")
    tdLog.info("import 16 data covering the existing data into each left %d tables" %(9))
    startTime = self.startTime - 1
    ...
    tdLog.info("================= step10")
    tdLog.info("import 18 data covering the existing data into each %d tables" %(self.ntables))
    startTime = self.startTime - 1
    ...
    tdLog.info("================= step12")
    tdLog.info("import 20 data covering the existing data into each left %d tables" %(9))
    startTime = self.startTime - 1
    ...
    tdLog.info("================= step14")
    tdLog.info("import 22 data covering the existing data into each %d tables" %(self.ntables))
    startTime = self.startTime - 1
