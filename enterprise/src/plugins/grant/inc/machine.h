...
#define GRANT_MACHINE_FLAG_CPU           0x01
#define GRANT_MACHINE_FLAG_SYS           0x02
#define GRANT_MACHINE_FLAG_MAC           0x04

#define GRANT_ACTIVE_SKIP_FAIL_OLD       0x01
#define GRANT_ACTIVE_CHECK_MACHINE       0x02
