...
class ClusterComCheck:
        ...
        while count < count_number:
            ...
            if self.db_replica == 1:
                ...
                vgroup_status_first = [
                    ...
                    tdSql.queryResult[0][6],
                    tdSql.queryResult[0][8],
                ]

                vgroup_status_last = [
                    tdSql.queryResult[last_number][4],
                    tdSql.queryResult[last_number][6],
                    tdSql.queryResult[last_number][8],
                ]
                if (
    ...
    def check_stream_status(self, stream_name=""):
    ...
    def drop_all_streams_and_dbs(self):
