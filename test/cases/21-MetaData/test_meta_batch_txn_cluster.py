...
class TestBatchMetaTxnCluster:
    ...
    def test_meta_batch_txn_cluster(self):
        ...
        History:
            ...
            - 2026-05-11 Added PRE_ALTER × snapshot rescue tests (s70-s71)
        ...
        70. PRE_ALTER × snapshot rescue → COMMIT (old-ver row injected in snapshot)
        71. PRE_ALTER × snapshot rescue → ROLLBACK (reverts to original schema)
        """
