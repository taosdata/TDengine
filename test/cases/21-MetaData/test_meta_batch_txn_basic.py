...
# -*- coding: utf-8 -*-
"""
Batch meta txn: basic lifecycle tests (s1-s44).
...
Tests cover single-session DDL lifecycle with COMMIT/ROLLBACK:
  ...
  - Normal table and empty transaction (s15-s17)
  - Cross-vgroup transactions (s18-s19)
  - Sequential transactions, batch syntax (s20-s22)
  - Super table (STB) lifecycle: CREATE/DROP/ALTER with COMMIT/ROLLBACK (s23-s37)
  - DDL chains: CREATE→DROP→re-CREATE, CREATE→ALTER→DROP (s38-s43)
  - Same-txn data ops: DESC, INSERT blocking, SELECT on committed data (s44)
"""
...
class TestBatchMetaTxnBasic:
    ...
    def test_meta_batch_txn_basic(self):
        """Batch meta txn: basic lifecycle (s1-s44)
        ...
        15. table_create_commit
        16. table_create_rollback
        17. transaction
        18. vgroup_commit
        19. vgroup_rollback
        20. transactions
        ...
        25. isolation
        26. txn_stb_child
        27. txn_stb_child_rollback
        28. table_desc_in_txn
        29. create_table_ctb_in_txn
        30. stb_child_normal_alter
        31. stb_commit
        32. stb_rollback
        33. stb_commit
        34. stb_rollback
        35. stb_isolation
        36. stb_isolation
        37. stb_catalog_isolation
        38. drop_recreate_commit
        39. drop_recreate_rollback
        40. alter_drop_commit
        41. alter_drop_rollback
        42. alter_drop_commit
        43. alter_drop_rollback
        44. txn_data_ops
