...
class TestFuncAvg:
    ...
    def test_func_avg(self):
        ...
        Test the AVG function, including time windows, filtering on ordinary data columns, filtering on tag columns, GROUP BY, and PARTITION BY.
        ...
        History:
            - 2025-4-28 Simon Guan Migrated from tsim/compute/avg.sim
