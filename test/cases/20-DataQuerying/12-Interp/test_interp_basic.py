...
class TestInterpBasic:
    ...
    def test_interp_basic(self):
        ...
        1. Basic INTERP queries
        2. Including RANGE and EVERY clauses
        3. Including FILL modes like PREV, LINEAR, NULL, VALUE
        4. INTERP queries used as subqueries
        5. Single INTERP query covering multiple columns
