...
class TestInsertSelect:
    ...
    def test_insert_stb_select(self):
        ...
        tdSql.execute(f" INSERT INTO ohlcv_1d(  tbname,ts)  SELECT concat('t_',tbname) as tb,  '2025-12-01T00:00:00.000-05:00' FROM us.ohlcv_1m WHERE symbol = 'AAPL' AND ts >= '2025-12-01T00:00:00.000' AND ts < '2025-12-02T00:00:00.000' PARTITION BY tbname, symbol;")
