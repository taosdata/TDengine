...
class TestShow:
    def setup_class(cls):
        ...
        cls.setsql = TDSetSql()
        cls.ins_param_list = ['dnodes','mnodes','qnodes','cluster','functions','users','grants','topics','subscriptions','streams']
        cls.perf_param = ['apps','connections','consumers','queries','transactions']
