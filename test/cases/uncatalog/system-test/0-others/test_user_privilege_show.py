...
class TestUserPrivilegeShow:
    ...
    def setup_class(cls):
        ...
        # db info
        cls.dbname = "user_privilege_show"
        cls.stbname = 'stb'
        cls.common_tbname = "tb"
        ...
        cls.privilege_check_dic = {}
        cls.senario_type = ["stable", "table", "ctable"]
        cls.priv_type = ["read", "write", "all", "none"]
        # stable senarios
        ...
        st_senarios_list = []
        for senario in list(product(cls.priv_type, repeat=2)):
            expect_res = True
        ...
        cls.privilege_check_dic["ctable"] = ct_senarios_list
    ...
    def test_user_privilege_show(self):
        """summary: xxx

        description: This test case is used to veirfy the show create stable/table command for
