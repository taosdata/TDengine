...
class Test4dnode1mnodeBasicReplica3InsertdatasStopFollowerUnsyncForceStop:
    def setup_class(cls):
    ...
    def test_4dnode1mnode_basic_replica3_insertdatas_stop_follower_unsync_force_stop(self):
        """summary: xxx
