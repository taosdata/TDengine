...
class Test4dnode1mnodeBasicReplica3InsertdatasQuerysLoopRestartAllVnode:
    def setup_class(cls):
        ...
        cls.tb_nums = 10 
        cls.row_nums = 500
        cls.max_restart_time = 20
        cls.restart_server_times = 10
        cls.dnode_index = 0 
    ...
    def test_4dnode1mnode_basic_replica3_insertdatas_querys_loop_restart_all_vnode(self):
        """summary: xxx
