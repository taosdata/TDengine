...
class Test4dnode1mnodeBasicReplica3InsertdatasQuerysLoopRestartFollower:
    def setup_class(cls):
    ...
    def test_4dnode1mnode_basic_replica3_insertdatas_querys_loop_restart_follower(self):
        """summary: xxx
