...
class TestJoin:
    ...
    def setup_class(cls):
        ...
        cls.super_table_names = ["st1", "st2", "st_empty"]
    ...
    def run_join(self, join_type, pk=False):
    ...
    def test_join(self):
        ...
        self.run_join("inner")
        self.run_join("left-outer")
        self.run_join("right-outer")
        self.run_join("full")
        self.run_join("left-semi")
        self.run_join("right-semi")
        self.run_join("left-anti")
        self.run_join("right-anti")
        self.run_join("left-asof")
        self.run_join("right-asof")
        self.run_join("left-window")
        self.run_join("right-window")

        # composite primary key
        self.run_join("pk_int32", pk=True)
        self.run_join("pk_int64", pk=True)
