...
class TestDbCachemodel:
    ...
    def do_cachemodel(self):
        self.illegal_params()
        self.prepare_datas()
        self.check_cachemodel_sets()
        self.restart_check_cachemodel_sets()
        print("do cache mode ......................... [passed]")

    #
    # ------------------- test_last_cache_scan.py ----------------
    #
    def init_class(self):        
        self.vgroups    = 4
        self.ctbNum     = 10
    ...
    def do_last_cache_scan(self):
        ...
        print("do last cache scan .................... [passed]")
    ...
    def test_db_cachemodel(self):
        ...
        History:
            - 2025-11-04 Alex Duan Migrated from uncatalog/system-test/0-others/test_cachemodel.py
            - 2025-11-04 Alex Duan Migrated from uncatalog/system-test/2-query/test_last_cache_scan.py

        """
        self.do_cachemodel()
        self.do_last_cache_scan()
