...
class TestRedistributeVgroupReplica3V2:

    def setup_class(cls):
        tdLog.debug(f"start to execute {__file__}")

    def test_redistribute_vgroup_replica3_v2(self):
        """redistribute vgroup replica3 v2
        ...
        History:
            - 2025-5-6 Simon Guan Migrated to new test framework, from tsim/dnode/redistribute_vgroup_replica3_v2.sim
        ...
        tdLog.info(f"=============== step40:")
        tdLog.info(f"redistribute vgroup 2 dnode {leaderVnode} dnode 5 dnode 6")
        tdSql.execute(f"redistribute vgroup 2 dnode {leaderVnode} dnode 5 dnode 6")
        tdSql.query(f"show d1.vgroups")
        tdLog.info(
            f"===> {tdSql.getData(0,0)} {tdSql.getData(0,1)} {tdSql.getData(0,2)} {tdSql.getData(0,3)} {tdSql.getData(0,4)} {tdSql.getData(0,5)} {tdSql.getData(0,6)} {tdSql.getData(0,7)} {tdSql.getData(0,8)} {tdSql.getData(0,9)}"
        )
        ...
        tdLog.info(f"=============== step41:")
        tdLog.info(f"redistribute vgroup 2 dnode 5 dnode {follower2} dnode {follower1}")
        tdSql.execute(
            f"redistribute vgroup 2 dnode 5 dnode {follower2} dnode {follower1}"
        )
        tdSql.query(f"show d1.vgroups")
        tdLog.info(
            f"===> {tdSql.getData(0,0)} {tdSql.getData(0,1)} {tdSql.getData(0,2)} {tdSql.getData(0,3)} {tdSql.getData(0,4)} {tdSql.getData(0,5)} {tdSql.getData(0,6)} {tdSql.getData(0,7)} {tdSql.getData(0,8)} {tdSql.getData(0,9)}"
        ...
        tdLog.info(f"=============== step42:")
        tdLog.info(
            f"redistribute vgroup 2 dnode {follower2} dnode 6 dnode {leaderVnode}"
        )
        tdSql.execute(
            f"redistribute vgroup 2 dnode {follower2} dnode 6 dnode {leaderVnode}"
        )
        ...
        tdLog.info(f"=============== step43:")
        tdLog.info(f"redistribute vgroup 2 dnode {follower1} dnode 5 dnode 6")
        tdSql.execute(f"redistribute vgroup 2 dnode {follower1} dnode 5 dnode 6")
        tdSql.query(f"show d1.vgroups")
        tdLog.info(
            f"===> {tdSql.getData(0,0)} {tdSql.getData(0,1)} {tdSql.getData(0,2)} {tdSql.getData(0,3)} {tdSql.getData(0,4)} {tdSql.getData(0,5)} {tdSql.getData(0,6)} {tdSql.getData(0,7)} {tdSql.getData(0,8)} {tdSql.getData(0,9)}"
        )
        ...
        tdLog.info(f"=============== step44:")
        tdLog.info(
            f"redistribute vgroup 2 dnode {follower2} dnode 5 dnode {leaderVnode}"
        )
        tdSql.execute(
            f"redistribute vgroup 2 dnode {follower2} dnode 5 dnode {leaderVnode}"
        )
        ...
        tdLog.info(f"=============== step45:")
        tdLog.info(
            f"redistribute vgroup 2 dnode {leaderVnode} dnode {follower1} dnode 6"
        )
        tdSql.execute(
            f"redistribute vgroup 2 dnode {leaderVnode} dnode {follower1} dnode 6"
        )
        ...
        tdLog.info(f"=============== step47:")
        tdLog.info(
            f"redistribute vgroup 2 dnode {follower1} dnode 6 dnode {leaderVnode}"
        )
        tdSql.execute(
            f"redistribute vgroup 2 dnode {follower1} dnode 6 dnode {leaderVnode}"
        )
