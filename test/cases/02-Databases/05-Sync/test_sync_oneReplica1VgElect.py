...
class TestSyncOneReplica1VgElect:

    def setup_class(cls):
        tdLog.debug(f"start to execute {__file__}")

    def test_sync_oneReplica1VgElect(self):
        """sync One Replica1 Vg Elect
        ...
        History:
            - 2025-5-5 Simon Guan Migrated from tsim/sync/oneReplica1VgElect.sim
