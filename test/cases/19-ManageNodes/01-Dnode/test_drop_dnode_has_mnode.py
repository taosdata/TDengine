...
class TestDropDnodeHasMnode:
    ...
    def test_drop_dnode_has_mnode(self):
        ...
        History:
            - 2025-5-6 Simon Guan Migrated to new test framework, from tsim/dnode/drop_dnode_has_mnode.sim
...
step3:
	...
	if x == 10 "":
        ...
        tdSql.query(f"select * from information_schema.ins_mnodes -x step3")
