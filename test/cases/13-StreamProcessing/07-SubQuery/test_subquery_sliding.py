...
class TestStreamSubquerySliding:
    ...
    def createStreams(self):
        ...
        stream = StreamItem(
            ...
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
        ...
        stream = StreamItem(
            id=20,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers partition by c1, c2 as select _wend tw, count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=21,
            stream="create stream rdb.s0 sliding(5m) from tdb.n1 into rdb.r0 as select _wend tw, count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=22,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers into rdb.r0 as select _wend tw, count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=23,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers partition by tbname into rdb.r0 as select _wend tw, count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=24,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers partition by id into rdb.r0 as select _wend tw, count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=39,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers into rdb.r0 as select _tnext_ts tn, TIMETRUNCATE(_tnext_ts, '1d'), count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=40,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers partition by tbname into rdb.r0 as select _tnext_ts tn, TIMETRUNCATE(_tnext_ts, '1d'), count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
        ...
        stream = StreamItem(
            id=41,
            stream="create stream rdb.s0 interval(5m) sliding(5m) from tdb.triggers partition by id into rdb.r0 as select _tnext_ts tn, TIMETRUNCATE(_tnext_ts, '1d'), count(*) c1, _tgrpid tg, _tlocaltime tl  from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000' partition by %%1",
            res_query="select count(*) cnt from rdb.r1 interval(5m)",
            exp_query="select count(*) cnt from qdb.meters where ts >= '2025-01-01 00:00:00.000' and ts < '2025-01-01 00:05:00.000'",
            exp_rows=(0 for _ in range(12)),
        )
