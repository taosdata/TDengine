...
=======
            id=0,
            stream="create stream rdb.s0 count(1, c1) from tdb.triggers into rdb.r0 as select _twstart ts, _twstart + 5m te, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m;",
        ...
        stream = StreamItem(
            id=2,
            stream="create stream rdb.s2 count(1, c1) from tdb.triggers partition by tbname into rdb.r2 as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, _tlocaltime tl, tbname tb, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null partition by tbname",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s3 count(1, c1) from tdb.triggers partition by tbname into rdb.r3 as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, _tlocaltime tl, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s4 count(1, c1) from tdb.triggers partition by tbname into rdb.r4 as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, _tlocaltime tl, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null and tbname=%%tbname",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=5,
<<<<<<< HEAD
            stream="create stream rdb.s5 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r5 as select _twstart ts, _twend te, _twduration td, _twrownum tw, %%tbname as tb, count(c1) c1, avg(c2) c2 from %%tbname where ts >= _twstart and ts < _twend",
=======
            stream="create stream rdb.s5 count(1, c1) from tdb.triggers partition by tbname into rdb.r5 as select _twstart ts, _twend te, _twduration td, _twrownum tw, %%tbname as tb, count(c1) c1, avg(c2) c2 from %%tbname where ts >= _twstart and ts < _twend",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s6 count(1, c1) from tdb.triggers partition by tbname into rdb.r6 as select _twstart ts, count(c1), avg(c2) from %%trows where ts >= _twstart and ts < _twend partition by tbname",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s7 count(1, c1) from tdb.triggers partition by tbname into rdb.r7 as select _twstart ts, count(c1), avg(c2) from %%tbname where ts >= _twstart and ts < _twend and %%tbname = tbname",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s8 count(1, c1) from tdb.triggers partition by tbname into rdb.r8 as select _twstart ts, count(c1), avg(c2) from %%trows where ts >= _twstart and ts < _twend partition by %%1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=9,
<<<<<<< HEAD
            stream="create stream rdb.s9 count_window(2, c1) from tdb.triggers partition by id into rdb.r9 tags(gid bigint as _tgrpid, id int as %%1) as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, _tlocaltime tl, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null;",
=======
            stream="create stream rdb.s9 count(1, c1) from tdb.triggers partition by id into rdb.r9 tags(gid bigint as _tgrpid, id int as %%1) as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, _tlocaltime tl, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s10 count(1, c1) from tdb.triggers partition by id, tbname into rdb.r10 as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, cast(_tlocaltime % 1000000 as timestamp) tl, %%1 t1_data, %%2 t2_data, %%tbname tb_data, count(cint) c1_data, avg(cint) c2_data from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null and tbname = %%2;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=11,
<<<<<<< HEAD
            stream="create stream rdb.s11 count_window(2, c1) from tdb.n1 into rdb.r11 as select _tcurrent_ts tc, _tprev_ts tp, _tnext_ts tn, _tgrpid tg, _tlocaltime tl, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _tcurrent_ts and cts < _tnext_ts and _tgrpid is not null and _tlocaltime is not null and tbname != 't1';",
=======
            stream="create stream rdb.s11 count(1, c1) from tdb.n1 into rdb.r11 as select _tcurrent_ts tc, _tprev_ts tp, _tnext_ts tn, _tgrpid tg, _tlocaltime tl, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _tcurrent_ts and cts < _tnext_ts and _tgrpid is not null and _tlocaltime is not null and tbname != 't1';",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s12 count(1, c1) from tdb.triggers partition by tbname into rdb.r12 as select _twstart ts, %%tbname tb, %%1, count(*) v1, avg(c1) v2, first(c1) v3, last(c1) v4 from %%trows where c2 > 0;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s13 count(1, c1) from tdb.triggers partition by tbname into rdb.r13 as select _twstart ts, _twend te, _twduration td, _twrownum tw, _tgrpid tg, _tlocaltime tl, %%1 t1 , %%tbname t2, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _twduration is not null and _twrownum is not null and _tgrpid is not null and _tlocaltime is not null and %%1 = tbname and %%tbname = tbname;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s14 count(1, c1) from tdb.triggers partition by id, tbname into rdb.r14 as select _twstart ts, %%tbname t1, %%1 t2, count(*) c1, avg(c1) c2, first(c1) c3, last(c1) c4 from %%trows;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=15,
<<<<<<< HEAD
            stream="create stream rdb.s15 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r15 as select _wstart, sum(cint), FIRST(cint) from qdb.meters where cts >= _twstart and cts <_twend interval(150s)",
=======
            stream="create stream rdb.s15 count(1, c1) from tdb.triggers partition by tbname into rdb.r15 as select _wstart, sum(cint), FIRST(cint) from qdb.meters where cts >= _twstart and cts <_twend interval(150s)",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=16,
<<<<<<< HEAD
            stream="create stream rdb.s16 count_window(2, c1) from tdb.n1 into rdb.r16 as select _tcurrent_ts ts, count(*) c1, avg(cint) c2, _tcurrent_ts + 1 as ts2, _tgrpid from qdb.meters where tbname = 't1' partition by tbname;",
=======
            stream="create stream rdb.s16 count(1, c1) from tdb.n1 into rdb.r16 as select _tcurrent_ts ts, count(*) c1, avg(cint) c2, _tcurrent_ts + 1 as ts2, _tgrpid from qdb.meters where tbname = 't1' partition by tbname;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=17,
<<<<<<< HEAD
            stream="create stream rdb.s17 count_window(2, c1) from tdb.triggers into rdb.r17 as select _wstart, sum(cint), FIRST(cint) from qdb.meters interval(5m)",
=======
            stream="create stream rdb.s17 count(1, c1) from tdb.triggers into rdb.r17 as select _wstart, sum(cint), FIRST(cint) from qdb.meters interval(5m)",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=18,
<<<<<<< HEAD
            stream="create stream rdb.s18 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r18 tags(t1 int as %%1, t2 int as cast(%%2 as int)) as select _twstart c1, first(tw) c2, last(te) c3, count(tb) c4, sum(cnt) c5 from (select _wstart tw, _wend te, tbname tb, count(*) cnt from qdb.meters where cts >= _twstart and cts <_twend and tint=%%1 partition by tbname count_window(1000))",
=======
            stream="create stream rdb.s18 count(1, c1) from tdb.triggers partition by id, name into rdb.r18 tags(t1 int as %%1, t2 int as cast(%%2 as int)) as select _twstart c1, first(tw) c2, last(te) c3, count(tb) c4, sum(cnt) c5 from (select _wstart tw, _wend te, tbname tb, count(*) cnt from qdb.meters where cts >= _twstart and cts <_twend and tint=%%1 partition by tbname count_window(1000))",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=19,
<<<<<<< HEAD
            stream="create stream rdb.s19 count_window(2, c1) from tdb.triggers partition by id into rdb.r19 as select _twend tw, sum(c1) sumcnt from (select tbname, count(*) c1 from qdb.meters where cts >= '2025-01-01 00:00:00.000' and cts < '2025-01-01 00:05:00.000' and tint=%%1 partition by tbname)",
=======
            stream="create stream rdb.s19 count(1, c1) from tdb.triggers partition by id into rdb.r19 as select _twend tw, sum(c1) sumcnt from (select tbname, count(*) c1 from qdb.meters where cts >= '2025-01-01 00:00:00.000' and cts < '2025-01-01 00:05:00.000' and tint=%%1 partition by tbname)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s20 count(1, c1) from tdb.triggers partition by id, name into rdb.r20 as select _twend tw, count(*) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= '2025-01-01 00:00:00.000' and cts < '2025-01-01 00:05:00.000' and tint=%%1;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=21,
<<<<<<< HEAD
            stream="create stream rdb.s21 count_window(2, c1) from tdb.n1 into rdb.r21 as select _tcurrent_ts tw, count(*) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= '2025-01-01 00:00:00.000' and cts < '2025-01-01 00:05:00.000'",
=======
            stream="create stream rdb.s21 count(1, c1) from tdb.n1 into rdb.r21 as select _tcurrent_ts tw, count(*) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= '2025-01-01 00:00:00.000' and cts < '2025-01-01 00:05:00.000'",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=22,
<<<<<<< HEAD
            stream="create stream rdb.s22 count_window(2, c1) from tdb.triggers into rdb.r22 as select _twend tw, sum(cint) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= _twstart and cts < _twstart + 5m",
=======
            stream="create stream rdb.s22 count(1, c1) from tdb.triggers into rdb.r22 as select _twend tw, sum(cint) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= _twstart and cts < _twstart + 5m",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=23,
<<<<<<< HEAD
            stream="create stream rdb.s23 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r23 as select _twend tw, sum(cint) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname=%%tbname partition by tbname",
=======
            stream="create stream rdb.s23 count(1, c1) from tdb.triggers partition by tbname into rdb.r23 as select _twend tw, sum(cint) c1, _tgrpid tg, _tlocaltime tl from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname=%%tbname partition by tbname",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=24,
<<<<<<< HEAD
            stream="create stream rdb.s24 count_window(2, c1) from tdb.triggers partition by id into rdb.r24 as select _twend tw, sum(cint) c1, %%1 c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tint=%%1 partition by tint",
=======
            stream="create stream rdb.s24 count(1, c1) from tdb.triggers partition by id into rdb.r24 as select _twend tw, sum(cint) c1, %%1 c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tint=%%1 partition by tint",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s25 count(1, c1) from tdb.triggers partition by id, name into rdb.r25 as select _twstart tw, sum(cint) c1, %%1 c2, %%2 c3 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tint=%%1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=26,
<<<<<<< HEAD
            stream="create stream rdb.s26 count_window(2, c1) from tdb.triggers into rdb.r26 as select _twstart tw, sum(cint) c1, tbname from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname='t18' partition by tbname",
=======
            stream="create stream rdb.s26 count(1, c1) from tdb.triggers into rdb.r26 as select _twstart tw, sum(cint) c1, tbname from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname='t18' partition by tbname",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=27,
<<<<<<< HEAD
            stream="create stream rdb.s27 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r27 as select _tcurrent_ts tw, sum(cint) c1, count(cint) c2 from qdb.meters where cts >= _tcurrent_ts and cts < _tnext_ts and tbname=%%1",
=======
            stream="create stream rdb.s27 count(1, c1) from tdb.triggers partition by tbname into rdb.r27 as select _tcurrent_ts tw, sum(cint) c1, count(cint) c2 from qdb.meters where cts >= _tcurrent_ts and cts < _tnext_ts and tbname=%%1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=28,
<<<<<<< HEAD
            stream="create stream rdb.s28 count_window(2, c1) from tdb.triggers partition by id into rdb.r28 as select _twstart ts, `name` as cname, `super` csuper, create_time cctime, %%1 from information_schema.ins_users",
=======
            stream="create stream rdb.s28 count(1, c1) from tdb.triggers partition by id into rdb.r28 as select _twstart ts, `name` as cname, `super` csuper, create_time cctime, %%1 from information_schema.ins_users",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=29,
<<<<<<< HEAD
            stream="create stream rdb.s29 count_window(2, c1) from tdb.t1 into rdb.r29 as select _wstart, sum(cint), avg(cint) from qdb.meters where cts >= _twstart and cts < _twstart + 5m interval(1m);",
=======
            stream="create stream rdb.s29 count(1, c1) from tdb.t1 into rdb.r29 as select _wstart, sum(cint), avg(cint) from qdb.meters where cts >= _twstart and cts < _twstart + 5m interval(1m);",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s30 count(1, c1) from tdb.n1 into rdb.r30 as select _wstart, sum(cint), FIRST(cint) from qdb.meters interval(2m)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s31 count(1, c1) from tdb.triggers partition by tbname into rdb.r31 as select _tprev_ts tp, _tcurrent_ts tc, _tnext_ts tn, _tgrpid tg, cast(_tlocaltime as bigint) tl, %%1 tg1, %%tbname tb, count(cint) c1, avg(cint) c2 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and _tprev_ts > '2024-12-30' and _tcurrent_ts > '2024-12-30' and _tnext_ts > '2024-12-30' and _tgrpid is not null and _tlocaltime is not null and %%1 != '1' and %%tbname != '1';",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=32,
<<<<<<< HEAD
            stream="create stream rdb.s32 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r32 as select _wstart, sum(cint), avg(cint) from qdb.meters where tbname != %%tbname and cts >= _twstart and cts < _twstart + 5m interval(1m);",
=======
            stream="create stream rdb.s32 count(1, c1) from tdb.triggers partition by tbname into rdb.r32 as select _wstart, sum(cint), avg(cint) from qdb.meters where tbname != %%tbname and cts >= _twstart and cts < _twstart + 5m interval(1m);",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=33,
<<<<<<< HEAD
            stream="create stream rdb.s33 count_window(2, c1) from tdb.triggers partition by id into rdb.r33 tags(tbn varchar(128) as cast(%%1 as varchar)) as select _twstart, sum(cint), avg(cint) from qdb.meters where tint=%%1 and cts >= _twstart and cts < _twstart + 5m interval(1m);",
=======
            stream="create stream rdb.s33 count(1, c1) from tdb.triggers partition by id into rdb.r33 tags(tbn varchar(128) as cast(%%1 as varchar)) as select _twstart, sum(cint), avg(cint) from qdb.meters where tint=%%1 and cts >= _twstart and cts < _twstart + 5m interval(1m);",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=34,
<<<<<<< HEAD
            stream="create stream rdb.s34 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r34 as select _tprev_ts tc, TIMEDIFF(_tprev_ts, _tnext_ts) tx, %%tbname tb, %%1 tg1, sum(c1) c1, avg(c2) c2, first(c1) c3, last(c2) c4 from %%trows where c1 > 0;",
=======
            stream="create stream rdb.s34 count(1, c1) from tdb.triggers partition by tbname into rdb.r34 as select _tprev_ts tc, TIMEDIFF(_tprev_ts, _tnext_ts) tx, %%tbname tb, %%1 tg1, sum(c1) c1, avg(c2) c2, first(c1) c3, last(c2) c4 from %%trows where c1 > 0;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s35 count(1, c1) from tdb.triggers partition by id, name into rdb.r35 as select _wstart ts, count(c1) c1, sum(c2) c2, %%1 c3, %%2 c4, cast(_tlocaltime / 1000000 as timestamp) c5, _tgrpid c6 from %%trows count_window(2);",
>>>>>>> feat/TS-6100-3.0
...
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=37,
<<<<<<< HEAD
            stream="create stream rdb.s37 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r37 as select _twstart ts, _twend, count(c1), sum(c2) from %%trows",
=======
            stream="create stream rdb.s37 count(1, c1) from tdb.triggers partition by id, name into rdb.r37 as select _twstart ts, _twend, count(c1), sum(c2) from %%trows",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s38 count(1, c1) from tdb.triggers partition by tbname into rdb.r38 as select _twstart ts, _irowts, _isfilled, interp(c1), _irowtsorigin, _twend, _twduration, _twrownum from %%trows RANGE(_twend) FILL(linear);",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=39,
<<<<<<< HEAD
            stream="create stream rdb.s39 count_window(2, c1) from tdb.triggers into rdb.r39 as select _tnext_ts tn, TIMETRUNCATE(_tnext_ts, 1d) tnt, sum(cint) c1, _tgrpid tg, TIMETRUNCATE(cast(_tlocaltime /1000000 as timestamp), 1d) tl from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tint = 1 partition by tint",
=======
            stream="create stream rdb.s39 count(1, c1) from tdb.triggers into rdb.r39 as select _tnext_ts tn, TIMETRUNCATE(_tnext_ts, 1d) tnt, sum(cint) c1, _tgrpid tg, TIMETRUNCATE(cast(_tlocaltime /1000000 as timestamp), 1d) tl from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tint = 1 partition by tint",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s40 count(1, c1) from tdb.triggers partition by tbname into rdb.r40 as select _twstart, table_name, db_name, stable_name, tag_name, tag_value from information_schema.ins_tags where table_name='j0' and stable_name='jmeters' and tag_name='tjson'",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=41,
<<<<<<< HEAD
            stream="create stream rdb.s41 count_window(2, c1) from tdb.triggers partition by id into rdb.r41 as select cts, cint, cbool, cast(tjson->'k1' as varchar(8)) cjson, _twstart from qdb.j0 where cts >= _twstart and cts < _twstart + 5m and cbool = %%1 order by cts limit 2, 3",
=======
            stream="create stream rdb.s41 count(1, c1) from tdb.triggers partition by id into rdb.r41 as select cts, cint, cbool, cast(tjson->'k1' as varchar(8)) cjson, _twstart from qdb.j0 where cts >= _twstart and cts < _twstart + 5m and cbool = %%1 order by cts limit 2, 3",
>>>>>>> feat/TS-6100-3.0
...
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=43,
<<<<<<< HEAD
            stream="create stream rdb.s43 count_window(2, c1) from tdb.triggers partition by id into rdb.r43 as select _twstart ts, cts, %%1 tt, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary from qdb.v1 where cts >= _twstart and cts < _twstart + 5m order by cts limit 1",
=======
            stream="create stream rdb.s43 count(1, c1) from tdb.triggers partition by id into rdb.r43 as select _twstart ts, cts, %%1 tt, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary from qdb.v1 where cts >= _twstart and cts < _twstart + 5m order by cts limit 1",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s44 count(1, c1) from tdb.triggers partition by tbname into rdb.r44 as select _twstart ts, cts, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary, cgeometry from qdb.v1 order by cts limit 1 _qstart, _qend, _c0, rowts",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=45,
<<<<<<< HEAD
            stream="create stream rdb.s45 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r45 as select _twstart ts, cts, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary, cdecimal8, cdecimal16 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname='t2' order by cts limit 1",
=======
            stream="create stream rdb.s45 count(1, c1) from tdb.triggers partition by id, name into rdb.r45 as select _twstart ts, cts, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary, cdecimal8, cdecimal16 from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname='t2' order by cts limit 1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=46,
<<<<<<< HEAD
            stream="create stream rdb.s46 count_window(2, c1) from tdb.triggers into rdb.r46 as select _twstart ts, count(c1) ccnt, sum(c2) csum, first(id) cfirst from %%trows",
=======
            stream="create stream rdb.s46 count(1, c1) from tdb.triggers into rdb.r46 as select _twstart ts, count(c1) ccnt, sum(c2) csum, first(id) cfirst from %%trows",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=47,
<<<<<<< HEAD
            stream="create stream rdb.s47 count_window(2, c1) from tdb.triggers into rdb.r47 as select _twstart ts, sum(`vgroups`) c1, sum(ntables) c2 from information_schema.ins_databases where name != 'information_schema' and name != 'performance_schema'",
=======
            stream="create stream rdb.s47 count(1, c1) from tdb.triggers into rdb.r47 as select _twstart ts, sum(`vgroups`) c1, sum(ntables) c2 from information_schema.ins_databases where name != 'information_schema' and name != 'performance_schema'",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s48 count(1, c1) from tdb.triggers partition by tbname into rdb.r48 as select _twstart ts, ABS(cint), ACOS(cuint), ASIN(cbigint), ATAN(cubigint), CEIL(cfloat), COS(cdouble), DEGREES(csmallint), EXP(cusmallint), FLOOR(ctinyint), LN(cutinyint), LOG(cfloat), MOD(cbigint, cint), PI(), POW(cuint, 2), RADIANS(cbigint), ROUND(cfloat), SIGN(cdouble), SQRT(csmallint), TAN(cfloat), TRUNCATE(cdouble, 1), CRC32(cvarchar) from qdb.meters where cts >=_twstart and cts <= _twend and tbname=%%1 order by cts limit 1;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=49,
<<<<<<< HEAD
            stream="create stream rdb.s49 count_window(2, c1) from tdb.triggers into rdb.r49 as select _twstart ts, ABS(cint), ACOS(cuint), ASIN(cbigint), ATAN(cubigint), CEIL(cfloat), COS(cdouble), DEGREES(csmallint), EXP(cusmallint), FLOOR(ctinyint), LN(cutinyint), LOG(cfloat), MOD(cbigint, cint), PI(), POW(cuint, 2), RADIANS(cbigint), ROUND(cfloat), SIGN(cdouble), SQRT(csmallint), TAN(cfloat), TRUNCATE(cdouble, 1), CRC32(cvarchar) from qdb.meters where cts >=_twstart and cts <= _twend and tbname='t1' order by cts limit 1",
=======
            stream="create stream rdb.s49 count(1, c1) from tdb.triggers into rdb.r49 as select _twstart ts, ABS(cint), ACOS(cuint), ASIN(cbigint), ATAN(cubigint), CEIL(cfloat), COS(cdouble), DEGREES(csmallint), EXP(cusmallint), FLOOR(ctinyint), LN(cutinyint), LOG(cfloat), MOD(cbigint, cint), PI(), POW(cuint, 2), RADIANS(cbigint), ROUND(cfloat), SIGN(cdouble), SQRT(csmallint), TAN(cfloat), TRUNCATE(cdouble, 1), CRC32(cvarchar) from qdb.meters where cts >=_twstart and cts <= _twend and tbname='t1' order by cts limit 1",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s50 count(1, c1) from tdb.triggers partition by tbname into rdb.r50 as select _tcurrent_ts ts, ABS(cint), ACOS(cuint), ASIN(cbigint), ATAN(cubigint), CEIL(cfloat), COS(cdouble), DEGREES(csmallint), EXP(cusmallint), FLOOR(ctinyint), LN(cutinyint), LOG(cfloat), MOD(cbigint, cint), PI(), POW(cuint, 2), RADIANS(cbigint), ROUND(cfloat), SIGN(cdouble), SQRT(csmallint), TAN(cfloat), TRUNCATE(cdouble, 1), CRC32(cvarchar) from qdb.meters where cts >=_tcurrent_ts and cts <= _tnext_ts and tbname=%%1 order by cts limit 1;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s52 count(1, c1) from tdb.triggers partition by tbname into rdb.r52 as select _twstart ts, ASCII(cvarchar), CHAR(cnchar), CHAR_LENGTH(%%tbname), CHAR_LENGTH(cast(%%1 as varchar)), CHAR_LENGTH(cvarchar), CONCAT(cvarchar, cnchar), CONCAT_WS('--', cvarchar, cnchar), LENGTH(cnchar), LOWER(cvarchar), LTRIM(cnchar), POSITION('a' in cvarchar), REPEAT(cnchar, 3), REPLACE(cvarchar, 'a', 'b'), RTRIM(cnchar), SUBSTRING(cvarchar, 1), SUBSTR(cvarchar, 1), SUBSTRING_INDEX(cnchar, 'a', 1), TRIM(cvarchar), UPPER(cnchar) from qdb.n1 where cts >=_twstart and cts <= _twend order by cts limit 1;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s54 count(1, c1) from tdb.triggers partition by tbname into rdb.r54 as select _twstart ts, cint, CAST(cint as varchar(20)) c1, cuint, cts, TO_CHAR(cts, 'yyyy-mm-dd hh24:mi:ss') c2, TO_ISO8601(cts) c3, TO_TIMESTAMP(TO_CHAR(cts, 'yyyy-mm-dd'), 'yyyy-mm-dd') c4, TO_UNIXTIMESTAMP(TO_CHAR(cts, 'yyyy-mm-dd')) c5 from qdb.v1 where cts >= _twstart and cts <_twend and _tlocaltime > '2024-12-30' order by cts limit 1",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s55 count(1, c1) from tdb.t1 into rdb.r55 as select _irowts , _isfilled , _irowts_origin, interp(cts), interp(cint), interp(cuint), interp(cbigint), interp(cubigint), interp(cfloat), interp(cdouble), interp(csmallint), interp(cusmallint), interp(ctinyint) from qdb.meters partition by %%1 RANGE(_twstart) fill(linear)",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=56,
<<<<<<< HEAD
            stream="create stream rdb.s56 count_window(2, c1) from tdb.v1 into rdb.r56 as select _wstart ws, _wend we, _twstart tws, _twend twe, first(c1) cf, last(c1) cl, count(c1) cc from %%trows where ts >= _twstart and ts < _twend interval(1m) fill(prev)",
=======
            stream="create stream rdb.s56 count(1, c1) from tdb.v1 into rdb.r56 as select _wstart ws, _wend we, _twstart tws, _twend twe, first(c1) cf, last(c1) cl, count(c1) cc from %%trows where ts >= _twstart and ts < _twend interval(1m) fill(prev)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s58 count(1, c1) from tdb.triggers partition by tbname into rdb.r58 as select interp(cbigint) from qdb.v1 where ctinyint > 0 and cint > 2 RANGE('2025-01-01 00:02:00.000', '2025-01-01 00:08:00.000') EVERY (1m) FILL(linear) limit 50;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s59 count(1, c1) from tdb.triggers partition by id into rdb.r59 as select interp(csmallint) from qdb.meters partition by tbname where ctinyint > 0 and cint > 2 RANGE('2025-01-01 00:02:00.000') EVERY (1m) FILL(linear)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s60 count(1, c1) from tdb.triggers partition by tbname into rdb.r60 as select _twstart ts, RAND(), NOW(), TODAY(), TIMEZONE() from qdb.n2 where _tgrpid != 0 order by cts desc limit 1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=61,
<<<<<<< HEAD
            stream="create stream rdb.s61 count_window(2, c1) from tdb.triggers partition by id into rdb.r61 as select _twstart ts, RAND(), NOW(), TODAY(), TIMEZONE() from qdb.n2 where _tgrpid != 0 order by cts desc limit 1",
=======
            stream="create stream rdb.s61 count(1, c1) from tdb.triggers partition by id into rdb.r61 as select _twstart ts, RAND(), NOW(), TODAY(), TIMEZONE() from qdb.n2 where _tgrpid != 0 order by cts desc limit 1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=62,
<<<<<<< HEAD
            stream="create stream rdb.s62 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r62 as select _twstart ts, RAND(), NOW(), TODAY(), TIMEZONE() from qdb.n2 where _tgrpid != 0 order by cts desc limit 1",
=======
            stream="create stream rdb.s62 count(1, c1) from tdb.triggers partition by id, name into rdb.r62 as select _twstart ts, RAND(), NOW(), TODAY(), TIMEZONE() from qdb.n2 where _tgrpid != 0 order by cts desc limit 1",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s63 count(1, c1) from tdb.triggers partition by tbname into rdb.r63 as select _twstart ts, APERCENTILE(cint, 25) c1, AVG(cuint) c2, SUM(cint) c3, COUNT(cbigint) c4, ELAPSED(cts) c5, HYPERLOGLOG(cdouble) c6, LEASTSQUARES(csmallint, 1, 2) c7, SPREAD(ctinyint) c8, STDDEV(cutinyint) c9, STDDEV_POP(cfloat) c10, SUM(cdecimal8) c11, VAR_POP(cbigint) c12 from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=64,
<<<<<<< HEAD
            stream="create stream rdb.s64 count_window(2, c1) from tdb.triggers partition by id into rdb.r64 as select cts, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary from qdb.view1 where cts >= _twstart and cts < _twstart + 5m limit 1",
=======
            stream="create stream rdb.s64 count(1, c1) from tdb.triggers partition by id into rdb.r64 as select cts, cint, cuint, cbigint, cubigint, cfloat, cdouble, cvarchar, csmallint, cusmallint, ctinyint, cutinyint, cbool, cnchar, cvarbinary from qdb.view1 where cts >= _twstart and cts < _twstart + 5m limit 1",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s65 count(1, c1) from tdb.triggers partition by tbname into rdb.r65 as select _twstart ts, HISTOGRAM(cfloat, 'user_input', '[1, 7]', 1) th from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s66 count(1, c1) from tdb.triggers partition by tbname into rdb.r66 as select _twstart ts, FIRST(cuint), LAST(cbigint), LAST_ROW(cubigint) from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s67 count(1, c1) from tdb.triggers partition by tbname into rdb.r67 as select _twstart ts, MAX(ctinyint), MIN(cutinyint) from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s68 count(1, c1) from tdb.triggers partition by tbname into rdb.r68 as select _twstart ts, mode(cint) from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s69 count(1, c1) from tdb.triggers partition by tbname into rdb.r69 as select _twstart ts, SAMPLE(cdecimal8, 1) from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s70 count(1, c1) from tdb.triggers partition by tbname into rdb.r70 as select _twstart ts, BOTTOM(cint, 1) from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s71 count(1, c1) from tdb.triggers partition by tbname into rdb.r71 as select _twstart ts, TAIL(cbigint, 1)  from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s72 count(1, c1) from tdb.triggers partition by tbname into rdb.r72 as select _twstart ts, TOP(cint, 1) from qdb.meters where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s73 count(1, c1) from tdb.triggers into rdb.r73 as select _rowts, _twstart ts, CSUM(cint) + CSUM(cuint) from qdb.v1 where cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s74 count(1, c1) from tdb.triggers partition by tbname into rdb.r74 as select first(cts), _twstart, %%tbname, cint, avg(cfloat), count(cdouble), sum(cfloat), twa(cdouble) from qdb.meters where cts >= _twstart and cts < _twstart + 5m and tbname = %%1 group by cint having count(cdouble) == 1 order by first(cts);",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s75 count(1, c1) from tdb.vtriggers partition by id into rdb.r75 as select _wstart, twa(k),avg(k),count(1) from tdb.vtriggers where id=%%1 where ts>='2015-8-18 00:00:00' and ts<='2015-8-18 00:07:00' interval(1m) fill(prev)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s76 count(1, c1) from tdb.triggers partition by id, name into rdb.r76 as select _twstart ts, ST_GeomFromText('POINT (2.000000 2.000000)'), ST_AsText(cgeometry), ST_Contains(cgeometry, cgeometry), ST_ContainsProperly(cgeometry, cgeometry), ST_Covers(cgeometry, cgeometry), ST_Equals(cgeometry, cgeometry), ST_Intersects(cgeometry, cgeometry), ST_Touches(cgeometry, cgeometry) from qdb.meters where tbname='t4' and cts >=_tcurrent_ts and cts <= _tnext_ts order by cts limit 1;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=77,
<<<<<<< HEAD
            stream="create stream rdb.s77 count_window(2, c1) from tdb.vtriggers partition by id into rdb.r77 as select _twstart ts, count(*) c1 from information_schema.ins_streams where stream_name='s77'",
=======
            stream="create stream rdb.s77 count(1, c1) from tdb.vtriggers partition by id into rdb.r77 as select _twstart ts, count(*) c1 from information_schema.ins_streams where stream_name='s77'",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=78,
<<<<<<< HEAD
            stream="create stream rdb.s78 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r78 as select _twstart, _twrownum, count(*), sum(cdecimal8) from qdb.meters where tbname !=%%1 and cts >= _twstart and cts < _twstart + 5m and _twrownum > 0;",
=======
            stream="create stream rdb.s78 count(1, c1) from tdb.triggers partition by id, name into rdb.r78 as select _twstart, _twrownum, count(*), sum(cdecimal8) from qdb.meters where tbname !=%%1 and cts >= _twstart and cts < _twstart + 5m and _twrownum > 0;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s79 count(1, c1) from tdb.triggers partition by tbname into rdb.r79 as select _twstart, sum(cdecimal8), count(*), _twrownum from qdb.meters where tbname=%%1 and cts >= _twstart and cts < _twstart + 5m and _twrownum > 0;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=80,
<<<<<<< HEAD
            stream="create stream rdb.s80 count_window(2, c1) from tdb.triggers into rdb.r80 as select _twstart, sum(v1), sum(v2) from (select count(c1) v1, sum(c2) v2 from %%trows)",
=======
            stream="create stream rdb.s80 count(1, c1) from tdb.triggers into rdb.r80 as select _twstart, sum(v1), sum(v2) from (select count(c1) v1, sum(c2) v2 from %%trows)",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=81,
<<<<<<< HEAD
            stream="create stream rdb.s81 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r81 as select cts, diff(cint) c3, _twstart, _twend, _twrownum from qdb.meters where tbname=%%1 and cts >= _twstart and cts <= _twend and cint > 5 and _twrownum > 0 ",
=======
            stream="create stream rdb.s81 count(1, c1) from tdb.triggers partition by tbname into rdb.r81 as select cts, diff(cint) c3, _twstart, _twend, _twrownum from qdb.meters where tbname=%%1 and cts >= _twstart and cts <= _twend and cint > 5 and _twrownum > 0 ",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=82,
<<<<<<< HEAD
            stream="create stream rdb.s82 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r82 as select cts, diff(cint) c3, _twstart, _twend, _twrownum from qdb.meters where tbname=%%1 and cts >= _twstart and cts <= _twend and cint > 5",
=======
            stream="create stream rdb.s82 count(1, c1) from tdb.triggers partition by tbname into rdb.r82 as select cts, diff(cint) c3, _twstart, _twend, _twrownum from qdb.meters where tbname=%%1 and cts >= _twstart and cts <= _twend and cint > 5",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s83 count(1, c1) from tdb.t1 into rdb.r83 as select ts, diff(c1) c3 from %%trows ",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=84,
<<<<<<< HEAD
            stream="create stream rdb.s84 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r84 as select cts, top(cint, 5) from qdb.meters where tbname=%%1 and cts >= _twstart and cts <= _twend order by cint limit 2 offset 2;",
=======
            stream="create stream rdb.s84 count(1, c1) from tdb.triggers partition by tbname into rdb.r84 as select cts, top(cint, 5) from qdb.meters where tbname=%%1 and cts >= _twstart and cts <= _twend order by cint limit 2 offset 2;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=85,
<<<<<<< HEAD
            stream="create stream rdb.s85 count_window(2, c1) from tdb.triggers partition by id into rdb.r85 as select cts, top(cint, 5) from qdb.meters where tint=%%1 and cts >= _twstart and cts < _twstart + 5m order by cint limit 2 offset 2;",
=======
            stream="create stream rdb.s85 count(1, c1) from tdb.triggers partition by id into rdb.r85 as select cts, top(cint, 5) from qdb.meters where tint=%%1 and cts >= _twstart and cts < _twstart + 5m order by cint limit 2 offset 2;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s86 count(1, c1) from tdb.n1 into rdb.r86 as select ts, top(c1, 5) from %%trows limit 1 offset 1;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s87 count(1, c1) from tdb.t1 into rdb.r87 as select last(cts, cint, cuint) from qdb.t1 where cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s88 count(1, c1) from tdb.v1 into rdb.r88 as select from select cast(avg(f) as int) b  from view1 group by a having avg(f) > 100111 order by b",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=89,
<<<<<<< HEAD
            stream="create stream rdb.s89 count_window(2, c1) from tdb.v1 into rdb.r89 as select rand() from %%trows where rand() >= 0 and rand() < 1 _c0, _rowts;",
=======
            stream="create stream rdb.s89 count(1, c1) from tdb.v1 into rdb.r89 as select rand() from %%trows where rand() >= 0 and rand() < 1 _c0, _rowts;",
>>>>>>> feat/TS-6100-3.0
...
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=91,
<<<<<<< HEAD
            stream="create stream rdb.s91 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r91 as select _twstart, id cid, name cname, sum(c1) amount from %%trows where ts between _twstart and _twend and id=%%1 and name=%%1 partition by id, name having sum(c1) <= 5;",
=======
            stream="create stream rdb.s91 count(1, c1) from tdb.triggers partition by id, name into rdb.r91 as select _twstart, id cid, name cname, sum(c1) amount from %%trows where ts between _twstart and _twend and id=%%1 and name=%%1 partition by id, name having sum(c1) <= 5;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=92,
<<<<<<< HEAD
            stream="create stream rdb.s92 count_window(2, c1) from tdb.n1 as  select _twstart, tint, %%tbname, sum(cint) amount from qdb.meters where tbname=%%tbname and ts between _twstart and _twend partition by tbname having sum(cint) > 50",
=======
            stream="create stream rdb.s92 count(1, c1) from tdb.n1 as  select _twstart, tint, %%tbname, sum(cint) amount from qdb.meters where tbname=%%tbname and ts between _twstart and _twend partition by tbname having sum(cint) > 50",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s93 count(1, c1) from tdb.v1 into rdb.r93 as select _twstart, sum(cnt) from (select _twstart ts, count(*) cnt from information_schema.ins_tables where db_name='qdb' union all select _twstart ts, count(*) cnt from information_schema.ins_tables where db_name='tdb')",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s94 count(1, c1) from tdb.v1 into rdb.r94 as select diff(faev) from (select _ts, faev, deviceid from demo union all select _ts + 1s, faev, deviceid from %%trows order by faev, _ts, deviceid) partition by faev",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=95,
<<<<<<< HEAD
            stream="create stream rdb.s95 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r95 as select _twstart, _twend, last(cts, cint, cuint) from qdb.meters where tbname=%%1 and cts >= _twstart and cts < _twstart + 5m",
=======
            stream="create stream rdb.s95 count(1, c1) from tdb.triggers partition by tbname into rdb.r95 as select _twstart, _twend, last(cts, cint, cuint) from qdb.meters where tbname=%%1 and cts >= _twstart and cts < _twstart + 5m",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s97 count(1, c1) from tdb.triggers partition by tbname into rdb.r97 as select _twstart, cts, cint, cuint, cbool from qdb.meters where tbname=%%1 and cint > 1 and cint >= 1 and cint < 10000 and cint  <= 100000 and cint <> 1 and cint != 1 and cint is NOT NULL and cts BETWEEN _twstart AND _twend order by cts desc limit 1",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=98,
<<<<<<< HEAD
            stream="create stream rdb.s98 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r98 as select last(cts, cint, cbool) from qdb.jmeters where cts >= _twstart and cts < _twstart + 5m and tjson->'k1'='v1' partition by tjson->'k1'",
=======
            stream="create stream rdb.s98 count(1, c1) from tdb.triggers partition by id, name into rdb.r98 as select last(cts, cint, cbool) from qdb.jmeters where cts >= _twstart and cts < _twstart + 5m and tjson->'k1'='v1' partition by tjson->'k1'",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s100 count(1, c1) from tdb.v1 into rdb.r100 as select json, to_json from %%trows where BETWEEN AND",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s101 count(1, c1) from tdb.v1 into rdb.r101 as select 1&2, 2|3  and or && || case from tdb.v1 limit 1 offset 1 ",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=102,
<<<<<<< HEAD
            stream="create stream rdb.s102 count_window(2, c1) from tdb.t1 into rdb.r102 as select cols(last(ts), ts, c0), count(1) {t1} from {from_table} group by t1 order by t1",
=======
            stream="create stream rdb.s102 count(1, c1) from tdb.t1 into rdb.r102 as select cols(last(ts), ts, c0), count(1) {t1} from {from_table} group by t1 order by t1",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s103 count(1, c1) from tdb.vtriggers partition by tbname into rdb.r103 as select cvarchar like 'a', not like, regexp, not regexp from tdb.vtriggers where tbname=%%tbname limit 1 offset 1 ",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s104 count(1, c1) from tdb.triggers partition by tbname into rdb.r104 as select _wstart ts, CASE c1 WHEN 0 THEN 'Running' WHEN 5 THEN 'Warning' ELSE 'Unknown' END t1, c1 & c2 t2, c1 | c2 t3, (c1 != 0 or c2 <> 0) t4  from %%trows",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s106 count(1, c1) from tdb.triggers partition by tbname into rdb.r106 as select _twstart, cts, concat(cvarchar, cnchar), cint + cuint, ctinyint - cdouble, cfloat * cdouble, cbigint * 12, -ctinyint from qdb.meters where tbname=%%tbname limit 1 offset 1;",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=107,
<<<<<<< HEAD
            stream="create stream rdb.s107 count_window(2, c1) from tdb.triggers into rdb.r107 as select _twstart, cts, cvarchar like 'SanFrancisco', cnchar not like 'SanFrancisco', cvarchar regexp '%co', cnchar not regexp '%co' from qdb.t5 limit 1 offset 2;",
=======
            stream="create stream rdb.s107 count(1, c1) from tdb.triggers into rdb.r107 as select _twstart, cts, cvarchar like 'SanFrancisco', cnchar not like 'SanFrancisco', cvarchar regexp '%co', cnchar not regexp '%co' from qdb.t5 limit 1 offset 2;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s108 count(1, c1) from tdb.t1 into rdb.r108 as select _twstart, count(cts), first(cuint), last(cuint), sum(cuint), tbname from qdb.meters where tbname in ('t1', 't2', 't3', 't4') and cts >= _twstart and cts < _twstart + 5m partition by tbname slimit 1 soffset 2",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s109 count(1, c1) from tdb.v1 into rdb.r109 as select tb1.nchar_16_col from test_vtable_join.vtb_virtual_ctb_1 as tb1 join test_vtable_join.vtb_virtual_ctb_2 as tb2 on tb1.ts=tb2.ts where tb1.nchar_16_col is not null group by tb1.nchar_16_col having tb1.nchar_16_col is not null order by 1 slimit 20 limit 20",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s110 count(1, c1) from tdb.triggers partition by tbname into rdb.r110 as (select _twstart, count(cts), first(cuint), last(cuint), sum(cuint), tbname from qdb.meters where tbname in ('t1', 't2', 't3', 't4') and cts >= _twstart and cts < _twstart + 5m partition by tbname slimit 1 soffset 2) union (select _twstart + 1m, count(cts), first(cuint), last(cuint), sum(cuint), tbname from qdb.meters where tbname in ('t1', 't2', 't3', 't4') and cts >= _twstart and cts < _twstart + 5m partition by tbname slimit 1 soffset 3)",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=111,
<<<<<<< HEAD
            stream="create stream rdb.s111 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r111 as select _wstart, _wend, _twstart, _twend, csmallint, count(cts), count(cbool) from qdb.meters where cts >= _twstart and cts < _twstart + 5m partition by tbname state_window(csmallint)",
=======
            stream="create stream rdb.s111 count(1, c1) from tdb.triggers partition by tbname into rdb.r111 as select _wstart, _wend, _twstart, _twend, csmallint, count(cts), count(cbool) from qdb.meters where cts >= _twstart and cts < _twstart + 5m partition by tbname state_window(csmallint)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s112 count(1, c1) from tdb.t1 into rdb.r112 as select tb1.nchar_16_col from test_vtable_join.vtb_virtual_ctb_1 as tb1 join test_vtable_join.vtb_virtual_ctb_2 as tb2 on tb1.ts=tb2.ts where tb1.nchar_16_col is not null group by tb1.nchar_16_col having tb1.nchar_16_col is not null order by 1 slimit 20 limit 20",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=113,
<<<<<<< HEAD
            stream="create stream rdb.s113 count_window(2, c1) from tdb.t1 into rdb.r113 as select _wstart, _wend, _twstart, _twend, first(csmallint), count(cts), count(cbool) from qdb.t1 where cts >= _twstart and cts < _twstart + 5m and csmallint = 2 session(cts, 40s);",
=======
            stream="create stream rdb.s113 count(1, c1) from tdb.t1 into rdb.r113 as select _wstart, _wend, _twstart, _twend, first(csmallint), count(cts), count(cbool) from qdb.t1 where cts >= _twstart and cts < _twstart + 5m and csmallint = 2 session(cts, 40s);",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s114 count(1, c1) from tdb.v1 into rdb.r114 as show dnode 1 variables like 'bypassFlag'",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=115,
<<<<<<< HEAD
            stream="create stream rdb.s115 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r115 as SELECT a.voltage, sum(cint) FROM ct_join_1 a left JOIN ct_join_2 b ON a.ts = b.ts group by a.voltage having b.voltage > 14;",
=======
            stream="create stream rdb.s115 count(1, c1) from tdb.triggers partition by tbname into rdb.r115 as SELECT a.voltage, sum(cint) FROM ct_join_1 a left JOIN ct_join_2 b ON a.ts = b.ts group by a.voltage having b.voltage > 14;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s117 count(1, c1) from tdb.t1 into rdb.r117 as select t1.ts, t2.ts from db1_st1 t1 right asof join db1_st2 t2 where t1.v_int >= 0 and (cos(t2.t_double) >= 0 or cos(t2.t_double) < 0) order by t1.ts, t2.ts;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s118 count(1, c1) from tdb.v1 into rdb.r118 as select t1.ts, t2.ts from qdb.v1 t1 right asof join from qdb.v2 t2 where t1.v_int >= 0 and (cos(t2.t_double) >= 0 or cos(t2.t_double) < 0) order by t1.ts, t2.ts;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s119 count(1, c1) from tdb.v1 into rdb.r119 as select dictintc from qdb.meters where tbname in(%%tbname) _qstart, _qend, _c0, _rowts",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s120 count(1, c1) from tdb.triggers partition by tbname into rdb.r120 as select _wend, sum(cint) from (select t1.ts ts1, t2.ts ts2, t1.v_bigint v_bigint1, t2.v_bigint v_bigint2, t1.tbname from db1_st1 t1 left window join db1_st2 t2 window_offset(-100a, 100a) jlimit 10 order by t1.ts) where v_bigint1 + v_bigint2 > 0 and ts1 between '2025-01-01 12:00:00.400' and now and ts2 != '2025-01-01 12:00:00.300' partition by tbname interval(1s) order by _wend;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s121 count(1, c1) from tdb.triggers partition by id into rdb.r121 as select first(ts2), tbname, sum(v_int) from (select t1.ts ts1, t2.ts ts2, t2.v_int, t2.tbname from db1_st1 t1 right join db1_st2 t2 on t1.ts=t2.ts and t2.ts <= now and (t2.v_binary like '%abc%' or t2.v_binary not like '%abc%') where t2.v_binary like '%abc%' or t2.v_binary not like '%abc%') group by tbname order by tbname;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s122 count(1, c1) from tdb.triggers partition by tbname into rdb.r122 as select first(tats), last(tbts), count(tat1), sum(tat1), first(tbt1), last(tbt1) from (select ta.cts tats, tb.cts tbts, ta.cint tat1, tb.cint tbt1 from qdb.t1 ta left join qdb.t2 tb on ta.cts=tb.cts and (ta.cint >= tb.cint) order by ta.cts) where tats >= _twstart and tats < _twend",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=123,
<<<<<<< HEAD
            stream="create stream rdb.s123 count_window(2, c1) from tdb.triggers partition by id, name into rdb.r123 as select _wstart tw, _wend te, _twstart, _twend, count(c1) c1, sum(c2) c2 from %%trows interval(1m)",
=======
            stream="create stream rdb.s123 count(1, c1) from tdb.triggers partition by id, name into rdb.r123 as select _wstart tw, _wend te, _twstart, _twend, count(c1) c1, sum(c2) c2 from %%trows interval(1m)",
>>>>>>> feat/TS-6100-3.0
        ...
        stream = StreamItem(
            id=124,
<<<<<<< HEAD
            stream="create stream rdb.s124 count_window(2, c1) from tdb.triggers partition by tbname into rdb.r124 as select _wstart ts, count(c1), sum(c2) from %%trows where ts >= _twstart and ts < _twend interval(1m) fill(prev)",
=======
            stream="create stream rdb.s124 count(1, c1) from tdb.triggers partition by tbname into rdb.r124 as select _wstart ts, count(c1), sum(c2) from %%trows where ts >= _twstart and ts < _twend interval(1m) fill(prev)",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s125 count(1, c1) from tdb.v1 into rdb.r125 as select _rowts, _twstart ts, DERIVATIVE(cbigint, 5, 0) from qdb.v1 where cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s126 count(1, c1) from tdb.v1 into rdb.r126 as select _rowts, _twstart ts, IRATE(cubigint) from %%trows where cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s127 count(1, c1) from tdb.vtriggers into rdb.r127 as select _rowts, _twstart ts, MAVG(cfloat, 1) from %%trows where cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s128 count(1, c1) from tdb.triggers partition by tbname into rdb.r128 as select _rowts, _twstart ts, STATECOUNT(cdouble, 'LT', 5) from vdb.triggers where tbname=%%tbname and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s129 count(1, c1) from tdb.triggers partition by id into rdb.r129 as select _c0, _twstart ts, STATEDURATION(cusmallint, 'LT', 5, 1m) from vdb.triggers where tint=%%1 and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
...
=======
            stream="create stream rdb.s130 count(1, c1) from tdb.vtriggers partition by tbname into rdb.r130 as select _c0, _twstart ts, TWA(ctinyint) from vdb.triggers where tbname=%%1 and cts >= _twstart and cts < _twstart + 5m;",
>>>>>>> feat/TS-6100-3.0
