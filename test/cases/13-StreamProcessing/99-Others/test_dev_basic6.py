...
class TestStreamDevBasic:
    ...
    def basic1(self):
        ...
        sql = "create stream s9 PERIOD(10s, 10a) into out9 as select cast(_tlocaltime/1000000 as timestamp), _tprev_localtime/1000000, _tnext_localtime/1000000, now, max(v1) from stb;"
        tdSql.execute(sql)
