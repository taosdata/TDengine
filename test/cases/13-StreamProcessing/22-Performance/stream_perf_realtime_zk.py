...
def main():
    ...
    parser.add_argument('-m', '--mode', type=int, default=0,
                        help='1: do_start, 2: do_query_then_insert ')
    ...
    parser.add_argument('--vgroups', type=int, default=4,
                        help='vgroups,默认4')
    parser.add_argument('--sql-type', type=str, default='s2_1',
                       choices=['s2_1', 's2_2', 's2_3', 's2_4', 's2_5', 's2_6', 's2_7', 's2_8', 's2_9', 's2_10', 's2_11', 's2_12', 's2_13', 's2_14', 's2_15','all'],
