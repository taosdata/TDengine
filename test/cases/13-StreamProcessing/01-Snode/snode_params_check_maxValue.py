...
class TestStreamParametersCheckMaxValue:
    ...
    def test_snode_mgmt(self):
        """Stream TestStreamParametersCheckMaxValue test
    ...
    def checknumOfMnodeStreamMgmtThreads(self):
        ...
        if int(result) > 5:
            raise Exception(f"Error: numOfMnodeStreamMgmtThreads is {result}, expected max value is 5!")
    ...
    def checknumOfStreamMgmtThreads(self):
        ...
        result = tdSql.getData(0, 2)
        if int(result) > 5:
            raise Exception(f"Error: numOfStreamMgmtThreads is {result},  expected max value is 5!")
    ...
    def checknumOfVnodeStreamReaderThreads(self):
        ...
        if int(result) > 2147483647:
            raise Exception(f"Error: numOfVnodeStreamReaderThreads is {result}, expected max value is 2147483647!")
    ...
    def checknumOfStreamTriggerThreads(self):
        ...
        result = tdSql.getData(0, 2)
        if int(result) > 2147483647:
            raise Exception(f"Error: numOfStreamTriggerThreads is {result}, expected max value is 2147483647!")
    ...
    def checknumOfStreamRunnerThreads(self):
        ...
        result = tdSql.getData(0, 2)
        if int(result) > 2147483647:
            raise Exception(f"Error: numOfStreamRunnerThreads is {result}, expected max value is 2147483647!")
    ...
    def checkstreamBufferSize(self):
        ...
        result = tdSql.getData(0, 2)
        if int(result) > 2147483647:
            raise Exception(f"Error: streamBufferSize is {result}, expected max value is 2147483647!")
    ...
    def checkstreamNotifyMessageSize(self):
        ...
        if int(result) > 1048576:
            raise Exception(f"Error: streamNotifyMessageSize is {result}, expected max value is 1048576 KB!")
    ...
    def checkstreamNotifyFrameSize(self):
        ...
        result = tdSql.getData(0, 2)
        if int(result) > 1048576:
            raise Exception(f"Error: streamNotifyFrameSize is {result},  expected max value is 1048576 KB!")
