...
class Test_Three_Gorges_Phase3:
    ...
    def step2(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(1 = 1 and index_code in ('jldlglyjbj', 'zldlglyjbj') and ts >= to_char(today(), 'yyyy-mm-dd') and dcc_flag = 1))"
    ...
    def step3(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(1 = 1 and length(cnstationno) <> 0))"
    ...
    def step4(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(cz_flag = '1' and index_code = 'yggl' and ts >= today() )"
    ...
    def step6(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(cz_flag = '1' and index_code = 'zt' and val > 0 and ts >= today()))"
    ...
    def step8(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(1=1 and index_code in ('jldlglyjbj', 'zldlglyjbj') and dt >= today() and dcc_flag =1))"
            "  into `ctg_test`.`stb_cjdl_cn_all_cz_zt_base_tp`"
            "  output_subtable(concat('stb_cjdl_cn_all_cz_zt_base_tp', '_', %%2))"
    ...
    def step9(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_cjdl_cn_all_cz_zt_base_tp"
            "  partition by ps_code, cnstationno"
            "  options(max_delay(14m) | pre_filter(1 = 1 and and length(cnstationno) <> 0))"
    ...
    def step10(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(cz_flag = '1' and index_code = yggl and dt >= today()))"
    ...
    def step11(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(1 = 1 and index_code = 'gzzt' and dt >= today()))"
    ...
    def step12(self):
        tdSql.execute(
            ...
            "  options(max_delay(14m) | pre_filter(1 = 1 and dt >= today()))"
    ...
    def step13(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by ps_code, cnstationno"
            "  options(max_delay(14m) | pre_filter(cz_flag = '1' and index_code = 'zt' and ps_code in ('2137') and t.dt >= today() ))"
    ...
    def step14(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, ps_code, cnstationno"
            "  options(max_delay(14m) | fill_history('2025-01-01') | pre_filter(cz_flag = '1' and index_code = 'yggl' ))"
    ...
    def step15(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, ps_code, cnstationno"
            "  options(max_delay(14m) | fill_history('2025-01-01') | pre_filter(cz_flag = '1' and index_code = 'yggl' and dt >= today() ))"
    ...
    def step17(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by ps_code, cnstationno"
            "  options(max_delay(15m) | pre_filter(cz_flag = '1' and index_code = 'zt' and ps_code in ('2137') and t.dt >= today() ))"
            "  into `ctg_test`.`stb_sxny_cn_all_cz_yggl_base1`"
