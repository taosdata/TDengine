...
class Test_Three_Gorges_Phase3:
    ...
    def step1(self):
        tdSql.execute(
            ...
            "  stream_stream_options(fill_history('2025-01-01 00:00:00'))"
    ...
    def step2(self):
        tdSql.execute(
            ...
            "  stream_stream_options(max_delay(14m) | pre_filter(1 = 1 and index_code in ('jldlglyjbj', 'zldlglyjbj') and ts >= to_char(today(), 'yyyy-mm-dd') and dcc_flag = 1))"
    ...
    def step3(self):
        tdSql.execute(
            ...
            "  stream_stream_options(max_delay(14m) | pre_filter(1 = 1 and length(cnstationno) <> 0))"
    ...
    def step4(self):
        tdSql.execute(
            ...
            "  stream_stream_options(max_delay(14m) | pre_filter(cz_flag = '1' and index_code = 'yggl' and ts >= today() )"
    ...
    def step5(self):
        tdSql.execute(
            ...
            "  stream_stream_options(max_delay(14m))"
    ...
    def step6(self):
        tdSql.execute(
            ...
            "  stream_stream_options(max_delay(14m) | pre_filter(cz_flag = '1' and index_code = 'zt' and val > 0 and ts >= today()))"
