...
class Test_Three_Gorges_Phase2:
    ...
    def step1(self):
        tdSql.execute(
            ...
            "  stream_options(fill_history('2025-01-01 00:00:00') | max_delay(1s) | pre_filter(1 = 1 and index_code = 'drzcdl' and dt >= today() - 1d))"
    ...
    def step2(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, index_code, ps_code, ps_name"
            "  stream_options(fill_history('2025-01-01 00:00:00') | max_delay(1s) | pre_filter(1 = 1 and index_code = 'drzfdl' and dt >= today() - 1d))"
