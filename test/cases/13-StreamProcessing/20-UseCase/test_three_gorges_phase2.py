...
class Test_Three_Gorges_Phase2:
    ...
    def step3(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by index_code, ps_code"
            "  options(expired_time(0s) | pre_filter(1 = 1 and index_code = 'dccsoh' and dt >= today() - 1d))"
    ...
    def step4(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by index_code, ps_code"
            "  options(fill_history('2025-01-01 00:00:00') | pre_filter(1 = 1 and index_code = 'drdzsoc' and dt >= today()))"
    ...
    def step5(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by index_code, ps_code"
            "  options(fill_history('2025-01-01 00:00:00') | pre_filter(1 = 1 and index_code = 'dzyggl' and dt >= today() - 1d))"
    ...
    def step6(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by index_code, ps_code"
            "  options(fill_history('2025-01-01 00:00:00') | pre_filter(1 = 1 and index_code = 'dzyggl' and val > 0 and dt >= today()))"
    ...
    def step8(self):
        tdSql.execute(
            ...
            "  options(pre_filter(1 = 1 and index_code = 'drswdl' and dt >= today() - 1d))"
    ...
    def step9(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, index_code, ps_code"
            "  options(pre_filter(1 = 1 and index_code = 'drxwdl' and dt >= today()))"
    ...
    def step10(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, index_code, ps_code, ps_name"
            "  options(pre_filter(1 = 1 and index_code = 'drzydl' and dt >= today()))"
    ...
    def step11(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, index_code, ps_code, ps_name"
            "  options(fill_history('2025-01-01 00:00:00') | pre_filter(1 = 1 and index_code = 'gzzt' and dt >= today()))"
    ...
    def step12(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_sxny_cn"
            "  partition by tbname, point, index_code, ps_code, ps_name"
            "  options(fill_history('2025-01-01 00:00:00') | pre_filter(1 = 1 and index_code = 'gzztj' and dt >= to_char(now() - 1d, 'yyyy-mm-dd')))"
    ...
    def step13(self):
        tdSql.execute(
            ...
            "  options(fill_history('2025-01-01 00:00:00') | pre_filter(1 = 1 and index_code in('jldlglyjbj', 'zldlglyjbj', 'jydzyjyxbj', 'dccdlyjyxbj1', 'dccdlyjyxbj2', 'dccdyyjyxbj', 'dcdtwdyjyxbj', 'dcdtdyyjyxbj') and dt >= today()))"
    ...
    def step14(self):
        tdSql.execute(
            ...
            "  options(pre_filter(1 = 1 and index_code in('drzcdl', 'drzfdl') and dt >= today()))"
    ...
    def step18(self):
        tdSql.execute(
            ...
            "  options(max_delay(4m) | pre_filter(1 = 1 and index_code in('jldlglyjbj', 'zldlglyjbj', 'jydzyjyxbj', 'krqttcqbj', 'dyyjyxbj', 'dcdtwdyjyxbj', 'dcdtdyyjyxbj', 'cd_dljcyjyxbj', 'fd_dljcyjyxbj') and dt >= today() and dcc_flag = '1'))"
    ...
    def step19(self):
        tdSql.execute(
            ...
            "  options(max_delay(4m) | expired_time(0s) | pre_filter(1=1 and ps_code in ('0511', '0512', '0513') and index_code = 'jzzt'))"
    ...
    def step20(self):
        tdSql.execute(
            ...
            "  options(max_delay(4m) | expired_time(0s) | pre_filter(1=1 and index_code = 'czyggl') and dt >= today() - 1d)"
    ...
    def step21(self):
        tdSql.execute(
            ...
            "  options(max_delay(4m) | expired_time(0s) | pre_filter(index_code = 'czyggl') and dt >= today() - 1d)"
    ...
    def step23(self):
        tdSql.execute(
            ...
            "  options(max_delay(4m) | expired_time(0s) | pre_filter(1=1 and index_code = 'jzyggl') and dt >= today() - 1d)"
    ...
    def step24(self):
        tdSql.execute(
            ...
            "  from ctg_tsdb.stb_cjdl_rtems"
            "  partition by tbname, senid, sen_name, ps_code, ps_name, province_name, area_name, company_name, ps_type"
            "  options(max_delayh(14m) | expired_time(0s) | pre_filter(index_code = 'jzyggl') and dt >= today() - 1d)"
    ...
    def step25(self):
        tdSql.execute(
            ...
            "  options(expired_time(0s) | pre_filter(index_code in('jldlglyjbj', 'zldlglyjbj', 'jydzyjyxbj') and dt >= today())"
