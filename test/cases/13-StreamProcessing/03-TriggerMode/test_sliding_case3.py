...
class TestSliding:
    ...
    def test_sliding_case1(self):
        ...
        # self.createTable()
        stream1 = (
        """ create stream test1.st1 interval(30s) sliding(30s) from test1.stba partition by tbname
                        stream_options(fill_history) 
                        into test1.st1out output_subtable(concat_ws('_','outtabl_',tbname)) 
                        as select
        ...
        config = {
            ...
            "databases": [{
                    ...
                    "super_tables": [{
                            ...
                            "tags_file": "",
                            "columns": [
                                {"type": "int","name":"c1","max":100,"min":-1}
                            ],
                            "tags": [
