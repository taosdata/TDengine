...
class TestStreamParametersAlter:
    ...
    def test_snode_mgmt(self):
        """Privileges: alter parameter

        Check if the user has permission to modify stream computing parameters
    ...
    def alterstreamBufferSize(self, value):
        ...
        try:
            ...
            if "Insufficient privilege" not in str(e):
                raise Exception(
                    f"normal user cant  modify parameters ,but alter success"
                )
