...
class TestUnionBugs:
    ...
    def check_unionall_outer_count(self):
    ...
    def test_union_bugs(self):
        ...
        History:
            ...
            - 2026-03-20 Tony Zhang Add unionall with outer count() regression
        ...
        self.check_unionall_outer_count()
        tdLog.printNoPrefix("==========pass all checks")