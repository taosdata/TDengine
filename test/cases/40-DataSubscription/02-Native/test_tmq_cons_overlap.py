...
class TestTmpConsOverlap:
    ...
    def test_tmq_cons_overlap(self):
        """Tmq Test
        ...
        History:
            - 2025-5-9 Simon Guan migrated from tsim/tmq/basic2Of2ConsOverlap.sim
        ...
        while True:
            ...
            if tdSql.getRows() == 2:
                ...
                tdSql.checkAssert(sumOfRows == totalMsgCons)
        ...
        while True:
            ...
            if tdSql.getRows() == 2:
                tdSql.checkAssert(tdSql.getData(0, 1) + tdSql.getData(1, 1) == 1)
                tdSql.checkAssert(
                    tdSql.getData(0, 2) + tdSql.getData(1, 2) == 1 + topicNum
                )
                tdSql.checkAssert(
                    tdSql.getData(0, 3) + tdSql.getData(1, 3)
                    == totalMsgOfCtb + totalMsgOfOneTopic
                )
