...
BASE_VERSIONS = ["3.3.4.3","3.3.5.0"]  # Part 2: Test versions 3.3.4.3 and 3.3.5.0
...
class TestStreamCompatibility:
    ...
    def test_stream_compatibility(self):
        ...
        Catalog:
            - Streams:Compatibility:BackwardForward:Part2
        ...
        History:
            ...
            - 2026-01-13 Split into part 2 of 3 (versions 3.3.4.3 and 3.3.5.0)
