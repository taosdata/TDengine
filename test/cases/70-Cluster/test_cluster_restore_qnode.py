...
class TestClusterRestoreQnode:
    ...
    # run
    def test_cluster_restore_qnode(self):
        ...
        History:
            - 2025-10-31 Alex Duan Migrated from uncatalog/system-test/3-enterprise/restore/test_restore_qnode.py
