...
class Test4dnode1mnodeBasicReplica1InsertdatasQuerys:
    def setup_class(cls):
    ...
    def test_4dnode1mnode_basic_replica1_insertdatas_querys(self):
        ...
        History:
            - 2025-11-01 Alex Duan Migrated from uncatalog/system-test/6-cluster/test_4dnode1mnode_basic_replica1_insertdatas_querys.py
        ...
        writing = threading.Thread(target = self.create_db_replica_3_insertdatas, args=(self.db_name , self.replicaVar , self.vgroups , self.tb_nums , self.row_nums))
        writing.start()
