...
class Test4dnode1mnodeBasicReplica1Insertdatas:
    def setup_class(cls):
    ...
    def test_4dnode1mnode_basic_replica1_insertdatas(self):
        ...
        History:
            -2025-11-01 Alex Duan Migrated from uncatalog/system-test/6-cluster/test_4dnode1mnode_basic_replica1_insertdatas.py

        """
        self.check_setup_cluster_status()
        self.create_db_check_vgroups()
        self.create_db_replica_1_insertdatas(self.db_name , self.replicaVar , self.vgroups , self.tb_nums , self.row_nums)
