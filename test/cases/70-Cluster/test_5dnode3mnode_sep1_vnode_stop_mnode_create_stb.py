...
class Test5dnode3mnodeSep1VnodeStopMnodeCreateStb:
    ...
    def test_5dnode3mnode_sep1_vnode_stop_mnode_create_stb(self):
        ...
        History:
            - 2025-11-01 Alex Duan Migrated from uncatalog/system-test/6-cluster/test_5dnode3mnode_sep1_vnode_stop_dnode_create_stb.py
