...
class TestStableDropBasic3:

    def setup_class(cls):
        tdLog.debug(f"start to execute {__file__}")

    def test_stable_drop_basic3(self):
        """drop stable

        1. create stable
        2. create sub table
        3. create normal table
        4. insert data
        5. drop stable
        ...
        History:
            - 2025-4-28 Simon Guan Migrated to new test framework, from tests/script/tsim/table/basic3.sim
