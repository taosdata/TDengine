...
class TestStableQueryTagFilter:
    ...
    # ------------------- sim ----------------
    #     
    def do_stable_query_tag_filter(self):
        self.Filter()
    ...
    def test_query_tag_filter(self):
        ...
        History:
            ...
            - 2025-12-21 Alex Duan Migrated from cases/uncatalog/system-test/2-query/test_tagFilter.py

        """
        self.do_stable_query_tag_filter()
        self.do_tagFilter()