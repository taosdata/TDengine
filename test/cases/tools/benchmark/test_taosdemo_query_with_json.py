...
class TestTaosdemoQueryWithJson:
    ...
    def test_taosdemo_query_with_json(self):
        ...
        os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryTaosc.json')}")
        # forbid parallel spec query with super query
        os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryTaosc1.json')}")
        ...
        os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryInsertrestdata.json')}")
        os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryRestful.json')}")
        os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryRestful1.json')}")
        ...
        assert (
            os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryInsertdata.json')}") == 0
        )
        assert (
            os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'querySpeciMutisql100.json')}")
            != 0
        )
        assert (
            os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'querySuperMutisql100.json')}")
            == 0
        )

        # query result print QPS
        os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryInsertdata.json')}")
        exceptcode = os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryQps.json')}")
        assert exceptcode == 0
        exceptcode = os.system(f"{binPath} -f {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'json', 'queryQps1.json')}")
        assert exceptcode == 0
