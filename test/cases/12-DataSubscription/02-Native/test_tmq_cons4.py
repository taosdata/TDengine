...
class TestTmpCons4:
    ...
    def test_tmq_Cons4(self):
        ...
        History:
            - 2025-5-9 Simon Guan migrated from tsim/tmq/basic4Of2Cons.sim
        ...
        while True:
            ...
            if tdSql.getRows() == 2:
                ...
                sumOfConsRow = tdSql.getData(0, 3) + tdSql.getData(1, 3)
                tdSql.checkAssert(sumOfConsRow == totalMsgOfStb)
