...
class TestUdfTest:
    ...
    def run_change_udf_normal(self, func_name):
    ...
    def run_change_udf_failed(self, func_name, lib_name):
    ...
    def run_change_udf_reverse(self):
        tdSql.execute("create database if not exists db  duration 100")
        tdSql.execute("use db")
    ...
    def run_unexpected_using(self):
        ...
        self.run_change_udf_normal("change_udf_normal")
        self.run_change_udf_failed("change_udf_no_init", self.libchange_udf_no_init)
        
        self.run_change_udf_normal("change_udf_normal")
        self.run_change_udf_failed("change_udf_no_process", self.libchange_udf_no_process)
        
        self.run_change_udf_normal("change_udf_normal")
        self.run_change_udf_failed("change_udf_no_destroy", self.libchange_udf_no_destroy)
        
        self.run_change_udf_normal("change_udf_normal")
        self.run_change_udf_failed("change_udf_init_failed", self.libchange_udf_init_failed)
        
        self.run_change_udf_normal("change_udf_normal")
        self.run_change_udf_failed("change_udf_process_failed", self.libchange_udf_process_failed)
        
        self.run_change_udf_normal("change_udf_normal")
        self.run_change_udf_failed("libchange_udf_destroy_failed", self.libchange_udf_destroy_failed)
    ...
    def test_udf_test(self):
        ...
        History:
            - 2025-11-02 Alex Duan Migrated from uncatalog/system-test/0-others/test_udf_test.py
        ...
        self.run_unexpected_using()
        self.create_udf_function()
        self.run_change_udf_reverse()
