...
class TestCase:
    ...
    def s2_create_rsma(self):
        ...
        tdSql.error("create rsma rsma15 on d0.stb0 function(min(c0), max(c1), avg(c2), sum(c3),first(c4),min(c5)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : min", fullMatched=False)
        tdSql.error("create rsma rsma16 on d0.stb0 function(min(c4)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : min", fullMatched=False)
        tdSql.error("create rsma rsma17 on d0.stb0 function(min(c5)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : min", fullMatched=False)
        tdSql.error("create rsma rsma18 on d0.stb0 function(min(c6)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : min", fullMatched=False)
        tdSql.error("create rsma rsma19 on d0.stb0 function(max(c4)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : max", fullMatched=False)
        tdSql.error("create rsma rsma20 on d0.stb0 function(max(c5)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : max", fullMatched=False)
        tdSql.error("create rsma rsma21 on d0.stb0 function(max(c6)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : max", fullMatched=False)
        tdSql.error("create rsma rsma22 on d0.stb0 function(avg(c4)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : avg", fullMatched=False)
        tdSql.error("create rsma rsma23 on d0.stb0 function(avg(c5)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : avg", fullMatched=False)
        tdSql.error("create rsma rsma24 on d0.stb0 function(avg(c6)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : avg", fullMatched=False)
        tdSql.error("create rsma rsma25 on d0.stb0 function(sum(c4)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : sum", fullMatched=False)
        tdSql.error("create rsma rsma26 on d0.stb0 function(sum(c5)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : sum", fullMatched=False)
        tdSql.error("create rsma rsma27 on d0.stb0 function(sum(c6)) interval(1m,5m)", expectErrInfo=f"Invalid parameter data type : sum", fullMatched=False)
