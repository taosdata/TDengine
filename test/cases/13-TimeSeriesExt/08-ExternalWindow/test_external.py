...
class TestExternal:
    ...
    def more_branch_coverage(self):
        ...
        tdSql.query("select * from insert_test")
        tdSql.checkRows(4)
        tdSql.query("select cast(ts as bigint), cast(wstart as bigint), t1 from insert_test order by ts")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, 1700000060000)
        tdSql.checkData(0, 1, 1699999800000)
        tdSql.checkData(0, 2, 1)
        tdSql.checkData(1, 0, 1700000061000)
        tdSql.checkData(1, 1, 1699999800000)
        tdSql.checkData(1, 2, 1)
        tdSql.checkData(2, 0, 1700000120000)
        tdSql.checkData(2, 1, 1699999800000)
        tdSql.checkData(2, 2, 1)
        tdSql.checkData(3, 0, 1700000121000)
        tdSql.checkData(3, 1, 1699999800000)
        tdSql.checkData(3, 2, 1)
