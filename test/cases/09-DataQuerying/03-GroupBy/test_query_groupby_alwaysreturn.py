...
class TestAggGroupAlwarysReturnValue:
    ...
    def test_query_groupby_alwaysreturn(self):
        ...
        History:
            - 2025-12-19 Alex Duan Migrated from uncatalog/system-test/2-query/test_agg_group_NotReturnValue.py
        ...
        nested_query_test.dropandcreateDB_random("nested", 1, num_random=100)
        self.testTBNameUseJoin()
