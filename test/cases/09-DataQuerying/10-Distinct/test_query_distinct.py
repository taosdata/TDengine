...
class TestDistinct:
    ...
    def test_query_distinct(self):
        ...
        1. Distinct with super/child/normal table
        2. Distinct with multi-columns
        3. Distinct with tag columns
        4. Distinct with where condition
        5. Distinct with sub-query
        6. Distinct error cases
        7. Distinct with CSUM function
        8. Distinct with alias
        9. Distinct with limit and offset
        10. Distinct with order by/group by/fill/slimit (negative cases)
        11. Distinct with aggregation function (negative cases)
        12. Distinct with in/between condition
        13. Distinct with join (negative cases)
        ...
        History:
            ...
            - 2025-12-19 Alex Duan Migrated from uncatalog/system-test/2-query/test_distinct.py

        """
        self.do_sim_distinct()
        self.do_distinct()