...
class TestUserPrivilegeTopic:
    ...
    def test_user_privilege_topic(self):
        ...
        tdSql.checkKeyData("user1", 3, "root_d1")
        tdSql.checkKeyData("user2", 1, "INSERT")
        tdSql.checkKeyData("user2", 3, "root_d2")
        ...
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic1 TO user4")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic2 TO user5")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic3 TO user6")
        tdSql.query(f"show user privileges")
        tdSql.checkRows(7)
        tdSql.checkKeyData("user4", 1, "SUBSCRIBE")
        tdSql.checkKeyData("user4", 4, "root_d1_topic1")
        tdSql.checkKeyData("user5", 1, "SUBSCRIBE")
        tdSql.checkKeyData("user5", 4, "root_d1_topic2")
        tdSql.checkKeyData("user6", 1, "SUBSCRIBE")
        tdSql.checkKeyData("user6", 4, "root_d1_topic3")

        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic3 from user6")
        tdSql.query(f"show user privileges")
        tdSql.checkRows(6)
        tdSql.checkKeyData("user4", 1, "SUBSCRIBE")
        tdSql.checkKeyData("user4", 4, "root_d1_topic1")
        ...
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic1 to user4")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic2 to user4")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic3 to user4")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic1 to user5")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic2 to user5")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic3 to user5")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic1 to user6")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic2 to user6")
        tdSql.execute(f"GRANT subscribe ON topic root_d1.root_d1_topic3 to user6")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic1 from user4")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic2 from user4")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic3 from user4")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic1 from user5")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic2 from user5")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic3 from user5")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic1 from user6")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic2 from user6")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topic3 from user6")

        tdLog.info(f"=============== invalid revoke/grant")
        tdSql.error(f"GRANT subscribe ON topic root_d1.root_d1_topicx from user5")
        tdSql.execute(f"REVOKE subscribe ON topic root_d1.root_d1_topicx from user5") # revoke non-exist privilege is ok
