...
class TestUnion:
    ...
    def test_ts6660(self):
        ...
        History:
            - 2025-8-11 Jinqing Kuang add test for ORDER BY column check in UNION
        ...
        tdSql.execute(f"create table {stb} (attr_time timestamp, BAY_fwdwh_main double) tags (attr_id nchar(256));")
        tdSql.execute(f"create table t1 using {stb} (attr_id) tags ('CN_53_N0007_S0001_BAY0001');")
        tdSql.execute(f"create table t2 using {stb} (attr_id) tags ('CN_53_N0007_S0001_BAY0002');")
        tdSql.execute(f"insert into t1 values ('2025-06-13 00:00:00.0', 130000), ('2025-06-13 07:30:00.0', 130730), ('2025-06-13 07:31:00.0', 130731);")
        tdSql.execute(f"insert into t2 values ('2025-06-13 00:00:00.0', 130000), ('2025-06-13 07:30:00.0', 130730), ('2025-06-13 07:31:00.0', 130731);")
