...
class TestFuncFirst:
    ...
    def test_func_first(self):
        ...
        4. 对超级表执行 First 查询，包括时间窗口、普通数据列筛选、标签列筛选、Group By、Partition By
        ...
        History:
            - 2025-4-23 Simon Guan Migrated to new test framework, from tests/script/tsim/compute/first.sim
