...
class TestFuncLast:
    ...
    def test_func_last(self):
        ...
        2. 创建子表并写入数据
        3. 对子表执行 Last 查询，包括时间窗口、普通数据列筛选
        4. 对超级表执行 Last 查询，包括时间窗口、普通数据列筛选、标签列筛选、Group By、Partition By
        ...
        History:
            - 2025-4-28 Simon Guan Migrated to new test framework, from tests/script/tsim/compute/last.sim
