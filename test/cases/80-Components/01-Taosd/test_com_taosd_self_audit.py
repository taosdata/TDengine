...
class TestTaosdAudit:
    ...
    def test_taosd_audit(self):
        ...
        sql = "select * from audit.operations where operation like 'createStb' and resource like 'stb';"
        tdSql.query(sql)
        tdSql.checkRows(1)
        ...
        sql = "select * from audit.operations where operation like 'createTable' and resource like 'tb';"
        tdSql.query(sql)
        tdSql.checkRows(1)
        ...
        tdLog.info("check create tb")
        sql = "select * from audit.operations where operation like 'insert' and resource like 'db.tb';"
        tdSql.query(sql)
        tdSql.checkRows(1)
