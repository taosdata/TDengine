...
class TestIntColumn:
    ...
    def test_static_create_table(self):
        ...
        tdSql.execute(f"create table mt_tinyint (ts timestamp, c tinyint) tags (tagname tinyint)")
...
tdSql.execute(f'insert into st_tinyint_16 using mt_tinyint tags (NULL)   values (now, NULL)
...
tdSql.execute(f'insert into st_tinyint_17 using mt_tinyint tags (NULL)   values (now, NULL)
...
tdSql.execute(f'insert into st_tinyint_18 using mt_tinyint tags ('NULL')") values (now, 'NULL')
...
tdSql.execute(f'insert into st_tinyint_19 using mt_tinyint tags ('NULL')") values (now, 'NULL')
...
tdSql.execute(f'insert into st_tinyint_20 using mt_tinyint tags ("NULL") values (now, "NULL")
...
tdSql.execute(f'insert into st_tinyint_21 using mt_tinyint tags ("NULL") values (now, "NULL")
...
tdSql.execute(f'insert into st_tinyint_22 using mt_tinyint tags (127)  values (now, 127)
...
tdSql.execute(f'insert into st_tinyint_23 using mt_tinyint tags (-127)  values (now, -127)
...
tdSql.execute(f'insert into st_tinyint_24 using mt_tinyint tags (10)    values (now, 10)
...
tdSql.execute(f'insert into st_tinyint_25 using mt_tinyint tags ("-0") values (now, "-0")
...
tdSql.execute(f'insert into st_tinyint_26 using mt_tinyint tags ('123') values (now, '123')
...
tdSql.execute(f'insert into st_tinyint_27 using mt_tinyint tags (+056) values (now, +00056)
...
tdSql.execute(f'insert into st_tinyint_28 using mt_tinyint tags (-056) values (now, -0056)
...
tdSql.execute(f'insert into st_tinyint_e14_1 using mt_tinyint tags (033) values (now, -128)
...
tdSql.execute(f'insert into st_tinyint_e14 using mt_tinyint tags (-128)     values (now, -033)
...
tdSql.execute(f'insert into st_tinyint_e13 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e14 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e15 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e16 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e17 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e18 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e19 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e20 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e21 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e22 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e23 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e24 using mt_tinyint tags (033) values (now, 00062)
tdSql.execute(f'insert into st_tinyint_e25 using mt_tinyint tags (033) values (now, 00062)
