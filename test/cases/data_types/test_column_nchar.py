...
class TestIntColumn:
    ...
    def test_static_create_table(self):
        ...
        tdSql.execute(f"create table mt_nchar (ts timestamp, c nchar(50)) tags (tagname nchar(50))")
...
tdSql.execute(f'insert into st_nchar_0  using mt_nchar tags (NULL) values(now, NULL)
tdSql.query(f'show tags from st_nchar_0
tdSql.checkData(0, 5, None )
...
tdSql.execute(f'insert into st_nchar_1  using mt_nchar tags (NULL) values(now, NULL)
tdSql.query(f'show tags from st_nchar_1
tdSql.checkData(0, 5, None )
...
tdSql.execute(f'insert into st_nchar_2  using mt_nchar tags ('NULL')") values(now, 'NULL')
tdSql.query(f'show tags from st_nchar_2
tdSql.checkData(0, 5, None )
...
tdSql.execute(f'insert into st_nchar_3  using mt_nchar tags ('NULL')") values(now, 'NULL')
tdSql.query(f'show tags from st_nchar_3
tdSql.checkData(0, 5, None )
...
tdSql.execute(f'insert into st_nchar_4  using mt_nchar tags ("NULL") values(now, "NULL")
tdSql.query(f'show tags from st_nchar_4
tdSql.checkData(0, 5, None )
...
tdSql.execute(f'insert into st_nchar_5  using mt_nchar tags ("NULL") values(now, "NULL")
tdSql.query(f'show tags from st_nchar_5
tdSql.checkData(0, 5, None )
...
tdSql.execute(f'insert into st_nchar_6  using mt_nchar tags (+0123) values(now, +0123)
tdSql.query(f'show tags from st_nchar_6
tdSql.checkData(0, 5,  +0123 )
...
tdSql.execute(f'insert into st_nchar_7  using mt_nchar tags (-01.23) values(now, -01.23)
tdSql.query(f'show tags from st_nchar_7
tdSql.checkData(0, 5,  -01.23 )
...
tdSql.execute(f'insert into st_nchar_8  using mt_nchar tags (+0x01) values(now, +0x01)
tdSql.query(f'show tags from st_nchar_8
tdSql.checkData(0, 5,  +0x01 )
...
tdSql.execute(f'insert into st_nchar_9  using mt_nchar tags (-0b01) values(now, -0b01)
tdSql.query(f'show tags from st_nchar_9
tdSql.checkData(0, 5,  -0b01 )
...
tdSql.execute(f'insert into st_nchar_10  using mt_nchar tags (-0.1e-10) values(now, -0.1e-10)
tdSql.query(f'show tags from st_nchar_10
tdSql.checkData(0, 5,  -0.1e-10 )
...
tdSql.execute(f'insert into st_nchar_11  using mt_nchar tags (+0.1E+2) values(now, +0.1E+2)
tdSql.query(f'show tags from st_nchar_11
tdSql.checkData(0, 5,  +0.1e+2 )
...
tdSql.execute(f'insert into st_nchar_12  using mt_nchar tags (tRue) values(now, tRue)
tdSql.query(f'show tags from st_nchar_12
tdSql.checkData(0, 5,  true )
...
tdSql.execute(f'insert into st_nchar_13  using mt_nchar tags (FalsE) values(now, FalsE)
tdSql.query(f'show tags from st_nchar_13
tdSql.checkData(0, 5,  false )
...
tdSql.execute(f'insert into st_nchar_14  using mt_nchar tags (noW) values(now, noW)
tdSql.query(f'show tags from st_nchar_14
tdSql.checkData(0, 5,  now )
...
tdSql.execute(f'insert into st_nchar_15  using mt_nchar tags (toDay) values(now, toDay)
tdSql.query(f'show tags from st_nchar_15
tdSql.checkData(0, 5,  today )
