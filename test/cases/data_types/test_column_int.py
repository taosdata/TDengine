...
class TestIntColumn:
    ...
    def test_dynamic_create_table(self):
        ...
        tdSql.execute(f'insert into st_int_16 using mt_int tags(NULL) values(now, NULL)')
        ...
        tdSql.execute(f'insert into st_int_17 using mt_int tags(NULL) values(now, NULL)')
        ...
        tdSql.execute(f"insert into st_int_18 using mt_int tags('NULL') values(now, 'NULL')")
        ...
        tdSql.execute(f"insert into st_int_19 using mt_int tags('NULL') values(now, 'NULL')")
        ...
        tdSql.execute(f'insert into st_int_20 using mt_int tags("NULL") values(now, "NULL")')
        ...
        tdSql.execute(f'insert into st_int_21 using mt_int tags("NULL") values(now, "NULL")')
        ...
        tdSql.execute(f'insert into st_int_22 using mt_int tags(2147483647) values(now, 2147483647)')
        ...
        tdSql.execute(f'insert into st_int_23 using mt_int tags(-2147483647) values(now, -2147483647)')
        ...
        tdSql.execute(f'insert into st_int_25 using mt_int tags("-0") values(now, "-0")')
        ...
        tdSql.execute(f"insert into st_int_26 using mt_int tags('123') values(now, '123')")
        ...
        tdSql.execute(f'insert into st_int_27 using mt_int tags(+056) values(now, +00056)')
        ...
        tdSql.execute(f'insert into st_int_28 using mt_int tags(-056) values(now, -0056)')
        ...
        tdSql.execute(f'insert into st_int_1100 using mt_int tags("0x01") values(now, "0x01");')
        ...
        tdSql.execute(f'insert into st_int_1101 using mt_int tags("0b01") values(now, "0b01")')
        ...
        tdSql.execute(f'insert into st_int_1102 using mt_int tags("+0x01") values(now, "+0x01")')
        ...
        tdSql.execute(f'insert into st_int_1103 using mt_int tags("-0b01") values(now, "-0b01")')
        ...
        tdSql.execute(f'insert into st_int_1104 using mt_int tags("-123.1") values(now, "-123.1");')
        ...
        tdSql.execute(f'insert into st_int_1105 using mt_int tags("+123.5") values(now, "+123.5")')
        ...
        tdSql.execute(f'insert into st_int_1106 using mt_int tags("-1e-1") values(now, "-1e-1")')
        ...
        tdSql.execute(f'insert into st_int_1107 using mt_int tags("+0.1235e3") values(now, "+0.1235e3");')
        tdSql.query(f'show tags from st_int_1107')
        tdSql.checkData(0, 5,  124 )

        tdSql.execute(f'insert into st_int_1108 using mt_int tags("-0.11e-30") values(now, "-0.11e-30")')
        ...
        tdSql.execute(f'insert into st_int_1109 using mt_int tags("-1.1e-307") values(now, "-1.1e-307")')
        ...
        tdSql.execute(f'insert into st_int_1110 using mt_int tags( -1e-1 ) values(now, -1e-1);')
        ...
        tdSql.execute(f'insert into st_int_1111 using mt_int tags( +0.1235e3 ) values(now, +0.1235e3)')
        ...
        tdSql.execute(f'insert into st_int_1112 using mt_int tags(-0.11e-30) values(now, -0.11e-30)')
        ...
        tdSql.execute(f'insert into st_int_1113 using mt_int tags(-1.1e-307) values(now, -1.1e-307)')
        ...
        tdSql.execute(f'insert into st_int_1200 using mt_int tags( 0x01) values(now, 0x01)')
        ...
        tdSql.execute(f'insert into st_int_1201 using mt_int tags(0b01 ) values(now, 0b01)')
        ...
        tdSql.execute(f'insert into st_int_1202 using mt_int tags(+0x01) values(now, +0x01)')
        ...
        tdSql.execute(f'insert into st_int_1203 using mt_int tags( -0b01 ) values(now, -0b01)')
    ...
    def test_illegal_input(self):
        ...
        tdSql.error(f'create table st_int_e0 using mt_int tags(-214748364800)')
        #tdSql.error(f'create table st_int_e0 using mt_int tags(12.80)   truncate integer part
        #tdSql.error(f'create table st_int_e0 using mt_int tags(-11.80)')
        ...
        #tdSql.error(f'insert into st_int_e4 values(now, 12.80)')
        #tdSql.error(f'insert into st_int_e5 values(now, -11.80)')
        ...
        tdSql.error(f'insert into st_int_e13 using mt_int tags(033) values(now, 2147483648)')
        tdSql.execute(f'insert into st_int_e14 using mt_int tags(033) values(now, -2147483648)')
        tdSql.error(f'insert into st_int_e15 using mt_int tags(033) values(now, 5147483648)')
        tdSql.error(f'insert into st_int_e16 using mt_int tags(033) values(now, -21474836481)')
        #tdSql.error(f'insert into st_int_e17 using mt_int tags(033) values(now, 12.80)')
        #tdSql.error(f'insert into st_int_e18 using mt_int tags(033) values(now, -11.80)')
        tdSql.error(f'insert into st_int_e19 using mt_int tags(033) values(now, 123abc)')
        tdSql.error(f'insert into st_int_e20 using mt_int tags(033) values(now, "123abc")')
        ...
        tdSql.error(f'insert into st_int_e13 using mt_int tags(2147483648) values(now, -033)')
        tdSql.execute(f'insert into st_int_e14_1 using mt_int tags(-2147483648) values(now, -033)')
        tdSql.error(f'insert into st_int_e15 using mt_int tags(21474836480) values(now, -033)')
        tdSql.error(f'insert into st_int_e16 using mt_int tags(-2147483649) values(now, -033)')
        #tdSql.error(f'insert into st_int_e17 using mt_int tags(12.80) values(now, -033)')
        #tdSql.error(f'insert into st_int_e18 using mt_int tags(-11.80) values(now, -033)')
        tdSql.error(f'insert into st_int_e19 using mt_int tags(123abc) values(now, -033)')
        tdSql.error(f'insert into st_int_e20 using mt_int tags("123abc") values(now, -033)')
        tdSql.error(f'insert into st_int_e22 using mt_int tags(abc) values(now, -033)')
        tdSql.error(f'insert into st_int_e23 using mt_int tags("abc") values(now, -033)')
        tdSql.error(f'insert into st_int_e24 using mt_int tags(" ") values(now, -033)')
        tdSql.error(f'insert into st_int_e25_1 using mt_int tags('') values(now, -033)')
        tdSql.execute(f"insert into st_int_e26_1 using mt_int tags('123') values(now, -033)")
        tdSql.execute(f"insert into st_int_e27_1 using mt_int tags('12.80') values(now, -033)")
        tdSql.execute(f"insert into st_int_e28_1 using mt_int tags('-11.80') values(now, -033)")

        tdSql.execute(f'insert into st_int_e13 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e14 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e15 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e16 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e17 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e18 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e19 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e20 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e21 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e22 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e23 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e24 using mt_int tags(033) values(now, 00062)')
        tdSql.execute(f'insert into st_int_e25 using mt_int tags(033) values(now, 00062)')
