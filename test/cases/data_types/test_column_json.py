...
class TestIntColumn:
    ...
    def test_static_create_table(self):
        ...
        tdSql.execute(f"create table mt_json (ts timestamp, c varchar(50)) tags(tagname json)")
...
tdSql.execute(f'create table st_json_8  using mt_json tags("{\"k1\":\"v1\",\"k2\":\"v2\"}")
...
tdSql.execute(f'insert into st_json_100  using mt_json tags(NULL) values(now,NULL)
...
tdSql.execute(f'insert into st_json_101  using mt_json tags(NULL) values(now,NULL)
...
tdSql.execute(f'insert into st_json_102  using mt_json tags('NULL')") values(now,'NULL')
...
tdSql.execute(f'insert into st_json_103  using mt_json tags('NULL')") values(now,'NULL')
...
tdSql.execute(f'insert into st_json_104  using mt_json tags("NULL") values(now,"NULL")
...
tdSql.execute(f'insert into st_json_105  using mt_json tags("NULL") values(now,"NULL")
...
tdSql.execute(f'insert into st_json_106  using mt_json tags("") values(now,"vc")
...
tdSql.execute(f'insert into st_json_107  using mt_json tags(" ") values(now,"vc")
...
tdSql.execute(f'insert into st_json_108  using mt_json tags("{\"k1\":\"v1\",\"k2\":\"v2\"} ") values(now,"vc")
...
tdSql.execute(f'alter table st_json_108  set tag tagname="{\"k1\":\"v1\",\"k2\":\"v2\"}"
tdSql.query(f'show tags from st_json_108
tdSql.checkData(0, 5,  {"k1":"v1","k2":"v2"} )
