...
class TestFunLag:
    ...
    def test_func_win_lag(self):
        ...
        """
        self.lag_smoke()
        self.lag_input_types()
        self.lag_with_stable()
        self.lag_with_vtable()
        self.lag_error()
    ...
    def lag_input_types(self):
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4), lag(f5), lag(f6), lag(f7), lag(f8), lag(f9), lag(f10), lag(f11), lag(f12) from {dbName}.{tbName}")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
        ...
        tdSql.query(f"SELECT lag(null)")
        tdSql.checkRows(1)
        tdSql.checkData(0, 0, None)

    def lag_with_stable(self):
        vgroups = 4
        dbName = "db"
        tbName = "stb"
        ctbName = "ctb"
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{ctbName}0")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{ctbName}0 where _rowts <= '2025-12-2 1:1:4' and _rowts >= '2025-12-2 1:1:1'")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{ctbName}0 where _rowts <= '2025-12-2 1:1:3' and _rowts >= '2025-12-2 1:1:2' order by _rowts asc")
        tdSql.checkRows(2)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from (select * from {dbName}.{ctbName}0 where _rowts <= '2025-12-2 1:1:3' and _rowts >= '2025-12-2 1:1:2' order by _rowts desc)")
        tdSql.checkRows(2)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p from {dbName}.{tbName} partition by tbname")
        tdSql.checkRows(8)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
    ...
    def lag_with_vtable(self):
        ...
        tdSql.checkData(3, 10, 9)
        tdSql.checkData(3, 11, 81)
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{vtName}")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{tbName} where _rowts <= '2025-12-2 1:1:4' and _rowts >= '2025-12-2 1:1:1'")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
        ...
        tdSql.checkData(3, 10, 9)
        tdSql.checkData(3, 11, 81)
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{vtName} where _rowts <= '2025-12-2 1:1:4' and _rowts >= '2025-12-2 1:1:1'")
        tdSql.checkRows(4)
        tdSql.checkData(0, 0, '2025-12-2 1:1:1')
        tdSql.checkData(0, 1, 1)
        tdSql.checkData(0, 2, 2)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{tbName} where _rowts <= '2025-12-2 1:1:3' and _rowts >= '2025-12-2 1:1:2' order by _rowts asc")
        tdSql.checkRows(2)
        tdSql.checkData(0, 0, '2025-12-2 1:1:2')
        tdSql.checkData(0, 1, None)
        tdSql.checkData(0, 2, 4)
        ...
        tdSql.checkData(1, 10, 0)
        tdSql.checkData(1, 11, 25)
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from {dbName}.{vtName} where _rowts <= '2025-12-2 1:1:3' and _rowts >= '2025-12-2 1:1:2' order by _rowts asc")
        tdSql.checkRows(2)
        tdSql.checkData(0, 0, '2025-12-2 1:1:2')
        tdSql.checkData(0, 1, None)
        tdSql.checkData(0, 2, 4)
        ...
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from (select * from {dbName}.{tbName} where _rowts <= '2025-12-2 1:1:3' and _rowts >= '2025-12-2 1:1:2' order by _rowts desc)")
        tdSql.checkRows(2)
        tdSql.checkData(0, 0, '2025-12-2 1:1:3')
        tdSql.checkData(0, 1, 5)
        tdSql.checkData(0, 2, None)
        ...
        tdSql.checkData(1, 10, 0)
        tdSql.checkData(1, 11, 25)
        tdSql.query(f"SELECT _rowts, lag(f1) f1l, lag(f2) f2l, lag(f1)*lag(f2) p, lag(f3), lag(f3)*lag(f2), lag(f3)*lag(f1), lag(f4), lag(f4)*lag(f1), lag(f4)*lag(f2), lag(f4)*lag(f3), lag(f4)*lag(f4) from (select * from {dbName}.{vtName} where _rowts <= '2025-12-2 1:1:3' and _rowts >= '2025-12-2 1:1:2' order by _rowts desc)")
        tdSql.checkRows(2)
        tdSql.checkData(0, 0, '2025-12-2 1:1:3')
        tdSql.checkData(0, 1, 5)
        tdSql.checkData(0, 2, None)
