...
class TestInterp:
    ...
    def check_interp_fill_extension(self):
        ...
        tdSql.error(sql, -2147473747) ## TSDB_CODE_PAR_INVALID_FILL_TIME_RANGE
    ...
    def check_interval_fill_extension(self):
        ...
        tdSql.error(sql, -2147473749) ## TSDB_CODE_PAR_NOT_ALLOWED_FILL_MODE

        sql = f"select count(*) from test.meters interval(1s) fill(prev, 1)"
        tdSql.error(sql, -2147473748) ## TSDB_CODE_PAR_NOT_ALLOWED_FILL_VALUES
