...
class TestCase:
    ...
    def test_tmq_offset(self):
        """Basic: Offset variant
        
        1. Test offset reset behavior
        2. Verify offset commit timing
        3. Test offset position query
        4. Validate offset persistence across restarts
