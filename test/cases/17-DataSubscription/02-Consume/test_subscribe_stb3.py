...
class TestCase:
    ...
    def tmqCase10(self, cfgPath, buildPath):
        ...
        consumerId     = 1
        ifManualCommit = 1
        tmqCom.insertConsumerInfo(consumerId, expectrowcnt-10000,topicList,keyList,ifcheckdata,ifManualCommit, useConsumerIdTimestamp=False)
        tmqCom.startTmqSimProcess(pollDelay,parameterDict["dbName"],showMsg, showRow)
    ...
    def tmqCase13(self, cfgPath, buildPath):
        ...
        keyList        = 'group.id:cgrp1,\
                          ...
                          auto.commit.interval.ms:6000,\
                          auto.offset.reset:earliest'
        tmqCom.insertConsumerInfo(consumerId, expectrowcnt/2,topicList,keyList,ifcheckdata,ifManualCommit, useConsumerIdTimestamp=False)
