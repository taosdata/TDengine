...
class TestCase:
    ...
    def test_replay(self):
        ...
        1. Create replay scenario
        2. Setup initial consumption
        3. Execute replay from offset
        4. Verify replayed data correct
        5. Check replay completeness
        ...
        History:
            - 2025-12-23 Alex Duan Migrated from uncatalog/system-test/7-tmq/test_replay.py
