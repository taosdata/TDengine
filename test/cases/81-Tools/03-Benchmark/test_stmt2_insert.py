...
class TestStmt2Insert:
    ...
    def test_stmt2_insert(self):
        ...
        self.testBenchmarkJson(benchmark, "./81-Tools/03-Benchmark/json/stmt2_insert_batch_autoctb_yes.json")
        self.testBenchmarkJson(benchmark, "./81-Tools/03-Benchmark/json/stmt2_insert_batch_autoctb_no.json")
        # interlace - auto-create-table(yes or no)
        self.testBenchmarkJson(benchmark, "./81-Tools/03-Benchmark/json/stmt2_insert_interlace_autoctb_yes.json")
        self.testBenchmarkJson(benchmark, "./81-Tools/03-Benchmark/json/stmt2_insert_interlace_autoctb_no.json")
        # csv - (batch or interlace)
        self.testBenchmarkJson(benchmark, "./81-Tools/03-Benchmark/json/stmt2_insert_csv_interlace_autoctb_yes.json")
        self.testBenchmarkJson(benchmark, "./81-Tools/03-Benchmark/json/stmt2_insert_csv_batch_autoctb_no.json")
        '''
