...
class TestUdf:
    ...
    def test_udf(self):
        ...
        os.system("cases/25-UDFs/sh/prepare_pyudf.sh")
        os.system("mkdir -p /tmp/pyudf")
        os.system("cp cases/25-UDFs/sh/pybitand.py /tmp/pyudf/")
        os.system("cp cases/25-UDFs/sh/pyl2norm.py /tmp/pyudf/")
        os.system("cp cases/25-UDFs/sh/pycumsum.py /tmp/pyudf/")
