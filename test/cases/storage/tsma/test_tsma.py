...
class TestTsma:
    ...
    def tsma_query_with_tsma(self):
        ...
        self.tsma_query_with_tsma_interval()
        self.tsma_query_with_tsma_agg()
        if not ignore_some_tests:
            self.tsma_recursive_tsma()
        self.tsma_query_interval_sliding()
        self.tsma_union()
        self.tsma_query_child_table()
        self.tsma_skip_tsma_hint()
        self.tsma_long_tsma_name()
        self.tsma_long_ctb_name()
        self.tsma_add_tag_col()
        self.tsma_modify_col_name_value()
        self.tsma_alter_tag_val()
        if not ignore_some_tests:
            self.tsma_ins_tsma()

    def tsma_ins_tsma(self):
    ...
    def tsma_modify_col_name_value(self):
    ...
    def tsma_query_child_table(self):
    ...
    def tsma_recursive_tsma(self):
        ...
        self.tsma_tester.check_sql(sql, ctx)
        self.check(self.tsma_query_tsma_all(select_func_list))
        self.create_recursive_tsma(
    ...
    def tsma_query_with_tsma_interval(self):
        self.check(self.tsma_query_with_tsma_interval_possibly_partition())
        self.check(self.tsma_query_with_tsma_interval_partition_by_col())

    def tsma_query_tsma_all(self, func_list: List = ['avg(c1)', 'avg(c2)']) -> List:
        ctxs = []
    ...
    def tsma_query_with_tsma_interval_possibly_partition(self,db_name: str = 'test'):
        ...
        ctxs.extend(self.tsma_query_tsma_all()) 
        return ctxs

    def tsma_query_with_tsma_interval_partition_by_col(self):
        return []

    def tsma_query_with_tsma_agg(self):
        self.check(self.tsma_query_with_tsma_agg_no_group_by())
        self.check(self.tsma_query_with_tsma_agg_group_by_tbname())
        self.check(self.tsma_query_with_tsma_with_having())

    def tsma_query_with_tsma_agg_no_group_by(self, db_name: str = 'test'):
        ctxs: List[TSMAQueryContext] = []
    ...
    def tsma_query_with_tsma_agg_group_by_tbname(self,  db_name: str = 'test'):
        ctxs: List[TSMAQueryContext] = []
    ...
    def tsma_query_with_tsma_with_having(self):
        return []
    ...
    def tsma_create_diffrent_tsma_name(self):
        ...
        self.tsma_create_and_drop_tsma('meters', 'test', 'meters', ['count(c1)', 'avg(c2)'], '5m')
        self.tsma_create_and_drop_tsma('t1', 'test', 'meters', ['count(c1)', 'avg(c2)'], '5m')
        self.tsma_create_and_drop_tsma('test', 'test', 'meters', ['count(c1)', 'avg(c2)'], '5m')
