...
class TestVTableQueryCrossDBStbAggVtbRef4:
    updatecfgDict = {
        "supportVnodes": "1000",
    }
    ...
    def test_select_virtual_super_table(self):
        """Query: cross db virtual stable agg query with virtual table ref - partition expression

        1. test vstable select super table agg with partition expression
