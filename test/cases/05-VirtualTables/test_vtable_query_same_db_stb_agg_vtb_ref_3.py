...
class TestVTableQuerySameDBStbAggVtbRef3:
    updatecfgDict = {
    ...
    def setup_class(cls):
        ...
        vtbUtil.prepare_same_db_vtables(mode=2, ref_mode="virtual_ref")
    ...
    def test_select_virtual_super_table(self):
        """Query: same db virtual stable agg query with virtual table ref - tag condition

        1. test vstable select super table agg with tag condition
