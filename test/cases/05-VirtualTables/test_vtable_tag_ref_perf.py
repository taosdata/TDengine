...
class TestVtableTagRefPerf:
    ...
    def setup_class(cls):
        ...
        # ===========================================================
        tdSql.execute("CREATE DATABASE perf_tagref_scale VGROUPS 2 BUFFER 16;")
        ...
        # ===========================================================
        tdSql.execute("CREATE DATABASE perf_tagref_vgroup VGROUPS 4 BUFFER 16;")
        ...
        # ===========================================================
        tdSql.execute("CREATE DATABASE perf_tagref_many VGROUPS 2 BUFFER 16;")
        ...
        # ===========================================================
        tdSql.execute("CREATE DATABASE perf_tagref_mixed VGROUPS 2 BUFFER 16;")
        ...
        # ===========================================================
        tdSql.execute("CREATE DATABASE perf_tagref_data VGROUPS 2 BUFFER 16;")
