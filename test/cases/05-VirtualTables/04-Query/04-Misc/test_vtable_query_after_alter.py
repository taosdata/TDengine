...
class TestVtableQueryAfterAlter:
    ...
    def setup_class(cls):
        ...
        datafile = etool.getFilePath(os.path.dirname(os.path.dirname(__file__)), "data", "data1.csv")
        tdSql.execute("insert into vtb_org_normal_0 file '%s';" % datafile)
        tdSql.execute("insert into vtb_org_child_0 file '%s';" % datafile)

        datafile = etool.getFilePath(os.path.dirname(os.path.dirname(__file__)), "data", "data2.csv")
        tdSql.execute("insert into vtb_org_normal_1 file '%s';" % datafile)
        tdSql.execute("insert into vtb_org_child_1 file '%s';" % datafile)

        datafile = etool.getFilePath(os.path.dirname(os.path.dirname(__file__)), "data", "data3.csv")
