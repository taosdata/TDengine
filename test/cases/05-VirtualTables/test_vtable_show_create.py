...
class TestVTableShowCreate:

    def setup_class(cls):
        tdLog.info(f"prepare org tables.")

        tdSql.execute("drop database if exists test_vtable_show_create;")
        tdSql.execute("create database test_vtable_show_create;")
        tdSql.execute("use test_vtable_show_create;")
    ...
    def test_show_create_virtual_table(self):
        ...
        History:
            - 2026-1-2 Jing Sima Created

        """
        self.run_normal_query("test_vtable_show_create")
