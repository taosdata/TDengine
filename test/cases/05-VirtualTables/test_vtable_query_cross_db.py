...
class TestVtableQueryCrossDB:
    ...
    def setup_class(cls):
        ...
        tdSql.execute(f"CREATE VTABLE `vtb_virtual_ntb_full` ("
                      ...
                      "u_smallint_col smallint unsigned from test_vtable_select_1.vtb_org_normal_1.u_smallint_col, "
                      "u_int_col int unsigned from test_vtable_select_2.vtb_org_normal_2.u_int_col, "
                      "u_bigint_col bigint unsigned from test_vtable_select_3.vtb_org_normal_0.u_bigint_col, "
                      "tinyint_col tinyint from test_vtable_select_2.vtb_org_normal_1.tinyint_col, "
                      "smallint_col smallint from test_vtable_select_0.vtb_org_normal_2.smallint_col, "
                      "int_col int from test_vtable_select_1.vtb_org_normal_0.int_col, "
                      "bigint_col bigint from test_vtable_select_2.vtb_org_normal_1.bigint_col, "
                      "float_col float from test_vtable_select_3.vtb_org_normal_2.float_col, "
                      "double_col double from test_vtable_select_2.vtb_org_normal_0.double_col, "
                      "bool_col bool from test_vtable_select_0.vtb_org_normal_1.bool_col, "
                      "binary_16_col binary(16) from test_vtable_select_1.vtb_org_normal_2.binary_16_col,"
                      "binary_32_col binary(32) from test_vtable_select_2.vtb_org_normal_0.binary_32_col,"
                      "nchar_16_col nchar(16) from test_vtable_select_3.vtb_org_normal_1.nchar_16_col,"
                      "nchar_32_col nchar(32) from test_vtable_select_2.vtb_org_normal_2.nchar_32_col)")
        ...
        tdSql.execute(f"CREATE VTABLE `vtb_virtual_ntb_half_full` ("
                      ...
                      "tinyint_col tinyint, "
                      "smallint_col smallint, "
                      "int_col int from test_vtable_select_3.vtb_org_normal_0.int_col, "
                      "bigint_col bigint from test_vtable_select_2.vtb_org_normal_1.bigint_col, "
                      "float_col float from test_vtable_select_0.vtb_org_normal_2.float_col, "
                      "double_col double, "
                      "bool_col bool, "
                      "binary_16_col binary(16),"
                      "binary_32_col binary(32) from test_vtable_select_1.vtb_org_normal_0.binary_32_col,"
                      "nchar_16_col nchar(16) from test_vtable_select_2.vtb_org_normal_1.nchar_16_col,"
                      "nchar_32_col nchar(32) from test_vtable_select_3.vtb_org_normal_2.nchar_32_col)")
        ...
        tdSql.execute(f"CREATE VTABLE `vtb_virtual_ctb_half_full` ("
                      ...
                      "u_smallint_col from test_vtable_select_1.vtb_org_normal_1.u_smallint_col, "
                      "u_int_col from test_vtable_select_2.vtb_org_normal_2.u_int_col, "
                      "int_col from test_vtable_select_3.vtb_org_normal_0.int_col, "
                      "bigint_col from test_vtable_select_2.vtb_org_normal_1.bigint_col, "
                      "float_col from test_vtable_select_0.vtb_org_normal_2.float_col, "
                      "binary_32_col from test_vtable_select_1.vtb_org_normal_0.binary_32_col,"
                      "nchar_16_col from test_vtable_select_2.vtb_org_normal_1.nchar_16_col,"
                      "nchar_32_col from test_vtable_select_3.vtb_org_normal_2.nchar_32_col)"
        ...
        tdSql.execute(f"CREATE VTABLE `vtb_virtual_ctb_mix` ("
                      ...
                      f"u_smallint_col from test_vtable_select_1.vtb_org_child_1.u_smallint_col, "
                      f"u_int_col from test_vtable_select_2.vtb_org_child_2.u_int_col, "
                      f"u_bigint_col from test_vtable_select_3.vtb_org_child_0.u_bigint_col, "
                      f"tinyint_col from test_vtable_select_2.vtb_org_child_1.tinyint_col, "
                      f"smallint_col from test_vtable_select_0.vtb_org_child_2.smallint_col, "
                      f"int_col from test_vtable_select_1.vtb_org_child_0.int_col, "
                      f"bigint_col from test_vtable_select_2.vtb_org_child_1.bigint_col, "
                      f"float_col from test_vtable_select_3.vtb_org_child_2.float_col, "
                      f"double_col from test_vtable_select_2.vtb_org_child_0.double_col, "
                      f"bool_col from test_vtable_select_0.vtb_org_child_1.bool_col, "
                      f"binary_16_col from test_vtable_select_1.vtb_org_child_2.binary_16_col,"
                      f"binary_32_col from test_vtable_select_2.vtb_org_child_0.binary_32_col,"
                      f"nchar_16_col from test_vtable_select_3.vtb_org_child_1.nchar_16_col,"
                      f"nchar_32_col from test_vtable_select_2.vtb_org_child_2.nchar_32_col)"
