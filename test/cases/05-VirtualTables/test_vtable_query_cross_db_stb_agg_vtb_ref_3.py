...
class TestVTableQueryCrossDBStbAggVtbRef3:
    updatecfgDict = {
        "supportVnodes": "1000",
    }
    ...
    def setup_class(cls):
        ...
        vtbUtil.prepare_cross_db_vtables(mode=2, ref_mode="virtual_ref")
    ...
    def test_select_virtual_super_table(self):
        """Query: cross db virtual stable agg query with virtual table ref - time condition

        1. test vstable select super table agg with time condition
