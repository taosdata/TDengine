...
class TestVTableQueryCrossDBStbAggSmaVtbRef:
    updatecfgDict = {
        "supportVnodes": "1000",
    }
    ...
    def setup_class(cls):
        ...
        vtbUtil.prepare_cross_db_vtables(mode=2, sma=True, ref_mode="virtual_ref")
    ...
    def test_select_virtual_super_table(self):
        """Query: cross db virtual stable agg sma query with virtual table ref
