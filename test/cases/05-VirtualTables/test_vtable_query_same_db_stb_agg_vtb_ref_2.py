...
class TestVTableQuerySameDBStbAggVtbRef2:
    updatecfgDict = {
    ...
    def test_select_virtual_super_table(self):
        """Query: same db virtual stable agg query with virtual table ref - group by

        1. test vstable select super table agg group by
