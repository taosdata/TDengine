...
<script>
  import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, prevDate, nextDate, isDate, clearTime as _clearTime, switchTimezone} from '@/utils/date-util';
  ...
  export default {
    ...
    computed: {
      ...
      rows() {
        ...
        const now = getDateTimestamp(switchTimezone(new Date()));
    ...
    methods: {
      ...
      isWeekActive(cell) {
        ...
        const newDate = switchTimezone(new Date(this.year, this.month, 1));
