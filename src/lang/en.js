...
Windows: <code>C:\\Program Files\\taosx\\config</code>`,
    ...
    virtual: {
      grafana: {
        ...
        ste3pwd:'Pawword',
        step3desc3: `Then click <code>Save & Test</code> button to verify if ${grafanagds} data source works. `,
        step3desc:
          `Inside Grafana data source configuration page, copy the service address of taosAdapter and use the correct user name and password to login. `,
        step4: "Use Grafana",
