...
export default {
  ...
  data: {
    ...
    `,
    walRetentionPeriodTip: "The time length of keeping WAL files, it determines the data that can be consumed, the unit is second, the default value is 3600, a value of 0 which means no data can be consumed，please set to a proper positive value if you want to consume data.",
  ...
  dataIn: {
    ...
    successVersionTip: 'Your data source is reachable, its version is {version}, which is supported.',
    unSupportTip:'Your data source is reachable, its version is {version}, which is not supported for now. We are sorry for your inconvenience, please contact TDengine team, we will add the support for your data source version in future.',
