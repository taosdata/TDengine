...
Windows: <code>C:\\TDengine\\cfg\\</code>`,
    ...
    virtual: {
      grafana: {
        ...
        step3desc: `Inside Grafana data source configuration page, config the host as taos-adapter server address(always be <strong>http://ip:6041</strong>), then input database username and password to login to TDengine, then click <code>Save & Test</code> button to verify if ${grafanagds} data source works.  `,
        step4: "Use Grafana",
