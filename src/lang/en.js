...
Windows: <code>C:\\TDengine\\cfg\\</code>`,
    ...
    connector: {
      ...
      odbc: {
        ...
        step11desc1: 'Download the latest version from the TDengine website ',
        step11desc2: 'Windows X64 client driver',
        step11desc3: ',And install it on a machine running PowerBI.',
        step12desc1: 'Windows X64 ODBC connector',
        step12desc2: ',After the installation is successful, you can view TAOS_ODBC_DSN Driver in ODBC Data Source (64-bit) Management Tool.',
        step2: 'Configure',
        ...
        step22desc: 'Select "User DSN" tab, and click "Add" to enter the page for "Create Data Source".',
        step23desc:
        ...
        step23desc8: '[Server]:',
        step23desc9: 'Enter the service address of TDengine, for example, 192.168.1.100:6030 (Cloud services are not supported).',
        step23desc10: '[UserID]:',
        ...
        step24desc: 'Click "Test Connection" to test whether the data source can be connectted; if successful, it will prompt "Successfully".'
      }
    },
    party: {
      prometheus: {
    ...
    tools: {
      ...
      powerbi: {
        ...
        step1desc: 'Power BI Desktop has been installed and running. (If not, please download and install latest Windows X64 version from ',
        step1desc1: 'PowerBI',
        step1desc2: '.)',
        ...
        step4desc2: 'If you want to input some specific SQL, click "Advanced Options", and input your SQL in the open dialogue box and load the data.',
        step4desc3:
      ...
      yonghongbi: {
        ...
        step36desc: 'Click "Test connection" and the dialog box "Test success" will pop up. Click the "Save" button and enter "tdengine" to save the TDengine data source.',
        step4: 'Create data set',
        step4full: 'Create TDengine datasets',
        step41desc: 'Click "Add Data Set" in the BI tool, expand the data source you just created, and browse the super table in TDengine.',
        step42desc: 'You can load all the data of the super table into the BI tool, or you can import some data through custom SQL statements.',
        step43desc: 'When "Computation in Database" is selected, the BI tool will no longer cache TDengine timing data and will send SQL requests to TDengine for direct processing when processing queries.',
        step44desc:
        ...
        step44desc2: '.By using these featured queries, BI tools can greatly improve data access speed and reduce network transmission bandwidth when they send SQL queries to TDengine databases. ',
        step45desc:
