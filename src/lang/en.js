...
export default {
  ...
  datasource: {
    ...
    transformer: {
      ...
      For more detailed rules, please refer to <a href="/docs-en/enterprise/datain/transformer/#2-extractsplit">the enterprise version documentation</a>.`,
      ...
      Multiple expressions</strong> can be combined with logical operators <em>&&</em> or <em>||</em>. For more detailed rules, please refer to <a href="/docs-en/enterprise/datain/transformer/#3-filter">the enterprise version documentation</a>.`,
      ...
      For more detailed rules, please refer to <a href="/docs-en/enterprise/datain/transformer/#4-mapping">the enterprise version documentation</a>.`,
