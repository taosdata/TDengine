...
Windows： <code>C:\\TDengine\\cfg\\</code>`,
    ...
    virtual: {
      grafana: {
        ...
        step3: "添加数据源",
        step3desc: `在Grafana数据源配置页面中，配置 taos-adapter 服务地址，一般是 <strong> http://ip:6041 </strong>，输入数据库用户名密码登陆 ${grafanagds}，然后点击 <code>Save & Test</code> 按钮来验证 ${grafanagds} 是否能够工作。`,
        step4: "使用 Grafana",
