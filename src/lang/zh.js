...
export default {
  ...
  datasource: {
    transformer: {
      ...
      可使用 && 或 || 组合多个判断表达式。<span style="${IS_COMMUNITY ? 'display:none': 'display:inline-block'}">更详细过滤规则请访问<a href="/docs/advanced/data-in/#${encodeURIComponent('过滤')}" target="_blank">企业版文档<a>。</span>`,
...
Windows： <code>C:\\TDengine\\cfg\\</code>`,
    ...
    virtual: {
      grafana: {
        ...
        topdesc1: `   快速集成搭建数据监测报警系统，整个过程无需任何代码开发。${grafanagds} 中数据表的内容可以在仪表盘(DashBoard)上进行可视化展现。关于 ${grafanagds} 插件的使用您可以查看 `,
        ...
        step3desc1: "Host:",
        step3desc2: "User:",
        step3desc3: `输入密码登录 ${grafanagds}，然后点击 <code>Save & Test</code> 按钮来验证 ${grafanagds} 是否能够工作。`,
  ...
  slowSql: {
    ...
    rowsNum: "返回行数",
    queryTime: "执行耗时(秒)",
    averageTime: "平均执行时间(秒)",
    maximumTime: "最大执行时间(秒)",
    averageRow: "平均返回行数",
    maximumRow: "最大返回行数",
    executionTimes: "执行次数",
