  ...
  //     9: '在资源管理器中刷新代理状态，以检查代理是否正确连接。当代理成功连接时，代理的状态将显示为"Idle"。'
    ...
    virtual: {
      grafana: {
        ...
        plugin1desc:`1. 在浏览器打开 Grafana 后点击三个横条图标，然后再点击 “Connections”。`,
        plugin2desc:`2. 在弹出页面的搜索栏内搜索 ${grafanagds}，然后会弹出 "${grafanagds} Data Source"。 `,
        plugin3desc:`3. 最后点击 “Install” 按钮安装 ${grafanagds} 插件。`,
    ...
    dashboard:{
      ...
      step5: '添加Dashboard',
      desc51:`1. 数据源工作后，单击数据源配置页面上的“仪表板”选项卡。`,
      desc52:`2. 选择TDengine for 3.x点击倒入。`,
      desc53:`3. 单击三个水平条图标，然后单击“Dashboards”，搜索“TDinsight”，然后单击它。`,
