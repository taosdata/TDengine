<template>
  <div class="flexBetween">
    <el-form :disabled="requestIng" ref="inputCsvForm" :model="inputCsvForm" label-position="left" label-width="120px">
      ...
      <el-form-item>
        <el-button class="w100" type="primary" :loading="requestIng" :disabled="submitDisabled" @click="submitForm">{{ $t("submit") }}</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      submitDisabled() {
        return this.requestIng || !this.inputCsvForm.dbName || !this.inputCsvForm.tbName || !this.inputCsvForm.data;
      },
    },
    created() {
      this.getDBList();
