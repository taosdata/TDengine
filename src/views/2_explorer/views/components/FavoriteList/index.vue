  ...
  <el-row class="favorites_wrapper" :gutter="20">
    <el-col :span="12">
      <el-card shadow="always">
        ...
        <el-empty :image-size="imageSize" v-if="favorites.length === 0"></el-empty>
        <template v-else>
          <RecordItem v-for="record in favorites" :key="record.id" :record="record"></RecordItem>
        </template>
      </el-card>
    </el-col>
    <el-col :span="12">
      <el-card shadow="always">
        ...
        <el-empty :image-size="imageSize" v-if="sharedFavorites.length === 0"></el-empty>
        <template v-else>
          <RecordItem v-for="record in sharedFavorites" :isShared="true" :key="record.id" :record="record"></RecordItem>
        </template>
      </el-card>
    </el-col>
  </el-row>
