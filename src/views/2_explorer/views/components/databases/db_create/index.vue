<template>
  <div class="dbCreate" :style="isExplorerComp ? {} : { padding: '0 20px' }">
    <div
      :class="[
        'dbCreate_title',
        isExplorerComp ? '' : 'datain_style color_style',
      ]"
    >
      {{ formTitle }}
    </div>
    <div class="formWrapper">
      ...
      <div class="section2">
        ...
        >
          <el-collapse
            v-model="activeNames"
            :class="isExplorerComp ? '' : 'data-collapse'"
          >
            <el-collapse-item
              :title="$t('data.performanceRelatedParameters')"
              name="1"
            >
              <div class="column1">
                <!-- BUFFER -->
                ...
                <el-form-item>
                  <span slot="label">
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.cacheModelTip')"
                      ></div>
                      <Icon name="info" class="lableTips_icon"></Icon>
                    </el-tooltip>
                  </span>
                  <el-select
                    v-model="db_form.cachemodel"
                    placeholder="none"
                    class="w100"
                    style="width: 130px"
                  >
            ...
            <el-collapse-item
              :title="$t('data.dataPersistenceParameters')"
              name="2"
            >
              <div class="column1">
                <el-form-item>
                ...
                <el-form-item>
                  <span slot="label">
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.walRetentionPeriodTip')"
                      ></div>
                      <Icon name="info" class="lableTips_icon"></Icon>
                    </el-tooltip>
                  </span>
                ...
                <el-form-item>
                  <span slot="label">
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.walRollPeriodTip')"
                      ></div>
                      <Icon name="info" class="lableTips_icon"></Icon>
                    </el-tooltip>
                  </span>
                ...
                <el-form-item>
                  <span slot="label">
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.walRetentionSizeTip')"
                      ></div>
                      <Icon name="info" class="lableTips_icon"></Icon>
                    </el-tooltip>
                  </span>
                ...
                <el-form-item>
                  <span slot="label">
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.walSegmentSizeTip')"
                      ></div>
                      <Icon name="info" class="lableTips_icon"></Icon>
                    </el-tooltip>
                  </span>
                ...
                <el-form-item v-if="db_form.wal_level == 2">
                  <span slot="label">
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.walFsyncPeriodTip')"
                      ></div>
                      <Icon name="info" class="lableTips_icon"></Icon>
                    </el-tooltip>
                  </span>
                ...
                <el-form-item>
                  <span slot="label"
                    ...
                    <el-tooltip placement="bottom" effect="light">
                      <div
                        slot="content"
                        v-html="$t('data.singleStableTip')"
                      ></div>
                      <Icon
                        name="info"
                        class="lableTips_icon"
                      ></Icon> </el-tooltip
                  ></span>
                  <el-switch
                    size="small"
        ...
        <div class="confirm_line" size="medium">
          <el-button
            ...
            >{{ $t(!isEdit ? "create" : "change") }}</el-button
          >
...
export default {
  ...
  computed: {
    ...
    formTitle() {
      return this.isEdit
        ? this.$t("data.editDatabase")
        : this.$t("data.createDatabase");
    },
    isExplorerComp() {
