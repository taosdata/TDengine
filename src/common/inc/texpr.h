...
#define TSDB_FUNC_SCALAR_TIMETRUNCATE     (TSDB_FUNC_FLAG_SCALAR | 0x0017)
#define TSDB_FUNC_SCALAR_TIMEDIFF         (TSDB_FUNC_FLAG_SCALAR | 0x0018)
#define TSDB_FUNC_SCALAR_MAX_NUM      25
