...
#define TAOS_BUILD_FOR_SMALLSIZE

#ifdef  TAOS_BUILD_FOR_SMALLSIZE
#  define TLOG(flags, dflag, fmt, ...)     taosPrintLog(flags, dflag, fmt, ##__VA_ARGS__)
#  define TLOGLONG(flags, dflag, fmt, ...) taosPrintLongString(flags, dflag, fmt, ##__VA_ARGS__) 
#else // TAOS_BUILD_FOR_SMALLSIZE
...
#endif // TAOS_BUILD_FOR_SMALLSIZE
