...
public class WSResultSetMetaData extends WrapperImpl implements ResultSetMetaData {
    private final String database;
    private final List<WSResultSet.Field> fields;

    public WSResultSetMetaData(String database, List<WSResultSet.Field> fields) {
