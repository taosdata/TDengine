...
public class DatetimeBefore1970Test {
    ...
    public void test() throws SQLException {
        try (Statement stmt = conn.createStatement()) {
            // given
            stmt.executeUpdate("insert into weather(ts) values('2020-12-31 23:59:59.999')");
            stmt.executeUpdate("insert into weather(ts) values('2020-01-01 00:00:00.000')");
            stmt.executeUpdate("insert into weather(ts) values('2020-01-01 08:00:00.000')");
            stmt.executeUpdate("insert into weather(ts) values('2020-01-01 07:59:59.999')");
