...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */   174,  541,  174,  195,  301,    1,  816,  620,  869,  542,
 /*    10 */  1004,  202, 1005,   47,   48,  917,   51,   52,  135,  199,
 /*    20 */   207,   41,  174,   50,  251,   55,   53,   57,   54,  196,
 /*    30 */   881,  201, 1005,   46,   45,  277,  276,   44,   43,   42,
 /*    40 */    47,   48,  212,   51,   52,  906,  135,  207,   41,  541,
 /*    50 */    50,  251,   55,   53,   57,   54,   78,  542,  928,  214,
 /*    60 */    46,   45,  758,  303,   44,   43,   42,  866,  906,  854,
 /*    70 */   855,  856,  857,  858,  859,  860,  861,  862,  863,  864,
 /*    80 */   865,  867,  868,  870,  957,  906,  246,  889,  890,   29,
 /*    90 */   893,  218,  297,  495,  496,  497,  498,  499,  500,  501,
 /*   100 */   502,  503,  504,  505,  506,  507,  302,  541,  917,  224,
 /*   110 */    70,   81,  956,   47,   48,  542,   51,   52,  906,  925,
 /*   120 */   207,   41,  234,   50,  251,   55,   53,   57,   54,   44,
 /*   130 */    43,   42,  704,   46,   45,  216,  267,   44,   43,   42,
 /*   140 */    47,   49,  805,   51,   52,  894,  160,  207,   41,  135,
 /*   150 */    50,  251,   55,   53,   57,   54,  287,  130,   30,  220,
 /*   160 */    46,   45,  274,  273,   44,   43,   42,   23,  265,  296,
 /*   170 */   295,  264,  263,  262,  294,  261,  293,  292,  291,  260,
 /*   180 */   290,  289,   23,  265,  296,  295,  264,  263,  262,  294,
 /*   190 */   261,  293,  292,  291,  260,  290,  289,  288,   48,  197,
 /*   200 */    51,   52,  903,  217,  207,   41,  269,   50,  251,   55,
 /*   210 */    53,   57,   54,  248,  135,   75,   17,   46,   45,  239,
 /*   220 */   219,   44,   43,   42,  866,  172,  854,  855,  856,  857,
 /*   230 */   858,  859,  860,  861,  862,  863,  864,  865,  867,  868,
 /*   240 */    51,   52,  814,  252,  207,   41,  160,   50,  251,   55,
 /*   250 */    53,   57,   54,   28,   18,  904,  257,   46,   45,  227,
 /*   260 */    30,   44,   43,   42,  206,  717,  231,  230,  708,   12,
 /*   270 */   711,  183,  714,   80,  892,  145,   69,  184, 1014,   23,
 /*   280 */    76,  296,  295,  114,  113,  182,  294,  806,  293,  292,
 /*   290 */   291,  160,  290,  289,  288,  874,  203,  204,  872,  873,
 /*   300 */   250,  210,   30,  875,  903,  877,  878,  876,  891,  879,
 /*   310 */   880,  882,  206,  717,   24,  710,  708,  713,  711,  900,
 /*   320 */   714,   23,   38,  296,  295,  300,  299,  122,  294,   24,
 /*   330 */   293,  292,  291,  644,  290,  289,  641,   38,  642,  720,
 /*   340 */   643,  128,  101,  233,  203,  204,  902,  287,  874,   38,
 /*   350 */   190,  872,  873,  267,    3,  804,  875,   30,  877,  878,
 /*   360 */   876,  213,  879,  880,  221,  222,   30,   56,  905,   55,
 /*   370 */    53,   57,   54,  660,   77,  685,  686,   46,   45,  919,
 /*   380 */   716,   44,   43,   42,   99,  104,   71,  709,  706,  712,
 /*   390 */    93,  103,  109,  112,  102,  715,    5,  150,  211,  178,
 /*   400 */   106,  903,   33,  149,   88,   83,   87,  270,   30,   30,
 /*   410 */   903,  167,  163,   30,  652,   56,  657,  165,  162,  117,
 /*   420 */   116,  115,  236,   25,  707,   46,   45,  205,  716,   44,
 /*   430 */    43,   42,  237,  672,  676,  677,   31,  132,   60,   20,
 /*   440 */   737,   61,  645,  715,   19,   67,   64,  619, 1001,  271,
 /*   450 */   275,  664,  903,  903,  279,  718,  630,  903, 1000,   19,
 /*   460 */    31,  999,   62,  254,  632,   65,  256,   31,   60,  631,
 /*   470 */    79,    6,  191,   60,   92,   91,   14,   13,   98,   97,
 /*   480 */   192,   16,   15,  648,  646,  649,  647,  111,  110,  127,
 /*   490 */   125,  176,  177,  179,  173,  180,  181,  187,  188,  186,
 /*   500 */   967,  966,  171,  185,  129,  175,  208,  963,  962,  209,
 /*   510 */   278,  927,  934,   39,  936,  131,  144,  949,  948,  146,
 /*   520 */   899,  147,  148,  235,  817,   38,  126,  671,  259,   34,
 /*   530 */   169,   35,  268,  813, 1019,   89, 1018, 1016,  240,  151,
 /*   540 */   272, 1013,   95,   66,  198,  916,  244,   63,  136, 1012,
 /*   550 */    58,  137,  249,  138,  247, 1010,  245,  139,  140,  152,
 /*   560 */   243,  241,  835,   36,   32,   40,  141,  142,   37,  170,
 /*   570 */   802,  105,  800,  107,  100,  280,  108,  281,  798,  797,
 /*   580 */   282,  223,  161,  283,  795,  794,  793,  792,  791,  790,
 /*   590 */   164,  166,  787,  785,  783,  781,  779,  168,  284,  285,
 /*   600 */   238,   72,   73,  950,  286,  298,  756,  193,  215,  226,
 /*   610 */   258,  225,  755,  194,  189,  228,   84,   85,  229,  796,
 /*   620 */   754,  742,  118,  119,  232,  789,  236,  253,  155,  788,
 /*   630 */   154,  836,  153,  156,  157,  159,  158,  120,  121,  780,
 /*   640 */     2,  654,    4,   68,    8,  133,   74,  673,  901,  200,
 /*   650 */   242,  134,  143,  678,   26,    9,   10,  719,   27,    7,
 /*   660 */    11,  721,   21,   22,  255,   82,  583,  579,   80,  577,
 /*   670 */   576,  575,  572,  545,  266,   86,   90,   31,  622,   59,
 /*   680 */    94,  621,  618,  567,  565,  557,  563,  559,   96,  561,
 /*   690 */   555,  553,  586,  585,  584,  582,  581,  580,  578,  574,
 /*   700 */   573,   60,  543,  511,  123,  509,  760,  759,  759,  759,
 /*   710 */   759,  759,  759,  759,  759,  759,  759,  124,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */   276,    1,  276,  215,  216,  223,  224,    5,    0,    9,
 /*    10 */   286,  285,  286,   13,   14,  259,   16,   17,  216,  235,
 /*    20 */    20,   21,  276,   23,   24,   25,   26,   27,   28,  273,
 /*    30 */     0,  285,  286,   33,   34,   33,   34,   37,   38,   39,
 /*    40 */    13,   14,  235,   16,   17,  261,  216,   20,   21,    1,
 /*    50 */    23,   24,   25,   26,   27,   28,  222,    9,  216,  235,
 /*    60 */    33,   34,  213,  214,   37,   38,   39,  234,  261,  236,
 /*    70 */   237,  238,  239,  240,  241,  242,  243,  244,  245,  246,
 /*    80 */   247,  248,  249,  250,  282,  261,  284,  253,  254,  255,
 /*   160 */   522,  466,  526,  526,  466,  526,  466,  526,  466,  718,
 /*   170 */   718,   27,  100,  127,  100,  100,  184,  224,  344,  344,
 /*   180 */   344,  344,  322,  334,  349,  392,  392,  392,  392,   24,
 /*   190 */   125,   92,   92,  165,   68,  261,  309,  327,  328,  329,
 /*   200 */   330,  335,  350,  310,  382,  387,  367,  228,  332,  337,
 /*   210 */   351,  358,  359,  361,  364,  149,  338,  340,  342,  341,
 /*   220 */   345,  478,  479,  411,  427,  601,  468,  604,  607,  472,
 /*   230 */   613,  615,  532,  490,  513,  536,  529,  520,  540,  537,
 /*   240 */   542,  541,  648,  546,  548,  547,  545,  533,  549,  534,
 /*   250 */   552,  555,  550,  556,  520,  558,  557,  559,  560,  589,
 /*   260 */   657,  662,  664,  665,  666,  667,  593,  659,  599,  539,
 /*   270 */   568,  568,  663,  543,  551,  568,  673,  676,  577,  568,
 /*   280 */   678,  679,  680,  681,  682,  684,  685,  686,  687,  688,
 /*   290 */   689,  690,  691,  692,  693,  694,  695,  592,  622,  683,
 /*   300 */   696,  643,  646,  706,
};
...
static const short yy_reduce_ofst[] = {
 /*     0 */  -151, -167,  -10,   61,  114, -166, -274, -254,  -58, -198,
 /*    10 */   -67,   44,  141,  150,  192,  193,  197, -158, -212, -276,
 /*    20 */  -216, -193, -176, -143, -244,  -59, -170,   -2,  103, -111,
 /*    30 */     4,   86,  -79,   54, -218,   21,   66,  135,  112,  -60,
 /*    40 */   -51,  123,  172,  182,  185,  196,  204,  215,  216,  217,
 /*    50 */   218,  219,  220,  221,  222,  223,  226,  227,  229,   17,
 /*    60 */   107,  248,  249,  254,  255,  256,  257,  258,  120,  288,
 /*    70 */   295,  238,  296,  298,  299,  234,  235,  253,  303,  304,
 /*    80 */   305,  306,  308,  312,  313,  314,  315,  316,  317,  318,
 /*    90 */   319,  320,  321,  323,  324,  325,  326,  333,  339,  343,
 /*   100 */   346,  347,  348,  352,  353,  354,  355,  356,  357,  360,
 /*   110 */   362,  363,  365,  366,  368,  369,  370,  371,  372,  373,
 /*   120 */   374,  375,  376,  377,  378,  379,  380,  381,  264,  383,
 /*   130 */   384,  385,  259,  265,  267,  386,  273,  277,  281,  284,
 /*   140 */   289,  291,  300,  302,  388,  389,  390,  391,  393,  394,
 /*   150 */   395,  396,  397,  398,  400,  399,  401,  403,  406,  407,
 /*   160 */   409,  402,  404,  405,  408,  419,  412,  420,  422,  417,
 /*   170 */   423,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */   757,  757,  815,  757,  803,  812, 1007, 1007,  757,  757,
 /*    10 */   757,  757,  757,  757,  757,  757,  757,  929,  776, 1007,
 /*    20 */   757,  757,  757,  757,  757,  757,  757,  757,  757,  812,
 /*    30 */   757,  757,  818,  812,  853,  818,  818,  871,  924,  757,
 ...
 /*   140 */   954,  945,  941,  940,  968,  757,  778,  778,  778,  812,
 /*   150 */   812,  778,  778,  834,  832,  830,  822,  828,  824,  826,
 /*   160 */   820,  778,  810,  810,  778,  810,  778,  810,  778,  853,
 /*   170 */   871,  757,  969,  757, 1006,  959,  996,  995, 1002,  994,
 /*   180 */   993,  992,  757,  757,  757,  988,  989,  991,  990,  757,
 /*   190 */   757,  998,  997,  757,  757,  757,  757,  757,  757,  757,
 /*   200 */   757,  757,  757,  757,  757,  757,  971,  757,  965,  961,
 /*   210 */   757,  757,  757,  757,  757,  757,  757,  757,  757,  883,
 /*   220 */   757,  757,  757,  757,  757,  757,  757,  757,  757,  757,
 /*   230 */   757,  757,  757,  757,  921,  757,  757,  757,  757,  932,
 /*   240 */   757,  757,  757,  757,  757,  757,  955,  757,  947,  757,
 /*   250 */   757,  757,  757,  757,  895,  757,  757,  757,  757,  757,
 /*   260 */   757,  757,  757,  757,  757,  757,  757,  757,  757,  757,
 /*   270 */  1017, 1015,  757,  757,  757, 1011,  757,  757,  757, 1009,
 /*   280 */   757,  757,  757,  757,  757,  757,  757,  757,  757,  757,
 /*   290 */   757,  757,  757,  757,  757,  757,  757,  837,  757,  784,
 /*   300 */   782,  757,  774,  757,
};
...
static const char *const yyRuleName[] = {
 ...
 /* 109 */ "topic_optr ::=",
 /* 110 */ "topic_optr ::= db_optr partitions",
 /* 111 */ "alter_db_optr ::=",
 ...
 /* 121 */ "alter_topic_optr ::=",
 /* 122 */ "alter_topic_optr ::= alter_db_optr partitions",
 /* 123 */ "typename ::= ids",
...
static const YYCODETYPE yyRuleInfoLhs[] = {
   ...
   224,  /* (109) topic_optr ::= */
   224,  /* (110) topic_optr ::= db_optr partitions */
   ...
   220,  /* (121) alter_topic_optr ::= */
   220,  /* (122) alter_topic_optr ::= alter_db_optr partitions */
...
static const signed char yyRuleInfoNRhs[] = {
   ...
   -2,  /* (108) db_optr ::= db_optr cachelast */
    0,  /* (109) topic_optr ::= */
   -2,  /* (110) topic_optr ::= db_optr partitions */
    0,  /* (111) alter_db_optr ::= */
   ...
   -2,  /* (120) alter_db_optr ::= alter_db_optr cachelast */
    0,  /* (121) alter_topic_optr ::= */
   -2,  /* (122) alter_topic_optr ::= alter_db_optr partitions */
   -1,  /* (123) typename ::= ids */
...
{
    yymsp[-1].minor.yy0.n += yymsp[0].minor.yy0.n;
    setDropDbTableInfo(pInfo, TSDB_SQL_DROP_TABLE, &yymsp[-1].minor.yy0, &yymsp[-2].minor.yy0, TSDB_DB_TYPE_DEFAULT, -1);
}
        break;
      case 29: /* cmd ::= DROP STABLE ifexists ids cpxName */
{
    yymsp[-1].minor.yy0.n += yymsp[0].minor.yy0.n;
    setDropDbTableInfo(pInfo, TSDB_SQL_DROP_TABLE, &yymsp[-1].minor.yy0, &yymsp[-2].minor.yy0, TSDB_DB_TYPE_DEFAULT, TSDB_SUPER_TABLE);
}
        break;
...
{ yylhsminor.yy100 = yymsp[-1].minor.yy100; yylhsminor.yy100.cachelast = strtol(yymsp[0].minor.yy0.z, NULL, 10); }
  yymsp[-1].minor.yy100 = yylhsminor.yy100;
        break;
      case 109: /* topic_optr ::= */
{setDefaultCreateTopicOption(&yymsp[1].minor.yy100);}
        break;
      case 110: /* topic_optr ::= db_optr partitions */
      case 122: /* alter_topic_optr ::= alter_db_optr partitions */ yytestcase(yyruleno==122);
