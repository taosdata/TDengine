...
typedef void (*scriptNormalFunc1)(void *pCtx, char* data, int16_t itype, int16_t iBytes, int32_t numOfRows,
                                  int64_t* ptList, int64_t key, char* dataOutput, char* tsOutput, int32_t* numOfOutput, int16_t oType, int16_t oBytes);
typedef void (*scriptNormalFunc2)(void *pCtx, char* data1, int16_t itype1, int16_t iBytes1, char* data2, int16_t itype2, int16_t iBytes2, int32_t numOfRows,
                                  int64_t* ptList, int64_t key, char* dataOutput, char* tsOutput, int32_t* numOfOutput, int16_t oType, int16_t oBytes);
...
// dynamic lib
typedef void (*udfNormalFunc1)(char* data, int16_t itype, int16_t iBytes, int32_t numOfRows, int64_t* ts,
                             char* dataOutput, char* interBuf, char* tsOutput, int32_t* numOfOutput, int16_t oType, int16_t oBytes, SUdfInit* buf);
typedef void (*udfNormalFunc2)(char* data1, int16_t itype1, int16_t iBytes1, char* data2, int16_t itype2, int16_t iBytes2, int32_t numOfRows, int64_t* ts,
                             char* dataOutput, char* interBuf, char* tsOutput, int32_t* numOfOutput, int16_t oType, int16_t oBytes, SUdfInit* buf);
