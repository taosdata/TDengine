...
url &lt;- Sys.getenv("TDENGINE_JDBC_URL")
    ...
    <p>
      ...
      <a :href="`https://docs.${urlPart}.com/develop/insert-data/`">{{ `https://docs.${urlPart}.com/develop/insert-data/` }}</a>
      {{ $t('docs.connector.bottomand') }}
      <a :href="`https://docs.${urlPart}.com/develop/query-data/`">{{ `https://docs.${urlPart}.com/develop/query-data/` }}</a
      >{{ $t('docs.connector.bottom3end') }}
    </p>
    <p>
      {{ $t('docs.connector.bottom3') }}
      <a :href="`https://docs.${urlPart}.com/reference/rest-api`">REST API</a>{{ $t('docs.connector.bottom3end') }}
    </p>
  </div>
</template>
