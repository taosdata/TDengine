...
`
  ...
  -T, --thread-num=THREAD_NUM   Number of thread for dump in file. Default is
                             8.
  -C, --cloud=CLOUD_DSN      specify a DSN to access TDengine  service
...
export default {
  ...
  data() {
    return {
      ...
      linuxcode:`tar -xzf TDengine${this.$COMMUNITY ? '' : '-enterprise'}-client-${localStorage.getItem('agent_version')}-Linux-x64.tar.gz
