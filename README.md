...
This repository contains [TDengine OSS](https://tdengine.com/oss/), our open-source offering. Highlights include:
...
- Built-in caching, stream processing, and data subscription
- Client libraries for mainstream programming languages

TDengine also offers the on-prem [TDengine Enterprise](https://tdengine.com/enterprise/) and fully managed [TDengine Cloud](https://cloud.tdengine.com) built on the TDengine OSS codebase for enterprise customers. In addition to all features of TDengine OSS, these include:

- Ingestion from industrial data sources such as OPC, MQTT, PI System, and Wonderware Historian
- Integration with industry-specific analytics and visualization tools such as Seeq
...
For more information about using and managing TDengine OSS, see [TDengine Documentation](https://docs.tdengine.com).
...
TDengine provides client libraries with which you can develop applications for TDengine. The documentation for these libraries is listed as follows:
...
TDengine also provides a [REST API](https://docs.tdengine.com/reference/rest-api/) through which your applications can connect to TDengine.

# Contribute to TDengine

If you would like to contribute to TDengine, we ask that you review our [contribution guidelines](CONTRIBUTING.md).
