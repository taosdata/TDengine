...
export type TreeKey = string | number | null;
...
export type LoadFunction = (rootNode: Node, loadedCallback: LoadedCallback, stopLoading: () => void) => void;
export type LoadedCallback = (data: TreeData, total?: number) => void;
