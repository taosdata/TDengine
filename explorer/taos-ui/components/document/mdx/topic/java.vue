<template>
  <div>
    <h2 id="init">{{ t('topic.createProject') }}</h2>
    <p>{{ t('topic.step1desc', ['Java']) }}</p>
    <pre
      v-highlight="
        `mvn archetype:generate -DgroupId=com.taos -DartifactId=consumer -Dversion=1.0.0 -DarchetypeArtifactId=maven-archetype-quickstart`
      "
    ><code class="language-bash"></code></pre>
    <p>{{ t('topic.step1desc1', ['consumer/pom.xml']) }}</p>
    <pre
      v-highlight="
        `<properties>
...
TaosConsumer<Map<String, Object>> consumer = new TaosConsumer<>(properties));`
    ...
    <h2 id="subscribe-topic">{{ t('topic.step4') }}</h2>
