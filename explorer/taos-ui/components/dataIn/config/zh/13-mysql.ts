  ...
  config: [
    ...
    },
    {
      ...
      children: [
        {
          label: '连接选项',
          field: '86178942-440e-482c-8f12-30f38a2e7e70',
          description: '其他数据库连接选项。',
          children: [
            {
              label: '字符集',
              description:
                '设置连接的字符集。默认字符集为 utf8mb4 。MySQL 5.5.3 支持此功能。如果需要连接到旧版本，建议改为 utf8 。',
              field: 'charset',
    ...
    },
    {
      ...
      children: [
        {
          label: 'SQL 查询',
          field: '1a8dc601-3288-431d-8e64-aea376388145',
