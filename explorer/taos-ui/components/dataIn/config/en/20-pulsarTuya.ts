  ...
  config: [
    ...
    },
    {
      ...
      children: [
        {
          label: 'Access Id',
          description: 'The Tuya Access Id for authentication.',
          field: 'tuya_access_id',
          required: true,
          placeholder: '',
          pattern: null,
          grid_two: false,
        ...
        {
          label: 'Access Key',
          description: 'The Tuya Access Key for authentication.',
          field: 'tuya_access_key',
          required: true,
          placeholder: '',
          pattern: null,
          grid_two: false,
