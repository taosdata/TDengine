...
export default {
  ...
  invalidZipFile: '无效的 ZIP 文件：{0}',
  failedToUpload: '上传 {0} 失败：{1}',
  zipImportUploadFailed: 'ZIP 导入时上传文件失败：{0}',
  ...
  csvSelectFiles: '请上传文件',
  csvSelectFilesTip: '只能上传csv文件，且文件大小不能超过100MB，支持批量上传',
  csvKeepProcessedFile: '保留已处理文件',
  csvKeepProcessedFileDesc: '处理完CSV文件后，是否保留该文件?',
  ...
  ViewBackPage: '返回',
  dataInTitle: '数据接入',
  dataInTaskTitle: '数据接入任务',
  createDataInTaskTitle: '创建数据接入任务',
  viewDataInTaskTitle: '查看任务',
  editDataInTaskTitle: '编辑任务',
  discardEditConfirm: '当前存在未保存的修改，是否放弃并返回数据接入？',
