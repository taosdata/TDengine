      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
        ...
        <g id="train">
          ...
          <g id="car-layers">
            ...
            <g id="Text">
              <text transform="translate(377.037 230.025)" class="st8 st10" font-size="21">404</text>
              <text transform="translate(659.5 213.994)" class="st8 st10" font-size="24.025">Page not found.</text>
            </g>
            <g id="ladders">
              <g id="ladder-f">
