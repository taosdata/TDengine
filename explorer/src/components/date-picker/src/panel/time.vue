...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange, switchTimezone } from '@/utils/date-util';
  ...
  export default {
    ...
    watch: {
      ...
      value(newVal) {
        ...
        if (newVal instanceof Date) {
          ...
          date = this.defaultValue ? switchTimezone(new Date(this.defaultValue)) : switchTimezone(new Date());
        }
    ...
    data() {
      return {
        ...
        oldValue: switchTimezone(new Date()),
        selectableRange: [],
        selectionRange: [0, 2],
        disabled: false,
        arrowControl: false,
