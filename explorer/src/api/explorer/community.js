...
export function getDataSource(lang, type) {
  ...
  for (let i = 0; i < allDataSources.length; i++) {
    if (allDataSources[i].id === type) {
      return JSON.parse(
        JSON.stringify(allDataSources[i], (k, v) => {
    ...
    return [
      {
        ...
        options: {
          endpoint: {
            ...
            placeholder:
              "Topic example: ws://root:taosdata@127.0.0.1:6041/topic1",
          },
        },
        groups: [
          {
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "Wait for some period to querying random-order data.",
                description:
        ...
        advanced: {
          ...
          params: [
            ...
            },
            {
              ...
              description:
                "Synchronize the changes of all static attribute to TDengine",
              hint: {
                type: "bool",
              },
              value: "true",
          ...
          categories: [
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  description:
                    "Upload a single column mode point list file in CSV format.",
                },
              ],
            },
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  description:
                    "Upload a multi column pattern model configuration file in CSV format.",
                },
              ],
            },
          ],
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                description:
                  "The end time for backfilling data.Cannot be later than the now.\n",
                placeholder: "YYYY-MM-DD HH:mm:ss",
              },
            ],
          },
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Use username/password plain authentication or with certificate files, or anonymous(default).",
          value: "anonymous",
          alternatives: [
            {
              name: "anonymous",
        ...
        groups: [
          {
            ...
            display_order: 1,
            short_description:
              "Configurations for collecting data from OPC UA server.",
            description:
              "Configurations for collecting data from OPC UA server.",
            collapsible: false,
            connection_option: false,
            params: [
              ...
              },
              {
                ...
                short_description:
                  "Timeout for a request to endpoint in seconds",
              ...
              },
              {
                ...
                short_description:
                  "Update the OPC data points interval in seconds.",
                description:
                  "Update the OPC data points interval in seconds.\n",
                value: "600",
              },
          ...
          categories: [
            {
              ...
              target: {
                ...
                description:
                  "Upload a csv file to define the mapping rules for each data point to the TDengine table.\n",
                required: true,
                multiple: true,
                editable: true,
                selectable: true,
            ...
            },
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  multiple: true,
                  placeholder:
                    "Please select after connection check successfully",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "The primary key column name in the target table.\n",
                  required: false,
                  value: "ts",
                },
              ],
          ...
          categories: [
            ...
            },
            {
              ...
              target: {
                name: "select_all_points",
                description:
                  "Select data points that meet specified conditions on the OPC server.\n",
                required: true,
                multiple: true,
                editable: true,
                selectable: true,
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Authentication is the process of verifying the identity before granting access to InfluxDB.",
          value: "2.x",
          alternatives: [
            {
              name: "1.x",
              ...
              params: [
                ...
                },
                {
                  ...
                  hint: "str",
                  description:
                    "This user must have permission to read anything in this organization.",
                  required: true,
            ...
            },
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  required: true,
                  placeholder:
                    "Please input your organization id in the InfluxDB",
                },
                {
                  name: "token",
                  display: "Token",
                  hint: "str",
                  description:
                    "This token must have permission to read anything in this organization.",
                  required: true,
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "The maximum time range every time when retrieving data from InfluxDB.",
                description:
                  "The maximum time range every time when retrieving data from InfluxDB.",
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "The maximum time range every time when retrieving data from OpenTSDB.",
                description:
                  "The maximum time range every time when retrieving data from OpenTSDB.",
                placeholder: "Please input the time range",
                value: "60",
        ...
        groups: [
          {
            ...
            display_order: 0,
            short_description:
              "Use self-signed certificate file and private key.",
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "If the broker does not receive any messages from the",
                description:
              ...
              },
              {
                ...
                short_description:
                  "True means that the server will forget all information",
                description:
            ...
            params: [
              {
                ...
                hint: {
                  type: "str",
                  choices: ["PLAIN", "SCRAM-SHA-256", "GSSAPI"],
                },
              ...
              },
              {
                ...
                short_description:
                  "The username for SASL authentication mechanism.",
              ...
              },
              {
                ...
                short_description:
                  "The password for SASL authentication mechanism.",
              ...
              },
              {
                ...
                description:
                  "The Kerberos service name for GSSAPI authentication mechanism.",
              ...
              },
              {
                ...
                description:
                  "The Kerberos principal for GSSAPI authentication mechanism.",
              ...
              },
              {
                ...
                description:
                  "The Kerberos init command for GSSAPI authentication mechanism.",
                placeholder:
                  "for example: kinit -R -t '%{sasl.kerberos.keytab}' -k %{sasl.kerberos.principal}",
                required: false,
                hint: {
                  type: "str",
                },
              },
              {
                ...
                description:
                  "The Kerberos keytab for GSSAPI authentication mechanism.",
                required: true,
                hint: {
                  type: "file",
                },
            ...
            params: [
              {
                ...
                short_description:
                  "CA certificate file(PEM format) for verifying the broker's key.",
                description:
                  "CA certificate file(PEM format) for verifying the broker's key.",
                required: true,
              },
              ...
              },
              {
                ...
                short_description:
                  "Client's public key file(PEM format) used for authentication.",
                description:
                  "Client's public key file(PEM format) used for authentication.",
                required: true,
              },
              {
                ...
                short_description:
                  "Client's private key file(PEM format) used for authentication.",
                description:
                  "Client's private key file(PEM format) used for authentication.",
                required: true,
              },
            ...
            params: [
              {
                ...
                short_description:
                  "If including header, the first row will be treated as column information.",
                description:
                  "If including header, the first row will be treated as column information.\n",
              },
              {
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Use username and password of AVEVA Historian SQL Server",
          value: "plain",
          alternatives: [
            {
              name: "plain",
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                hint: {
                  type: "str",
                  choices: ["Runtime.dbo.History", "Runtime.dbo.Live"],
                },
                short_description:
              ...
              },
              {
                ...
                short_description:
                  "The start time of the task is in rfc3339 format.",
              ...
              },
              {
                ...
                short_description:
                  "The end time of the task is in rfc3339 format.",
              ...
              },
              {
                ...
                short_description:
                  "Pull interval for real-time data synchronization.",
                description:
                  "Pull interval for real-time data synchronization.",
                required: false,
                placeholder: "The value is an integer ranging [0,60000]",
              ...
              },
              {
                ...
                short_description:
                  "The maximum time limit for tolerating out-of-order data delay.",
                description:
                  "The maximum time limit for tolerating out-of-order data delay.",
                required: false,
                placeholder: "The value is an integer ranging [0,60000]",
        ...
        parser: {
          ...
          fields: [
            ...
            },
            {
              name: "vValue",
              description:
                "The value of the analog, discrete, or string tag stored as a sql_variant.",
              type: "varchar",
            },
            {
              name: "Quality",
            ...
            },
            {
              name: "SourceTag",
              description:
                "The name of the source tag for a replicated tag at the time this point was stored.",
              type: "varchar",
            },
            {
              name: "SourceServer",
              description:
                "The name of the server for this replicated tag at the time this point was stored.",
              type: "varchar",
            },
          ],
        },
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Authentication is the process of verifying the identity before granting access to MySQL.",
          value: "plain",
          alternatives: [
            {
              name: "plain",
            ...
            params: [
              {
                ...
                short_description:
                  "Fields and query statements used for splitting sub tables.",
                description:
                  "Fields and query statements used for splitting sub tables.",
                required: false,
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Authentication is the process of verifying the identity before granting access to PostgreSQL.",
          value: "plain",
          alternatives: [
            {
              name: "plain",
            ...
            params: [
              {
                ...
                short_description:
                  "Set the application name to identify the connecting application.",
                description:
                  "Set the application name to identify the connecting application.",
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Authentication is the process of verifying the identity before granting access to Oracle.",
          value: "plain",
          alternatives: [
            {
              name: "plain",
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Authentication is the process of verifying the identity before granting access to SQL Server.",
          value: "plain",
          alternatives: [
            {
              name: "plain",
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                hint: {
                  type: "str",
                  choices: ["Off", "On", "NotSupported", "Required"],
                },
              ...
              },
              {
                ...
                placeholder:
                  "Please select whether to trust the server certificate",
                value: "true",
              },
              {
                name: "trust_cert_ca",
                ...
                short_description:
                  "The certificate of the CA if you trust the server certificate.",
                description:
                  "The certificate of the CA if you trust the server certificate.",
      ...
      },
      {
        ...
        authentication: {
          display: "Authentication",
          description:
            "Authentication is the process of verifying the identity before granting access to MongoDB.",
          value: "plain",
          alternatives: [
            {
              name: "plain",
              ...
              params: [
                ...
                // },
                {
                  ...
                  short_description:
                    "The default database for storing user information in MongoDB is admin.\n",
                  description:
                    "The default database for storing user information in MongoDB is admin.\n",
                },
              ],
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                required: true,
                placeholder:
                  '{"ddate":{"$gte":${start_datetime},"$lt":${end_datetime}},${col_name1},${col_name2}}',
                grid_two: true,
              },
              {
                name: "sort",
    ...
    return [
      {
        ...
        options: {
          endpoint: {
            ...
            placeholder:
              "Topic 示例: tmq+ws://root:taosdata@localhost:6041/topic",
          },
        },
        groups: [
          {
      ...
      },
      {
        ...
        options: {
          host: {
            ...
            display: "服务器",
            description:
              "TDengine REST API 服务地址。如果应用多节点，建议配合负载均衡器使用。",
            placeholder: "taos-adapter-addr",
          },
          port: {
            required: true,
        ...
        groups: [
          {
            ...
            display_order: 1,
            short_description:
              "支持迁移历史数据或近实时数据同步，也可设置是否总是重建表模型。",
            description:
              "支持迁移历史数据或近实时数据同步，也可设置是否总是重建表模型。",
            collapsible: false,
            connection_option: false,
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "查询数据的基本单元，长时间范围的查询会以此为依据切割为多次查询。",
                description:
            ...
            params: [
              {
                ...
                short_description:
                  "连接丢失或首次启动时自动回填的最长时间：`2d`、`3h`、`4m` 等。",
                description:
                  "连接丢失或首次启动时自动回填的最长时间：`2d`、`3h`、`4m` 等。",
          ...
          params: [
            {
              ...
              display: "同步新增的元素",
              description:
                "监听配置的模板下新增的元素，无需重启任务，即可自动同步新增元素",
              hint: {
                type: "bool",
              },
              value: "true",
            ...
            },
            {
              ...
              display: "同步删除元素的操作",
              description:
                "监听配置的模板下删除元素的事件，并同步删除 TDengine 对应子表",
              hint: {
                type: "bool",
              },
              value: "true",
            ...
            },
            {
              ...
              description:
                "对于某个元素的动态属性，如果在 PI 中历史数据被修改了，TDengine 对应时间的数据也会更新",
              hint: {
                type: "bool",
              },
              value: "true",
          ...
          categories: [
            {
              ...
              display: "单列模式",
              short_description:
                "单列模式基于点位所属 UOM 建立超级表，每一个点位建立一个子表。",
              target: {
                name: "single-column",
              },
              params: [
            ...
            },
            {
              ...
              display: "多列模式",
              short_description:
                "多列模式基于 AF Template 建立超级表，每一个 AF element建立一个子表。",
              target: {
                name: "multi-column",
                selectable: false,
              },
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "动态点位更新间隔，在“点位更新模式”为 append 和 update 时生效，以秒为单位。",
                description:
                  "动态点位更新间隔，在“点位更新模式”为 append 和 update 时生效，以秒为单位。\n",
                value: "600",
              },
          ...
          categories: [
            {
              ...
              target: {
                name: "csv_config_file",
                description:
                  "上传 CSV 配置文件，定义数据点位到 TDengine 数据子表的映射规则。\n",
                required: true,
                multiple: true,
                editable: true,
                selectable: true,
            ...
            },
            {
              ...
              target: {
                name: "select_all_points",
                description:
                  "设置过滤条件，选择 OPC UA 服务器上满足指定条件的数据点位。\n",
                required: true,
                multiple: true,
                editable: true,
                selectable: true,
              ...
              params: [
                ...
                },
                {
                  ...
                  description:
                    "支持 `<super table prefix>_{type}` 格式，`{type}` 表示点位的数据类型。\n",
                  required: true,
                  value: "opc_{type}",
                },
                {
            ...
            },
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  description:
                    "数据点位 id 或者 TagName 需要满足设置的正则表达式。\n",
                },
                {
                  name: "super_table_expression",
                  display: "超级表名称",
                ...
                },
                {
                  ...
                  description:
                    "支持 `<child table prefix>_{tag_name}` 格式，`{tag_name}` 表示点位名称。\n",
                  required: true,
                  value: "t_{tag_name}",
                },
                {
      ...
      },
      {
        ...
        protocol: {
          display: "连接协议",
          description:
            "InfluxDB 数据库的连接协议，请按实际情况选择，否则无法正常运行任务。",
          choices: [
            {
              name: "http",
              display: "HTTP 协议",
              ...
              params: [
                {
                  ...
                  description:
                    "InfluxDB 数据库的版本，由于版本之间存在接口差异，所以请按实际情况选择。",
                  required: true,
                ...
                },
                {
                  ...
                  hint: "str",
                  description:
                    "InfluxDB 数据库的用户，该用户必须在该组织中拥有读取权限。",
                  required: true,
            ...
            },
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  hint: "str",
                  description:
                    "InfluxDB 数据库的访问令牌，该令牌必须在该组织中拥有读取权限。",
                  required: true,
            ...
            params: [
              {
                ...
                short_description:
                  "InfluxDB 数据库中的 Bucket，是存储数据的一个命名空间，每个任务需要指定一个 Bucket。",
                description:
                  "InfluxDB 数据库中的 Bucket，是存储数据的一个命名空间，每个任务需要指定一个 Bucket。",
                required: true,
              ...
              },
              {
                ...
                short_description:
                  "为了消除乱序数据的影响，TDengine 总是等待这里指定的时长，然后才读取数据。",
                description:
                  "为了消除乱序数据的影响，TDengine 总是等待这里指定的时长，然后才读取数据。",
                placeholder: "请输入延迟时长",
                value: "10",
      ...
      },
      {
        ...
        protocol: {
          display: "连接协议",
          description:
            "OpenTSDB 数据库的连接协议，请按实际情况选择，否则无法正常运行任务。",
          choices: [
            {
              name: "http",
              display: "HTTP 协议",
            ...
            params: [
              {
                ...
                short_description:
                  "OpenTSDB 中的物理量，可以指定多个需要同步的 Metrics，未指定则同步数据库中的全部数据。",
                description:
                  "OpenTSDB 中的物理量，可以指定多个需要同步的 Metrics，未指定则同步数据库中的全部数据。",
                multiple: true,
                editable: true,
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "如果clean session标志设置为True，则代理将忘记有关会话的所有信息，包括客户端的订阅。",
                description:
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                placeholder:
                  "示例：kinit -R -t '%{sasl.kerberos.keytab}' -k %{sasl.kerberos.principal}",
                required: false,
                hint: {
                  type: "str",
                },
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "当 CSV 字段中包含分隔符或换行符时，用于包围字段内容，以确保整个字段被正确识别。",
                description:
                  "当 CSV 字段中包含分隔符或换行符时，用于包围字段内容，以确保整个字段被正确识别。",
                editable: true,
                value: '"',
        ...
        parser: {
          ...
          fields: [
            ...
            },
            {
              name: "Value",
              description:
                "标记在时间戳处的值。对于字符串tag，该值始终为NULL。",
              type: "double",
            },
            {
              name: "vValue",
              description:
                "字符串形式的值，在查询中使用此列允许您使用混合数据类型的值。",
              type: "varchar",
            },
            {
              name: "Quality",
        ...
        groups: [
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "设置是否与服务器协商安全 SSL TCP/IP 连接或以何种优先级进行协商。",
                description:
                  "设置是否与服务器协商安全 SSL TCP/IP 连接或以何种优先级进行协商。",
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "用于查询的 SQL 语句，SQL 语句中必须包含时间范围条件，且开始时间和结束时间必须成对出现。",
                description:
              ...
              },
              {
                ...
                short_description:
                  "实时同步数据场景中，为了避免延迟写入的数据丢失，每次同步任务会读取延迟时长之前的数据。",
                description:
                  "实时同步数据场景中，为了避免延迟写入的数据丢失，每次同步任务会读取延迟时长之前的数据。\n",
                required: false,
                placeholder: "输入范围为[0,60000]整数",
          ...
          },
          {
            ...
            params: [
              ...
              },
              {
                ...
                short_description:
                  "用于查询数据的查询语句，JSON格式，语句中必须包含时间范围条件，且开始时间和结束时间必须成对出现。",
                description:
