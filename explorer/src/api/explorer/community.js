...
export function getDataSources(lang) {
    if (lang && lang === 'en') {
        return [{
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "display": "Start From",
                    "hint": {
                        "type": "str", "choices": ["earliest", "latest"]
                    },
            ...
            "protocol": {
                ...
                "choices": [{
                    "name": "ws", "display": "WS", "description": "Use WebSocket with HTTP connection."
                }, {
                    "name": "wss", "display": "WSS", "description": "Use WebSocket with HTTPS connection."
                }],
                "value": "ws"
            },
            "authentication": {
                ...
                "value": "plain",
                "alternatives": [{
                    "name": "plain", "display": "Plain", "username": {
                        "display": "Username",
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "display": "Mode",
                    "hint": {
                        "type": "str", "choices": ["history", "realtime", "all"]
                    },
                    ...
                    "display": "Schema",
                    "hint": {
                        "type": "str", "choices": ["always", "none", "only"]
                    },
            ...
            "advanced": {
                ...
                "params": [{
                    ...
                    "display": "Log Level",
                    "hint": {
                        "type": "str", "choices": ["error", "warn", "info", "debug", "trace"]
                    },
            ...
            "params": [{
                "name": "system_configuration", "display": "System Configuration", "display_order": 0, "hint": {
                    "type": "str",
                    "choices": ["PI Data Archive and Asset Framework (AF) Server", "PI Data Archive Only"]
            ...
            "datasets": {
                ...
                "categories": [{
                    ...
                    "params": [{
                        ...
                        "hint": {
                            "type": "compose", "choices": ["point", "element", "template"]
                        },
                        "action": "download",
                    ...
                    "target": {
                        "name": "multi-column", "selectable": false
                    },
                    "params": [{
                        "name": "filter_value",
                        "display": "Dataset filtering",
            ...
            "options": {
                "endpoint": {
                    ...
                    "name": "security_mode", "display": "Security Mode", "hint": {
                        "type": "str", "choices": ["None", "Sign", "SignAndEncrypt"]
                    }, "description": "Available value is one of None / Sign / SignAndEncrypt.\n"
                }, "security_policy": {
                    "name": "security_policy", "display": "Security Policy", "hint": {
                        "type": "str",
                        "choices": ["None", "Basic128Rsa15", "Basic256", "Basic256Sha256", "Aes128_Sha256_RsaOaep", "Aes256_Sha256_RsaPss"]
                    ...
                    "name": "private_key", "display": "Certificate's Private Key", "hint": {
                        "type": "file"
                    }, "description": "The private key of the certificate."
                }, "connect_timeout": {
                    "name": "connect_timeout", "display": "Connect Timeout", "hint": {
                        "type": "integer", "min": 1, "max": 60
                    }, "description": "Timeout for connect to endpoint in seconds", "placeholder": "10", "value": "10"
                }
            },
            "authentication": {
                "display": "Authentication",
                ...
                "value": "anonymous",
                "alternatives": [{
                    "name": "anonymous", "display": "Anonymous"
                }, {
                    "name": "plain", "display": "Username", "username": {
                        "required": true,
                        "display": "Username",
                    ...
                    "name": "certificates", "display": "Certificates", "params": [{
                        "name": "auth_certificate", "required": true, "display": "Authentication Certificate", "hint": {
                            "type": "file"
                        }
                    }, {
                        "name": "auth_private_key", "required": true, "display": "Private key of Certificate", "hint": {
                            "type": "file"
                        }
                    }]
                }]
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "hint": {
                        "type": "str", "choices": ["observe", "subscribe"]
                    },
                    ...
                    "hint": {
                        "type": "str", "choices": ["none", "append", "update"]
                    },
                    ...
                    "hint": {
                        "type": "integer", "min": 60, "max": 2147483647
                    },
            ...
            "advanced": {
                ...
                "params": [{
                    ...
                    "name": "keep_raw_data", "display": "Keep Raw Data", "hint": {
                        "type": "bool"
            ...
            "datasets": {
                ...
                "categories": [{
                    ...
                    "params": [{
                        ...
                        "display": "Primary Key",
                        "hint": {
                            "type": "str", "choices": ["original_ts", "received_ts"]
                        },
            ...
            "protocol": {
                ...
                "choices": [{
                    "name": "http", "display": "HTTP Protocol"
                }, {
                    "name": "https", "display": "HTTPS Protocol"
                }],
                "value": "http"
            },
            "authentication": {
                ...
                "value": "2.x",
                "alternatives": [{
                    "name": "1.x", "display": "Version 1.x", "params": [{
                        "name": "version",
                        "display": "Version",
                        "hint": {
                            "type": "str", "choices": ["1.8", "1.7"]
                        },
                    ...
                    "name": "2.x", "display": "Version 2.x", "params": [{
                        "name": "version",
                        "display": "Version",
                        "hint": {
                            "type": "str", "choices": ["2.7", "2.6", "2.5", "2.4", "2.3", "2.2", "2.1", "2.0"]
                        },
                        "description": "The version of InfluxDB, due to interface differences between versions, please choose according to the actual situation.",
                        "required": true,
                        "placeholder": "Please select the version of InfluxDB"
            ...
            "authentication": {
                "display": "Authentication", "value": "plain", "alternatives": [{
                    "name": "plain", "display": "Username Password", "username": {
                        "display": "Username", "placeholder": "username"
                    }, "password": {
                        "display": "Password", "placeholder": "password"
                    }
                }]
            },
            "groups": [{
                ...
                "collapsed": false,
                "params": [{
                    "name": "ca", "display": "CA", "hint": {
                        "type": "file"
                    }, "short_description": "CA file.", "description": "CA file.", "required": true
                }, {
                    "name": "cert",
                    ...
                    "name": "cert_key", "display": "Client key file", "hint": {
                        "type": "file"
                    }, "short_description": "Client key file.", "description": "Client key file.", "required": true
                }]
            }, {
                "name": "Collect",
                "display_order": 1,
                ...
                "params": [{
                    ...
                    "hint": {
                        "type": "str", "choices": ["3.1", "3.1.1", "5.0"]
                    },
            ...
            "parser": {
                ...
                "fields": [{
                    "name": "ts", "description": "Timestamp.", "type": "timestamp"
                }, {
                    "name": "topic", "description": "Topic name.", "type": "varchar"
                }, {
                    "name": "qos", "description": "QoS, one of 0/1/2.", "type": "int"
                }, {
                    "name": "payload", "description": "Payload", "type": "varchar"
                }]
            }
        }, {
            "id": "kafka",
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "display": "Mechanism",
                    "hint": {
                        "type": "str", "choices": ["PLAIN", "SCRAM-SHA-256", "GSSAPI"]
                    },
            ...
            "parser": {
                ...
                "fields": [{
                    ...
                    "name": "partition", "description": "Topic partition.", "type": "int"
                }, {
                    "name": "offset", "description": "Message offset.", "type": "bigint"
                }, {
                    "name": "key", "description": "Message key.", "type": "varchar"
                }, {
                    "name": "value", "description": "Value", "type": "varchar"
                }]
            }
        }, {
            "id": "csv",
            ...
            "authentication": {
                ...
                "value": "plain",
                "alternatives": [{
                    "name": "plain", "display": "Username and Password", "username": {
                        "required": true, "display": "Username", "placeholder": "aaAdmin"
                    }, "password": {
                        "required": true, "display": "Password", "placeholder": "password"
                    }
                }]
            },
            "groups": [{
                ...
                "params": [{
                    ...
                    "hint": {
                        "type": "str", "choices": ["synchronize", "migrate"]
                    },
                    ...
                    "display": "Table",
                    "hint": {
                        "type": "str", "choices": ["Runtime.dbo.History", "Runtime.dbo.Live"]
                    },
            ...
            "parser": {
                ...
                "fields": [{
                    "name": "DateTime", "description": "The timestamp of the returned value.", "type": "timestamp"
                }, {
                    "name": "TagName", "description": "The unique name of the tag.", "type": "varchar"
                }, {
                    "name": "Value",
                    ...
                    "name": "QualityDetail", "description": "An internal representation of data quality.", "type": "int"
                }, {
                    "name": "OPCQuality",
                    "description": "The quality value received from the data source.",
                    "type": "int"
                }, {
                    "name": "wwTagKey", "description": "The unique numerical identifier of a tag.", "type": "int"
                }, {
                    "name": "wwResolution",
            ...
            "authentication": {
                ...
                "alternatives": [{
                    "name": "plain", "display": "Username and Password", "username": {
                        "required": true, "display": "Username", "placeholder": "username"
                    }, "password": {
                        "required": true, "display": "Password", "placeholder": "password"
                    }
                }]
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "hint": {
                        "type": "str",
                        "choices": ["utf8", "utf8mb4", "utf16", "utf32", "gbk", "big5", "latin1", "ascii"]
                    },
                    ...
                    "display": "SSL Mode",
                    "hint": {
                        "type": "str", "choices": ["DISABLED", "PREFERRED", "REQUIRED"]
                    },
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "display": "SSL Mode",
                    "hint": {
                        "type": "str", "choices": ["DISABLE", "ALLOW", "PREFER", "REQUIRE"]
                    },
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "display": "Encryption",
                    "hint": {
                        "type": "str", "choices": ["Off", "On", "NotSupported", "Required"]
                    },
            ...
            "authentication": {
                ...
                "value": "plain",
                "alternatives": [{
                    "name": "plain", "display": "Username and Password", "params": [{
                        "name": "username", "required": true, "display": "Username", "placeholder": "Username"
                    }, {
                        "name": "password", "required": true, "display": "Password", "placeholder": "Password"
                    }, // {
                        //   "name": "mechanism",
                        //   "required": false,
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "name": "cert_key_file_path", "display": "Cert File", "hint": {
                        "type": "file"
                    }, "short_description": ".cert file", "description": ".cert file", "required": true
                },]
            }, {
                "name": "Data Collection",
                "display_order": 2,
            ...
            "parser": {
                ...
                "description": "taosX could let users to specify the data model in the database, for example, the table name pattern and stable name pattern, field names as tags or field names as columns.\n",
                "fields": [{
                    "name": "value", "description": "Sample Message Body", "type": "varchar"
                }]
            }
        },]
    } else {
        return [{
            ...
            "protocol": {
                "display": "连接协议", "description": "选择使用何种方式连接到 TDengine 数据源。", "choices": [{
                    "name": "ws", "display": "WS", "description": "使用 HTTP 协议的 WebSocket 连接。"
                }, {
                    "name": "wss", "display": "WSS", "description": "使用 HTTPS 协议的 WebSocket 连接。"
                }], "value": "ws"
            },
            "authentication": {
                "display": "认证", "description": "使用用户名密码进行认证。", "value": "plain", "alternatives": [{
                    "name": "plain", "display": "用户名密码", "username": {
                        "display": "用户名",
            ...
            "advanced": {
                ...
                "connection_option": false,
                "params": [{
                    "name": "workers", "display": "最大读并发数", "hint": {
                        "type": "integer", "min": 0, "max": 100
                    }, "description": "并发查询的线程数，如果为 0 会自动设置为 CPU 核数。", "value": "0"
                }, {
                    "name": "write-concurrency",
                    "display": "最大写并发数",
                    "hint": {
                    ...
                    "name": "fails-to", "display": "错误记录文件", "hint": {
                        "type": "str"
            ...
            "advanced": {
                ...
                "params": [{
                    ...
                    "name": "log_level", "display": "日志级别", "hint": {
                        "type": "str", "choices": ["error", "warn", "info", "debug", "trace"]
                    }, "description": "根据需要调整数据源的日志级别，此参数不总是生效。", "value": "info"
                }, {
                    "name": "batch_size", "display": "批次大小", "hint": {
                        "type": "integer", "min": 1, "max": 10000
            ...
            "params": [{
                "name": "system_configuration", "display": "PI 系统配置", "display_order": 0, "hint": {
                    "type": "str",
                    "choices": ["PI Data Archive and Asset Framework (AF) Server", "PI Data Archive Only"]
                }, "value": "PI Data Archive and Asset Framework (AF) Server"
            }, {
            ...
            "options": {
                "endpoint": {
                    ...
                    "name": "security_mode", "display": "安全模式", "hint": {
                        "type": "str", "choices": ["None", "Sign", "SignAndEncrypt"]
                    ...
                    "name": "certificate", "display": "安全通信证书", "hint": {
                        "type": "file"
                    }, "description": "建立连接时，发送给 OPC UA 服务器；如果未经 CA 认证，请在服务器端信任此证书后，再次发起连通性检查。"
                }, "private_key": {
                    "name": "private_key", "display": "安全通信私钥", "hint": {
                        "type": "file"
                    }, "description": "私钥文件，对服务器发送的消息做签名检查或者解密。"
                }, "connect_timeout": {
                    "name": "connect_timeout", "display": "连接超时", "hint": {
                        "type": "integer", "min": 1, "max": 60
                    }, "description": "连接超时间隔，单位为：秒 (s)。", "placeholder": "10", "value": "10"
                }
            },
            "authentication": {
                "display": "认证",
                ...
                "value": "anonymous",
                "alternatives": [{
                    "name": "anonymous", "display": "匿名访问"
                }, {
                    "name": "plain", "display": "用户名", "username": {
                        "required": true,
                        "display": "用户名",
                    ...
                    "name": "certificates", "display": "证书访问", "params": [{
                        "name": "auth_certificate", "required": true, "display": "认证证书文件", "hint": {
                            "type": "file"
                        }
                    }, {
                        "name": "auth_private_key", "required": true, "display": "认证证书私钥", "hint": {
                            "type": "file"
                        }
                    }]
                }]
            ...
            "advanced": {
                ...
                "params": [{
                    ...
                    "name": "write_concurrency", "display": "最大写入并发数", "hint": {
                        "type": "integer", "min": 0, "max": 128
                    ...
                    "name": "keep_raw_data", "display": "保存原始数据", "hint": {
                        "type": "bool"
                    }, "description": "是否保存原始数据？\n"
                }, {
                    "name": "keep_raw_data_days", "display": "最大保留天数", "hint": {
                        "type": "integer", "min": 1, "max": 365
                    }, "description": "原始数据最大保存天数，默认 1 天。\n", "value": "1", "requires": "keep_raw_data"
                }, {
                    "name": "keep_raw_data_dir",
                    "display": "原始数据存储目录",
                    "hint": {
            ...
            "datasets": {
                "name": "点位集", "description": "OPC 采集数据点位列表。", "value": "csv_config_file", "categories": [{
                    "category": "csv_config_file",
                    "display": "上传 CSV 配置文件",
                    ...
                    "category": "select_all_points", "display": "选择数据点位", "target": {
                        "name": "select_all_points",
                        ...
                        "name": "table_primary_key_alias", "display": "主键别名", "hint": {
                            "type": "str"
                        }, "description": "在目标数据表中的主键列名称。\n", "required": false, "value": "ts"
                    }]
                }]
            }
        }, {
            ...
            "protocol": {
                ...
                "choices": [{
                    "name": "http", "display": "HTTP 协议"
                }, {
                    "name": "https", "display": "HTTPS 协议"
                }],
                "value": "http"
            },
            "authentication": {
                "display": "认证", "description": "InfluxDB 的鉴权认证。", "value": "2.x", "alternatives": [{
                    "name": "1.x", "display": "1.x 版本", "params": [{
                        "name": "version",
                        "display": "版本",
                        "hint": {
                            "type": "str", "choices": ["1.8", "1.7"]
                    ...
                    "name": "2.x", "display": "版本 2.x", "params": [{
                        "name": "version",
                        "display": "版本",
                        "hint": {
                            "type": "str", "choices": ["2.7", "2.6", "2.5", "2.4", "2.3", "2.2", "2.1", "2.0"]
            ...
            "authentication": {
                ...
                "value": "plain",
                "alternatives": [{
                    "name": "plain", "display": "用户名密码访问", "username": {
                        "display": "用户", "placeholder": "username"
                    }, "password": {
                        "display": "密码", "placeholder": "password"
                    }
                }]
            },
            "groups": [{
                ...
                "params": [{
                    "name": "ca", "display": "CA", "hint": {
                        "type": "file"
                    }, "short_description": "CA 证书文件", "description": "CA 证书文件", "required": true
                }, {
                    "name": "cert", "display": "客户端证书", "hint": {
                        "type": "file"
                    }, "short_description": ".cert 文件", "description": ".cert 文件", "required": true
                }, {
                    "name": "cert_key", "display": "客户端私钥", "hint": {
                        "type": "file"
                    }, "short_description": "私钥文件", "description": "私钥文件", "required": true
                }]
            }, {
                "name": "采集配置",
                "display_order": 1,
            ...
            "parser": {
                ...
                "fields": [{
                    "name": "ts", "description": "时间戳", "type": "timestamp"
                }, {
                    "name": "topic", "description": "主题", "type": "varchar"
                }, {
                    "name": "qos", "description": "质量", "type": "int"
                }, {
                    "name": "payload", "description": "负载", "type": "varchar"
                }]
            }
        }, {
            "id": "kafka",
            ...
            "groups": [{
                ...
                "params": [{
                    ...
                    "name": "ca_password", "display": "CA 密码", "hint": {
                        "type": "password"
                    }, "short_description": "CA 私钥密码", "description": "CA 私钥密码", "required": true
                }, {
                    "name": "cert",
                    "display": "客户端证书",
                    "hint": {
            ...
            "parser": {
                ...
                "fields": [{
                    ...
                    "name": "topic", "description": "主题名。", "type": "varchar"
                }, {
                    "name": "partition", "description": "分区 ID。", "type": "int"
                }, {
                    "name": "offset", "description": "偏移。", "type": "bigint"
                }, {
                    "name": "key", "description": "消息 Key。", "type": "varchar"
                }, {
                    "name": "value", "description": "消息体。", "type": "varchar"
                }]
            }
        }, {
            "id": "csv",
            ...
            "authentication": {
                ...
                "alternatives": [{
                    "name": "plain", "display": "用户名密码访问", "username": {
                        "required": true, "display": "用户", "placeholder": "username"
                    }, "password": {
                        "required": true, "display": "密码", "placeholder": "password"
                    }
                }]
            },
            "groups": [{
            ...
            "parser": {
                ...
                "fields": [{
                    "name": "DateTime", "description": "值对应的时间戳。", "type": "timestamp"
                }, {
                    "name": "TagName", "description": "测点名称。", "type": "varchar"
                }, {
                    "name": "Value", "description": "标记在时间戳处的值。对于字符串tag，该值始终为NULL。", "type": "double"
                }, {
                    "name": "vValue",
                    "description": "字符串形式的值，在查询中使用此列允许您使用混合数据类型的值。",
                    "type": "varchar"
                }, {
                    "name": "Quality", "description": "与数据值相关联的基本数据质量指标。", "type": "int"
                }, {
                    "name": "QualityDetail", "description": "数据质量的内部表示。", "type": "int"
                }, {
                    "name": "OPCQuality", "description": "从数据源接收到的质量值。", "type": "int"
                }, {
                    "name": "wwTagKey", "description": "单个AVEVA历史记录中tag的唯一数字标识符。", "type": "int"
                }, {
                    "name": "wwResolution", "description": "在循环模式下检索数据的采样率，以毫秒为单位。", "type": "int"
                }, {
                    "name": "StartDateTime", "description": "返回该行的检索周期的开始时间。", "type": "timestamp"
                }, {
                    "name": "SourceTag", "description": "在存储该点时复制标记的源标记的名称。", "type": "varchar"
                }, {
                    "name": "SourceServer", "description": "在存储该点时复制标记的服务器的名称。", "type": "varchar"
                }]
            }
        }, {
            "id": "mysql",
            ...
            "options": {
                "host": {
                    ...
                    "required": true, "display": "数据库", "description": "MySQL 数据库名称", "placeholder": "示例: db1"
                }
            },
            "authentication": {
                "display": "认证",
            ...
            "options": {
                "host": {
                    ...
                    "required": true, "display": "数据库", "description": "Oracle 数据库名称", "placeholder": "示例: db1"
                }
            },
            "authentication": {
                "display": "认证",
            ...
            "authentication": {
                ...
                "value": "plain",
                "alternatives": [{
                    "name": "plain", "display": "用户名密码访问", "params": [{
                        "name": "username", "required": true, "display": "用户", "placeholder": "请输入用户名"
                    }, {
                        "name": "password", "required": true, "display": "密码", "placeholder": "请输入密码"
                    }, // {
                        //   "name": "mechanism",
                        //   "required": false,
                        //   "display": "认证机制",
            ...
            "groups": [{
                ...
                "collapsed": false,
                "params": [{
                    "name": "ca_file_path", "display": "CA 文件", "hint": {
                        "type": "file"
                    }, "short_description": "CA 证书文件", "description": "CA 证书文件", "required": true
                }, {
                    "name": "cert_key_file_path", "display": "证书文件", "hint": {
                        "type": "file"
                    }, "short_description": ".cert 文件", "description": ".cert 文件", "required": true
                },]
            }, {
