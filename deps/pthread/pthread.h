 ...
 */
int PTW32_CDECL pthread_mutexattr_setkind_np(pthread_mutexattr_t * attr,
                                         int kind);
int PTW32_CDECL pthread_mutexattr_getkind_np(pthread_mutexattr_t * attr,
                                         int *kind);

/*
 * Possibly supported by other POSIX threads implementations
 */
int PTW32_CDECL pthread_delay_np (struct timespec * interval);
int PTW32_CDECL pthread_num_processors_np(void);
unsigned __int64 PTW32_CDECL pthread_getunique_np(pthread_t thread);
 ...
 */
void * PTW32_CDECL pthread_timechange_handler_np(void *);
 ...
 */
HANDLE PTW32_CDECL pthread_getw32threadhandle_np(pthread_t thread);
/*
 * Returns the win32 thread ID for POSIX thread.
 */
DWORD PTW32_CDECL pthread_getw32threadid_np (pthread_t thread);
 ...
 */
DWORD PTW32_CDECL ptw32_get_exception_services_code(void);
