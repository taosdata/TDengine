...
class ReadTask implements Runnable {
    ...
    private final long rowsPerTable;

    public ReadTask(int readTaskId, List<BlockingQueue<String>> queues, int tableCount, long rowsPerTable) {
    ...
    public void run() {
        logger.info("started");
        Iterator<String> it = new MockDataSource("tb" + this.taskId, tableCount, rowsPerTable);
        try {
