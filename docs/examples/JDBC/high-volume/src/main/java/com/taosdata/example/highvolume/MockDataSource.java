...
class MockDataSource implements Iterator {
    ...
    long startMs = System.currentTimeMillis() - totalRows * 100;
    ...
    public MockDataSource(String tbNamePrefix, int tableCount, long maxRowsPerTable) {
        this.tbNamePrefix = tbNamePrefix;
        this.tableCount = tableCount;
        this.totalRows = maxRowsPerTable;
    }
