# TDengine 3.3.7.5 验收报告

## 1. 验收结论

TDengine TSDB 3.3.7.5 版本验收通过，准予发布。

## 2. 安装包地址

NAS 服务器： http://192.168.1.252:5000/
目录：`/Release/TDengine/3.3/v``3.3.7.5`

## 3. 版本发布说明 （Release Notes）

[3.3.7.5 中英文 Release Notes](https://taosdata.feishu.cn/docx/Ez3zdfpQqoYstYx7J7qc1JIYnTf)
...
<quote-container>
结论：CI 测试共运行 1711 个用例，测试通过 1711 个，通过率 100%。
</quote-container>
...
| taosx | 98 | 98 | 1 | [用例文档](https://taosdata.github.io/taosx/) |
...
- taosd
  ...
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest_main/detail/FullTest_main/3659/pipeline
...
- taosd: https://github.com/taosdata/TestNG/tree/master/scripts   
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest_main/detail/FullTest_main/3659/pipeline
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest-main-query-replica3/detail/FullTest-main-query-replica3/1197/pipeline
- taosx: [https://github.com/taosdata/taosx/tree/main/tests/e2e](https://github.com/taosdata/taosx/tree/main/tests/e2e)
