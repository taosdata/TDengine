...
本次系统测试旨在全面验证 TDengine TSDB v3.4.0.0 版本在功能、性能、可靠性及安全性方面是否达到发布标准。具体目标如下：
...
**准出标准：**
1. **功能：** 所有 P0/P1 级用例执行通过，功能覆盖率 100%。
2. **缺陷：** 无 P0/P1 级遗留缺陷，P2 级缺陷修复率 >90%。
