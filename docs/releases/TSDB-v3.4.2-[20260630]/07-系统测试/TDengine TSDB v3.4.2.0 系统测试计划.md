# TDengine TSDB v3.4.2.0 系统测试计划

### 1. 修订记录

| 编写日期 | 发布日期 | 版本 | 修订人 | 主要修改内容 |
| --- | --- | --- | --- | --- |
| 2026-04-28 | 2026-04-28 | 1.0 | 肖波 | 初始版本 |

### 2. 测试目标

本次系统测试旨在全面验证 TDengine TSDB v3.4.2.0 版本在功能、性能、可靠性及安全性方面是否达到发布标准。具体目标如下：
...
依据各模块 Test Spec 的时间安排，整体测试周期为 **2026年7月3日 至 2026年7月27日**。

| **阶段** | **时间段** | **主要任务** |
| --- | --- | --- |
| **阶段一** | 2026/7/3 - 7/6 | **内核模块功能测试 (1周)** 覆盖存储、查询、流计算、订阅等核心功能及单机性能验证。 |
| **阶段二** | 2026/7/7 - 7/13 | **安全模块与工具组件测试 (1周)** 执行身份鉴别、加密、审计测试，以及 taosAdapter、taosExplorer 等工具验证。 |
| **阶段三** | 2026/7/14 - 7/20 | **集群高可用与连接器测试 (1周)** 执行节点扩缩容、故障切换、多语言连接器测试。 |
| **阶段四** | 2026/7/21 - 7/27 | **系统集成与验收 (1周)** 端到端业务流程、安全合规验收及报告评审。 |
