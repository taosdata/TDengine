...
| 2026-03-02 | 2026-03-03 | 1.2 | 肖波 | 修订文字 |

### 2. 测试目标

本次系统测试旨在全面验证 TDengine TSDB v3.4.0.9 版本在功能、性能、可靠性及安全性方面是否达到发布标准。具体目标如下：
...
| **阶段** | **时间段** | **主要任务** |
| --- | --- | --- |
| **阶段一** | 2026/1/4 - 1/8 | **内核模块功能测试 (1周)** 覆盖存储、查询、流计算、订阅等核心功能及单机性能验证。 |
| **阶段二** | 2026/1/9 - 1/15 | **安全模块与工具组件测试 (1周)** 执行身份鉴别、加密、审计测试，以及 taosAdapter、taosExplorer 等工具验证。 |
| **阶段三** | 2026/1/16 - 1/22 | **集群高可用与连接器测试 (1周)** 执行节点扩缩容、故障切换、多语言连接器测试。 |
| **阶段四** | 2026/1/23 - 1/29 | **系统集成与验收 (1周)** 端到端业务流程、安全合规验收及报告评审。 |
