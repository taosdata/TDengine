# 产品发布报告 -TDengine TSDB 3.3.6.46

## 1. 发布概述

1. 发布名称和版本号​：TSDB 3.3.6.46
2. 发布类型​：月度版本发布
3. 发布日期：2026-03-24
4. 发布摘要：
...
- Docker Image
  - tdengine/tsdb:3.3.6.46
  - tdengine/tsdb-ee:3.3.6.46
  - tdengine/tdgpt:3.3.6.46
  - tdengine/tdgpt:3.3.6.46
  - tdengine/tdgpt-full:3.3.6.46
- NAS 服务器： https://nas.tdengine.net/
  - 目录：`/Release/TDengine/3.``4``/v3.3.6.46`

## 3. 版本发布说明 （Release Notes）

- 官网：https://docs.taosdata.com/releases/notes/{version}/
- Github: https://github.com/taosdata/TDengine/releases/tag/ver-3.3.6.46
- 飞书文档：[3.3.6.46 中英文 Release Notes](https://taosdata.feishu.cn/docx/KUjDdQI9SolqNVxns8gcsjN4nib)
