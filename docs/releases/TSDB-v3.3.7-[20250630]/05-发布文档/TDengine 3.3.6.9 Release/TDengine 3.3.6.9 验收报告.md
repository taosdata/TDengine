# TDengine 3.3.6.9 验收报告

## 1. 验收结论

TDengine 3.3.6.9 版本验收通过，准予发布。

## 2. 安装包地址

NAS 服务器： http://192.168.1.252:5000/
目录：`/Release/TDengine/3.3/v``3.3.6.9`

## 3. 版本发布说明 （Release Notes）

[3.3.6.9 中英文 Release Notes](https://taosdata.feishu.cn/docx/IKEHdQ8PmogxRPxqmEjcxfbEnNc)
[Hotfix 版本行为变更汇总](https://taosdata.feishu.cn/wiki/ObBjwUkGQi9UZmkI5gPcuK6pnSc)
...
<quote-container>
结论：CI 测试共运行 1903 个用例，测试通过 1903 个，通过率 100%。
</quote-container>

详见下表：
| 组件 | 用例数 | 通过用例数 | 通过率 | 用例详情 |
| --- | --- | --- | --- | --- |
| taosd | 1798 | 1798 | 1 | n/a |
...
- taosd: https://github.com/taosdata/TestNG/tree/master/scripts   
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest3.0/detail/FullTest3.0/3587/pipeline
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest-main-query-replica3/detail/FullTest-main-query-replica3/1143/pipeline
- taosx: [https://github.com/taosdata/taosx/tree/main/tests/e2e](https://github.com/taosdata/taosx/tree/main/tests/e2e)
...
详见：http://192.168.0.218/logs/xintongyuan_taosd_version_3.3.6.9_git_c11afec3_gitOfInternal_c5d70b5e_20250603.log
