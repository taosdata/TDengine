...
目录：`/Release/TDengine/3.3/v``3.3.6.6`

## 3. 版本发布说明 （Release Notes）

[3.3.6.6 中英文 Release Notes](https://taosdata.feishu.cn/docx/PIm7dL7ylowBpJxLql8cvYERnhh)
...
<quote-container>
结论：CI 测试共运行 1899 个用例，测试通过 17 个，通过率 100%。
</quote-container>

详见下表：
| 组件 | 用例数 | 通过用例数 | 通过率 | 用例详情 |
| --- | --- | --- | --- | --- |
| taosd | 1794 | 1794 | 1 | n/a |
...
- taosd
  ...
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest3.0/detail/FullTest3.0/3558/pipeline
...
- taosd: https://github.com/taosdata/TestNG/tree/master/scripts   
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest3.0/detail/FullTest3.0/3557/pipeline/50
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest3.0/detail/FullTest3.0/3557/pipeline/73
  - http://ci.bl.taosdata.com:8080/blue/organizations/jenkins/FullTest-main-query-replica3/detail/FullTest-main-query-replica3/1130/pipeline
- taosx: [https://github.com/taosdata/taosx/tree/main/tests/e2e](https://github.com/taosdata/taosx/tree/main/tests/e2e)
