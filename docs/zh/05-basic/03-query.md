...
- [修改服务端默认时区配置](../14-reference/01-components/01-taosd.md#timezone)
- [修改客户端默认时区配置](../14-reference/01-components/02-taosc.md#timezone)
- [设置当前会话时区](../14-reference/03-taos-sql/53-set.md#set-timezone)
- [了解夏令时（DST）对写入与查询的影响](../27-train-faq/02-dst.md)
...
3. 这里的周相关范围没有关注周起始日；TDengine 支持配置周起始日，具体请参考 [firstDayOfWeek](../14-reference/01-components/02-taosc.md#firstDayOfWeek)。
