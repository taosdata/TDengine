...
Ontop 通过 [TDengine TSDB Java Connector](../../10-developer-guide/08-connectors-reference/02-java.mdx) 连接 TDengine TSDB 数据源，需准备以下环境：
...
URL 参数详情参阅：[TDengine TSDB URL 规范](../../10-developer-guide/08-connectors-reference/02-java.mdx#url-规范)。
