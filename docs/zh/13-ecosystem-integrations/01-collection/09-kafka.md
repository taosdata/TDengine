...
企业版也可在 taosExplorer 中配置零代码 Kafka 写入与数据发布，详见 [零代码数据写入 · Kafka](../../08-data-ingest-and-delivery/01-no-code-ingestion/08-kafka.mdx) 与 [数据发布 · Kafka](../../08-data-ingest-and-delivery/02-no-code-delivery/03-Kafka.md)。基于主题的消费语义还可对照 [数据订阅](../../07-data-subscription/index.md)。
