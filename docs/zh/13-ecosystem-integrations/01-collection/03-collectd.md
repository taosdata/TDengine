...
title: collectd 写入
description: 使用 collectd 向 TDengine 写入数据
---

import CollectD from "../../12-operations-and-tooling/03-components/resources/_collectd.mdx"
...
使用 `taos` shell 验证从 collectd 向 TDengine 写入数据并能够正确读出：
