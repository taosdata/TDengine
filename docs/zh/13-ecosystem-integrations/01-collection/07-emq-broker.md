...
![TDengine Database EMQX login dashboard](../../assets/emq-broker-01.webp)

### 创建规则（Rule）

选择左侧“规则引擎（Rule Engine）”中的“规则（Rule）”并点击“创建（Create）”按钮：

![TDengine Database EMQX rule engine](../../assets/emq-broker-02.webp)
...
![TDengine Database EMQX create rule](../../assets/emq-broker-03.webp)

### 新增“动作（action handler）”

![TDengine Database EMQX](../../assets/emq-broker-04.webp)

### 新增“资源（Resource）”

![TDengine Database EMQX create resource](../../assets/emq-broker-05.webp)
...
![TDengine Database EMQX edit resource](../../assets/emq-broker-06.webp)
...
![TDengine Database EMQX edit action](../../assets/emq-broker-07.webp)
...
![TDengine Database EMQX client num](../../assets/emq-broker-08.webp)
...
![TDengine Database EMQX run-mock](../../assets/emq-broker-09.webp)

## 验证 EMQX 接收到数据

在 EMQX Dashboard 规则引擎界面进行刷新，可以看到有多少条记录被正确接收到：

![TDengine Database EMQX rule matched](../../assets/emq-broker-10.webp)

## 验证数据写入到 TDengine

使用 `taos` shell 程序登录并查询相应数据库和表，验证数据是否被正确写入到 TDengine 中：

![TDengine Database EMQX result in taos](../../assets/emq-broker-11.webp)
