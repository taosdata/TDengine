...
import StatsD from "../../12-operations-and-tooling/03-components/resources/_statsd.mdx"
...
使用 `taos shell` 验证从 StatsD 向 TDengine 写入数据并能够正确读出：
...
- TDengine 会根据规则自动生成唯一的 ID 作为子表名。
