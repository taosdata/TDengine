...
上述特性详细介绍可以参考 [特色查询](../../05-tdengine-sql/04-data-query/04-distinguished.md)。
...
![TDengine Database Grafana plugin feishu robot](../../assets/grafana-06.webp)

在 Grafana 页面找到“Home” -> “Alerting” -> “Contact points”创建新联络点  
“Name”：Feishu Contact Point  
“Integration”：选择联络类型，这里选择 Webhook，并填写 URL (在飞书机器人助手的 Grafana 触发器 Webhook 地址)，完成后保存联络点  

![TDengine Database Grafana plugin feishu contact point](../../assets/grafana-07.webp)

### 配置告警通知策略

配置好联络点后，可以看到已有一个 Default Policy

![TDengine Database Grafana plugin Notification default policy](../../assets/grafana-08.webp)

点击右侧“...” -> ”Edit”，然后编辑默认通知策略，弹出配置窗口：

![TDengine Database Grafana plugin Notification](../../assets/grafana-09.webp)
...
![TDengine Database Grafana plugin Alert Rules](../../assets/grafana-10.webp)
...
![TDengine Database Grafana plugin Alert Evaluation Behavior](../../assets/grafana-11.webp)
...
![TDengine Database Grafana plugin Alert Labels and Notifications](../../assets/grafana-12.webp)
...
![TDengine Database Grafana plugin Alert Labels and Notifications](../../assets/grafana-13.webp)
