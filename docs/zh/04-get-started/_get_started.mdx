...
填写以上信息后，请点击 Save & test 按钮，如果看到以下消息：TDengine Data source is working, 即表示 TDengine 与 Grafana 的连接已创建成功。下一步，就可以创建 Dashboard 了。具体的步骤，详见[与 Grafana 集成](https://docs.taosdata.com/third-party/visual/grafana/#%E5%88%9B%E5%BB%BA-dashboard)小节。
