...
1. 从列表中下载获得 tar.gz 安装包：
   <PkgListV37 productName="TDengine TSDB-OSS,TDengine TSDB-Enterprise" version="3.3.7.5" platform="Linux-Generic"  jsonPath="assets/data/product-data.json"/>
...
1. 从列表中下载获得最新 Windows 安装程序：
   <PkgListV37 productName="TDengine TSDB-OSS,TDengine TSDB-Enterprise" version="3.3.7.5" platform="Windows" jsonPath="assets/data/product-data.json"/>
...
1. 从列表中下载获得最新 macOS 安装包：
   <PkgListV37 productName="TDengine TSDB-OSS,TDengine TSDB-Enterprise"  version="3.3.7.5" platform="macOS" jsonPath="assets/data/product-data.json"/>
