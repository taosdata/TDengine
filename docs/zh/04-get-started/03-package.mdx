...
1. 从列表中下载获得 tar.gz 安装包：
    <PkgListV37 productName="TDengine TSDB-Enterprise" version="3.3.8.0" platform="Linux-Generic" pkgType="Server" jsonPath="version-json/product-data.json"/>
...
1. 从列表中下载获得最新 Windows 安装程序：
    <PkgListV37 productName="TDengine TSDB-Enterprise" version="3.3.8.0" platform="Windows" pkgType="Server" jsonPath="version-json/product-data.json"/>
