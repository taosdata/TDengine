...
分析平台内置了 6 个异常检查模型，分为 3 个类别，分别是 [基于统计学的算法](./01-statistics-approach.md)、[基于数据密度的算法](./02-data-density.md)、以及[基于机器学习的算法](./03-machine-learning.md)。在不指定异常检测使用的方法的情况下，默认调用 IQR 进行异常检测。
