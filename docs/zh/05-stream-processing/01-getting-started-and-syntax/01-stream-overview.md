---
sidebar_label: CREATE STREAM 核心语法
title: CREATE STREAM 核心语法
description: CREATE STREAM 语法与参数说明
...
- period_time：定时间隔，支持的时间单位详见[时间单位](../../04-tdengine-sql/01-datatype.md#时间单位)（支持毫秒至年），支持的时间范围为 `[10a, 3650d]`。
