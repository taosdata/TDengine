...
## 优化
 ...
 40. 修复：新增配置项 enableAdvancedSecurity（默认值为 0），取值为 0 时关闭密码过期、强密码、密码轮换等策略（与 v3.3 保持一致）
 41. 优化：禁止社区版与企业版互连
...
## 修复
 ...
 35. 修复：incorrect query result issue of session window on virtual super tables
 ...
 51. 修复：Explorer 写入配置错误是预览窗口不符合预期
