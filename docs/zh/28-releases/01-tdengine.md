---
sidebar_label: TDengine TSDB 发布历史
title: TDengine TSDB 发布历史及下载链接
description: TDengine TSDB 发布历史、Release Notes 及下载链接
---

## TDengine TSDB 版本规则说明

TDengine TSDB 版本号由四个数字组成，中间由点号分隔，定义如下
...
## TDengine TSDB 2.x 下载

TDengine TSDB 2.x 各版本安装包请访问 [这里](https://taosdata.com/all-downloads)

## TDengine TSDB 3.x 下载

TDengine TSDB 3.3.7.0 及以上版本请访问[下载中心](https://taosdata.com/download-center)
