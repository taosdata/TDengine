...
创建 ConfigMap yaml 配置文件 taoscfg.yaml。ConfigMap 是Kubernetes 用来向应用Pod 中注入配置数据的方法。 ConfigMap 允许你将配置文件与镜像文件分离，以使容器化的应用程序具有可移植性。
...
将生成一个两节点的 TDengine 集群，dnode 是自动配置的，可以使用 `kubectl exec -it tdengine-0 -- ` 加任意 Linux 命令包括 TDengine CLI 命令。执行如下命令可以查看 TDengine dnode 状态。
...
======================================================================================================================================
      1 | tdengine-0.taosd.default.sv... |      1 |     40 | ready      | 2021-06-01 17:13:24.181 |                          |
      2 | tdengine-1.taosd.default.sv... |      0 |     40 | ready      | 2021-06-01 17:14:09.257 |                          |
...
{"status":"succ","head":["name","created_time","ntables","vgroups","replica","quorum","days","keep","cache(MB)","blocks","minrows","maxrows","wallevel","fsync","comp","cachelast","precision","update","status"],"column_meta":[["name",8,32],["created_time",9,8],["ntables",4,4],["vgroups",4,4],["replica",3,2],["quorum",3,2],["days",3,2],["keep",8,24],["cache(MB)",4,4],["blocks",4,4],["minrows",4,4],["maxrows",4,4],["wallevel",2,1],["fsync",4,4],["comp",2,1],["cachelast",2,1],["precision",8,3],["update",2,1],["status",8,10]],"data":[["log","2022-07-25 15:39:36.705",20,1,1,1,10,"30",1,3,100,4096,1,3000,2,0,"us",0,"ready"]],"rows":1}
```
...
taos> show dnodes
   id   |           endpoint            | vnodes | support_vnodes |   status   | create_time       |      offline reason      |
======================================================================================================================================
      1 | tdengine-0.taosd.default.sv... |      0 |     40 | ready      | 2021-06-01 11:58:12.915 |                          |
      2 | tdengine-1.taosd.default.sv... |      0 |     40 | ready      | 2021-06-01 11:58:33.127 |                          |
      3 | tdengine-2.taosd.default.sv... |      0 |     40 | ready      | 2021-06-01 14:07:27.078 |                          |
      4 | tdengine-3.taosd.default.sv... |      1 |     40 | ready      | 2021-06-01 14:07:48.362 |                          |
...
```
$ kubectl exec -i -t tdengine-0 -- taos -s "drop dnode 'tdengine-3.taosd.default.svc.cluster.local:6030'"
```
...
4 | tdengine-2.taosd.default.sv... | 0 | 4 | ready | 2022-07-25 17:40:28.546 | |
Query OK, 3 row(s) in set (0.001383s)
```

使用 kubectl 查看 pod 状态
