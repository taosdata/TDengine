...
#### 标量函数示例 [bit_and](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/bit_and.c)
...
```c
{{#include test/cases/25-UDFs/sh/bit_and.c}}
```

</details>

#### 聚合函数示例 1 返回值为数值类型 [l2norm](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/l2norm.c)
...
```c
{{#include test/cases/25-UDFs/sh/l2norm.c}}
```

</details>

#### 聚合函数示例 2 返回值为字符串类型 [max_vol](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/max_vol.c)
...
```c
{{#include test/cases/25-UDFs/sh/max_vol.c}}
```

</details>

#### 聚合函数示例 3 切分字符串求平均值 [extract_avg](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/extract_avg.c)
...
```c
{{#include test/cases/25-UDFs/sh/extract_avg.c}}
```
...
#### 标量函数示例 [pybitand](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/pybitand.py)
...
```Python
{{#include test/cases/25-UDFs/sh/pybitand.py}}
```

</details>

#### 聚合函数示例 [pyl2norm](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/pyl2norm.py)
...
```c
{{#include test/cases/25-UDFs/sh/pyl2norm.py}}
```

</details>

#### 聚合函数示例 [pycumsum](https://github.com/taosdata/TDengine/blob/3.0/test/cases/25-UDFs/sh/pycumsum.py)
...
```c
{{#include test/cases/25-UDFs/sh/pycumsum.py}}
```
