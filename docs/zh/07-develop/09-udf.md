...
## Python UDF 示例代码
### Python UDF 标量函数示例 [pybitand](https://github.com/taosdata/TDengine/blob/main/tests/script/sh/pybitand.py)
...
### Python UDF 聚合函数示例 [pyl2norm](https://github.com/taosdata/TDengine/blob/main/tests/script/sh/pyl2norm.py)
