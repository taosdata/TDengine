...
![TDengine TSDB Database 时间窗口示意图](assets/time_window.webp)
...
INTERVAL 子句支持使用 FILL 子句来指定数据缺失时的数据填充方法，支持除 NEAR 填充模式外的所有填充模式。关于 FILL 子句如何使用请参考 [FILL 子句](../../03-quick-start/04-query-and-aggregate.md#fill-子句)。
...
![TDengine TSDB Database 会话窗口示意图](assets/session_window.png)
...
![TDengine TSDB Database 计数窗口示意图](assets/count_window.png)
...
关于 FILL 子句的通用语法请参考 [FILL 子句](../../03-quick-start/04-query-and-aggregate.md#fill-子句)。
