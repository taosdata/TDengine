...
3.4.0.0 开始，TDengine 企业版通过基于角色的访问控制（RBAC）实现了三权分立机制，权限部分改动较大。3.4.0.0-3.4.0.10 版本，3.3.x.y 版本的部分语法不兼容，自 3.4.0.11 版本开始，3.3.x.y 版本的语法也开始兼容，为了更精细化的权限管理，推荐使用 3.4.0.0 版本的新语法。
