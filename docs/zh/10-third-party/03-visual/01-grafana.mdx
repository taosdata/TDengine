...
使用 [`grafana-cli` 命令行工具](https://grafana.com/docs/grafana/latest/administration/cli/)  进行插件安装。
...
或者从 [GitHub](https://github.com/taosdata/grafanaplugin/releases/tag/latest) 下载 .zip 文件到本地并解压到 Grafana 插件目录。命令行下载示例如下：
