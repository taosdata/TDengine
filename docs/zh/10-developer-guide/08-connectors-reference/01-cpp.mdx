...
主题概念见 [数据订阅](../../06-data-subscription/index.md) 与 [主题语法](../../06-data-subscription/01-topic.md)；多语言用法见 [数据订阅编程接口](../07-subscription-api.md)。C/C++ 可通过 `tmq_get_res_type` 区分数据与元数据消息。
