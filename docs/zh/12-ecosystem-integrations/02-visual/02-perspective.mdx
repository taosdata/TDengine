...
![perspective-architecture](perspective/assets/prsp_architecture.webp)
...
- taosAdapter 能够正常运行，详细参考 [taosAdapter 使用手册](../../11-operations-and-tooling/03-components/03-taosadapter.md)。
...
![perspective-viewer](perspective/assets/prsp_view.webp)
...
Python 连接器详细写入说明可参见 [Python 参数绑定](../../09-developer-guide/08-connectors-reference/05-python.mdx#参数绑定)。
...
- [TDengine TSDB Python 连接器](../../09-developer-guide/08-connectors-reference/05-python.mdx)
- [TDengine TSDB 流计算](../../05-stream-processing/01-getting-started-and-syntax/01-stream-overview.md)
