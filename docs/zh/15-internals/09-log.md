---
description: TDengine 普通日志与慢日志说明
sidebar_label: 日志系统
title: 日志系统
toc_max_heading_level: 4
---

TDengine 通过日志文件记录系统运行状态，帮助用户监控系统运行情况，排查问题。Log 分为普通日志和慢日志。引擎侧的运行状态通过普通日志的方式记录下来，系统运行相关的慢日志操作则记录到慢日志文件里。
...
![TDengine 日志循环 buff](assets/normal_log1.png)
...
![TDengine 日志 buff 调整方式](assets/normal_log2.png)
...
![TDengine 上报框架](assets/slow_log1.png)
...
日志开关通过 bit 位来控制，具体如下：
  ...
  ![TDengine 日志级别](assets/slow_log2.png)
