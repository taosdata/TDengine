...
![TDengine TSDB Database 架构示意图](assets/structure.webp)
...
![TDengine TSDB Database 典型的操作流程](assets/message.webp)
...
![TDengine TSDB Database Leader 写入流程](assets/write_leader.webp)
...
![TDengine TSDB Database Follower 写入流程](assets/write_follower.webp)
