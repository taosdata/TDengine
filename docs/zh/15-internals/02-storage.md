...
![Tuple 行格式示意图](../assets/storage-01.png)
...
![Key-Value 行格式示意图](../assets/storage-02.png)
...
![vnode 存储架构](../assets/storage-04.png)
...
![B+ 树存储结构](../assets/storage-06.png)

B+ Tree 的页结构如下图所示：

![B+ 树页结构](../assets/storage-07.png)
...
![TSDB 引擎的写入流程](../assets/storage-08.png)
...
![SkipList 索引](../assets/storage-09.png)
...
![BRIN 索引结构](../assets/storage-11.png)
