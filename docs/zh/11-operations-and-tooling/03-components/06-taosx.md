...
更多 TMQ 订阅时的所有参数，详见 [数据订阅](../../09-developer-guide/07-subscription-api.md)
...
2. 3.4.0.0 版本开始，taosX 需要先创建 XNODE，然后才能创建任务。参考 [创建 XNODE 节点](../../04-tdengine-sql/08-cluster-management/02-xnode.md#创建节点)。
