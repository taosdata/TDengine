...
![Keep timerange 示意图](../../04-quick-start/assets/database-keep.jpg)
...
3. FILE 语法表示数据来自于 CSV 文件（英文逗号分隔、英文单引号括住每个值），CSV 文件无需表头。如仅需创建子表，请参考 [表](../02-ddl/02-table.md#批量创建子表) 章节。
