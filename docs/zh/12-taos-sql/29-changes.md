...
| 4 | ALTER STABLE | 调整 | <p>废除</p><ul><li>CHANGE TAG：修改标签列的名称。3.0版本使用RENAME TAG代替。</li></ul><p>新增</p><ul><li>RENAME TAG：代替原CHANGE TAG子句。</li><li>COMMENT：修改超级表的注释。</li></ul>
| 5 | ALTER TABLE | 调整 | <p>废除</p><ul><li>CHANGE TAG：修改标签列的名称。3.0版本使用RENAME TAG代替。</li></ul><p>新增</p><ul><li>RENAME TAG：代替原CHANGE TAG子句。</li><li>COMMENT：修改表的注释。</li><li>TTL：修改表的生命周期。</li></ul>
| 6 | ALTER USER | 调整 | <p>废除</p><ul><li>PRIVILEGE：修改用户权限。3.0版本使用GRANT和REVOKE来授予和回收权限。</li></ul><p>新增</p><ul><li>ENABLE：启用或停用此用户。</li><li>SYSINFO：修改用户是否可查看系统信息。</li></ul>
