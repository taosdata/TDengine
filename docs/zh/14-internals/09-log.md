...
![TDengine TSDB 日志循环 buff](assets/normal_log1.png)
...
![TDengine TSDB 日志 buff 调整方式](assets/normal_log2.png)
...
![TDengine TSDB 上报框架](assets/slow_log1.png)
...
日志开关通过 bit 位来控制，具体如下：
  ...
  ![TDengine TSDB 日志级别](assets/slow_log2.png)
