---
sidebar_label: 工具发布历史
title: 工具发布历史及下载链接
description: taosTools 的发布历史、版本说明与下载链接
---

从 `v3.0.6.0` 开始，taosTools 集成到 TDengine 的安装包中，不再单独提供。taosTools（对应 TDengine `v3.0.5.2` 及以下）各版本安装包下载链接如下：
