...
本节讲述如何通过 taosExplorer 界面创建数据写入任务，从 CSV 将数据接入当前 TDengine 集群。
...
![csv-05.png](../../assets/csv-05.png)

#### 解析

上传文件或配置监听目录后，点击解析按钮，页面将获取文件中的示例数据，同时得到识别的列与示例数据解析结果：

![csv-05.png](../../assets/csv-06.png)
...
![csv-10.png](../../assets/csv-10.png)

### 查看运行指标

点击 **查看** 按钮，查看任务的运行指标，同时也可以查看任务中所有文件的处理情况。

![csv-11.png](../../assets/csv-11.png)

![csv-12.png](../../assets/csv-12.png)

![csv-13.png](../../assets/csv-13.png)
