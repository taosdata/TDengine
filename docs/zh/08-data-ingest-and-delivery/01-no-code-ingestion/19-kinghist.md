...
本节讲述如何通过 taosExplorer 界面创建数据迁移/数据同步任务，从 KingHistorian 迁移/同步数据到当前 TDengine 集群。

## 功能概述

TDengine 可以高效地从 KingHistorian 读取数据并将其写入 TDengine，以实现历史数据迁移或实时数据同步。
...
![kinghist-01.png](../../assets/kinghist-01.png)
