...
本节讲述如何通过 taosExplorer 界面创建数据写入任务，从 SparkplugB 读取数据写入到当前 TDengine 集群。
...
![spb-01.png](../../assets/sparkplugb-01.png)
...
![spb-02.png](../../assets/sparkplugb-02.png)
...
![spb-03.png](../../assets/sparkplugb-03.png)
...
![spb-04.png](../../assets/sparkplugb-04.png)
...
![spb-05.png](../../assets/sparkplugb-05.png)

点击 **放大镜图标**  可查看预览解析结果。

![spb-06.png](../../assets/sparkplugb-06.png)
...
![spb-07.png](../../assets/sparkplugb-07.png)
...
![spb-08.png](../../assets/sparkplugb-08.png)

#### 数据过滤

在 **过滤** 中，填写过滤条件，例如：填写`datatype_str != "Int8"`，则只有 datatype_str 不为 `Int8` 的数据才会被写入 TDengine。

![spb-9.png](../../assets/sparkplugb-09.png)

点击 **删除**，可以删除当前过滤规则。

点击 **放大镜图标** 可查看预览过滤结果。

![spb-10.png](../../assets/sparkplugb-10.png)
...
![spb-11.png](../../assets/sparkplugb-11.png)

在 **映射** 中，填写目标超级表中的子表名称，例如：`t_{id}`。根据需求填写映射规则，其中 mapping 支持设置缺省值。

![spb-12.png](../../assets/sparkplugb-12.png)

点击 **预览**，可以查看映射的结果。

![spb-13.png](../../assets/sparkplugb-13.png)
...
![spb-14](../../assets/sparkplugb-14.png)
...
点击 **提交** 按钮，完成创建 Sparkplug B 到 TDengine 的数据同步任务，回到 **数据源列表** 页面可查看任务执行情况。
