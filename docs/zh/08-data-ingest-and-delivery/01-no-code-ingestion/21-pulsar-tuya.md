...
本节讲述如何通过 taosExplorer 界面创建数据写入任务，从 Pulsar-Tuya 将数据接入当前 TDengine 集群。

## 功能概述

Apache Pulsar 是一个云原生的开源分布式消息与流处理平台。Pulsar-Tuya 是涂鸦基于开源的 Pulsar 系统进行了定制的集群。

TDengine 可以高效地从 Pulsar-Tuya 读取数据并将其写入 TDengine，以实现历史数据迁移或实时数据流入库。
...
![image-20260103095152670](../../assets/pulsar-01.png)
...
![image-20260103123538920](../../assets/pulsar-tuya-01.png)
...
![image-20260103123929570](../../assets/pulsar-tuya-02.png)

### 认证机制

此处需要涂鸦平台专有的认证信息，填写平台提供的 Access Id 和 Access Key，并选择对应的执行环境。

![image-20260103123653400](../../assets/pulsar-tuya-03.png)
...
![image-20260103120055362](../../assets/pulsar-tuya-04.png)
...
点击 **提交** 按钮，完成创建 Pulsar-Tuya 到 TDengine 的数据同步任务，回到 **数据源列表** 页面可查看任务执行情况。
