...
本节讲述如何通过 taosExplorer 界面创建数据迁移/数据同步任务，从 pSpace 迁移/同步数据到当前 TDengine 集群。

## 功能概述

TDengine 可以高效地从 pSpace 读取数据并将其写入 TDengine，以实现历史数据迁移或实时数据同步。
...
![pspace-01.png](../../assets/kinghist-01.png)
...
![pspace-02.png](../../assets/pspace-01.png)
...
![pspace-03.png](../../assets/pspace-02.png)
...
![pspace-06.png](../../assets/pspace-05.png)
...
![pspace-07.png](../../assets/pspace-06.png)
...
- 任务运行过程中，若 pSpace 侧发生点位变更（新增或删除点位），需要手动重启本数据写入任务，否则新增点位的数据可能无法正确同步到 TDengine。
