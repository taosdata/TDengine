...
本节讲述如何通过 taosExplorer 界面创建数据写入任务，从 PostgreSQL 将数据接入当前 TDengine 集群。
...
![postgres-01.png](../../assets/postgres-01.png "选择数据源类型为 PostgreSQL")

### 3. 配置连接信息

在 **连接配置** 区域填写 *`源 PostgreSQL 数据库的连接信息`*，如下图所示：

![postgres-02.png](../../assets/postgres-02.png "填写源 PostgreSQL 数据库的连接信息")

### 4. 配置认证信息

**用户** 输入源 PostgreSQL 数据库的用户，该用户必须在该组织中拥有读取权限。  

**密码** 输入源 PostgreSQL 数据库中上方用户的登录密码。

![ postgres-03.png](../../assets/postgres-03.png "配置认证信息")  
...
![ postgres-04.png](../../assets/postgres-04.png "配置连接选项")  
...
![ postgres-05.png](../../assets/postgres-05.png "配置数据采集")
...
![postgres-06.png](../../assets/postgres-01.png)
