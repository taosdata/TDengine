...
本节讲述如何通过 taosExplorer 界面创建数据写入任务，从 Kafka 将数据接入当前 TDengine 集群。
...
![kafka-01.png](../../assets/no-code-ingestion-kafka-01.png)
...
![kafka-02.png](../../assets/no-code-ingestion-kafka-02.png)
...
![kafka-03.png](../../assets/no-code-ingestion-kafka-03.png)
...
![kafka-04-sasl-plain.png](../../assets/no-code-ingestion-kafka-04.png)

#### SCRAM(SCRAM-SHA-256) 认证

选择 `SCRAM-SHA-256` 认证机制，输入用户名和密码：

![kafka-04.png](../../assets/no-code-ingestion-kafka-05.png)

#### GSSAPI 认证

选择 `GSSAPI` ，将通过 [RDkafka 客户端](https://github.com/confluentinc/librdkafka) 调用 GSSAPI 应用 Kerberos 认证机制：

![kafka-04-sasl-gssapi.png](../../assets/no-code-ingestion-kafka-06.png)
...
![kafka-05.png](../../assets/no-code-ingestion-kafka-07.png)
...
- ByTime(ms)：从指定时间戳开始消费，取值为毫秒级 Unix 时间戳。
...
![kafka-06.png](../../assets/no-code-ingestion-kafka-08.png)
...
![kafka-multi-datastructures](../../assets/no-code-ingestion-kafka-09.png)
...
![kafka-07.png](../../assets/no-code-ingestion-kafka-10.png)

点击 **放大镜图标**  可查看预览解析结果。

![kafka-08.png](../../assets/no-code-ingestion-kafka-11.png)
...
![kafka-09.png](../../assets/no-code-ingestion-kafka-12.png)

点击 **放大镜图标** 可查看预览提取/拆分结果。

![kafka-10.png](../../assets/no-code-ingestion-kafka-13.png)
...
![kafka-11.png](../../assets/no-code-ingestion-kafka-14.png)

点击 **放大镜图标** 可查看预览过滤结果。

![kafka-12.png](../../assets/no-code-ingestion-kafka-15.png)
...
![kafka-13.png](../../assets/no-code-ingestion-kafka-16.png)

点击 **预览**，可以查看映射的结果。

![kafka-14.png](../../assets/no-code-ingestion-kafka-17.png)

### 配置高级选项

import AdvancedOptions from './resources/_02-advanced-options-mq.mdx'
