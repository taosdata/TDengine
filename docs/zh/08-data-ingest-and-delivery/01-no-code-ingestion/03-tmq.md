...
![准备一](../../assets/tmq-01.png)

### 第二步：添加新主题

输入主题名称，选择要订阅的数据库。

![准备二](../../assets/tmq-02.png)

对于 `数据库` 或 `超级表` 类型，如果需要同步表的增/删/改操作，则需要开启 `同步 Meta` 选项用于数据库/超级表的迁移，否则此主题只会进行数据同步。

关于主题的创建，详情请参考 [主题语法](../../06-data-subscription/01-topic.md)。

### 第三步：复制主题的 DSN

点击“创建”按钮，回到主题列表复制主题的 **DSN** 备用。

![准备三](../../assets/tmq-03.png)
