...
![spb-05.png](assets/spb-05.png)

点击 **放大镜图标**  可查看预览解析结果。

![spb-06.png](assets/spb-06.png)
...
![spb-11.png](assets/spb-11.png)

在 **映射** 中，填写目标超级表中的子表名称，例如：`t_{id}`。根据需求填写映射规则，其中 mapping 支持设置缺省值。

![spb-12.png](assets/spb-12.png)

点击 **预览**，可以查看映射的结果。

![spb-13.png](assets/spb-13.png)
