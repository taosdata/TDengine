...
| :-------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------- |
|        2.7.16         | 新增订阅配置 (session.timeout.ms, max.poll.interval.ms)                                                                                                            | 3.1.1.2 及更高版本 |
|        2.7.15         | 新增 VARBINARY 和 GEOMETRY 类型支持                                                                                                                                | 3.1.1.2 及更高版本 |
|        2.7.14         | 修复已知问题                                                                                                                                                       | 3.1.1.2 更高版本  |
|        2.7.13         | 新增 tmq 同步提交 offset 接口                                                                                                                                       | 3.1.1.2 及更高版本 |
...
|          0.2.9           | 已知问题修复                                                                          | 3.0.5.0 及更高版本 |
|          0.2.5           | 1. 数据订阅支持获取消费进度和重置消费进度 <br/> 2. 支持 schemaless <br/> 3. 支持 STMT | 3.0.5.0 及更高版本 |
