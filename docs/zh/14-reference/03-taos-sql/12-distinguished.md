...
7. NULL_F: 强制填充 NULL 值，例如：
```
taos> select _wstart,count(*) from meters where ts>='2020-11-01T08:00:00+0800' and ts<='2020-11-01T08:05:00+0800' interval(1m) fill(null);
Query OK, 0 row(s) in set (0.001734s)

taos> select _wstart,count(*) from meters where ts>='2020-11-01T08:00:00+0800' and ts<='2020-11-01T08:05:00+0800' interval(1m) fill(null_f);
         _wstart         |       count(*)        |
==================================================
 2020-11-01 08:00:00.000 | NULL                  |
 2020-11-01 08:01:00.000 | NULL                  |
 2020-11-01 08:02:00.000 | NULL                  |
 2020-11-01 08:03:00.000 | NULL                  |
 2020-11-01 08:04:00.000 | NULL                  |
 2020-11-01 08:05:00.000 | NULL                  |
Query OK, 6 row(s) in set (0.002179s)
```
9. VALUE_F: 强制填充 VALUE 值，例如：
```
taos> select _wstart,count(*) from meters where ts>='2020-11-01T08:00:00+0800' and ts<='2020-11-01T08:05:00+0800' interval(1m) fill(value,0);
Query OK, 0 row(s) in set (0.002028s)

taos> select _wstart,count(*) from meters where ts>='2020-11-01T08:00:00+0800' and ts<='2020-11-01T08:05:00+0800' interval(1m) fill(value_f,0);
         _wstart         |       count(*)        |
==================================================
 2020-11-01 08:00:00.000 |                     0 |
 2020-11-01 08:01:00.000 |                     0 |
 2020-11-01 08:02:00.000 |                     0 |
 2020-11-01 08:03:00.000 |                     0 |
 2020-11-01 08:04:00.000 |                     0 |
 2020-11-01 08:05:00.000 |                     0 |
Query OK, 6 row(s) in set (0.001846s)
```
