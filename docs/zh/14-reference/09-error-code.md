...
| 0x800004FB | No enabled user with SYSSEC role found                       | 三员分立策略要求有启用的 SYSSEC 角色用户           | 在激活三员分立前创建或启用 SYSSEC 角色用户 |
| 0x800004FC | No enabled user with SYSAUDIT role found                     | 三员分立策略要求有启用的 SYSAUDIT 角色用户         | 在激活三员分立前创建或启用 SYSAUDIT 角色用户 |
