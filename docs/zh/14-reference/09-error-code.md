...
| 0x800004E4 | Invalid encryption algorithm format                                                          | 输入算法id为空                                                                            | 确认操作是否正确                                                                                     |
...
| 0x80002699 | Algorithm ID too long, max lenght is 63 character                                                      | Algorithm ID 参数非法                                         | 检查并修正 SQL 语句                    |
| 0x8000269A | Algorithm name too long, max lenght is 63 character                                                    | Algorithm name 参数非法                                         | 检查并修正 SQL 语句                    |
| 0x8000269B | Algorithm description too long, max lenght is 127 character                                            | Algorithm description 参数非法                                         | 检查并修正 SQL 语句                    |
| 0x8000269C | Algorithm type too long, max lenght is 63 character                                                    | Algorithm type 参数非法                                         | 检查并修正 SQL 语句                    |
| 0x8000269D | Algorithm OpenSSL name too long, max lenght is 63 character                                            | Algorithm OpenSSL name 参数非法                                         | 检查并修正 SQL 语句                    |
