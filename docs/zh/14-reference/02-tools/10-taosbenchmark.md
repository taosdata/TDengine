...
```json
{{#include /TDengine/tools/taosBenchmark/example/insert.json}}
```
...
```json
{{#include /TDengine/tools/taosBenchmark/example/query.json}}
```
...
```json
{{#include /TDengine/tools/taosBenchmark/example/queryStb.json}}
```
...
```json
{{#include /TDengine/tools/taosBenchmark/example/tmq.json}}
```
...
```json
{{#include /TDengine/tools/taosBenchmark/example/csv-export.json}}
```
