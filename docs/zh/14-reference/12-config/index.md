...
| 5   | monitorFqdn | 否 | 是 |
| 5   | monitorPort | 否 | 是 |
| 5   | monitorInterval | 是 | 是 |
| 5   | monitorMaxLogs | 否 | 是 |
| 5   | monitorComp | 否 | 是 |
| 5   | telemetryReporting | 是 | 是 |
| 5   | telemetryInterval | 否 | 是 |
| 5   | telemetryServer | 否 | 是 |
| 5   | telemetryPort | 否 | 是 |
| 5   | queryPolicy | 否 | 是 |
| 5   | querySmaOptimize | 否 | 是 |
| 5   | queryBufferSize | 是 | 是 |
| 5   | maxNumOfDistinctRes | 是 | 是 |
| 5   | minSlidingTime | 是 | 是 |
| 5   | minIntervalTime | 是 | 是 |
| 5   | countAlwaysReturnValue | 是 | 是 |
| 5   | dataDir | 是 | 是 |
| 5   | minimalDataDirGB | 是 | 是 |
| 5   | supportVnodes | 否 | 是 |
| 5   | tempDir | 是 | 是 |
| 5   | minimalTmpDirGB | 是 | 是 |
| 5   | compressMsgSize | 是 | 是 |
| 5   | compressColData | 是 | 是 |
| 5   | smlChildTableName | 是 | 是 |
| 5   | smlTagName | 是 | 是 |
| 5   | smlDataFormat | 否 | 是 |
| 5   | statusInterval | 是 | 是 |
| 5   | shellActivityTimer | 是 | 是 |
| 5   | transPullupInterval | 否 | 是 |
| 5   | mqRebalanceInterval | 否 | 是 |
| 5   | ttlUnit | 否 | 是 |
| 5   | ttlPushInterval | 否 | 是 |
| 5   | numOfTaskQueueThreads | 否 | 是 |
| 5   | numOfRpcThreads | 否 | 是 |
| 5   | numOfCommitThreads | 是 | 是 |
| 5   | numOfMnodeReadThreads | 否 | 是 |
| 5   | numOfVnodeQueryThreads | 否 | 是 |
| 5   | numOfVnodeStreamThreads | 否 | 是 |
| 5   | numOfVnodeFetchThreads | 否 | 是 |
| 5   | numOfVnodeWriteThreads | 否 | 是 |
| 5   | numOfVnodeSyncThreads | 否 | 是 |
| 5   | numOfQnodeQueryThreads | 否 | 是 |
| 5   | numOfQnodeFetchThreads | 否 | 是 |
| 5   | numOfSnodeSharedThreads | 否 | 是 |
| 5   | numOfSnodeUniqueThreads | 否 | 是 |
| 5   | rpcQueueMemoryAllowed | 否 | 是 |
| 5   | logDir | 是 | 是 |
| 5   | minimalLogDirGB | 是 | 是 |
| 5   | numOfLogLines | 是 | 是 |
| 5   | asyncLog | 是 | 是 |
| 5   | logKeepDays | 是 | 是 |
| 5   | debugFlag | 是 | 是 |
...
| 5   | charset | 是 | 是 |
| 5   | udf | 是 | 是 |
| 5   | enableCoreFile | 是 | 是 |
| 5   | arbitrator | 是 | 否 |
| 5   | numOfThreadsPerCore | 是 | 否 |
| 5   | numOfMnodes | 是 | 否 |
| 5   | vnodeBak | 是 | 否 |
| 5   | balance | 是 | 否 |
| 5   | balanceInterval | 是 | 否 |
| 5   | offlineThreshold | 是 | 否 |
| 5   | role | 是 | 否 |
| 5   | dnodeNopLoop | 是 | 否 |
| 5   | keepTimeOffset | 是 | 否 |
| 5   | rpcTimer | 是 | 否 |
| 5   | rpcMaxTime | 是 | 否 |
| 5   | rpcForceTcp | 是 | 否 |
| 5   | tcpConnTimeout | 是 | 否 |
| 5   | syncCheckInterval | 是 | 否 |
| 5   | maxTmrCtrl | 是 | 否 |
| 5   | monitorReplica | 是 | 否 |
| 5   | smlTagNullName | 是 | 否 |
| 5   | keepColumnName | 是 | 否 |
| 5   | ratioOfQueryCores | 是 | 否 |
| 5   | maxStreamCompDelay | 是 | 否 |
| 5   | maxFirstStreamCompDelay | 是 | 否 |
| 5   | retryStreamCompDelay | 是 | 否 |
| 5   | streamCompDelayRatio | 是 | 否 |
| 5   | maxVgroupsPerDb | 是 | 否 |
| 5   | maxTablesPerVnode | 是 | 否 |
| 5   | minTablesPerVnode | 是 | 否 |
| 5   | tableIncStepPerVnode | 是 | 否 |
| 5   | cache | 是 | 否 |
| 5   | blocks | 是 | 否 |
| 5   | days | 是 | 否 |
| 5   | keep | 是 | 否 |
...
| 5   | cachelast | 是 | 否 |
| 5   | maxSQLLength | 是 | 否 |
| 5   | maxWildCardsLength | 是 | 否 |
| 5   | maxRegexStringLen | 是 | 否 |
| 5   | maxNumOfOrderedRes | 是 | 否 |
| 5   | maxConnections | 是 | 否 |
| 5   | mnodeEqualVnodeNum | 是 | 否 |
| 5   | http | 是 | 否 |
| 5   | httpEnableRecordSql | 是 | 否 |
| 5   | httpMaxThreads | 是 | 否 |
| 5   | restfulRowLimit | 是 | 否 |
| 5   | httpDbNameMandatory | 是 | 否 |
| 5   | httpKeepAlive | 是 | 否 |
| 5   | enableRecordSql | 是 | 否 |
| 5   | maxBinaryDisplayWidth | 是 | 否 |
| 5   | stream | 是 | 否 |
| 5   | retrieveBlockingModel | 是 | 否 |
| 5   | tsdbMetaCompactRatio | 是 | 否 |
| 5   | defaultJSONStrType | 是 | 否 |
| 5   | walFlushSize | 是 | 否 |
| 5   | keepTimeOffset | 是 | 否 |
| 5   | flowctrl | 是 | 否 |
| 5   | slaveQuery | 是 | 否 |
| 5   | adjustMaster | 是 | 否 |
| 5   | topicBinaryLen | 是 | 否 |
| 5   | telegrafUseFieldNum | 是 | 否 |
| 5   | deadLockKillQuery | 是 | 否 |
| 5   | clientMerge | 是 | 否 |
| 5   | sdbDebugFlag | 是 | 否 |
| 5   | odbcDebugFlag | 是 | 否 |
| 5   | httpDebugFlag | 是 | 否 |
