...
[database]
path = "/var/lib/taos/cls"

[log]
level = "info"
file = "/var/log/taos/taos_cls.log"
```

参数说明：

- `local.host`: 表示服务监听的地址，默认 0.0.0.0 表示监听所有网卡地址
- `local.port`: 表示开启的 http api 服务端口
