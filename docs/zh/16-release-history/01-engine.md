---
sidebar_label: 引擎发布历史
title: 引擎发布历史及下载链接
description: TDengine TSDB 发布历史、Release Notes 及下载链接
---

## 版本规则说明

TSDB 版本号由四个数字组成，中间由点号分隔，定义如下

- `[Major+].[Major].[Feature].[Maintenance]`
- `Major+`：产品有重大重构，不能直接升级，如有升级需要请联系 TDengine TSDB 客户支持团队
...
TSDB 2.x 各版本安装包请访问 [这里](https://taosdata.com/all-downloads)

## TSDB 3.x 下载

TSDB 3.3.7.0 及以上版本请访问[下载中心](https://taosdata.com/download-center)

TSDB 3.x 各版本安装包下载链接如下：
