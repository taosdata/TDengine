...
- [Set the current session timezone](../14-reference/03-taos-sql/53-set.md#set-timezone)
...
3. The week-related ranges here do not take the first day of the week into account. TDengine supports configuring the first day of the week; see [firstDayOfWeek](../14-reference/01-components/02-taosc.md#firstDayOfWeek).
