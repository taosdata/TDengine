...
- State Window: Windows are divided based on changes in device states values, with data of the same states value grouped into one window, which closes when the state value changes.
