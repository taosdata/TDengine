...
For detailed query syntax, see [Select](../../reference/taos-sql/select).
...
In [Select](../../reference/taos-sql/select), all query operations are marked as to whether they support STables or not.
...
For more information, see [Aggregate by Window](../../reference/taos-sql/distinguished).
