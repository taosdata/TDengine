...
1. Tuple Encoding Format
   ...
   ![Tuple row format](../assets/storage-01.png)
...
1. Key-Value Encoding Format
   ...
   ![Key-value row format](../assets/storage-02.png)
...
![Column format](../assets/storage-03.png)
...
![Vnode storage architecture](../assets/storage-04.png)
...
![Metadata writing process](../assets/storage-05.png)
...
![B+ tree storage structure](../assets/storage-06.png)

The page structure of the B+Tree is shown in the following figure:

![B+ tree page structure](../assets/storage-07.png)
...
![TSDB engine write process](../assets/storage-08.png)
...
![SkipList index](../assets/storage-09.png)
...
![File set](../assets/storage-10.png)
...
![BRIN index structure](../assets/storage-11.png)
