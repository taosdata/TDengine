---
description: TDengine query and computation module responsibilities and execution flow
...
![Multi-table aggregation query process](../assets/query-01.png)
...
![Cache scheme](../assets/query-02.png)
