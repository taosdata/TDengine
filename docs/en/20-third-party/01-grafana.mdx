...
![Search tdengine in grafana plugins](../assets/grafana-plugin-search-tdengine.png)

Installation may cost some minutes, then you can **Create a TDengine data source**:

![Install and configure Grafana data source](../assets/grafana-install-and-config.png)

Then you can add a TDengine data source by filling up the configuration options.

![TDengine Database Grafana plugin add data source](../assets/grafana-data-source.png)
...
![TDengine Database TDinsight plugin add datasource 1](../assets/add_datasource1.webp)
...
![TDengine Database TDinsight plugin add datasource 2](../assets/add_datasource2.webp)

Enter the datasource configuration page, and follow the default prompts to modify the corresponding configuration.

![TDengine Database TDinsight plugin add database 3](../assets/add_datasource3.webp)
...
![TDengine Database TDinsight plugin add database 4](../assets/add_datasource4.webp)
...
![TDengine Database TDinsight plugin create dashboard 1](../assets/create_dashboard1.webp)
...
![TDengine Database TDinsight plugin create dashboard 2](../assets/create_dashboard2.webp)

The example to query the average system free memory for the specified interval on each server as follows.

![TDengine Database TDinsight plugin create dashboard 2](../assets/create_dashboard3.webp)
...
![TDengine Database Grafana plugine import dashboard](../assets/import_dashboard.webp)
