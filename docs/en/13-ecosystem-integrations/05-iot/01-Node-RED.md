...
- taosAdapter running (refer to [taosAdapter Reference Manual](../../12-operations-and-tooling/03-components/03-taosadapter.md)).
...
Plugin data sources are configured in the node properties using the [Node.js connector](../../10-developer-guide/08-connectors-reference/06-node.mdx):
