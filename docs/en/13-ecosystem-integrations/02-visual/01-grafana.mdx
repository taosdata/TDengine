...
- taosAdapter has been installed and is running normally. For details, please refer to the [taosAdapter user manual](../../12-operations-and-tooling/03-components/03-taosadapter.md)
...
Detailed introduction to the above features can be found at [Distinguished Queries](../../05-tdengine-sql/04-data-query/06-distinguished.md).
