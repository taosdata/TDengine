...
- Install the TDengine Node.js client library. For more information, see [Node.js Client Library](../../10-developer-guide/08-connectors-reference/06-node.mdx).
...
1. Create a Perspective table to host on the WebSocket server:
   ...
   To determine the Node.js data type for each metric, refer to [Data Type Mapping](../../10-developer-guide/08-connectors-reference/06-node.mdx#data-type-mapping).
...
- Install the TDengine Python client library. For more information, see [Python Client Library](../../10-developer-guide/08-connectors-reference/05-python.mdx).
...
1. Create a Perspective table and update it with data from TDengine:
   ...
   To determine the Python data type for each metric, refer to [Data Type Mapping](../../10-developer-guide/08-connectors-reference/05-python.mdx#data-type-mapping).
...
This section creates a quick demonstration environment using Python with which you can explore TDengine and Perspective.
...
1. Clone the `perspective-examples` repository from GitHub to your local machine and open the `examples/tdengine/python` directory.
   ...
   ```bash
   git clone https://github.com/ProspectiveCo/perspective-examples
   cd perspective-examples/examples/tdengine/python
   ```
