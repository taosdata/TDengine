...
![Kafka Connect architecture](../../assets/collection-kafka-01.png)
...
![Streaming integration with Kafka Connect](../../assets/collection-kafka-02.png)
...
4. TDengine installed and running. If not yet installed, refer to [Installation and Uninstallation](../../04-quick-start/index.md)
...
The TDengine Sink Connector internally uses TDengine's [schemaless write interface](../../10-developer-guide/04-schemaless.md) to write data to TDengine, currently supporting three data formats: InfluxDB Line Protocol format, OpenTSDB Telnet Protocol format, and OpenTSDB JSON Protocol format.
