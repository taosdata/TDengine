...
| ----------------------- | ------------------------------------------------------------ | ------------------- |
| 2.1.4                   | Upgrade the JDBC driver to version 3.7.3. For details, see [JDBC Version History](../../../10-developer-guide/08-connectors-reference/02-java.mdx#version-history) | - |
