...
**Step 1**, Search and open the [ODBC Data Source (64 bit)] management tool in the Start menu of the Windows operating system and configure it, refer to [Install ODBC Driver](../../10-developer-guide/08-connectors-reference/09-odbc.mdx#installation).
