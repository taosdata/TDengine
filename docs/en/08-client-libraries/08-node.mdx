...
| Node.js Websocket version |    major changes     |   TDengine 版本    |
| :-----------------------: | :------------------: | :----------------:|
|        3.1.0              |  new version publish |  3.2.0.0 or later |
...
Error Description: The Node.js client library error code is between 100 and 110, while the other error codes are for the TDengine function module.
