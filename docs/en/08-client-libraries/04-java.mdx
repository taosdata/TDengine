...
`taos-jdbcdriver` mainly provides two connection types.   
...
- `taos-jdbcdriver` also supports REST connection, but we recommend using the **Websocket connection** type more.   

For a detailed introduction and difference of the connection types, please refer to: [Establish Connection](../../develop/connect/#Establish-Connection)

## Compatibility with JDBC and JRE Versions

- JDBC: mainly supports JDBC 4.2 version, some features like data subscription provided individually.  
