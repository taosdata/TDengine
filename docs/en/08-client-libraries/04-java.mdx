...
| :---------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------: |
|          3.2.10         |  REST/WebSocket connections support compression, and a configuration parameter for WebSocket automatic reconnection has been added, which is turned off by default. Schemaless writing is supported on the connection, with automatic reconnection support provided. The performance of data fetching on Native connections has been optimized. A bug related to the escaping of super table names has been resolved. Metadata can now retrieve a list of supported functions. |        -         |
