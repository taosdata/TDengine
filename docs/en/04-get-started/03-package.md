...
1. Download the tar.gz installation package from the list below:  
   <PkgList productName="TDengine TSDB-Enterprise" version="3.4.0.0" platform="Linux-Generic" />
...
1. Download the Windows installation package from the list below:  
   <PkgList productName="TDengine TSDB-Enterprise" version="3.4.0.0" platform="Windows" />
