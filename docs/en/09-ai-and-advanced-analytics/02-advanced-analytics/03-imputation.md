...
Since `v3.3.8.7`, imputation results can use the following pseudocolumns to obtain imputation-related information:

- `_IMPROWTS`: Displays the timestamp information for each data point.
- `_IMPMARK`: Identifies whether the corresponding data point was generated by model imputation.

## Example

Use the moment model for automatic imputation on column `i32`, with frequency in seconds, outputting timestamps and imputed values:
