...
This section describes how to create a data migration task through the taosExplorer interface to migrate data from PostgreSql to the current TDengine cluster.
