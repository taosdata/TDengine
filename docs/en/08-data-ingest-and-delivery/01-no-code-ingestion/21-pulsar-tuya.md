...
This section describes how to create a data migration task through the taosExplorer interface to migrate data from Pulsar-Tuya cluster to the current TDengine cluster.
...
TDengine can efficiently read data from Pulsar-Tuya and write it to TDengine to achieve historical data migration or real-time data ingestion.
