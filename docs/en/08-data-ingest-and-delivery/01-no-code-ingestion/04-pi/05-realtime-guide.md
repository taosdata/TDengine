...
6. Configure advanced options (see "Multi-column Model Advanced Features" below)
7. Submit the task

### Restart Compensation Time
...
![PI Real-time task restart compensation time](../../../assets/realtime-guide-01.png)
...
## Multi-column Model Advanced Features
...
1. **Network latency**: Check the network latency from taosX/taosX-Agent to the PI system
