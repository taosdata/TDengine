...
This section describes how to create data migration/data synchronization tasks through the taosExplorer interface, migrating/synchronizing data from AVEVA Historian to the current TDengine cluster.
