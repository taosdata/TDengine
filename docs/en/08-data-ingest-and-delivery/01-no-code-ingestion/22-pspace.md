...
This section describes how to create data migration/data synchronization tasks through the taosExplorer UI to migrate/synchronize data from pSpace to the current TDengine cluster.

## Feature Overview

TDengine can efficiently read data from pSpace and write it to TDengine for historical data migration or real-time data synchronization.
...
![pspace-en-03.png](../../assets/pspace-01.png)
...
![pspace-en-04.png](../../assets/pspace-02.png)
...
![pspace-en-05.png](../../assets/pspace-03.png)
...
![pspace-en-06.png](../../assets/pspace-04.png)
...
![pspace-en-07.png](../../assets/pspace-05.png)
...
- While a pspace data in task is running, if the point list changes(add or remove data points) in pSpace, you must manually restart this data-in task; otherwise, data from newly added points may not be correctly synchronized to TDengine.
