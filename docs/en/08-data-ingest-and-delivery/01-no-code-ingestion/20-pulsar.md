...
This section describes how to create a data migration task through the taosExplorer interface to migrate data from Pulsar to the current TDengine cluster.

## Feature Overview

Apache Pulsar is a cloud-native open-source distributed messaging and stream processing platform.

TDengine can efficiently read data from Pulsar and write it to TDengine to achieve historical data migration or real-time data ingestion.
...
![Configure connection information](../../assets/pulsar-01.png)
...
![Configure plain authentication](../../assets/pulsar-02.png)

#### JWT Authentication

Select the `JWT` authentication mechanism and enter the JWT token information:

![Configure SCRAM authentication](../../assets/pulsar-03.png)
...
![Configure collection settings](../../assets/pulsar-06.png)
