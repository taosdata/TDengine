...
This section describes how to create a data migration task through the taosExplorer interface to migrate data from InfluxDB to the current TDengine cluster.
