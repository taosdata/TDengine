...
![Stream processing architecture](../assets/stream-processing-engine-01.png)
...
![Composition of stream processing tasks](../assets/stream-processing-engine-02.png)
...
![Relationships between tasks](../assets/stream-processing-engine-03.png)
