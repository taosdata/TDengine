...
1. **Recommended to use WebSocket connection**:
   ...
   - <font color="red">**Native connections for Go, C#, and Java will be deprecated on 2027-01-01, please migrate in advance**</font>

2. Native connection (to be deprecated):
   - **Users using Go, C#, and Java connectors should note that native connection will be deprecated on 2027-01-01**
...
3. REST API:
   ...
   - <font color="red">**REST connections for Java, Python, and Go will be deprecated on 2027-01-01, please migrate to WebSocket connection**</font>
