...
![TDengine client library architecture](../../assets/connector-architecture.png)
...
For the support status of various connection methods and connectors for different languages, please refer to [Connector Features](../../14-reference/05-connector/index.md#feature-support).
