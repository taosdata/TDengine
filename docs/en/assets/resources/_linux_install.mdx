...
1. Download the client installation package
  ...
  <PkgListV37 productName="TDengine TSDB-OSS Client" version="3.3.8.8" platform="Linux-Generic" pkgType="Client"/>

2. Unzip the software package

   Place the package in any directory where the current user has read and write access, then execute the following command: `tar -xzvf tdengine-tsdb-oss-client-3.3.8.8-linux-x64.tar.gz`
