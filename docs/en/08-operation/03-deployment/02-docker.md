...
```shell
docker compose -f tsdb_cluster.yaml up
```

After the cluster is up, enter any node and execute the following command to check the cluster status:
