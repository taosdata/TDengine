...
- INTERP determines how to interpolate at each time point that meets the output conditions based on the FILL field. For how to use the FILL clause, refer to [FILL Clause](https://docs.tdengine.com/tdengine-reference/sql-manual/time-series-extensions/#fill-clause)
...
See [TDengine Distinctive Queries](https://docs.tdengine.com/tdengine-reference/sql-manual/time-series-extensions/)
...
For more information on JOIN operations, see the page [TDengine Join Queries](https://docs.tdengine.com/tdengine-reference/sql-manual/join-queries/)
