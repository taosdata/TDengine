...
Refer to the `VIRTUAL` parameter in [Create Supertable](./stable.md#create-supertable).
...
1. Naming rules for virtual tables/columns follow [Name Rules](./limit.md#naming-rules).
