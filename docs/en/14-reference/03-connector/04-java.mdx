...
| taos-jdbcdriver version |                                                                   major changes                                                                    | TDengine Minimum version |
| :---------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------: |
|          3.2.1          |                                                           subscription add seek function                                                           |         3.0.5.0          |
|          3.2.1          |                                      JDBC REST connection supports schemaless/prepareStatement over WebSocket                                      |         3.0.3.0          |
...
|          3.0.0          |                                                              Support for TDengine 3.0                                                              |         3.0.0.0          |
