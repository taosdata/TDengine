...
<TabItem value="CLI" label="Using Native Connection">
...
Beside, you can edit current .NET project file either. You can add following 'ItemGroup' into you project file (.csproj).
...
<TabItem value="source" label="Use WebSocket Connection">
