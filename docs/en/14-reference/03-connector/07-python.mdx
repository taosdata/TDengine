...
1. Install Python. The recent taospy package requires Python 3.6+. The earlier version of taospy requires Python 3.7+.  The taos-ws-py package requires Python 3.7+. If Python is not available on your system, refer to the [Python BeginnersGuide](https://wiki.python.org/moin/BeginnersGuide/Download) to install it.
