...
| :-------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------- |
|2.7.16 | Add subscription configuration (session. timeout. ms, Max. roll. interval. ms)                            | 3.1.1.2 and higher|
|2.7.15 | Added support for VARBINRY and GEOMETRY types                                                             | 3.1.1.2 and higher|
|2.7.14 | Fix Known Issues                                                                                          | 3.1.1.2 Higher Version|
|2.7.13 | Added tmq synchronous submission offset interface                                                         | 3.1.1.2 and higher|
...
|0.2.9 | Known issue fixes                                                                                                      | 3.0.5.0 and higher|
|0.2.5 | 1. Data subscription supports obtaining and resetting consumption progress<br/>2 Support schemaless<br/>3 Support STMT | 3.0.5.0 and higher|
