...
| Rust Connector Version |                                             Main Features                                             | TDengine Version  |
| :--------------------: | :---------------------------------------------------------------------------------------------------: | :---------------: |
|        v0.12.3         | 1. Optimized WebSocket query and insert performance. <br/> 2. Supported VARBINARY and GEOMETRY types. | 3.3.0.0 and later |
|        v0.12.0         |                                    WebSocket supports compression.                                    | 3.2.3.0 and later |
|        v0.11.0         |                                       TMQ feature optimization.                                       | 3.2.0.0 and later |
|        v0.10.0         |                                      WebSocket endpoint change.                                       | 3.1.0.0 and later |
|         v0.9.2         |                            STMT: WebSocket to get tag_fields, col_fields.                             | 3.0.7.0 and later |
|        v0.8.12         |      Message subscription: get consumption progress and start consuming at a specified progress.      | 3.0.5.0 and later |
|         v0.8.0         |                                     Supports schema-less writing.                                     | 3.0.4.0 and later |
|         v0.7.6         |                                  Supports using req_id in requests.                                   | 3.0.3.0 and later |
|         v0.6.0         |                                         Basic functionality.                                          | 3.0.0.0 and later |
