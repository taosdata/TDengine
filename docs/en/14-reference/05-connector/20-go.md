...
|-------------------|-------------------------------------------------------------------------------------------------|--------------------|
| v3.8.2            | WebSocket connections support taosAdapter high availability. | - |
| v3.8.1            | WebSocket connections support `skipVerify` to skip TLS certificate verification.                | -                  |
...
- `adapterHa` whether to enable taosAdapter high availability, default is false (supported since `v3.8.2`). When enabled, the connector requests the currently available taosAdapter instance list on the first successful WebSocket connection and adds discovered nodes to the address pool for load balancing and failover.
...
- `ws.adapterHa`: Whether to enable taosAdapter high availability, default false (supported since `v3.8.2`). When enabled, the connector requests the currently available taosAdapter instance list on the first successful subscription and adds discovered nodes to the address pool for load balancing and failover.
