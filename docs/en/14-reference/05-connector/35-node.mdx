...
1. "Unable to establish connection" or "Unable to resolve FQDN"
   ...
   **Reason**: This is usually due to incorrect configuration of the FQDN. You can refer to [How to Thoroughly Understand TDengine's FQDN](https://www.taosdata.com/blog/2021/07/29/2741.html).
