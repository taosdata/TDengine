...
| 0x800026AB | Invalid fill mode | Using fill(near) mode in interval window | Use supported fill modes for interval window |
| 0x800026AC | Invalid fill values | Incorrect use of fill values parameter | Use the correct fill mode with fill values parameter |
| 0x800026AD | Invalid surrounding time values | Incorrect surrounding time value provided | Use correct and valid time range and time unit  |
