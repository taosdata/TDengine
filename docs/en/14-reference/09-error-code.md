...
| 0x80002699 | Option duplicated                                                                                      | Option is only allowed to appear once but appeared twice or more           | Check and correct the SQL statement                          | 
| 0x8000269A | Invalid option value                                                                                   | Invalid option value                                                       | Check and correct the SQL statement                          |
| 0x8000269B | Option value too long                                                                                  | Option value too long                                                      | Check and correct the SQL statement                          |
| 0x8000269C | Option value too short                                                                                 | Option value too short                                                     | Check and correct the SQL statement                          |
| 0x8000269D | Option value too big                                                                                   | Option value too big                                                       | Check and correct the SQL statement                          |
| 0x8000269E | Option value too small                                                                                 | Option vlaue too small                                                     | Check and correct the SQL statement                          |
