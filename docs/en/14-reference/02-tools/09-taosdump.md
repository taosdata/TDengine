...
taosdump is included in both the server and client installation packages of TDengine TSDB v3.4.2.0 and later. For installation details, see [TDengine TSDB Installation](../../../get-started/).
