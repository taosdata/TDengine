...
- Install the taosTools official installer. Please find taosTools from [All download links](https://tdengine.com/downloads/historical/) page and download and install it.
