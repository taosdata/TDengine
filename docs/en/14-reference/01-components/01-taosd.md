...
| readCpuRatio         | After 3.3.6.0     | Not supported                    | Percentage of remaining CPU cores (after management allocation) assigned to read (query) threads. Write threads receive the remainder. Each category is guaranteed at least 1 core. Range: 0-100; default value is 50. Only effective when enableCpuAffinity is 1. |
