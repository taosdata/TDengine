...
| auditSaveInSelf            | After 3.4.1.0     | Supported, effective immediately   | audit information can be saved locally rather than sent to taoskeeper. range 0 - 1, default value 0 (1: open, 0: close).                                                                                                                                                                                                    |
