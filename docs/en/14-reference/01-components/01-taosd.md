...
| stableTagFilterCache     | since 3.3.8.6     | Supported, effective immediately   | Whether to cache tag equal condition filter results. It will not become invalid due to adding or deleting child tables or updating the tag values or modifying super table tags. |
