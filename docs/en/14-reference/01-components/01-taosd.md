...
| auditHttps                 |                   | Supported, effective immediately   | whether use https to report audit data; Enterprise parameter; range 0 - 1, default value 1, 1 means using https, 0 means not.                                                                                                         |
