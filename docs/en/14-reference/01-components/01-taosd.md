...
| numOfTaskQueueThreads  |                         | Supported, effective after restart                           | Number of threads for client to process RPC messages, range 4-1024, default value is twice the CPU cores (limited to [4, 1024]) |
...
| numOfMnodeReadThreads      |                   | Supported, effective after restart | Number of Read threads for mnode, range 1-1024, default value is one quarter of the CPU cores (not exceeding 4)                                                                                                                                                                |
...
| numOfVnodeFetchThreads     |                   | Supported, effective after restart | Number of Fetch threads for vnode, range 1-1024, default value is one quarter of the CPU cores (not exceeding 4)                                                                                                                                                               |
...
| auditLevel                 | After 3.4.0.0     | Supported, effective immediately   | Audit level for reporting audit data; Enterprise parameter; range 1 - 5, default value 0, 1 means system level, 2 means cluster level, 3 means database level, 4 means child table level, 5 means data level.                                                                                                         |
