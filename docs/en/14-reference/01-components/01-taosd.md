...
| auditLevel                 |                   | Supported, effective immediately   | Audit level for reporting audit data; Enterprise parameter; range 1 - 5, default value 3, 1 means system level, 2 means cluster level, 3 means database level, 4 means child table lvel, 5 means data level.                                                                                                         |
| auditHttps                 |                   | Supported, effective immediately   | whether use https to report audit data; Enterprise parameter; range 0 - 1, default value 0, 1 means using https, 0 means not.                                                                                                         |
