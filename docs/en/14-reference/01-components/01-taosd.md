...
| metaEntryCache           | since  3.3.6.33   | Not supported                      | Whether to cache meta tags                                   |
| metaEntryCacheSize       | since  3.3.6.33   | Supported, effective immediately   | The reserved memory size to cache meta tags                  |
