...
- TDengine Server: [Official Installation Docs](../../../04-quick-start/index.md)
- taosgen Tool (built into TDengine, for test data generation): [taosgen User Guide](../../04-tools/02-taosgen.md)
...
> For TDengine server config, refer to [taosd Configuration](../../03-components/01-taosd.md).
...
![HTML Report](../../../assets/jmeter-01.png)
...
> See [TDengine JDBC Docs](../../../10-developer-guide/08-connectors-reference/02-java.mdx#properties) for more options.
...
- [taosgen Guide](../../04-tools/02-taosgen.md)
