...
2. Starting from version 3.4.0.0, taosX requires creating an XNODE before creating tasks. Refer to [Creating XNODE](../../05-tdengine-sql/08-cluster-management/02-xnode.md#create-xnode).
