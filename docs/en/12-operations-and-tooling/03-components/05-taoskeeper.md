...
- taosKeeper is automatically installed with the official TDengine installation package, for details please refer to [TDengine Installation](../../04-quick-start/index.md).
