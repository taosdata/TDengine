...
description: TDengine server-side SSL/TLS certificate generation and taosAdapter configuration
---
...
Client-side SSL/TLS (TrustStore, `wss/useSSL`, REST HTTPS) is documented in [Connector Security Best Practices](./04-connector-security.md#2-ssltls-configuration).
