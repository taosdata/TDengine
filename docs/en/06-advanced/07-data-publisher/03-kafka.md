...
For more details about topic definitions, consumption offsets, and subscription parameters, see [Data Subscription](../../07-develop/07-tmq.md).
...
![Basic information section](./pic/kafka-01-basic-info.webp)
...
![TDengine data subscription section](./pic/kafka-02-tdengine-subscription.webp)
...
![Kafka connection section](./pic/kafka-03-kafka-connection.webp)
...
![Kafka publishing section](./pic/kafka-04-kafka-publish.webp)
...
![Advanced options section](./pic/kafka-05-advanced-options.webp)
...
![Connectivity check section](./pic/kafka-06-connectivity-check.webp)
...
![Preview settings section](./pic/kafka-07-preview.webp)
...
![Kafka preview result section](./pic/kafka-08-preview-result.webp)
