...
5. For each column, whether it is a Metrics column or a tag column, a mapping rule can be configured, see [Zero-code third-party data access](index.md) "Data extraction, filtering, and transformation" section
