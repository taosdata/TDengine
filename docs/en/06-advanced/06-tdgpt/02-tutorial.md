...
```shell
docker run -d -p 6035:6035 -p 6036:6036 -p 6037:6037 tdengine/tdgpt-full:3.4.0.0
```
...
1. Download the tar.gz package from the list:
   ...
   <PkgList productName="TDengine TDgpt-OSS" version="3.4.0.0" platform="Linux-Generic"/>
