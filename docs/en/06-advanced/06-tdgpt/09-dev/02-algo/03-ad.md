...
Starting from version 3.4.1.0, a new Python member variable, input_data_lists, has been added to all anomaly detection classes inherited from AbstractAnomalyDetectionService. This object is an array of arrays (nested array) used to store multi-column input data for anomaly detection.
