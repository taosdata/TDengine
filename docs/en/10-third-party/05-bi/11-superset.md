...
![superset-demo1](../../../zh/10-third-party/05-bi/superset-demo1.webp)  
1. `RAW RECORDS` Type, which displays the collected values of current and voltage during the specified time period in Group 4.  
![superset-demo2](../../../zh/10-third-party/05-bi/superset-demo2.webp)    