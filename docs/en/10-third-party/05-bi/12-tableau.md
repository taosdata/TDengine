...
![Configure ODBC connection](../../assets/tableau-01.webp)
...
![Select tables for analysis](../../assets/tableau-02.webp)

**Step 2**, Click the `Update Now` button below to display the data in the table.

![Display data in selected tables](../../assets/tableau-03.webp)
...
![Configure visualizations](../../assets/tableau-04.webp)
