...
For a detailed introduction of the connection method, please refer to: [Connection Method](../01-connect/index.md)
...
- For other TDengine module errors, please refer to [Error Codes](../09-error-codes.md)
