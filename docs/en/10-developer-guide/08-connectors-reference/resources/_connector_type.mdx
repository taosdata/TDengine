...
![TDengine client library architecture](../../../assets/connector-type-01.png)
...
For the support status of various connection methods and connectors for different languages, please refer to [Connector Features](../../../10-developer-guide/08-connectors-reference/index.md#feature-support).

The key differences are:

1. **Recommended to use WebSocket connection**:
   ...
   - <font color="red">**Native connections for Go, C#, and Java are deprecated and will be discontinued on 2027-01-01, please migrate in advance**</font>

2. Native connection (deprecated; to be discontinued on 2027-01-01 for Go, C#, and Java):
...
3. REST API:
   ...
   - <font color="red">**REST connections for Java, Python, and Go are deprecated and will be discontinued on 2027-01-01, please migrate to WebSocket connection**</font>
