...
- TSDBDriver.PROPERTY_KEY_USE_SSL [`useSSL`]: Whether to use SSL in the connection. Effective only in WebSocket connections. For details, see [Connector Security Best Practices](../../11-security-guide/04-connector-security.md).
