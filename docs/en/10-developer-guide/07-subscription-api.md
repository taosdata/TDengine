...
The parameters for creating a consumer with the Java connector are Properties. For a list of parameters you can set, please refer to [Consumer Parameters](./08-connectors-reference/02-java.mdx)  
...
The parameters for creating a consumer with the Rust connector are DSN. For a list of parameters you can set, please refer to [DSN](./08-connectors-reference/04-rust.mdx#dsn)  
For other parameters, refer to the common basic configuration items mentioned above.
