...
import ConnectionDeprecation from "../08-connectors-reference/resources/_connection_deprecation.mdx";
...
For detailed explanations of URL parameters and how to use them, see [URL specifications](../08-connectors-reference/05-python.mdx#url-specification)
...
For detailed explanation of DSN and how to use it, see [Connection Features](../08-connectors-reference/04-rust.mdx)
...
For specific parameters using the REST API, refer to: [HTTP request format](../08-connectors-reference/10-rest-api.mdx)
...
:::tip
If the connection fails, in most cases it is due to incorrect FQDN or firewall settings. For detailed troubleshooting methods, please see ["Encountering the error 'Unable to establish connection, what should I do?'"](../../16-faq/01-faq.md) in the "Common Questions and Feedback".
