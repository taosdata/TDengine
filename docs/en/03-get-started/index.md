...
You can register for a TDengine Cloud account for free and automatically obtain $250 in credit to test TDengine for yourself.
...
In the dialog box displayed, select **IDMP** to create a TDengine IDMP instance or **TSDB** to create a TDengine TSDB instance.

:::note

Because TDengine IDMP requires TDengine TSDB, a TDengine TSDB instance will also be created if you select TDengine IDMP.

:::

### Create a TDengine IDMP Instance
...
Your TDengine IDMP and TDengine TSDB-Enterprise instances are created and started. This process may take some time. For further instructions, see the [TDengine IDMP documentation](https://idmpdocs.tdengine.com/en/get-started/get-started-cloud/#load-sample-scenarios).

### Create a TDengine TSDB Instance

Create your first instance.

1. Select a cloud and region from the drop-down lists.
1. Enter a name for your instance.
1. Specify whether to enable high availability.
1. Specify whether to create a sample database.
1. Select your desired price plan.
1. Click **Create**.

Your TDengine TSDB-Enterprise instance is created and started. This process may take some time. For further information, see the [TDengine TSDB documentation](/).