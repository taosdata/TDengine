...
- If you use the native connection, please install the TDengine client driver. Please refer to [Install Client Driver](/tdengine-reference/client-libraries/#install-client-driver) for specific steps
