...
- If you use the native connection, please install the TDengine client driver. Please refer to [Install Client Driver](https://docs.tdengine.com/reference/connector/#install-client-driver) for specific steps
