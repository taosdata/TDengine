...
For detailed query syntax please refer to [Select](https://docs.tdengine.com/tdengine-reference/sql-manual/query-data/).
...
Join queries are only allowed between subtables of the same STable. In [Query Data](https://docs.tdengine.com/tdengine-reference/sql-manual/query-data/), all query operations are marked as to whether they support STables or not.
...
For more details please refer to [Aggregate by Window](https://docs.tdengine.com/tdengine-reference/sql-manual/time-series-extensions/#window-partitioning-queries).
