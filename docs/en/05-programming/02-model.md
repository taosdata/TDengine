...
For more details please refer to [Database](https://docs.tdengine.com/reference/taos-sql/database/).
...
For more details please refer to [Create Table Automatically](https://docs.tdengine.com/reference/taos-sql/insert/#automatic-table-creation-during-record-insertion).
