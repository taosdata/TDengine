...
"{\"type\":\"create\",\"tableType\":\"child\",\"tableName\":\"t2\",\"using\":\"st\",\"tagNum\":1,\"tags\":[{\"name\":\"t1\",\"type\":4,\"value\":2}],\"createList\":[]}",
...
static void msg_process(TAOS_RES* msg, int cnt) {
  ...
  if (tmq_get_res_type(msg) == TMQ_RES_TABLE_META || tmq_get_res_type(msg) == TMQ_RES_METADATA) {
    ...
    ASSERT(strcmp(result, result1[cnt]) == 0);
...
tmq_list_t* build_topic_list() {
  ...
  tmq_list_append(topic_list, "topic1");
//   tmq_list_append(topic_list, "topic2");
  return topic_list;
}
