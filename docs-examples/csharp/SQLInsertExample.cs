...
namespace TDengineExample
{
    internal class SQLInsertExample
    {
        ...
        static void Main()
        {
            ...
            CheckRes(res, "failed to create database");
            res = TDengine.Query(conn, "USE power");
            CheckRes(res, "failed to change database");
            ...
            CheckRes(res, "failed to create stable");
            ...
            CheckRes(res, "failed to insert data");
        ...
        static void CheckRes(IntPtr res, String errorMsg) {
