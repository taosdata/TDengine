...
mod tests {
    ...
    async fn test_produce() {
        let dsn = Dsn::from_str("mysql://root:password@192.168.1.45:3306/test_ci?sql=select * from t_metric&start=2021-01-01T00:00:00Z&end=2021-02-01T00:00:00Z&interval=12h&delay=0")
            .unwrap();
