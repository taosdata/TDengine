            ...
            match col_type {
                ...
                "SMALLINT" | "SMALLSERIAL" | "INT2" => {
                    ...
                    match val {
                        ...
                        Err(e) => {
                            tracing::warn!(
                                "migrate postgres, decoding 'SMALLINT/SMALLSERIAL/INT2' result error: {e:?}"
                            );
                            builders[col_cidx]
                                .as_any_mut()
                                .downcast_mut::<array::Int16Builder>()
                ...
                "BIGINT" | "BIGSERIAL" | "INT8" => {
                    ...
                    match val {
                        ...
                        Err(e) => {
                            tracing::warn!(
                                "migrate postgres, decoding 'BIGINT/BIGSERIAL/INT8' result error: {e:?}"
                            );
                            builders[col_cidx]
                                .as_any_mut()
                                .downcast_mut::<array::Int64Builder>()
                ...
                "DOUBLE PRECISION" | "FLOAT8" => {
                    ...
                    match val {
                        ...
                        Err(e) => {
                            tracing::warn!(
                                "migrate postgres, decoding 'DOUBLE PRECISION/FLOAT8' result error: {e:?}"
                            );
                            builders[col_cidx]
                                .as_any_mut()
                                .downcast_mut::<array::Float64Builder>()
                ...
                "VARCHAR" | "CHAR(N)" | "TEXT" | "NAME" | "CITEXT" => {
                    ...
                    match val {
                        ...
                        Err(e) => {
                            tracing::warn!(
                                "migrate postgres, decoding 'VARCHAR/CHAR(N)/...' result error: {e:?}"
                            );
                            builders[col_cidx]
                                .as_any_mut()
                                .downcast_mut::<array::StringBuilder>()
...
mod tests {
    use super::*;
    use crate::{config::connect::ConnectConfig, query::PostgresQuery};
    use sqlx::Executor;
    use std::str::FromStr;
    use taos::Dsn;
