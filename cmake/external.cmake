...
if(${BUILD_LIBSASL})      # {
    ...
    ExternalProject_Add(ext_sasl2
        ...
        PATCH_COMMAND
            COMMAND ./autogen.sh
        CONFIGURE_COMMAND
            COMMAND ./configure -prefix=${_ins} --with-pic --enable-static=yes --enable-shared=no --enable-plain --enable-anon --enable-scram=no --enable-login=no --enable-digest=on CFLAGS=-Wno-missing-braces CXXFLAGS=-Wno-missing-braces
        BUILD_COMMAND
            COMMAND make 
        INSTALL_COMMAND
            COMMAND make install
