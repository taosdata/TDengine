...
if(${BUILD_LIBSASL})      # {
    ...
    ExternalProject_Add(ext_sasl2
        ...
        PATCH_COMMAND
            COMMAND ./autogen.sh
        CONFIGURE_COMMAND
            COMMAND ./configure -prefix=${_ins} --with-pic --enable-static --disable-shared --enable-plain --enable-anon --enable-scram --enable-login --enable-digest --without-openssl  CFLAGS=-Wno-missing-braces CXXFLAGS=-Wno-missing-braces
        BUILD_COMMAND
            COMMAND make 
        INSTALL_COMMAND
            COMMAND make install
