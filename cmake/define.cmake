...
IF(TD_RISCV_64)
    SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wl,--relax -mcmodel=medany")
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wl,--relax -mcmodel=medany")
    ...
    ADD_DEFINITIONS(-DUSE_VOLTAILE=voltaile)
ELSE()
    ADD_DEFINITIONS(-DUSE_VOLTAILE=)
ENDIF()
