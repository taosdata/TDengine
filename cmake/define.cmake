...
IF("${BUILD_XNODED}" STREQUAL "")
    SET(TD_BUILD_XNODED FALSE)
ELSEIF(${BUILD_XNODED} MATCHES "false")
    SET(TD_BUILD_XNODED FALSE)
ELSEIF(${BUILD_XNODED} MATCHES "true")
    SET(TD_BUILD_XNODED TRUE)
ELSEIF(${BUILD_XNODED} MATCHES "internal")
    SET(TD_BUILD_XNODED FALSE)
    SET(TD_BUILD_XNODED_INTERNAL TRUE)
ELSE()
    SET(TD_BUILD_XNODED FALSE)
ENDIF()
