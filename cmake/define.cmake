...
# Allow default user to use default password
IF("${ALLOW_DEFAULT_PASSWORD}" STREQUAL "")
    SET(ALLOW_DEFAULT_PASSWORD "true")
ENDIF()

IF("${ALLOW_DEFAULT_PASSWORD}" MATCHES "true")
    ADD_DEFINITIONS(-DTD_ALLOW_DEFAULT_PASSWORD)
ENDIF()

# Security feature control
IF("${BUILD_SECURITY}" STREQUAL "")
    SET(TD_BUILD_SECURITY TRUE)
ELSEIF(${BUILD_SECURITY} MATCHES "false")
    SET(TD_BUILD_SECURITY FALSE)
ELSEIF(${BUILD_SECURITY} MATCHES "true")
    SET(TD_BUILD_SECURITY TRUE)
ELSE()
    SET(TD_BUILD_SECURITY TRUE)
ENDIF()

IF(TD_BUILD_SECURITY)
    ADD_DEFINITIONS(-DTD_SECURITY_ENABLED)
ENDIF()
