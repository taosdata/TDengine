...
ELSE()
    ...
    elseif(TD_LINUX)
        SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Werror -fPIC -ldl -g3 -gdwarf-2 -Wno-format-truncation -Wno-write-strings -Wno-format-overflow -Wno-stringop-overread")
        SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Werror -fPIC -ldl -g3 -gdwarf-2 -Wno-format-truncation -Wno-write-strings -Wno-format-overflow -Wno-conversion-null -Wno-stringop-overread")
